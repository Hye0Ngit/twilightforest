...
public class TFTeleporter extends ot
{
    public boolean b(final wz world, final nk entity) {
        final int c = 200;
        double d = -1.0;
        int i = 0;
        int j = 0;
        int k = 0;
        final int l = gh.c(entity.o);
        final int i2 = gh.c(entity.q);
    ...
    public boolean isBlockPortal(final wz world, final int x, final int y, final int z) {
        return world.f(x, y, z) == aci.B;
    }
    
    public boolean c(final wz world, final nk entity) {
        final double yFactor = (world.t.g == 0) ? 2.0 : 0.5;
        final byte byte0 = 16;
        double weight = -1.0;
        final int ex = gh.c(entity.o);
        final int ey = gh.c(entity.p * yFactor);
        final int ez = gh.c(entity.q);
        int px = ex;
        int py = ey;
        int pz = ez;
        int k1 = 0;
    ...
    private void makePortalAt(final wz world, final int px, int py, final int pz) {
        if (py < 30) {
            py = 30;
        }
        world.getClass();
        ...
        --py;
        world.o = true;
        world.d(px - 1, py + 0, pz - 1, ox.u.bO);
        world.d(px + 0, py + 0, pz - 1, ox.u.bO);
        world.d(px + 1, py + 0, pz - 1, ox.u.bO);
        world.d(px + 2, py + 0, pz - 1, ox.u.bO);
        world.d(px - 1, py + 0, pz + 0, ox.u.bO);
        world.d(px + 2, py + 0, pz + 0, ox.u.bO);
        world.d(px - 1, py + 0, pz + 1, ox.u.bO);
        world.d(px + 2, py + 0, pz + 1, ox.u.bO);
        world.d(px - 1, py + 0, pz + 2, ox.u.bO);
        world.d(px + 0, py + 0, pz + 2, ox.u.bO);
        world.d(px + 1, py + 0, pz + 2, ox.u.bO);
        world.d(px + 2, py + 0, pz + 2, ox.u.bO);
        world.d(px + 0, py - 1, pz + 0, ox.v.bO);
        world.d(px + 1, py - 1, pz + 0, ox.v.bO);
        world.d(px + 0, py - 1, pz + 1, ox.v.bO);
        world.d(px + 1, py - 1, pz + 1, ox.v.bO);
    ...
    public int randNatureBlockID(final Random random) {
        final int[] block = { ox.af.bO, ox.ag.bO, ox.X.bO, ox.ae.bO, ox.ad.bO };
