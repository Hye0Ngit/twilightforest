...
public class GenLayerTFFourZoom extends fh
{
    int zoomFactor;
    
    public GenLayerTFFourZoom(final long l, final fh genlayer) {
        super(l);
        this.zoomFactor = 2;
        super.a = genlayer;
    }
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] dest = ak.a(swidth * this.zoomFactor * (sdepth * this.zoomFactor));
    ...
    public static fh multipleZoom(final long l, final fh genlayer, final int i) {
        Object obj = genlayer;
        for (int j = 0; j < i; ++j) {
            obj = new GenLayerTFFourZoom(l + j, (fh)obj);
        }
        return (fh)obj;
    }
}
