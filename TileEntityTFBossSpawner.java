...
public class TileEntityTFBossSpawner extends ch
{
    ...
    public void n_() {
        ...
        if (!this.i.F) {
            ...
            final acl entityliving = (acl)aaj.a(this.a(), this.i);
            if (entityliving == null) {
                return;
            }
            final int j = this.i.a((Class)entityliving.getClass(), wq.b((double)this.j, (double)this.k, (double)this.l, (double)(this.j + 1), (double)(this.k + 1), (double)(this.l + 1)).b(100.0, 20.0, 100.0)).size();
            if (j >= 1) {
                this.updateDelay();
                return;
            }
