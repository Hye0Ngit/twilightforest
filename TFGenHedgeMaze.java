...
public class TFGenHedgeMaze extends TFGenerator
{
    ...
    public boolean a(final ry world, final Random rand, final int x, final int y, final int z) {
        ...
        this.maze.oddBias = 2;
        this.maze.torchBlockID = TFBlocks.firefly.bM;
        this.maze.wallBlockID = TFBlocks.hedge.bM;
        this.maze.type = 4;
        this.maze.tall = 3;
        this.maze.roots = 3;
        this.fill(sx, y - 1, sz, msize * 3, 1, msize * 3, yy.u.bM, 0);
        this.putBlockAndMetadata(sx - 1, y, sz + 23, yy.bf.bM, 1, true);
        this.putBlockAndMetadata(sx - 1, y, sz + 28, yy.bf.bM, 1, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 23, yy.bf.bM, 3, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 28, yy.bf.bM, 3, true);
        this.putBlockAndMetadata(sx + 23, y, sz - 1, yy.bf.bM, 2, true);
        this.putBlockAndMetadata(sx + 28, y, sz - 1, yy.bf.bM, 2, true);
        this.putBlockAndMetadata(sx + 23, y, sz + 49, yy.bf.bM, 0, true);
        this.putBlockAndMetadata(sx + 28, y, sz + 49, yy.bf.bM, 0, true);
    ...
    private boolean roomJackO(final int dx, final int dy, final int dz, final int diameter) {
        ...
        this.worldObj.d(rx, dy, rz, yy.bf.bM, this.rand.nextInt(4));
        return true;
    }
}
