...
public class TFGenHedgeMaze extends TFGenerator
{
    ...
    public boolean a(final ge world, final Random rand, final int x, final int y, final int z) {
        ...
        this.maze.tall = 3;
        this.maze.roots = 3;
        this.fill(sx, y - 1, sz, msize * 3, 1, msize * 3, vz.u.bO, 0);
        this.putBlockAndMetadata(sx - 1, y, sz + 23, vz.bf.bO, 1, true);
        this.putBlockAndMetadata(sx - 1, y, sz + 28, vz.bf.bO, 1, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 23, vz.bf.bO, 3, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 28, vz.bf.bO, 3, true);
        this.putBlockAndMetadata(sx + 23, y, sz - 1, vz.bf.bO, 2, true);
        this.putBlockAndMetadata(sx + 28, y, sz - 1, vz.bf.bO, 2, true);
        this.putBlockAndMetadata(sx + 23, y, sz + 49, vz.bf.bO, 0, true);
        this.putBlockAndMetadata(sx + 28, y, sz + 49, vz.bf.bO, 0, true);
    ...
    private boolean roomJackO(final int dx, final int dy, final int dz, final int diameter) {
        ...
        this.worldObj.b(rx, dy, rz, vz.bf.bO, this.rand.nextInt(4));
        return true;
    }
}
