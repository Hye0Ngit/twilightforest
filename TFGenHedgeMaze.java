...
public class TFGenHedgeMaze extends TFGenerator
{
    ...
    public boolean a(final wz world, final Random rand, final int x, final int y, final int z) {
        ...
        this.maze.tall = 3;
        this.maze.roots = 3;
        this.fill(sx, y - 1, sz, msize * 3, 1, msize * 3, ox.u.bO, 0);
        this.putBlockAndMetadata(sx - 1, y, sz + 23, ox.bf.bO, 1, true);
        this.putBlockAndMetadata(sx - 1, y, sz + 28, ox.bf.bO, 1, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 23, ox.bf.bO, 3, true);
        this.putBlockAndMetadata(sx + 49, y, sz + 28, ox.bf.bO, 3, true);
        this.putBlockAndMetadata(sx + 23, y, sz - 1, ox.bf.bO, 2, true);
        this.putBlockAndMetadata(sx + 28, y, sz - 1, ox.bf.bO, 2, true);
        this.putBlockAndMetadata(sx + 23, y, sz + 49, ox.bf.bO, 0, true);
        this.putBlockAndMetadata(sx + 28, y, sz + 49, ox.bf.bO, 0, true);
    ...
    private boolean roomJackO(final int dx, final int dy, final int dz, final int diameter) {
        ...
        this.worldObj.d(rx, dy, rz, ox.bf.bO, this.rand.nextInt(4));
        return true;
    }
}
