...
public class ComponentTFHedgeMaze extends StructureTFComponent
{
    ...
    public ComponentTFHedgeMaze(final ge world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
        this.h = 0;
    ...
    public boolean a(final ge world, final Random rand, final xv sbb) {
        ...
        maze.tall = 3;
        maze.roots = 3;
        maze.setSeed(world.n() + this.g.a * this.g.c);
        for (int fx = 0; fx <= ComponentTFHedgeMaze.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFHedgeMaze.DIAMETER; ++fz) {
                this.a(world, vz.u.bO, 0, fx, ComponentTFHedgeMaze.FLOOR_LEVEL - 1, fz, sbb);
            }
        }
        this.a(world, vz.bf.bO, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, vz.bf.bO, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, vz.bf.bO, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, vz.bf.bO, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, vz.bf.bO, 2, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, vz.bf.bO, 2, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, vz.bf.bO, 0, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
        this.a(world, vz.bf.bO, 0, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
    ...
    void decorate3x3Rooms(final ge world, final int[] rcoords, final xv sbb) {
        for (int i = 0; i < rcoords.length / 2; ++i) {
            int dx = rcoords[i * 2];
    ...
    void decorate3x3Room(final ge world, final int x, final int z, final xv sbb) {
        final Random roomRNG = new Random(world.n() ^ (long)(x + z));
    ...
    private void roomSpawner(final ge world, final Random rand, final int x, final int z, final int diameter, final xv sbb) {
    ...
    private void roomTreasure(final ge world, final Random rand, final int x, final int z, final int diameter, final xv sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.placeTreasureAtCurrentPosition(world, rand, rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, TFTreasure.hedgemaze, sbb);
    }
    
    private void roomJackO(final ge world, final Random rand, final int x, final int z, final int diameter, final xv sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.a(world, vz.bf.bO, rand.nextInt(4), rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, sbb);
    }
