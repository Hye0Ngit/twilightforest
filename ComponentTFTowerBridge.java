...
public class ComponentTFTowerBridge extends ComponentTFTowerWing
{
    ...
    public boolean a(final wz world, final Random rand, final qc sbb) {
        for (int x = 0; x < 3; ++x) {
            this.a(world, ox.aZ.bO, 0, x, 2, 0, sbb);
            this.a(world, ox.aZ.bO, 0, x, 2, 2, sbb);
            this.a(world, ox.bm.bO, 0, x, 1, 0, sbb);
            this.a(world, ox.bm.bO, 0, x, 1, 2, sbb);
            this.a(world, ox.bm.bO, 0, x, 0, 0, sbb);
            this.a(world, ox.bm.bO, 0, x, 0, 1, sbb);
            this.a(world, ox.bm.bO, 0, x, 0, 2, sbb);
            this.a(world, ox.bm.bO, 0, x, -1, 1, sbb);
        }
        return true;
    }
}
