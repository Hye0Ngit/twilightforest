...
public class TFGenCanopyMushroom extends TFGenerator
{
    ...
    public boolean a(final ge world, final Random random, final int treeX, final int treeY, final int treeZ) {
        ...
        if ((blockUnder != vz.u.bO && blockUnder != vz.v.bO && blockUnder != vz.by.bO) || this.y >= 128 - this.treeHeight - 1) {
            return false;
        }
        this.x = treeX;
        this.y = treeY;
        this.z = treeZ;
        this.treeBlock = vz.bn.bO;
        this.treeMeta = 10;
        this.leafBlock = ((this.treeRNG.nextInt(3) == 0) ? vz.bo.bO : vz.bn.bO);
        this.leafMeta = 5;
        this.treeHeight = 12;
