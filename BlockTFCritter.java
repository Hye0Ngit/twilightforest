...
public abstract class BlockTFCritter extends rl
{
    protected BlockTFCritter(final int index, final ls material) {
        super(index, material);
    }
    
    protected BlockTFCritter(final int index, final int sprite, final ls material) {
        super(index, sprite, material);
    }
    
    public void d(final fq world, final int i, final int j, final int k) {
        super.d(world, i, j, k);
    }
    
    public uv a(final fq world, final int i, final int j, final int k, final cc vec3d, final cc vec3d1) {
    ...
    public boolean c(final fq world, final int i, final int j, final int k) {
    ...
    public void e(final fq world, final int i, final int j, final int k, final int l) {
    ...
    public void a(final fq world, final int i, final int j, final int k) {
        super.a(world, i, j, k);
    ...
    private boolean dropCritterIfCantStay(final fq world, final int i, final int j, final int k) {
    ...
    public void a(final fq world, final int i, final int j, final int k, final int l) {
    ...
    protected abstract boolean canPlaceAt(final fq p0, final int p1, final int p2, final int p3);
}
