...
public class GenLayerReinsertFeatures extends wl
{
    private wl withoutLayer;
    private wl withLayer;
    
    public GenLayerReinsertFeatures(final long par1, final wl par3GenLayer, final wl par4GenLayer) {
        super(par1);
