...
public class ComponentTFHollowTreeMedBranch extends ln
{
    int[] src;
    int[] dest;
    double length;
    ...
    protected ComponentTFHollowTreeMedBranch(final int i, final int sx, final int sy, final int sz, final double length, final double angle, final double tilt, final boolean leafy) {
        ...
        this.leafy = leafy;
        this.h = 0;
        this.g = new xv(Math.min(this.src[0], this.dest[0]), Math.min(this.src[1], this.dest[1]), Math.min(this.src[2], this.dest[2]), Math.max(this.src[0], this.dest[0]), Math.max(this.src[1], this.dest[1]), Math.max(this.src[2], this.dest[2]));
    }
    ...
    public boolean a(final ge world, final Random random, final xv sbb) {
    ...
    protected void drawBresehnam(final ge world, final xv sbb, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue) {
