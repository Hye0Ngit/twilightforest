...
{
    public ComponentTFTowerMain(final ry world, final Random rand, final int index, final int x, final int y, final int z) {
        super(index, x, y, z, 15, 45 + rand.nextInt(30), 0);
    }
    ...
    public boolean makeTowerOutbuilding(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        final nk intersect = nk.a(list, outbuilding.e);
