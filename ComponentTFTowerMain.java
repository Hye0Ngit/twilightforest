...
{
    public ComponentTFTowerMain(final fq world, final Random rand, final int index, final int x, final int y, final int z) {
        super(index, x, y, z, 15, 45 + rand.nextInt(world.c - world.e - 20), 0);
    }
    ...
    public boolean makeTowerOutbuilding(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        final ki intersect = StructureTFComponent.getIntersectingStructureComponent(list, outbuilding.g);
