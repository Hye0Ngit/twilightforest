...
public class TFMaze
{
    ...
    public void copyToWorld(final ge world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final ge world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    public void copyToStructure(final ge world, final Random rand, final int dx, final int dy, final int dz, final StructureTFComponent component, final xv sbb) {
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    final int mdx = dx + x / 2 * (this.evenBias + this.oddBias);
    ...
    protected void putWallBlock(final ge world, final int x, final int y, final int z) {
        world.b(x, y, z, this.wallBlockID, this.wallBlockMeta);
    }
    
    protected void putWallBlock(final ge world, final int x, final int y, final int z, final StructureTFComponent component, final xv sbb) {
        component.a(world, this.wallBlockID, this.wallBlockMeta, x, y, z, sbb);
    }
    
    protected void carveBlock(final ge world, final int x, final int y, final int z) {
        world.b(x, y, z, 0, 0);
    }
    
    protected void putRootBlock(final ge world, final int x, final int y, final int z) {
        world.b(x, y, z, this.rootBlockID, this.rootBlockMeta);
    }
    
    protected void putRootBlock(final ge world, final int x, final int y, final int z, final StructureTFComponent component, final xv sbb) {
        component.a(world, this.rootBlockID, this.rootBlockMeta, x, y, z, sbb);
    }
    
    protected void putCanopyTree(final ge world, final int x, final int y, final int z, final StructureTFComponent component, final xv sbb) {
    ...
    public void placeTorches(final ge world) {
            ...
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    ...
                    if (this.isEven(x) && this.isEven(z) && this.shouldTorch(x, z) && world.a(mdx, mdy, mdz) == this.wallBlockID) {
                        world.b(mdx, mdy, mdz, this.torchBlockID, this.torchBlockMeta);
                    }
                }
            }
        }
