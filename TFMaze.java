...
public class TFMaze
{
    ...
    public TFMaze(final int cellsWidth, final int cellsDepth) {
        ...
        this.tall = 3;
        this.roots = 0;
        this.wallBlockID = TFBlocks.mazestone.bM;
        this.wallBlockMeta = 2;
        this.rootBlockID = TFBlocks.mazestone.bM;
        this.rootBlockMeta = 0;
        this.torchBlockID = yy.aq.bM;
    ...
    public void copyToWorld(final ry world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final ry world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    protected void putWallBlock(final ry world, final int x, final int y, final int z) {
        world.d(x, y, z, this.wallBlockID, this.wallBlockMeta);
    }
    
    protected void carveBlock(final ry world, final int x, final int y, final int z) {
        world.d(x, y, z, 0, 0);
    }
    
    protected void putRootBlock(final ry world, final int x, final int y, final int z) {
        world.d(x, y, z, this.rootBlockID, this.rootBlockMeta);
    }
    
    public boolean isEven(final int n) {
        return n % 2 == 0;
    }
    
    public void placeTorches(final ry world) {
    ...
    public boolean shouldTorch(final int rx, final int rz) {
        return this.getRaw(rx + 1, rz) != Integer.MIN_VALUE && this.getRaw(rx - 1, rz) != Integer.MIN_VALUE && this.getRaw(rx, rz + 1) != Integer.MIN_VALUE && this.getRaw(rx, rz - 1) != Integer.MIN_VALUE && (this.getRaw(rx + 1, rz) != 0 || this.getRaw(rx - 1, rz) != 0) && (this.getRaw(rx, rz + 1) != 0 || this.getRaw(rx, rz - 1) != 0) && this.rand.nextInt(2) == 0;
    }
