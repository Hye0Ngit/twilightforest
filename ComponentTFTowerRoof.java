...
public abstract class ComponentTFTowerRoof extends StructureTFComponent
{
    ...
    protected void makeAttachedOverhangBB(final ComponentTFTowerWing wing) {
        switch (this.h) {
            case 0: {
                this.g = new qc(wing.g.a, wing.g.e, wing.g.c - 1, wing.g.d + 1, wing.g.e + this.height - 1, wing.g.f + 1);
                break;
            }
            case 1: {
                this.g = new qc(wing.g.a - 1, wing.g.e, wing.g.c, wing.g.d + 1, wing.g.e + this.height - 1, wing.g.f + 1);
                break;
            }
            case 2: {
                this.g = new qc(wing.g.a - 1, wing.g.e, wing.g.c - 1, wing.g.d, wing.g.e + this.height - 1, wing.g.f + 1);
                break;
            }
            case 3: {
                this.g = new qc(wing.g.a - 1, wing.g.e, wing.g.c - 1, wing.g.d + 1, wing.g.e + this.height - 1, wing.g.f);
                break;
            }
        }
    }
    ...
    protected void makeCapBB(final ComponentTFTowerWing wing) {
        this.g = new qc(wing.g.a, wing.g.e, wing.g.c, wing.g.d, wing.g.e + this.height, wing.g.f);
    }
    ...
    public boolean a(final wz world, final Random random, final qc structureboundingbox) {
        return false;
    }
