...
public class EntityTFFireflyFX extends rp
{
    float fireflyParticleScale;
    int fireflyHalfLife;
    
    public EntityTFFireflyFX(final wz world, final double d, final double d1, final double d2, final float f, final float f1, final float f2) {
        this(world, d, d1, d2, 1.0f, f, f1, f2);
    }
    
    public EntityTFFireflyFX(final wz world, final double d, final double d1, final double d2, final float f, float f1, final float f2, final float f3) {
    ...
    public void a(final adu tessellator, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
