...
public class TFTreasureTable
{
    ...
    public void add(final ym item, final int quantity) {
        this.add(item, quantity, 10);
    }
    
    public void add(final ym item, final int quantity, final int rarity) {
        this.list.add(new TFTreasureItem(item, quantity, rarity));
    }
    
    public void add(final ox block, final int quantity) {
        this.add(block, quantity, 10);
    }
    
    public void add(final ox block, final int quantity, final int rarity) {
    ...
    public aai getRandomItem(final Random rand) {
