...
public class TFTreasureTable
{
    ...
    public void add(final id item, final int quantity) {
        this.add(item, quantity, 10);
    }
    
    public void add(final id item, final int quantity, final int rarity) {
        this.list.add(new TFTreasureItem(item, quantity, rarity));
    }
    
    public void add(final kp itemstack) {
        this.list.add(new TFTreasureItem(itemstack, 10));
    }
    
    public void add(final vz block, final int quantity) {
        this.add(block, quantity, 10);
    }
    
    public void add(final vz block, final int quantity, final int rarity) {
    ...
    public kp getRandomItem(final Random rand) {
