...
{
    private final ro chunkManager;
    private long lastCleanupTime;
    private ek cacheMap;
    private List cache;
    
    public TFFeatureCache(final ro par1WorldChunkManager) {
        this.lastCleanupTime = 0L;
        this.cacheMap = new ek();
    ...
    public abi isAreaFeature(final int mapX, final int mapZ) {
    ...
    public void cleanupCache() {
        ...
        if (l2 > 7500L || l2 < 0L) {
            ...
            for (int i = 0; i < this.cache.size(); ++i) {
                final ail biomecacheblock = this.cache.get(i);
    ...
    static ro getChunkManager(final TFFeatureCache par0BiomeCache) {
