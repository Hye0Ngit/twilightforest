...
public class TFGenHollowHill extends TFGenerator
{
    ...
    public boolean a(final wz world, final Random rand, final int x, final int y, final int z) {
        ...
        for (int i = 0; i < this.sn; ++i) {
            final int[] dest = this.getCoordsInHill2D();
            new TFGenCaveStalactite(ox.t.bO, rand.nextDouble(), true).a(this.worldObj, rand, dest[0], this.hy + 1, dest[1]);
        }
        for (int i = 0; i < this.sn; ++i) {
            final int[] dest = this.getCoordsInHill2D();
            new TFGenCaveStalactite(ox.t.bO, rand.nextDouble() * 0.7, false).a(this.worldObj, rand, dest[0], this.hy + 1, dest[1]);
        }
        if (this.hsize == 3) {
    ...
    protected aai getTreasure(final int level) {
        if (level == 1) {
            switch (this.hillRNG.nextInt(6)) {
                case 0: {
                    return new aai(ym.o, this.hillRNG.nextInt(4) + 1);
                }
                case 1: {
                    return new aai(ym.aw);
                }
                case 2: {
                    return new aai(ym.U);
                }
                case 4: {
                    return new aai(ym.T, this.hillRNG.nextInt(3) + 1);
                }
                default: {
                    return new aai(ox.aq, this.hillRNG.nextInt(16) + 1);
                }
            }
        }
        else if (level == 2) {
            switch (this.hillRNG.nextInt(8)) {
                ...
                case 4: {
                    return new aai(ym.p, this.hillRNG.nextInt(6) + 1);
                }
                case 5: {
                    return new aai(ym.aA);
                }
                case 6: {
                    return new aai(ym.aW, this.hillRNG.nextInt(10) + 1, this.hillRNG.nextInt(16));
                }
                default: {
                    return new aai(ym.F);
                }
            ...
            if (level != 3) {
                return new aai(ym.m, this.hillRNG.nextInt(16) + 1);
            }
            switch (this.hillRNG.nextInt(8)) {
                case 0:
                case 1:
                ...
                case 4: {
                    return new aai(ym.at);
                }
                case 5: {
                    return new aai(ym.bF);
                }
                case 6: {
                    return new aai(ym.aA);
                }
