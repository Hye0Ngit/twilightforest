...
public class ComponentTFHillMaze extends StructureTFComponent
{
    ...
    public ComponentTFHillMaze(final int i, final int x, final int y, final int z, final int hsize) {
        ...
        this.hillSize = hsize;
        this.h = 0;
        this.g = StructureTFComponent.getComponentToAddBoundingBox(x, y, z, -this.getRadius(), 0, -this.getRadius(), this.getRadius() * 2, 5, this.getRadius() * 2, 0);
    }
    ...
    public boolean a(final ge world, final Random rand, final xv sbb) {
        ...
        this.a(world, sbb, 0, 0, 0, this.getDiameter(), 0, this.getDiameter(), TFBlocks.mazestone.bO, 0, false);
        this.a(world, sbb, 0, 4, 0, this.getDiameter(), 4, this.getDiameter(), TFBlocks.mazestone.bO, 0, true);
        final TFMaze maze = new TFMaze(this.getMazeSize(), this.getMazeSize());
        maze.wallBlockID = TFBlocks.mazestone.bO;
    ...
    private void roomTreasure(final ge world, final Random rand, final int x, final int z, final int diameter, final xv sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.placeTreasureAtCurrentPosition(world, rand, rx, 1, rz, TFTreasure.underhill_room, sbb);
    }
}
