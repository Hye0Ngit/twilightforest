...
public class TileEntityTFLichSpawner extends dx
{
    ...
    public boolean c() {
        final ih closestPlayer = this.k.a(this.l + 0.5, this.m + 0.5, this.n + 0.5, 9.0);
        return closestPlayer != null && closestPlayer.bn > this.m - 2;
    }
    ...
    public void q_() {
        ...
        if (!this.k.F) {
            ...
            final ne entityliving = (ne)kr.a("Twilight Lich", this.k);
            if (entityliving == null) {
                return;
            }
            final int j = this.k.a((Class)entityliving.getClass(), fp.b((double)this.l, (double)this.m, (double)this.n, (double)(this.l + 1), (double)(this.m + 1), (double)(this.n + 1)).b(30.0, 30.0, 30.0)).size();
            if (j >= 1) {
                this.updateDelay();
                return;
            }
