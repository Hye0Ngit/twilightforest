...
public class ComponentTFLeafSphere extends hb
{
    int rad;
    ...
    protected ComponentTFLeafSphere(final int index, final int x, final int y, final int z, final int radius) {
        super(index);
        this.h = 0;
        this.g = new qc(x - radius, y - radius, z - radius, x + radius, y + radius, z + radius);
        this.rad = radius;
    }
    ...
    protected void placeBlockIfEmpty(final wz world, final int blockID, final int meta, final int x, final int y, final int z, final qc sbb) {
