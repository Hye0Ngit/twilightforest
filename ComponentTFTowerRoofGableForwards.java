...
public class ComponentTFTowerRoofGableForwards extends ComponentTFTowerRoof
{
    ...
    public boolean a(final fq world, final Random rand, final vw sbb) {
            ...
            for (int x = 0; x <= this.size - 2; ++x) {
                for (int z = min; z <= max; ++z) {
                    if (z == min || z == max) {
                        ...
                        this.a(world, ud.al.bO, 5, x, y, z, sbb);
                    }
                }
            }
        }
        ...
        this.a(world, ud.am.bO, 2, 0, top, zMid, sbb);
        this.a(world, ud.am.bO, 2, this.size - 3, top, zMid, sbb);
        this.a(world, ud.al.bO, 2, this.size - 2, top, zMid, sbb);
        this.a(world, ud.al.bO, 2, this.size - 1, top, zMid, sbb);
        this.a(world, ud.am.bO, 2, this.size - 1, top + 1, zMid, sbb);
        return true;
    }
