...
public class ComponentTFNagaCourtyard extends StructureTFComponent
{
    ...
    public ComponentTFNagaCourtyard(final wz world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
        this.h = 0;
    ...
    public boolean a(final wz world, final Random rand, final qc sbb) {
        for (int fx = 0; fx <= ComponentTFNagaCourtyard.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFNagaCourtyard.DIAMETER; ++fz) {
                if (rand.nextInt(3) == 0) {
                    this.a(world, ox.aj.bO, 0, fx, 0, fz, sbb);
                    if (rand.nextInt(20) == 0) {
                        this.a(world, ox.ak.bO, 0, fx, 1, fz, sbb);
                    }
                    else {
                    ...
                    this.a(world, ox.u.bO, 0, fx, 0, fz, sbb);
                }
            }
        }
        for (int fx = 0; fx <= ComponentTFNagaCourtyard.DIAMETER; ++fx) {
            ...
            if (fx % 2 == 0) {
                this.a(world, ox.ak.bO, 5, fx, 2, ComponentTFNagaCourtyard.DIAMETER, sbb);
                this.a(world, ox.bm.bO, 0, fx, 2, 0, sbb);
            }
            else {
                this.a(world, ox.ak.bO, 5, fx, 2, 0, sbb);
                this.a(world, ox.bm.bO, 0, fx, 2, ComponentTFNagaCourtyard.DIAMETER, sbb);
            }
        }
        for (int fz2 = 0; fz2 <= ComponentTFNagaCourtyard.DIAMETER; ++fz2) {
            ...
            if (fz2 % 2 == 0) {
                this.a(world, ox.ak.bO, 5, ComponentTFNagaCourtyard.DIAMETER, 2, fz2, sbb);
                this.a(world, ox.bm.bO, 0, 0, 2, fz2, sbb);
            }
            else {
                this.a(world, ox.ak.bO, 5, 0, 2, fz2, sbb);
                this.a(world, ox.bm.bO, 0, ComponentTFNagaCourtyard.DIAMETER, 2, fz2, sbb);
            }
        }
    ...
    public boolean makePillar(final wz world, final Random rand, final int x, final int y, final int z, final qc sbb) {
        final int height = 8;
        this.a(world, ox.ak.bO, 0, x - 1, y + 0, z - 1, sbb);
        this.a(world, ox.ak.bO, 0, x + 0, y + 0, z - 1, sbb);
        this.a(world, ox.ak.bO, 0, x + 1, y + 0, z - 1, sbb);
        this.a(world, ox.ak.bO, 0, x - 1, y + 0, z + 0, sbb);
        this.a(world, ox.ak.bO, 0, x + 1, y + 0, z + 0, sbb);
        this.a(world, ox.ak.bO, 0, x - 1, y + 0, z + 1, sbb);
        this.a(world, ox.ak.bO, 0, x + 0, y + 0, z + 1, sbb);
        this.a(world, ox.ak.bO, 0, x + 1, y + 0, z + 1, sbb);
        for (int i = 0; i < height; ++i) {
            ...
            if (i > 0 && rand.nextInt(2) == 0) {
                switch (rand.nextInt(4)) {
                    case 0: {
                        this.a(world, ox.bu.bO, 8, x - 1, y + i, z + 0, sbb);
                        break;
                    }
                    case 1: {
                        this.a(world, ox.bu.bO, 2, x + 1, y + i, z + 0, sbb);
                        break;
                    }
                    case 2: {
                        this.a(world, ox.bu.bO, 4, x + 0, y + i, z + 1, sbb);
                        break;
                    }
                    case 3: {
                        this.a(world, ox.bu.bO, 1, x + 0, y + i, z - 1, sbb);
                        break;
                    }
                }
            }
        ...
        if (height == 8) {
            this.a(world, ox.ak.bO, 0, x - 1, y + 8, z - 1, sbb);
            this.a(world, ox.ak.bO, 0, x + 0, y + 8, z - 1, sbb);
            this.a(world, ox.ak.bO, 0, x + 1, y + 8, z - 1, sbb);
            this.a(world, ox.ak.bO, 0, x - 1, y + 8, z + 0, sbb);
            this.a(world, ox.ak.bO, 5, x + 0, y + 8, z + 0, sbb);
            this.a(world, ox.ak.bO, 0, x + 1, y + 8, z + 0, sbb);
            this.a(world, ox.ak.bO, 0, x - 1, y + 8, z + 1, sbb);
            this.a(world, ox.ak.bO, 0, x + 0, y + 8, z + 1, sbb);
            this.a(world, ox.ak.bO, 0, x + 1, y + 8, z + 1, sbb);
    ...
    public void randomBrick(final wz world, final Random rand, final int x, final int y, final int z, final qc sbb) {
        this.a(world, ox.bm.bO, rand.nextInt(4), x, y, z, sbb);
    }
