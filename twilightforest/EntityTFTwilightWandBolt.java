...
public class EntityTFTwilightWandBolt extends rh
{
    public EntityTFTwilightWandBolt(final xv par1World) {
        super(par1World);
    }
    
    public EntityTFTwilightWandBolt(final xv par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }
    
    public EntityTFTwilightWandBolt(final xv par1World, final md par2EntityLiving) {
