...
public class TFWorld extends xd
{
    public static int SEALEVEL;
    public static int WORLDHEIGHT;
    
    public TFWorld(final xd world, final alb worldprovider) {
    ...
    public uh x() {
        final uh twilightSpawn;
        final uh originalSpawn = twilightSpawn = new uh(this.x.c(), this.x.d(), this.x.e());
