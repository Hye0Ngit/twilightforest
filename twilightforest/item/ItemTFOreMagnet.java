        ...
        if (baseY != -1 && foundID != -1) {
            ...
            for (final ChunkCoordinates coord : veinBlocks) {
                ...
                if (isReplaceable(world, replaceID, replaceMeta, replaceX, replaceY, replaceZ) || replaceID == 0) {
                    world.func_72832_d(coord.field_71574_a, coord.field_71572_b, coord.field_71573_c, Block.field_71981_t.field_71990_ca, 0, 2);
