...
public class ItemTFOreMagnet extends ItemTF
{
    ...
    public static int doMagnet(final World world, final int useX, final int useY, final int useZ, final int destX, final int destY, final int destZ) {
        ...
        for (final ChunkCoordinates coord : lineArray) {
            final int searchID = world.func_72798_a(coord.field_71574_a, coord.field_71572_b, coord.field_71573_c);
        ...
        if (baseY != -1 && foundID != -1) {
            ...
            for (final ChunkCoordinates coord2 : veinBlocks) {
                ...
                world.func_72832_d(coord2.field_71574_a, coord2.field_71572_b, coord2.field_71573_c, isNetherrack ? Block.field_72012_bb.field_71990_ca : Block.field_71981_t.field_71990_ca, 0, 2);
    ...
    private static boolean findVein(final World world, final int x, final int y, final int z, final int oreID, final int oreMeta, final ArrayList<ChunkCoordinates> veinBlocks) {
