...
public class ItemTFLifeDrainWand extends ItemTF
{
    ...
    public static void animateTargetShatter(final World worldObj, final EntityLiving target) {
        for (int var1 = 0; var1 < 50; ++var1) {
            final double gaussX = ItemTFLifeDrainWand.field_77697_d.nextGaussian() * 0.02;
            final double gaussY = ItemTFLifeDrainWand.field_77697_d.nextGaussian() * 0.02;
            final double gaussZ = ItemTFLifeDrainWand.field_77697_d.nextGaussian() * 0.02;
            final double gaussFactor = 10.0;
            final int popItem = (getTargetDropItemId(target) > 0) ? getTargetDropItemId(target) : Item.field_77737_bm.field_77779_bT;
            worldObj.func_72869_a("iconcrack_" + popItem, target.field_70165_t + ItemTFLifeDrainWand.field_77697_d.nextFloat() * target.field_70130_N * 2.0f - target.field_70130_N - gaussX * gaussFactor, target.field_70163_u + ItemTFLifeDrainWand.field_77697_d.nextFloat() * target.field_70131_O - gaussY * gaussFactor, target.field_70161_v + ItemTFLifeDrainWand.field_77697_d.nextFloat() * target.field_70130_N * 2.0f - target.field_70130_N - gaussZ * gaussFactor, gaussX, gaussY, gaussZ);
        }
    }
    
    public static int getTargetDropItemId(final EntityLiving target) {
    ...
    private Entity getPlayerLookTarget(final World worldObj, final EntityPlayer player) {
        ...
        final Vec3 srcVec = worldObj.func_82732_R().func_72345_a(player.field_70165_t, player.field_70163_u + player.func_70047_e(), player.field_70161_v);
        ...
        final List possibleList = worldObj.func_72839_b((Entity)player, player.field_70121_D.func_72321_a(lookVec.field_72450_a * range, lookVec.field_72448_b * range, lookVec.field_72449_c * range).func_72314_b((double)var9, (double)var9, (double)var9));
        double hitDist = 0.0;
    ...
    public void onUsingItemTick(final ItemStack stack, final EntityPlayer player, final int count) {
        ...
        if (count % 5 == 0) {
            ...
            if (pointedEntity != null && pointedEntity instanceof EntityLiving) {
                final EntityLiving target = (EntityLiving)pointedEntity;
                if (target.func_70660_b(Potion.field_76421_d) != null || target.func_70630_aN() < 1) {
                    if (target.func_70630_aN() <= 3) {
                        ...
                        target.func_70656_aK();
                        worldObj.func_72956_a((Entity)target, "damage.fallbig", 1.0f, ((ItemTFLifeDrainWand.field_77697_d.nextFloat() - ItemTFLifeDrainWand.field_77697_d.nextFloat()) * 0.7f + 1.0f) * 2.0f);
                        ...
                        target.func_70097_a(DamageSource.func_76354_b((Entity)player, (Entity)player), 3);
                        if (target.func_70667_aM() <= player.func_70667_aM()) {
                    ...
                    if (!worldObj.field_72995_K) {
                        target.func_70097_a(DamageSource.func_76354_b((Entity)player, (Entity)player), 1);
                        if (target.func_70667_aM() <= player.func_70667_aM()) {
                            target.field_70159_w = 0.0;
                            target.field_70181_x = 0.2;
                            target.field_70179_y = 0.0;
