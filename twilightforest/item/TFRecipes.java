...
public class TFRecipes
{
    public static void registerRecipes() {
        ...
        addEnchantedRecipe(TFItems.fieryHelm, TFEnchantment.fieryAura, 2, "###", "# #", '#', TFItems.fieryIngot);
        addEnchantedRecipe(TFItems.fieryPlate, TFEnchantment.fieryAura, 2, "# #", "###", "###", '#', TFItems.fieryIngot);
        addEnchantedRecipe(TFItems.fieryLegs, TFEnchantment.fieryAura, 2, "###", "# #", "# #", '#', TFItems.fieryIngot);
        addEnchantedRecipe(TFItems.fieryBoots, TFEnchantment.fieryAura, 2, "# #", "# #", '#', TFItems.fieryIngot);
        ...
        GameRegistry.addRecipe(new ItemStack(TFItems.knightlyAxe), new Object[] { "##", "X#", "X ", '#', TFItems.knightMetal, 'X', Items.field_151055_y });
        addEnchantedRecipe(TFItems.yetiHelm, Enchantment.field_77332_c, 2, TFEnchantment.chillAura, 1, "###", "# #", '#', TFItems.alphaFur);
        addEnchantedRecipe(TFItems.yetiPlate, Enchantment.field_77332_c, 2, TFEnchantment.chillAura, 1, "# #", "###", "###", '#', TFItems.alphaFur);
        addEnchantedRecipe(TFItems.yetiLegs, Enchantment.field_77332_c, 2, TFEnchantment.chillAura, 1, "###", "# #", "# #", '#', TFItems.alphaFur);
        ...
        GameRegistry.addRecipe(new ItemStack((Block)TFBlocks.auroraSlab, 6, 0), new Object[] { "###", '#', TFBlocks.auroraBrick });
        GameRegistry.addRecipe(new ItemStack(TFBlocks.auroraPillar, 2, 0), new Object[] { "#", "#", '#', TFBlocks.auroraBrick });
    }
