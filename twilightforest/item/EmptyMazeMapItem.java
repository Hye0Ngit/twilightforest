...
public class EmptyMazeMapItem extends AbstractMapItem
{
    ...
    public ActionResult<ItemStack> func_77659_a(final World worldIn, final PlayerEntity playerIn, final Hand handIn) {
        final ItemStack itemstack = MazeMapItem.setupNewMap(worldIn, MathHelper.func_76128_c(playerIn.func_226277_ct_()), MathHelper.func_76128_c(playerIn.func_226281_cx_()), (byte)0, true, false, MathHelper.func_76128_c(playerIn.func_226278_cu_()), this.mapOres);
