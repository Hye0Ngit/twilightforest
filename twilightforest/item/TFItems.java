...
{
    public static ItemArmor.ArmorMaterial ARMOR_NAGA;
    public static ItemArmor.ArmorMaterial ARMOR_IRONWOOD;
    public static ItemArmor.ArmorMaterial ARMOR_FIERY;
    public static ItemArmor.ArmorMaterial ARMOR_STEELEAF;
    public static ItemArmor.ArmorMaterial ARMOR_KNIGHTLY;
    public static ItemArmor.ArmorMaterial ARMOR_PHANTOM;
    public static ItemArmor.ArmorMaterial ARMOR_YETI;
    public static ItemArmor.ArmorMaterial ARMOR_ARCTIC;
    public static Item.ToolMaterial TOOL_IRONWOOD;
    public static Item.ToolMaterial TOOL_FIERY;
    public static Item.ToolMaterial TOOL_STEELEAF;
    public static Item.ToolMaterial TOOL_KNIGHTLY;
    public static Item.ToolMaterial TOOL_GIANT;
    public static Item.ToolMaterial TOOL_ICE;
    public static Item.ToolMaterial TOOL_GLASS;
    static final UUID GIANT_REACH_MODIFIER;
    ...
    public static void initRepairMaterials() {
        TFItems.ARMOR_NAGA.setRepairItem(new ItemStack(TFItems.naga_scale));
        TFItems.ARMOR_IRONWOOD.setRepairItem(new ItemStack(TFItems.ironwood_ingot));
        TFItems.ARMOR_FIERY.setRepairItem(new ItemStack(TFItems.fiery_ingot));
        TFItems.ARMOR_STEELEAF.setRepairItem(new ItemStack(TFItems.steeleaf_ingot));
        TFItems.ARMOR_KNIGHTLY.setRepairItem(new ItemStack(TFItems.knightmetal_ingot));
        TFItems.ARMOR_PHANTOM.setRepairItem(new ItemStack(TFItems.knightmetal_ingot));
        TFItems.ARMOR_YETI.setRepairItem(new ItemStack(TFItems.alpha_fur));
        TFItems.ARMOR_ARCTIC.setRepairItem(new ItemStack(TFItems.arctic_fur));
        TFItems.TOOL_IRONWOOD.setRepairItem(new ItemStack(TFItems.ironwood_ingot));
        TFItems.TOOL_FIERY.setRepairItem(new ItemStack(TFItems.fiery_ingot));
        TFItems.TOOL_STEELEAF.setRepairItem(new ItemStack(TFItems.steeleaf_ingot));
        TFItems.TOOL_KNIGHTLY.setRepairItem(new ItemStack(TFItems.knightmetal_ingot));
        TFItems.TOOL_GIANT.setRepairItem(new ItemStack(TFItems.knightmetal_ingot));
        TFItems.TOOL_ICE.setRepairItem(new ItemStack(Blocks.field_150403_cj));
    }
    
    static {
        TFItems.ARMOR_NAGA = EnumHelper.addArmorMaterial("NAGA_SCALE", "naga_scale", 21, new int[] { 3, 6, 7, 2 }, 15, SoundEvents.field_187719_p, 0.5f);
        TFItems.ARMOR_IRONWOOD = EnumHelper.addArmorMaterial("IRONWOOD", "ironwood", 20, new int[] { 2, 5, 7, 2 }, 15, SoundEvents.field_187719_p, 0.0f);
        TFItems.ARMOR_FIERY = EnumHelper.addArmorMaterial("FIERY", "fiery", 25, new int[] { 4, 7, 9, 4 }, 10, SoundEvents.field_187719_p, 1.5f);
        TFItems.ARMOR_STEELEAF = EnumHelper.addArmorMaterial("STEELEAF", "steeleaf", 10, new int[] { 3, 6, 8, 3 }, 9, SoundEvents.field_187719_p, 0.0f);
        TFItems.ARMOR_KNIGHTLY = EnumHelper.addArmorMaterial("KNIGHTMETAL", "knightly", 20, new int[] { 3, 6, 8, 3 }, 8, SoundEvents.field_187719_p, 1.0f);
        TFItems.ARMOR_PHANTOM = EnumHelper.addArmorMaterial("KNIGHTPHANTOM", "phantom", 30, new int[] { 3, 6, 8, 3 }, 8, SoundEvents.field_187719_p, 2.5f);
        TFItems.ARMOR_YETI = EnumHelper.addArmorMaterial("YETI", "yetiarmor", 20, new int[] { 3, 6, 7, 4 }, 15, SoundEvents.field_187719_p, 3.0f);
        TFItems.ARMOR_ARCTIC = EnumHelper.addArmorMaterial("ARCTIC", "arcticarmor", 10, new int[] { 2, 5, 7, 2 }, 8, SoundEvents.field_187719_p, 2.0f);
        ...
        TFItems.TOOL_GIANT = EnumHelper.addToolMaterial("GIANTSTONE", 1, 1024, 4.0f, 1.0f, 5);
        TFItems.TOOL_ICE = EnumHelper.addToolMaterial("TFICE", 0, 32, 1.0f, 3.5f, 5);
        TFItems.TOOL_GLASS = EnumHelper.addToolMaterial("TFGLASS", 0, 1, 1.0f, 36.0f, 30);
