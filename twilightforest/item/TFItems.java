...
public class TFItems
{
    ...
    public static void registerItems() {
        ...
        final int yetiRenderID = TwilightForestMod.proxy.registerArmorRenderID("twilightforest/yeti_");
        final int arcticRenderID = TwilightForestMod.proxy.registerArmorRenderID("twilightforest/arctic_");
        ...
        TFItems.minotaurAxe = new ItemTFMinotaurAxe(Item.ToolMaterial.EMERALD).func_77655_b("minotaurAxe").func_77625_d(1);
        TFItems.mazebreakerPick = new ItemTFMazebreakerPick(Item.ToolMaterial.EMERALD).func_77655_b("mazebreakerPick").func_77625_d(1);
    ...
    private static void registerTFItem(final Item item, final String englishName) {
        GameRegistry.registerItem(item, item.func_77658_a(), "TwilightForest");
    }
    
    private static void registerTFItem(final Item item) {
        GameRegistry.registerItem(item, item.func_77658_a(), "TwilightForest");
    }
    ...
    static {
        ...
        TFItems.ARMOR_YETI = EnumHelper.addArmorMaterial("YETI", 20, new int[] { 4, 7, 6, 3 }, 15);
        TFItems.ARMOR_ARCTIC = EnumHelper.addArmorMaterial("ARCTIC", 10, new int[] { 2, 7, 5, 2 }, 8);
