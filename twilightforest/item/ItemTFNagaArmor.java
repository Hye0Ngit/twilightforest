...
public class ItemTFNagaArmor extends ItemArmor implements IArmorTextureProvider
{
    ...
    public String getArmorTextureFile(final ItemStack itemstack) {
        if (itemstack.field_77993_c == TFItems.plateNaga.field_77779_bT) {
            return "/mods/twilightforest/textures/armor/naga_scale_1.png";
        }
        if (itemstack.field_77993_c == TFItems.legsNaga.field_77779_bT) {
            return "/mods/twilightforest/textures/armor/naga_scale_2.png";
        }
        return "/mods/twilightforest/textures/armor/naga_scale_1.png";
    }
