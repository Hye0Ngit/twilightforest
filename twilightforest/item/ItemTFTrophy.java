...
public class ItemTFTrophy extends ItemTF
{
    ...
    public boolean func_77648_a(final ItemStack itemStack, final EntityPlayer player, final World world, int x, int y, int z, final int direction, final float par8, final float par9, final float par10) {
        ...
        if (!TFBlocks.trophy.func_71930_b(world, x, y, z)) {
            return false;
        }
        world.func_72832_d(x, y, z, TFBlocks.trophy.field_71990_ca, direction, 3);
        int skullRotate = 0;
        if (direction == 1) {
            skullRotate = (MathHelper.func_76128_c(player.field_70177_z * 16.0f / 360.0f + 0.5) & 0xF);
        }
        final TileEntity tileEntity = world.func_72796_p(x, y, z);
        if (tileEntity != null && tileEntity instanceof TileEntitySkull) {
            String skullName = "";
            if (itemStack.func_77942_o() && itemStack.func_77978_p().func_74764_b("SkullOwner")) {
                skullName = itemStack.func_77978_p().func_74779_i("SkullOwner");
            }
            ((TileEntitySkull)tileEntity).func_82118_a(itemStack.func_77960_j(), skullName);
            ((TileEntitySkull)tileEntity).func_82116_a(skullRotate);
        }
    ...
    public void func_94581_a(final IconRegister par1IconRegister) {
        this.trophyIcons = new Icon[ItemTFTrophy.trophyTextures.length];
