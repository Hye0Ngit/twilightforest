...
public class ItemTFEmptyMazeMap extends ItemMapBase implements ModelRegisterCallback
{
    ...
    public ActionResult<ItemStack> func_77659_a(final World worldIn, final EntityPlayer playerIn, final EnumHand handIn) {
        final ItemStack itemstack = ItemTFMazeMap.setupNewMap(worldIn, playerIn.field_70165_t, playerIn.field_70161_v, (byte)0, true, false, playerIn.field_70163_u, this.mapOres);
