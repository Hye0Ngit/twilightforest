...
public class ItemTFSteeleafArmor extends ItemArmor implements IArmorTextureProvider
{
    public ItemTFSteeleafArmor(final int par1, final EnumArmorMaterial par2EnumArmorMaterial, final int renderIndex, final int armorType) {
    ...
    public String getArmorTextureFile(final ItemStack itemstack) {
        if (itemstack.field_77993_c == TFItems.steeleafPlate.field_77779_bT || itemstack.field_77993_c == TFItems.steeleafHelm.field_77779_bT || itemstack.field_77993_c == TFItems.steeleafBoots.field_77779_bT) {
            return "/mods/twilightforest/textures/armor/steeleaf_1.png";
        }
        if (itemstack.field_77993_c == TFItems.steeleafLegs.field_77779_bT) {
