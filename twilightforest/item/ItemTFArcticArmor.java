...
{
    public ItemTFArcticArmor(final ItemArmor.ArmorMaterial par2EnumArmorMaterial, final int renderIndex, final int armorType) {
    ...
    public boolean func_82789_a(final ItemStack par1ItemStack, final ItemStack par2ItemStack) {
        return par2ItemStack.func_77973_b() == TFItems.arcticFur || super.func_82789_a(par1ItemStack, par2ItemStack);
    }
