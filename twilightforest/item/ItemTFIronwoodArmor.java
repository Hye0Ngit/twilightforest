...
{
    public ItemTFIronwoodArmor(final ItemArmor.ArmorMaterial par2EnumArmorMaterial, final int renderIndex, final int armorType) {
    ...
    public String getArmorTexture(final ItemStack itemstack, final Entity entity, final int slot, final String layer) {
        if (itemstack.func_77973_b() == TFItems.ironwoodPlate || itemstack.func_77973_b() == TFItems.ironwoodHelm || itemstack.func_77973_b() == TFItems.ironwoodBoots) {
            return "twilightforest:textures/armor/ironwood_1.png";
        }
        if (itemstack.func_77973_b() == TFItems.ironwoodLegs) {
