...
public class ItemTFIronwoodArmor extends wg
{
    public ItemTFIronwoodArmor(final int par1, final wi par2EnumArmorMaterial, final int renderIndex, final int armorType) {
    ...
    public String getArmorTexture(final yd itemstack, final nm entity, final int slot, final int layer) {
        if (itemstack.d == TFItems.ironwoodPlate.cv || itemstack.d == TFItems.ironwoodHelm.cv || itemstack.d == TFItems.ironwoodBoots.cv) {
            return "twilightforest:textures/armor/ironwood_1.png";
        }
        if (itemstack.d == TFItems.ironwoodLegs.cv) {
