...
public class ItemTFFieryPick extends ItemPickaxe
{
    ...
    public boolean func_77660_a(final ItemStack par1ItemStack, final World par2World, final int blockID, final int x, final int y, final int z, final EntityLivingBase par7EntityLiving) {
        if (super.func_77660_a(par1ItemStack, par2World, blockID, x, y, z, par7EntityLiving) && this.func_77641_a(Block.field_71973_m[blockID])) {
            if (par2World.field_72995_K) {
                final int meta = par2World.func_72805_g(x, y, z);
                final ArrayList<ItemStack> items = Block.field_71973_m[blockID].getBlockDropped(par2World, x, y, z, meta, 0);
