...
public class ItemTFLampOfCinders extends ItemTF
{
    ...
    private void doBurnEffect(final World world, final EntityPlayer player) {
        ...
        for (int i = 0; i < 6; ++i) {
            final int rx = px + ItemTFLampOfCinders.field_77697_d.nextInt(range) - ItemTFLampOfCinders.field_77697_d.nextInt(range);
            final int ry = py + ItemTFLampOfCinders.field_77697_d.nextInt(2);
            final int rz = pz + ItemTFLampOfCinders.field_77697_d.nextInt(range) - ItemTFLampOfCinders.field_77697_d.nextInt(range);
