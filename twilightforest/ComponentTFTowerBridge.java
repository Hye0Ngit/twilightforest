...
public class ComponentTFTowerBridge extends ComponentTFTowerWing
{
    ...
    public boolean a(final xd world, final Random rand, final qg sbb) {
        for (int x = 0; x < 3; ++x) {
            this.a(world, pb.aZ.bO, 0, x, 2, 0, sbb);
            this.a(world, pb.aZ.bO, 0, x, 2, 2, sbb);
            this.a(world, pb.bm.bO, 0, x, 1, 0, sbb);
            this.a(world, pb.bm.bO, 0, x, 1, 2, sbb);
            this.a(world, pb.bm.bO, 0, x, 0, 0, sbb);
            this.a(world, pb.bm.bO, 0, x, 0, 1, sbb);
            this.a(world, pb.bm.bO, 0, x, 0, 2, sbb);
            this.a(world, pb.bm.bO, 0, x, -1, 1, sbb);
        }
        this.a(world, pb.bm.bO, 0, -1, -1, 1, sbb);
        this.a(world, pb.bm.bO, 0, 3, -1, 1, sbb);
        return true;
    }
}
