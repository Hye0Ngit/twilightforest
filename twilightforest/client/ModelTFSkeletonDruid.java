...
public class ModelTFSkeletonDruid extends awp
{
    public axx dress;
    
    public ModelTFSkeletonDruid() {
        final float f = 0.0f;
        (this.e = new axx((awt)this, 8, 16)).a(-4.0f, 0.0f, -2.0f, 8, 12, 4, f);
        this.e.a(0.0f, 0.0f + f, 0.0f);
        (this.f = new axx((awt)this, 0, 16)).a(-1.0f, -2.0f, -1.0f, 2, 12, 2, f);
        ...
        this.i = new axx((awt)this, 0, 16);
        this.i.i = true;
        this.i.a(-1.0f, 0.0f, -1.0f, 2, 12, 2);
        this.i.a(2.0f, 12.0f, 0.0f);
        (this.dress = new axx((awt)this, 40, 16)).a(-4.0f, 12.0f, -2.0f, 8, 12, 4, f);
