...
public class RenderBlockTFMagicLeaves implements ISimpleBlockRenderingHandler
{
    ...
    private void restoreRendererRotate(final baq renderer) {
        renderer.p = 0;
        renderer.n = 0;
        renderer.o = 0;
        renderer.q = 0;
    ...
    private void setRenderRotate(final baq renderer, final int meta) {
    ...
    public static void renderInvNormalBlock(final baq renderblocks, final amj par1Block, final int meta) {
        final bao tessellator = bao.a;
