...
public class RenderBlockTFMagicLeaves implements ISimpleBlockRenderingHandler
{
    ...
    public static void renderInvNormalBlock(final RenderBlocks renderblocks, final Block par1Block, final int meta) {
        ...
        renderblocks.func_78611_c(par1Block, 0.0, 0.0, 0.0, par1Block.func_71858_a(2, meta));
        tessellator.func_78381_a();
        tessellator.func_78382_b();
        tessellator.func_78375_b(0.0f, 0.0f, 1.0f);
        renderblocks.func_78622_d(par1Block, 0.0, 0.0, 0.0, par1Block.func_71858_a(3, meta));
        tessellator.func_78381_a();
        tessellator.func_78382_b();
        tessellator.func_78375_b(-1.0f, 0.0f, 0.0f);
        renderblocks.func_78573_e(par1Block, 0.0, 0.0, 0.0, par1Block.func_71858_a(4, meta));
        tessellator.func_78381_a();
        tessellator.func_78382_b();
        tessellator.func_78375_b(1.0f, 0.0f, 0.0f);
        renderblocks.func_78605_f(par1Block, 0.0, 0.0, 0.0, par1Block.func_71858_a(5, meta));
        tessellator.func_78381_a();
    }
}
