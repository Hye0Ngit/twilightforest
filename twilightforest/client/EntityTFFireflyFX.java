...
public class EntityTFFireflyFX extends aze
{
    float fireflyParticleScale;
    int fireflyHalfLife;
    
    public EntityTFFireflyFX(final xv world, final double d, final double d1, final double d2, final float f, final float f1, final float f2) {
        this(world, d, d1, d2, 1.0f, f, f1, f2);
    }
    
    public EntityTFFireflyFX(final xv world, final double d, final double d1, final double d2, final float f, float f1, final float f2, final float f3) {
    ...
    public void a(final bao tessellator, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        final float f11 = (float)(this.q + (this.t - this.q) * f - EntityTFFireflyFX.at);
        final float f12 = (float)(this.r + (this.u - this.r) * f - EntityTFFireflyFX.au);
        final float f13 = (float)(this.s + (this.v - this.s) * f - EntityTFFireflyFX.av);
    ...
    public void j_() {
        ...
        if (this.d < this.fireflyHalfLife) {
            this.a(this.d * 8 / this.fireflyHalfLife);
        }
        else {
            this.a(7 - (this.d - this.fireflyHalfLife) * 8 / this.e);
        }
