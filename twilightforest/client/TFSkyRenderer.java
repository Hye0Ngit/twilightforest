...
public class TFSkyRenderer extends IRenderHandler
{
    ...
    public TFSkyRenderer() {
        this.starGLCallList = arx.a(3);
        GL11.glPushMatrix();
        GL11.glNewList(this.starGLCallList, 4864);
        this.renderStars();
        GL11.glEndList();
        GL11.glPopMatrix();
        final baz var5 = baz.a;
    ...
    @SideOnly(Side.CLIENT)
    public void render(final float partialTicks, final ayp world, final Minecraft mc) {
        GL11.glDisable(3553);
        final aoj var2 = this.getTwilightSkyColor((yc)world);
        ...
        GL11.glRotatef(this.getRealCelestialAngle((yc)world, partialTicks) * 360.0f, 1.0f, 0.0f, 0.0f);
        float var13 = 30.0f;
        GL11.glDisable(3553);
    ...
    private float getRealCelestialAngle(final yc world, final float partialTicks) {
