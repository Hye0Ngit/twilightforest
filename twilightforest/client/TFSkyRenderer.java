...
public class TFSkyRenderer extends IRenderHandler
{
    ...
    public TFSkyRenderer() {
        this.starGLCallList = auw.a(3);
        GL11.glPushMatrix();
        GL11.glNewList(this.starGLCallList, 4864);
        this.renderStars();
        GL11.glEndList();
        GL11.glPopMatrix();
        final bfx var5 = bfx.a;
    ...
    @SideOnly(Side.CLIENT)
    public void render(final float partialTicks, final bdm world, final Minecraft mc) {
        GL11.glDisable(3553);
        final aqw var2 = this.getTwilightSkyColor((zv)world);
        ...
        GL11.glPushMatrix();
        final float var8 = 1.0f - world.i(partialTicks);
        ...
        GL11.glRotatef(this.getRealCelestialAngle((zv)world, partialTicks) * 360.0f, 1.0f, 0.0f, 0.0f);
        float var13 = 30.0f;
        GL11.glDisable(3553);
    ...
    private float getRealCelestialAngle(final zv world, final float partialTicks) {
        final int var4 = (int)(world.H() % 24000L);
    ...
    private aqw getTwilightSkyColor(final zv world) {
        return world.T().a(0.125, 0.1328125, 0.2890625);
    }
    
    private void renderStars() {
        final Random var1 = new Random(10842L);
        final bfx var2 = bfx.a;
        var2.b();
