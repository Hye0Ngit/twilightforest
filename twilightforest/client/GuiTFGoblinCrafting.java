...
public class GuiTFGoblinCrafting extends avf
{
    public GuiTFGoblinCrafting(final qw inventory, final yc world, final int x, final int y, final int z) {
        super((rq)new ContainerTFUncrafting(inventory, world, x, y, z));
    }
    ...
    protected void a(final float var1, final int var2, final int var3) {
        ...
        for (int i = 0; i < 9; ++i) {
            final sr uncrafting = tfContainer.a(2 + i);
            final sr assembly = tfContainer.a(11 + i);
            if (uncrafting.c() != null) {
                this.drawSlotAsBackground(uncrafting, assembly);
            }
        }
        GL11.glPopMatrix();
        final atq fontRenderer = this.f.p;
        arw.a();
        int costVal = tfContainer.getUncraftingCost();
        if (costVal > 0) {
            if (this.f.g.ce < costVal && !this.f.g.cd.d) {
    ...
    private void drawSlotAsBackground(final sr backgroundSlot, final sr appearSlot) {
        final int screenX = appearSlot.h;
        final int screenY = appearSlot.i;
        final ur itemStackToRender = backgroundSlot.c();
        this.j = 50.0f;
