...
public class ModelTFDeathTome extends awi
{
    axx everything;
    axx book;
    axx loosePage1;
    ...
    public ModelTFDeathTome() {
        this.everything = new axx((awt)this).a(0, 0).a(0.0f, 0.0f, 0.0f, 0, 0, 0);
        (this.book = new axx((awt)this).a(0, 0).a(0.0f, 0.0f, 0.0f, 0, 0, 0)).a(this.a);
        this.book.a(this.b);
        this.book.a(this.g);
        this.book.a(this.c);
        this.book.a(this.d);
        this.book.a(this.e);
        this.book.a(this.f);
        this.loosePage1 = new axx((awt)this).a(24, 10).a(0.0f, -4.0f, -8.0f, 5, 8, 0);
        this.loosePage2 = new axx((awt)this).a(24, 10).a(0.0f, -4.0f, 9.0f, 5, 8, 0);
        this.loosePage3 = new axx((awt)this).a(24, 10).a(0.0f, -4.0f, 11.0f, 5, 8, 0);
        this.loosePage4 = new axx((awt)this).a(24, 10).a(0.0f, -4.0f, 7.0f, 5, 8, 0);
