...
public class ModelTFQuestRam extends axa
{
    ayf frontbody;
    ayf rearbody;
    ayf leg1;
    ...
    public ModelTFQuestRam() {
        ...
        this.a("head.horn1f", 76, 95);
        this.a("head.horn1g", 88, 97);
        (this.frontbody = new ayf((axa)this, 0, 0)).a(-9.0f, -7.5f, -15.0f, 18, 15, 15);
        this.frontbody.a(0.0f, -1.0f, 2.0f);
        (this.rearbody = new ayf((axa)this, 0, 30)).a(-9.0f, -7.5f, 0.0f, 18, 15, 15);
        this.rearbody.a(0.0f, -1.0f, 4.0f);
        (this.leg1 = new ayf((axa)this, 66, 0)).a(-3.0f, 10.0f, -3.0f, 6, 12, 6);
        this.leg1.a(-6.0f, 2.0f, 13.0f);
        (this.haunch1 = new ayf((axa)this, 90, 0)).a(-3.5f, 0.0f, -6.0f, 7, 10, 10);
        this.haunch1.a(-6.0f, 2.0f, 13.0f);
        (this.leg2 = new ayf((axa)this, 66, 0)).a(-3.0f, 10.0f, -3.0f, 6, 12, 6);
        this.leg2.a(6.0f, 2.0f, 13.0f);
        (this.haunch2 = new ayf((axa)this, 90, 0)).a(-3.5f, 0.0f, -6.0f, 7, 10, 10);
        this.haunch2.a(6.0f, 2.0f, 13.0f);
        (this.leg3 = new ayf((axa)this, 66, 18)).a(-3.0f, 10.0f, -3.0f, 6, 13, 6);
        this.leg3.a(-6.0f, 1.0f, -8.0f);
        (this.haunch3 = new ayf((axa)this, 90, 20)).a(-3.5f, 0.0f, -4.0f, 7, 10, 7);
        this.haunch3.a(-6.0f, 1.0f, -8.0f);
        (this.leg4 = new ayf((axa)this, 66, 18)).a(-3.0f, 10.0f, -3.0f, 6, 13, 6);
        this.leg4.a(6.0f, 1.0f, -8.0f);
        (this.haunch4 = new ayf((axa)this, 90, 20)).a(-3.5f, 0.0f, -4.0f, 7, 10, 7);
        this.haunch4.a(6.0f, 1.0f, -8.0f);
        (this.neck = new ayf((axa)this, 66, 37)).a(-5.5f, -8.0f, -8.0f, 11, 14, 12);
        this.neck.a(0.0f, -8.0f, -7.0f);
        this.setRotation(this.neck, 0.2617994f, 0.0f, 0.0f);
        (this.head = new ayf((axa)this, "head")).a(0.0f, -13.0f, -5.0f);
        ...
        (this.nose = new ayf((axa)this, 54, 73)).a(-5.5f, -5.0f, -13.0f, 11, 9, 12);
        this.nose.a(0.0f, -7.0f, -1.0f);
        this.nose.b(128, 128);
        this.setRotation(this.nose, 0.5235988f, 0.0f, 0.0f);
        this.head.a(this.nose);
        this.segments = new ayf[16];
        this.segmentEnabled = new boolean[16];
        for (int i = 0; i < 16; ++i) {
            (this.segments[i] = new ayf((axa)this, 0, 104)).a(-9.0f, -7.5f, 0.0f, 18, 15, 2);
