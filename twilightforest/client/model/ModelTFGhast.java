...
public class ModelTFGhast extends bbx
{
    bdc body;
    protected bdc[] tentacles;
    
    public ModelTFGhast() {
        this.tentacles = new bdc[9];
        final byte yOffset = -16;
        (this.body = new bdc((bbx)this, 0, 0)).a(-8.0f, -8.0f, -8.0f, 16, 16, 16);
        final bdc body = this.body;
        body.d += 24 + yOffset;
    ...
    protected void makeTentacle(final byte yOffset, final Random random, final int i) {
        this.tentacles[i] = new bdc((bbx)this, 0, 0);
    ...
    public void a(final float par1, final float par2, final float par3, final float yaw, final float pitch, final float par6, final mp par7Entity) {
        for (int i = 0; i < this.tentacles.length; ++i) {
            this.tentacles[i].f = 0.2f * kx.a(par3 * 0.3f + i) + 0.4f;
        }
        this.body.f = pitch / 57.295776f;
        this.body.g = yaw / 57.295776f;
    }
    
    public void a(final mp par1Entity, final float par2, final float par3, final float par4, final float yaw, final float pitch, final float time) {
