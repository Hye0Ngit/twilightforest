...
public class ModelTFHydraHead extends bbl
{
    ...
    public ModelTFHydraHead() {
        ...
        (this.head = new bcr((bbl)this, "head")).a("box", -16.0f, -14.0f, -32.0f, 32, 24, 32);
        ...
        (this.jaw = new bcr((bbl)this, "jaw")).a(0.0f, 10.0f, -20.0f);
        ...
        (this.frill = new bcr((bbl)this, "frill")).a(0.0f, 0.0f, -14.0f);
    ...
    public void a(final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final nm par7Entity) {
    }
    
    public void a(final oe entityliving, final float f, final float f1, final float time) {
