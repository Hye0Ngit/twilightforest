...
public class ModelTFNaga extends bbx
{
    public bdc head;
    public bdc body;
    
    public ModelTFNaga() {
        (this.head = new bdc((bbx)this, 0, 0)).a(-8.0f, -12.0f, -8.0f, 16, 16, 16, 0.0f);
        this.head.a(0.0f, 0.0f, 0.0f);
        (this.body = new bdc((bbx)this, 0, 0)).a(-8.0f, -4.0f, -8.0f, 16, 16, 16, 0.0f);
