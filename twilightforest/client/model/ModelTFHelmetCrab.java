...
public class ModelTFHelmetCrab extends ModelBase
{
    ...
    public void func_78087_a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        final float f9 = -(MathHelper.func_76134_b(par1 * 0.6662f * 2.0f + 3.1415927f) * 0.4f) * par2;
        final float f10 = -(MathHelper.func_76134_b(par1 * 0.6662f * 2.0f + 1.5707964f) * 0.4f) * par2;
        final float f11 = -(MathHelper.func_76134_b(par1 * 0.6662f * 2.0f + 4.712389f) * 0.4f) * par2;
        final float f12 = Math.abs(MathHelper.func_76126_a(par1 * 0.6662f + 3.1415927f) * 0.4f) * par2;
        final float f13 = Math.abs(MathHelper.func_76126_a(par1 * 0.6662f + 1.5707964f) * 0.4f) * par2;
        final float f14 = Math.abs(MathHelper.func_76126_a(par1 * 0.6662f + 4.712389f) * 0.4f) * par2;
