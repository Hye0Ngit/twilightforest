...
public class ModelTFWraith extends bbg
{
    public bcr dress;
    
    public ModelTFWraith() {
        final float f = 0.0f;
        (this.dress = new bcr((bbl)this, 40, 16)).a(-4.0f, 12.0f, -2.0f, 8, 12, 4, f);
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final nm par7Entity) {
        ...
        final float var8 = lr.a(this.p * 3.1415927f);
        final float var9 = lr.a((1.0f - (1.0f - this.p) * (1.0f - this.p)) * 3.1415927f);
        this.f.h = 0.0f;
        this.g.h = 0.0f;
        ...
        final bcr f2 = this.f;
        f2.h += lr.b(par3 * 0.09f) * 0.05f + 0.05f;
        final bcr g2 = this.g;
        g2.h -= lr.b(par3 * 0.09f) * 0.05f + 0.05f;
        final bcr f3 = this.f;
        f3.f += lr.a(par3 * 0.067f) * 0.05f;
        final bcr g3 = this.g;
