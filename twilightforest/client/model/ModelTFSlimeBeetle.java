...
public class ModelTFSlimeBeetle extends bbx
{
    bdc head;
    bdc RearEnd;
    bdc Leg6;
    ...
    public ModelTFSlimeBeetle(final boolean renderpass) {
        ...
        this.t = 64;
        this.u = 64;
        (this.connector1 = new bdc((bbx)this, 0, 12)).a(-3.0f, -3.0f, -1.0f, 6, 6, 1);
        this.connector1.a(0.0f, 19.0f, -4.0f);
        (this.RearEnd = new bdc((bbx)this, 31, 6)).a(-4.0f, -11.0f, -4.0f, 8, 10, 8);
        ...
        (this.antenna1 = new bdc((bbx)this, 38, 4)).a(0.0f, -0.5f, -0.5f, 12, 1, 1);
        this.antenna1.a(1.0f, -3.0f, -5.0f);
        this.setRotation(this.antenna1, 0.0f, 1.047198f, -0.296706f);
        (this.antenna2 = new bdc((bbx)this, 38, 4)).a(0.0f, -0.5f, -0.5f, 12, 1, 1);
        ...
        (this.mouth = new bdc((bbx)this, 17, 12)).a(-1.0f, -1.0f, -1.0f, 2, 2, 1);
        ...
        (this.tail1 = new bdc((bbx)this, 0, 20)).a(-3.0f, -3.0f, -3.0f, 6, 6, 6);
        this.tail1.a(0.0f, 19.0f, 9.0f);
        (this.tail2 = new bdc((bbx)this, 0, 20)).a(-3.0f, -6.0f, -3.0f, 6, 6, 6);
        this.tail2.a(0.0f, -3.0f, 2.0f);
        (this.slimeCube = new bdc((bbx)this, 0, 40)).a(-6.0f, -12.0f, -9.0f, 12, 12, 12);
        this.slimeCube.a(0.0f, -6.0f, 0.0f);
        (this.slimeCenter = new bdc((bbx)this, 32, 24)).a(-4.0f, -10.0f, -7.0f, 8, 8, 8);
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final mp par7Entity) {
        ...
        leg12.h += -var16;
        this.tail1.f = kx.b(par3 * 0.3335f) * 0.15f;
        this.tail2.f = kx.b(par3 * 0.4445f) * 0.2f;
        this.slimeCube.f = kx.b(par3 * 0.5555f) * 0.25f;
        this.slimeCenter.f = kx.b(par3 * 0.5555f + 0.25f) * 0.25f;
    }
}
