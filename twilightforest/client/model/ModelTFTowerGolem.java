...
public class ModelTFTowerGolem extends bbl
{
    ...
    public ModelTFTowerGolem() {
        this.t = 128;
        this.u = 64;
        (this.head = new bcr((bbl)this, 0, 0)).a(0.0f, -11.0f, -2.0f);
        this.head.a(0, 0).a(-3.5f, -10.0f, -3.0f, 7, 8, 6);
        this.head.a(0, 14).a(-4.0f, -6.0f, -3.5f, 8, 4, 6);
        (this.body = new bcr((bbl)this, 0, 26)).a(-8.0f, 0.0f, -5.0f, 16, 10, 10);
        this.body.a(0.0f, -13.0f, 0.0f);
        (this.ribs = new bcr((bbl)this, 0, 46)).a(-5.0f, 0.0f, -3.0f, 10, 6, 6);
        this.ribs.a(0.0f, -3.0f, 0.0f);
        (this.rightarm = new bcr((bbl)this, 52, 0)).a(-8.0f, -12.0f, 0.0f);
        ...
        this.leftarm = new bcr((bbl)this, 52, 0);
        this.leftarm.i = true;
        ...
        (this.hips = new bcr((bbl)this, 84, 25)).a(-5.0f, 0.0f, -2.0f, 10, 3, 4);
        this.hips.a(0.0f, 1.0f, 0.0f);
        (this.spine = new bcr((bbl)this, 84, 18)).a(-1.5f, 0.0f, -1.5f, 3, 4, 3);
        this.spine.a(0.0f, -3.0f, 0.0f);
        this.leftleg = new bcr((bbl)this, 84, 32);
        this.leftleg.i = true;
        this.leftleg.a(1.0f, 2.0f, 0.0f);
        this.leftleg.a(84, 32).a(0.0f, 0.0f, -1.5f, 3, 8, 3);
        this.leftleg.a(84, 43).a(-0.5f, 8.0f, -4.0f, 6, 14, 7);
        (this.rightleg = new bcr((bbl)this, 84, 32)).a(-1.0f, 2.0f, 0.0f);
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final nm par7Entity) {
        ...
        this.rightarm.h = lr.b(par3 * 0.09f) * 0.05f + 0.05f;
        this.leftarm.h = -lr.b(par3 * 0.09f) * 0.05f - 0.05f;
    }
