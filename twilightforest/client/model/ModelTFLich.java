...
public class ModelTFLich extends bbt
{
    bdc collar;
    bdc cloak;
    bdc shieldBelt;
    ...
    public ModelTFLich() {
        ...
        this.t = 64;
        this.u = 64;
        (this.e = new bdc((bbx)this, 8, 16)).a(-4.0f, 0.0f, -2.0f, 8, 24, 4);
        this.e.a(0.0f, -4.0f, 0.0f);
        this.e.b(64, 64);
        (this.f = new bdc((bbx)this, 0, 16)).a(-2.0f, -2.0f, -1.0f, 2, 12, 2);
        this.f.b(64, 64);
        ...
        this.g.b(64, 64);
        (this.d = new bdc((bbx)this, 32, 0)).a(-4.0f, -12.0f, -4.0f, 8, 8, 8, 0.5f);
        this.d.a(0.0f, -4.0f, 0.0f);
        this.d.b(64, 64);
        (this.c = new bdc((bbx)this, 0, 0)).a(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        this.c.a(0.0f, -4.0f, 0.0f);
        this.c.b(64, 64);
        (this.h = new bdc((bbx)this, 0, 16)).a(-1.0f, 0.0f, -1.0f, 2, 12, 2);
        this.h.a(-2.0f, 9.5f, 0.0f);
        this.h.b(64, 64);
        (this.i = new bdc((bbx)this, 0, 16)).a(-1.0f, 0.0f, -1.0f, 2, 12, 2);
        this.i.a(2.0f, 9.5f, 0.0f);
        this.i.b(64, 64);
        this.i.i = true;
        (this.collar = new bdc((bbx)this, 32, 16)).a(-6.0f, 0.0f, 0.0f, 12, 12, 1);
        this.collar.a(0.0f, -3.0f, -1.0f);
        this.collar.b(64, 64);
        this.setRotation(this.collar, 2.164208f, 0.0f, 0.0f);
        (this.cloak = new bdc((bbx)this, 0, 44)).a(-6.0f, 0.0f, 0.0f, 12, 19, 1);
        this.cloak.a(0.0f, -4.0f, 2.5f);
        this.cloak.b(64, 64);
        this.setRotation(this.cloak, 0.0f, 0.0f, 0.0f);
        (this.shieldBelt = new bdc((bbx)this)).a(0.0f, 0.0f, 0.0f);
    }
        ...
        if (!lich.isShadowClone() && shields > 0) {
            if (this.shieldBelt.m == null || this.shieldBelt.m.size() != shields) {
                ...
                for (int i = 0; i < shields; ++i) {
                    ...
                    vec.b(rotateY);
                    final bdc shield = new bdc((bbx)this, 26, 40);
            ...
            this.shieldBelt.f = kx.a((lich.ac + time) / 5.0f) / 4.0f;
            this.shieldBelt.h = kx.b((lich.ac + time) / 5.0f) / 4.0f;
        }
    }
    ...
    public void a(final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final mp entity) {
        ...
        final float ogSin = kx.a(this.p * 3.141593f);
        final float otherSin = kx.a((1.0f - (1.0f - this.p) * (1.0f - this.p)) * 3.141593f);
        this.f.h = 0.0f;
        this.g.h = 0.5f;
        ...
        final bdc f7 = this.f;
        f7.h += kx.b(f2 * 0.26f) * 0.15f + 0.05f;
        final bdc g2 = this.g;
        g2.h -= kx.b(f2 * 0.26f) * 0.15f + 0.05f;
        final bdc f8 = this.f;
        f8.f += kx.a(f2 * 0.167f) * 0.15f;
        final bdc g3 = this.g;
        g3.f -= kx.a(f2 * 0.167f) * 0.15f;
        this.c.d = -4.0f;
        this.d.d = -4.0f;
        this.h.d = 9.5f;
        this.i.d = 9.5f;
