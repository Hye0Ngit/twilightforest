...
public class UrGhastTrophyLegacyModel extends GenericTrophyModel
{
    ...
    public UrGhastTrophyLegacyModel(final ModelPart root) {
        ...
        for (int i = 0; i < this.tentacles.length; ++i) {
            ...
            this.tentacles[i][3] = this.tentacles[i][1].m_171324_("tentacle_" + i + "_tip");
        }
    }
    ...
    protected static void makeTentacle(final PartDefinition parent, final String name, final int iteration) {
        ...
        final PartDefinition tentacleExtension = tentacleBase.m_171599_(name + "_extension", CubeListBuilder.m_171558_().m_171514_(0, 3).m_171481_(-1.5f, -0.5f, -1.5f, 3.0f, 4.0f, 3.0f), PartPose.m_171419_(0.0f, 4.0f, 0.0f));
        final PartDefinition tentacleExtension2 = tentacleExtension.m_171599_(name + "_extension_2", CubeListBuilder.m_171558_().m_171514_(0, 9).m_171481_(-1.5f, 1.3f, -1.5f, 3.0f, 4.0f, 3.0f), PartPose.m_171419_(0.0f, 4.0f, 0.0f));
        tentacleExtension2.m_171599_(name + "_tip", CubeListBuilder.m_171558_().m_171514_(0, 9).m_171481_(-1.5f, 1.3f, -1.5f, 3.0f, 4.0f, 3.0f), PartPose.m_171419_(0.0f, 4.0f, 0.0f));
    }
