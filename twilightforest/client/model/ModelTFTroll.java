...
public class ModelTFTroll extends ModelBiped
{
    ...
    public void func_78087_a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        final EntityTFTroll troll = (EntityTFTroll)par7Entity;
        ...
        if (this.field_78119_l != 0 || this.field_78120_m != 0) {
            ...
            field_78112_f2.field_78795_f += (float)3.141592653589793;
            final ModelRenderer field_78113_g2 = this.field_78113_g;
            field_78113_g2.field_78795_f += (float)3.141592653589793;
        }
        if (this.field_78095_p > 0.0f) {
            final float swing = 1.0f - this.field_78095_p;
            final ModelRenderer field_78112_f3 = this.field_78112_f;
            field_78112_f3.field_78795_f -= (float)(3.141592653589793 * swing);
            final ModelRenderer field_78113_g3 = this.field_78113_g;
            field_78113_g3.field_78795_f -= (float)(3.141592653589793 * swing);
        }
    ...
    public void func_78086_a(final EntityLivingBase par1EntityLivingBase, final float par2, final float par3, final float par4) {
        final EntityTFTroll troll = (EntityTFTroll)par1EntityLivingBase;
