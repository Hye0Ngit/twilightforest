...
public class ModelTFMoonworm extends bbl
{
    ...
    public ModelTFMoonworm() {
        this.t = 32;
        this.u = 32;
        (this.Shape1 = new bcr((bbl)this, 0, 4)).a(-1.0f, -1.0f, -1.0f, 4, 2, 2);
        this.Shape1.a(-1.0f, 7.0f, 3.0f);
        (this.Shape2 = new bcr((bbl)this, 0, 8)).a(-1.0f, -1.0f, -1.0f, 2, 2, 4);
        this.Shape2.a(3.0f, 7.0f, 0.0f);
        (this.Shape3 = new bcr((bbl)this, 0, 14)).a(-1.0f, -1.0f, -1.0f, 2, 2, 2);
        this.Shape3.a(2.0f, 7.0f, -2.0f);
        (this.head = new bcr((bbl)this, 0, 0)).a(-1.0f, -1.0f, -1.0f, 2, 2, 2);
    ...
    public void setLivingAnimations(final TileEntityTFMoonworm moonworm, final float partialTime) {
        ...
        if (moonworm.yawDelay == 0) {
            ...
            final bcr head = this.head;
            head.d += Math.min(0.0f, lr.a(time / 2.0f));
            final bcr shape1 = this.Shape1;
            shape1.d += Math.min(0.0f, lr.a(time / 2.0f + 1.0f));
            final bcr shape2 = this.Shape2;
            shape2.d += Math.min(0.0f, lr.a(time / 2.0f + 2.0f));
            final bcr shape3 = this.Shape3;
            shape3.d += Math.min(0.0f, lr.a(time / 2.0f + 3.0f));
        }
    }
}
