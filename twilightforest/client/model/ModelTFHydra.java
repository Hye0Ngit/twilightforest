...
public class ModelTFHydra extends bbl
{
    ...
    public ModelTFHydra() {
        ...
        (this.body = new bcr((bbl)this, "body")).a(0.0f, -12.0f, 0.0f);
        this.body.a("body", -48.0f, 0.0f, 0.0f, 96, 96, 40);
        this.setRotation(this.body, 1.22173f, 0.0f, 0.0f);
        (this.leg1 = new bcr((bbl)this, "leg")).a(48.0f, -24.0f, 0.0f);
        ...
        (this.leg2 = new bcr((bbl)this, "leg")).a(-48.0f, -24.0f, 0.0f);
        this.leg2.i = true;
    ...
    public void a(final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final nm entity) {
        ...
        this.leg1.f = lr.b(f * 0.6662f) * 1.4f * f1;
        this.leg2.f = lr.b(f * 0.6662f + 3.141593f) * 1.4f * f1;
        this.leg1.g = 0.0f;
        this.leg2.g = 0.0f;
    }
    
    public float getRotationY(final EntityTFHydra hydra, final EntityTFHydraPart whichHead, final float time) {
        final float yawOffset = hydra.aO + (hydra.aN - hydra.aO) * time;
