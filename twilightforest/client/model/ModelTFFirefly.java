...
public class ModelTFFirefly extends bbx
{
    public bdc legs;
    public bdc fatbody;
    ...
    public ModelTFFirefly() {
        (this.legs = new bdc((bbx)this, 0, 21)).a(-4.0f, 7.9f, -5.0f, 8, 1, 10, 0.0f);
        ...
        (this.glow = new bdc((bbx)this, 20, 0)).a(-5.0f, 5.9f, -9.0f, 10, 0, 10, 0.0f);
    }
