...
public class ModelTFFirefly extends bbl
{
    public bcr legs;
    public bcr fatbody;
    ...
    public ModelTFFirefly() {
        (this.legs = new bcr((bbl)this, 0, 21)).a(-4.0f, 7.9f, -5.0f, 8, 1, 10, 0.0f);
        ...
        (this.glow = new bcr((bbl)this, 20, 0)).a(-5.0f, 5.9f, -9.0f, 10, 0, 10, 0.0f);
    }
