...
public class ModelTFHydraHead extends ModelBase
{
    ...
    public void func_78086_a(final EntityLivingBase entity, final float limbSwing, final float limbSwingAmount, final float partialTicks) {
        final EntityTFHydraHead whichHead = (EntityTFHydraHead)entity;
        this.head.field_78796_g = this.getRotationY(whichHead, partialTicks);
        this.head.field_78795_f = this.getRotationX(whichHead, partialTicks);
