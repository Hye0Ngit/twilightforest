...
public class TrollModel extends HumanoidModel<Troll>
{
    ...
    public static LayerDefinition create() {
        ...
        partRoot.m_171599_("head", CubeListBuilder.m_171558_().m_171514_(52, 31).m_171481_(-5.0f, -8.0f, -8.0f, 10.0f, 10.0f, 10.0f).m_171514_(36, 41).m_171481_(-2.0f, -4.0f, -11.0f, 4.0f, 8.0f, 4.0f), PartPose.m_171419_(0.0f, -11.0f, -1.0f));
        partRoot.m_171599_("hat", CubeListBuilder.m_171558_(), PartPose.f_171404_);
        partRoot.m_171599_("body", CubeListBuilder.m_171558_().m_171514_(0, 0).m_171481_(-8.0f, -37.0f, -6.0f, 16.0f, 26.0f, 15.0f), PartPose.m_171419_(0.0f, 24.0f, 0.0f));
        partRoot.m_171599_("right_arm", CubeListBuilder.m_171558_().m_171514_(0, 41).m_171481_(-6.0f, -1.0f, -4.0f, 6.0f, 25.0f, 8.0f), PartPose.m_171419_(-8.0f, -9.0f, 0.0f));
        partRoot.m_171599_("left_arm", CubeListBuilder.m_171558_().m_171480_().m_171514_(0, 41).m_171481_(0.0f, -1.0f, -4.0f, 6.0f, 25.0f, 8.0f), PartPose.m_171419_(8.0f, -9.0f, 0.0f));
        partRoot.m_171599_("right_leg", CubeListBuilder.m_171558_().m_171514_(28, 54).m_171481_(-3.0f, -1.0f, -4.0f, 6.0f, 12.0f, 8.0f), PartPose.m_171419_(-4.0f, 13.0f, 0.0f));
        partRoot.m_171599_("left_leg", CubeListBuilder.m_171558_().m_171480_().m_171514_(28, 54).m_171481_(-3.0f, -1.0f, -4.0f, 6.0f, 12.0f, 8.0f), PartPose.m_171419_(4.0f, 13.0f, 0.0f));
