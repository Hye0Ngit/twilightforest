...
public class ModelTFQuestRam extends ModelBase
{
    ...
    public void func_78088_a(final Entity entity, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        this.haunch1.func_78785_a(scale);
        this.leg2.func_78785_a(scale);
        this.haunch2.func_78785_a(scale);
        this.leg3.func_78785_a(scale);
        this.haunch3.func_78785_a(scale);
        this.leg4.func_78785_a(scale);
        this.haunch4.func_78785_a(scale);
        this.neck.func_78785_a(scale);
        this.head.func_78785_a(scale);
        for (int i = 0; i < 16; ++i) {
            if (this.segmentEnabled[i]) {
                final float var4 = 1.0f;
                final float[] dyeRgb = EntitySheep.func_175513_a(EnumDyeColor.func_176764_b(i));
                GlStateManager.func_179124_c(var4 * dyeRgb[0], var4 * dyeRgb[1], var4 * dyeRgb[2]);
                this.segments[i].func_78785_a(scale);
            }
        }
    ...
    public void func_78086_a(final EntityLivingBase entity, final float limbSwing, final float limbSwingAmount, final float partialTicks) {
        final EntityTFQuestRam ram = (EntityTFQuestRam)entity;
        ...
        for (final int color : this.colorOrder) {
            if (ram.isColorPresent(EnumDyeColor.func_176764_b(color))) {
