...
{
    @Override
    public void setLivingAnimations(final StableIceCoreEntity entity, final float limbSwing, final float limbSwingAmount, final float partialTicks) {
        ...
        for (int i = 0; i < this.spikes.length; ++i) {
            ...
            ((ModelRenderer)this.spikes[i].field_78805_m.get(0)).field_78797_d = 9.5f + MathHelper.func_76126_a((i + entity.field_70173_aa + partialTicks) / 3.0f) * 3.0f;
        }
    }
}
