...
public class LowerGoblinKnightLegacyModel extends HumanoidModel<LowerGoblinKnight>
{
    ...
    public LowerGoblinKnightLegacyModel(final ModelPart root) {
        super(root);
    ...
    public static LayerDefinition create() {
        ...
        partRoot.m_171599_("head", CubeListBuilder.m_171558_().m_171514_(0, 32).m_171481_(-2.5f, -5.0f, -3.5f, 5.0f, 5.0f, 5.0f), PartPose.m_171419_(0.0f, 10.0f, 1.0f));
        ...
        partRoot.m_171599_("right_arm", CubeListBuilder.m_171558_().m_171514_(40, 48).m_171481_(-2.0f, -2.0f, -1.5f, 2.0f, 8.0f, 3.0f), PartPose.m_171419_(-3.5f, 10.0f, 0.0f));
        partRoot.m_171599_("left_arm", CubeListBuilder.m_171558_().m_171480_().m_171514_(40, 48).m_171481_(0.0f, -2.0f, -1.5f, 2.0f, 8.0f, 3.0f), PartPose.m_171419_(3.5f, 10.0f, 0.0f));
        partRoot.m_171599_("right_leg", CubeListBuilder.m_171558_().m_171514_(0, 48).m_171481_(-3.0f, 0.0f, -2.0f, 4.0f, 8.0f, 4.0f), PartPose.m_171419_(-2.5f, 16.0f, 0.0f));
        partRoot.m_171599_("left_leg", CubeListBuilder.m_171558_().m_171480_().m_171514_(0, 48).m_171481_(-1.0f, 0.0f, -2.0f, 4.0f, 8.0f, 4.0f), PartPose.m_171419_(2.5f, 16.0f, 0.0f));
