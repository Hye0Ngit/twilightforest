...
public class PinchBeetleLegacyModel extends SegmentedModel<PinchBeetleEntity>
{
    ...
    public PinchBeetleLegacyModel() {
        ...
        (this.RearEnd = new ModelRenderer((Model)this, 28, 14)).func_228300_a_(-5.0f, -9.0f, -4.0f, 10.0f, 10.0f, 8.0f);
        ...
        (this.jaw1a = new ModelRenderer((Model)this, 40, 6)).func_228300_a_(-1.0f, -1.0f, -1.5f, 8.0f, 2.0f, 3.0f);
        this.jaw1a.func_78793_a(-3.0f, 1.0f, -6.0f);
        this.setRotation(this.jaw1a, 0.0f, 2.635447f, 0.0f);
        (this.jaw1b = new ModelRenderer((Model)this, 40, 10)).func_228300_a_(-1.0f, -1.0f, -1.0f, 10.0f, 2.0f, 2.0f);
        this.jaw1b.func_78793_a(7.0f, 0.0f, 0.0f);
        this.setRotation(this.jaw1b, 0.0f, -1.047197f, 0.0f);
        (this.jaw2a = new ModelRenderer((Model)this, 40, 6)).func_228300_a_(-1.0f, -1.0f, -1.5f, 8.0f, 2.0f, 3.0f);
        this.jaw2a.func_78793_a(3.0f, 1.0f, -6.0f);
        this.setRotation(this.jaw2a, 0.0f, 0.541052f, 0.0f);
        (this.jaw2b = new ModelRenderer((Model)this, 40, 10)).func_228300_a_(-1.0f, -1.0f, -1.0f, 10.0f, 2.0f, 2.0f);
        ...
        (this.tooth1a = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(0.0f, -0.5f, -0.0f, 2.0f, 1.0f, 1.0f);
        this.tooth1a.func_78793_a(9.0f, 0.0f, 0.0f);
        this.setRotation(this.tooth1a, 0.0f, -0.5235987f, 0.0f);
        (this.tooth1b = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(-2.5f, -0.5f, -0.0f, 2.0f, 1.0f, 1.0f);
        this.tooth1b.func_78793_a(6.0f, 0.0f, 0.0f);
        this.setRotation(this.tooth1b, 0.0f, 1.5707963f, 0.0f);
        (this.tooth1c = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(-2.5f, -0.5f, -0.0f, 2.0f, 1.0f, 1.0f);
        this.tooth1c.func_78793_a(3.0f, 0.0f, 0.0f);
        this.setRotation(this.tooth1c, 0.0f, 1.5707963f, 0.0f);
        (this.tooth2a = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(0.0f, -0.5f, -1.0f, 2.0f, 1.0f, 1.0f);
        this.tooth2a.func_78793_a(9.0f, 0.0f, 0.0f);
        this.setRotation(this.tooth2a, 0.0f, 0.5235987f, 0.0f);
        (this.tooth2b = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(-2.5f, -0.5f, -1.0f, 2.0f, 1.0f, 1.0f);
        this.tooth2b.func_78793_a(6.0f, 0.0f, 0.0f);
        this.setRotation(this.tooth2b, 0.0f, -1.5707963f, 0.0f);
        (this.tooth2c = new ModelRenderer((Model)this, 0, 0)).func_228300_a_(-2.5f, -0.5f, -1.0f, 2.0f, 1.0f, 1.0f);
