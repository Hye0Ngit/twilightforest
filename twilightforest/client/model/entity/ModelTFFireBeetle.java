...
public class ModelTFFireBeetle extends ModelBase
{
    ...
    public ModelTFFireBeetle() {
        ...
        (this.RearEnd = new ModelRenderer((ModelBase)this, 22, 9)).func_78789_a(-6.0f, -9.0f, -4.0f, 12, 14, 9);
        ...
        (this.jaw1a = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, -2.0f, 1, 1, 2);
        this.jaw1a.func_78793_a(-3.0f, 0.0f, -6.0f);
        this.setRotation(this.jaw1a, 0.3490659f, 0.0f, 0.0f);
        (this.jaw1b = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, 0.0f, 1, 1, 2);
        this.jaw1b.func_78793_a(0.0f, 0.0f, -2.0f);
        this.setRotation(this.jaw1b, 0.0f, 1.570796f, 0.0f);
        (this.jaw2a = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(-1.0f, 0.0f, -2.0f, 1, 1, 2);
        this.jaw2a.func_78793_a(3.0f, 0.0f, -6.0f);
        this.setRotation(this.jaw2a, 0.3490659f, 0.0f, 0.0f);
        (this.jaw2b = new ModelRenderer((ModelBase)this, 0, 0)).func_78789_a(0.0f, 0.0f, -2.0f, 1, 1, 2);
    ...
    public void func_78088_a(final Entity entity, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        this.thorax.func_78785_a(scale);
        this.head.func_78785_a(scale);
        this.connector2.func_78785_a(scale);
