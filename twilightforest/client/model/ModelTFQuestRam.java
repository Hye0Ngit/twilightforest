...
public class ModelTFQuestRam extends bbl
{
    bcr frontbody;
    bcr rearbody;
    bcr leg1;
    ...
    public ModelTFQuestRam() {
        ...
        this.a("head.horn1f", 76, 95);
        this.a("head.horn1g", 88, 97);
        (this.frontbody = new bcr((bbl)this, 0, 0)).a(-9.0f, -7.5f, -15.0f, 18, 15, 15);
        this.frontbody.a(0.0f, -1.0f, 2.0f);
        (this.rearbody = new bcr((bbl)this, 0, 30)).a(-9.0f, -7.5f, 0.0f, 18, 15, 15);
        this.rearbody.a(0.0f, -1.0f, 4.0f);
        (this.leg1 = new bcr((bbl)this, 66, 0)).a(-3.0f, 10.0f, -3.0f, 6, 12, 6);
        this.leg1.a(-6.0f, 2.0f, 13.0f);
        (this.haunch1 = new bcr((bbl)this, 90, 0)).a(-3.5f, 0.0f, -6.0f, 7, 10, 10);
        this.haunch1.a(-6.0f, 2.0f, 13.0f);
        (this.leg2 = new bcr((bbl)this, 66, 0)).a(-3.0f, 10.0f, -3.0f, 6, 12, 6);
        this.leg2.a(6.0f, 2.0f, 13.0f);
        (this.haunch2 = new bcr((bbl)this, 90, 0)).a(-3.5f, 0.0f, -6.0f, 7, 10, 10);
        this.haunch2.a(6.0f, 2.0f, 13.0f);
        (this.leg3 = new bcr((bbl)this, 66, 18)).a(-3.0f, 10.0f, -3.0f, 6, 13, 6);
        this.leg3.a(-6.0f, 1.0f, -8.0f);
        (this.haunch3 = new bcr((bbl)this, 90, 20)).a(-3.5f, 0.0f, -4.0f, 7, 10, 7);
        this.haunch3.a(-6.0f, 1.0f, -8.0f);
        (this.leg4 = new bcr((bbl)this, 66, 18)).a(-3.0f, 10.0f, -3.0f, 6, 13, 6);
        this.leg4.a(6.0f, 1.0f, -8.0f);
        (this.haunch4 = new bcr((bbl)this, 90, 20)).a(-3.5f, 0.0f, -4.0f, 7, 10, 7);
        this.haunch4.a(6.0f, 1.0f, -8.0f);
        (this.neck = new bcr((bbl)this, 66, 37)).a(-5.5f, -8.0f, -8.0f, 11, 14, 12);
        this.neck.a(0.0f, -8.0f, -7.0f);
        this.setRotation(this.neck, 0.2617994f, 0.0f, 0.0f);
        (this.head = new bcr((bbl)this, "head")).a(0.0f, -13.0f, -5.0f);
        ...
        (this.nose = new bcr((bbl)this, 54, 73)).a(-5.5f, -5.0f, -13.0f, 11, 9, 12);
        this.nose.a(0.0f, -7.0f, -1.0f);
        this.nose.b(128, 128);
        this.setRotation(this.nose, 0.5235988f, 0.0f, 0.0f);
        this.head.a(this.nose);
        this.segments = new bcr[16];
        this.segmentEnabled = new boolean[16];
        for (int i = 0; i < 16; ++i) {
            (this.segments[i] = new bcr((bbl)this, 0, 104)).a(-9.0f, -7.5f, 0.0f, 18, 15, 2);
    ...
    public void a(final nm entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        for (int i = 0; i < 16; ++i) {
            if (this.segmentEnabled[i]) {
                ...
                GL11.glColor3f(var4 * ry.bp[i][0], var4 * ry.bp[i][1], var4 * ry.bp[i][2]);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6) {
        ...
        this.leg1.f = lr.b(par1 * 0.6662f) * 1.4f * par2 * 0.5f;
        this.leg2.f = lr.b(par1 * 0.6662f + 3.1415927f) * 1.4f * par2 * 0.5f;
        this.leg3.f = lr.b(par1 * 0.6662f + 3.1415927f) * 1.4f * par2 * 0.5f;
        this.leg4.f = lr.b(par1 * 0.6662f) * 1.4f * par2 * 0.5f;
