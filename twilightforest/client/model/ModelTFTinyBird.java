...
public class ModelTFTinyBird extends bbl
{
    bcr beak;
    bcr head;
    bcr body;
    ...
    public ModelTFTinyBird() {
        this.t = 32;
        this.u = 32;
        (this.head = new bcr((bbl)this, 0, 0)).a(-1.5f, -1.5f, -1.5f, 3, 3, 3);
        this.head.a(0.0f, 20.5f, -0.5f);
        this.head.b(32, 32);
        this.head.i = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.beak = new bcr((bbl)this, 12, 0)).a(-0.5f, -0.5f, -0.5f, 1, 1, 1);
        this.beak.a(0.0f, 0.5f, -2.0f);
        this.head.a(this.beak);
        (this.body = new bcr((bbl)this, 0, 6)).a(-1.5f, 0.0f, -1.0f, 3, 3, 3);
        this.body.a(0.0f, 20.0f, 0.0f);
        this.body.b(32, 32);
        this.body.i = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.rightarm = new bcr((bbl)this, 12, 2)).a(-1.0f, 0.0f, -1.5f, 1, 2, 3);
        this.rightarm.a(-1.5f, 20.5f, 1.0f);
        this.rightarm.b(32, 32);
        this.rightarm.i = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        (this.leftarm = new bcr((bbl)this, 12, 2)).a(0.0f, 0.0f, -1.5f, 1, 2, 3);
        this.leftarm.a(1.5f, 20.5f, 1.0f);
        this.leftarm.b(32, 32);
        this.leftarm.i = true;
        this.setRotation(this.leftarm, 0.0f, 0.0f, 0.0f);
        (this.rightleg = new bcr((bbl)this, 0, 12)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.rightleg.a(-1.5f, 23.0f, 0.0f);
        this.rightleg.b(32, 32);
        this.rightleg.i = true;
        this.setRotation(this.rightleg, 0.0f, 0.0f, 0.0f);
        (this.leftleg = new bcr((bbl)this, 0, 12)).a(0.5f, 0.0f, 0.0f, 1, 1, 1);
        this.leftleg.a(0.0f, 23.0f, 0.0f);
        this.leftleg.b(32, 32);
        this.leftleg.i = true;
        this.setRotation(this.leftleg, 0.0f, 0.0f, 0.0f);
        (this.tail = new bcr((bbl)this, 0, 14)).a(-1.5f, -0.5f, 0.0f, 3, 1, 2);
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final nm par7Entity) {
        ...
        if (((EntityTFBird)par7Entity).isBirdLanded()) {
            this.rightleg.d = 23.0f;
            this.leftleg.d = 23.0f;
        }
        else {
            this.rightleg.d = 22.5f;
            this.leftleg.d = 22.5f;
        }
    }
}
