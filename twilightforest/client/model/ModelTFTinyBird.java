...
public class ModelTFTinyBird extends bbx
{
    bdc beak;
    bdc head;
    bdc body;
    ...
    public ModelTFTinyBird() {
        this.t = 32;
        this.u = 32;
        (this.head = new bdc((bbx)this, 0, 0)).a(-1.5f, -1.5f, -1.5f, 3, 3, 3);
        this.head.a(0.0f, 20.5f, -0.5f);
        this.head.b(32, 32);
        this.head.i = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.beak = new bdc((bbx)this, 12, 0)).a(-0.5f, -0.5f, -0.5f, 1, 1, 1);
        this.beak.a(0.0f, 0.5f, -2.0f);
        this.head.a(this.beak);
        (this.body = new bdc((bbx)this, 0, 6)).a(-1.5f, 0.0f, -1.0f, 3, 3, 3);
        this.body.a(0.0f, 20.0f, 0.0f);
        this.body.b(32, 32);
        this.body.i = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.rightarm = new bdc((bbx)this, 12, 2)).a(-1.0f, 0.0f, -1.5f, 1, 2, 3);
        this.rightarm.a(-1.5f, 20.5f, 1.0f);
        this.rightarm.b(32, 32);
        this.rightarm.i = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        (this.leftarm = new bdc((bbx)this, 12, 2)).a(0.0f, 0.0f, -1.5f, 1, 2, 3);
        this.leftarm.a(1.5f, 20.5f, 1.0f);
        this.leftarm.b(32, 32);
        this.leftarm.i = true;
        this.setRotation(this.leftarm, 0.0f, 0.0f, 0.0f);
        (this.rightleg = new bdc((bbx)this, 0, 12)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.rightleg.a(-1.5f, 23.0f, 0.0f);
        this.rightleg.b(32, 32);
        this.rightleg.i = true;
        this.setRotation(this.rightleg, 0.0f, 0.0f, 0.0f);
        (this.leftleg = new bdc((bbx)this, 0, 12)).a(0.5f, 0.0f, 0.0f, 1, 1, 1);
        this.leftleg.a(0.0f, 23.0f, 0.0f);
        this.leftleg.b(32, 32);
        this.leftleg.i = true;
        this.setRotation(this.leftleg, 0.0f, 0.0f, 0.0f);
        (this.tail = new bdc((bbx)this, 0, 14)).a(-1.5f, -0.5f, 0.0f, 3, 1, 2);
