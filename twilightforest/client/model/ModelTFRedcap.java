...
public class ModelTFRedcap extends bbt
{
    bdc goblinRightEar;
    bdc goblinLeftEar;
    
    public ModelTFRedcap() {
        (this.c = new bdc((bbx)this, 0, 0)).a(-3.4f, 1.0f, -4.0f, 7, 7, 7, 0.0f);
        this.c.a(0.0f, 0.0f, 0.0f);
        (this.d = new bdc((bbx)this, 32, 0)).a(-2.0f, 0.0f, -3.0f, 4, 5, 7, 0.0f);
        this.d.a(0.0f, 0.0f, 0.0f);
        (this.e = new bdc((bbx)this, 12, 19)).a(-4.0f, 6.0f, -2.0f, 8, 9, 4, 0.0f);
        this.e.a(0.0f, 0.0f, 0.0f);
        (this.f = new bdc((bbx)this, 36, 17)).a(-2.0f, -2.0f, -2.0f, 3, 12, 3, 0.0f);
        this.f.a(-5.0f, 8.0f, 0.0f);
        (this.g = new bdc((bbx)this, 36, 17)).a(-1.0f, -2.0f, -2.0f, 3, 12, 3, 0.0f);
        this.g.a(5.0f, 8.0f, 0.0f);
        (this.h = new bdc((bbx)this, 0, 20)).a(-2.0f, 2.0f, -1.0f, 3, 9, 3, 0.0f);
        this.h.a(-2.0f, 12.0f, 0.0f);
        (this.i = new bdc((bbx)this, 0, 20)).a(-1.0f, 3.0f, -1.0f, 3, 9, 3, 0.0f);
        this.i.a(2.0f, 12.0f, 0.0f);
        (this.goblinRightEar = new bdc((bbx)this, 48, 20)).a(3.0f, -2.0f, -1.0f, 2, 3, 1, 0.0f);
        this.goblinRightEar.a(0.0f, 3.0f, 0.0f);
        (this.goblinLeftEar = new bdc((bbx)this, 48, 24)).a(-5.0f, -2.0f, -1.0f, 2, 3, 1, 0.0f);
