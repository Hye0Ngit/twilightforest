...
public class ModelTFRaven extends bbx
{
    bdc head;
    bdc beak1;
    bdc beak2;
    ...
    public ModelTFRaven() {
        this.t = 32;
        this.u = 32;
        (this.head = new bdc((bbx)this, 0, 0)).a(-1.5f, -1.5f, -3.0f, 3, 3, 3);
        this.head.a(0.0f, 18.0f, 0.0f);
        this.head.b(32, 32);
        this.head.i = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.beak1 = new bdc((bbx)this, 12, 0)).a(-0.5f, -1.0f, -2.0f, 1, 1, 2);
        this.beak1.a(0.0f, 0.0f, -2.5f);
        this.beak1.f = 0.2617994f;
        this.head.a(this.beak1);
        (this.beak2 = new bdc((bbx)this, 12, 0)).a(-0.5f, 0.0f, -2.0f, 1, 1, 2);
        this.beak2.a(0.0f, 0.0f, -2.5f);
        this.beak2.f = -0.2617994f;
        this.head.a(this.beak2);
        (this.body = new bdc((bbx)this, 0, 6)).a(-1.5f, 0.0f, -1.0f, 3, 4, 6);
        this.body.a(0.0f, 17.0f, 1.0f);
        this.body.b(32, 32);
        this.setRotation(this.body, -0.5235988f, 0.0f, 0.0f);
        (this.rightarm = new bdc((bbx)this, 0, 16)).a(-1.0f, 0.0f, -1.5f, 1, 3, 6);
        this.rightarm.a(-1.5f, 18.0f, 1.0f);
        this.rightarm.b(32, 32);
        (this.leftarm = new bdc((bbx)this, 0, 16)).a(0.0f, 0.0f, -1.5f, 1, 3, 6);
        this.leftarm.a(1.5f, 18.0f, 1.0f);
        this.leftarm.b(32, 32);
        (this.rightleg = new bdc((bbx)this, 14, 16)).a(0.0f, 0.0f, 0.0f, 1, 2, 1);
        this.rightleg.a(-1.5f, 21.0f, 1.0f);
        this.rightleg.b(32, 32);
        (this.rightfoot = new bdc((bbx)this, 14, 20)).a(0.0f, -1.0f, -2.0f, 1, 1, 2);
        ...
        (this.leftleg = new bdc((bbx)this, 14, 16)).a(0.0f, 0.0f, 0.0f, 1, 2, 1);
        this.leftleg.a(0.5f, 21.0f, 1.0f);
        this.leftleg.b(32, 32);
        (this.leftfoot = new bdc((bbx)this, 14, 20)).a(0.0f, -1.0f, -2.0f, 1, 1, 2);
        ...
        (this.tail = new bdc((bbx)this, 0, 25)).a(-1.5f, -0.5f, 0.0f, 3, 1, 3);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6) {
        ...
        this.rightleg.f = kx.b(par1 * 0.6662f) * 1.4f * par2;
        this.leftleg.f = kx.b(par1 * 0.6662f + 3.1415927f) * 1.4f * par2;
