...
public class ModelTFFireBeetle extends bbx
{
    bdc thorax;
    bdc head;
    bdc connector2;
    ...
    public ModelTFFireBeetle() {
        ...
        (this.RearEnd = new bdc((bbx)this, 22, 9)).a(-6.0f, -9.0f, -4.0f, 12, 14, 9);
