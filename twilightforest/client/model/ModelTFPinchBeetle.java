...
public class ModelTFPinchBeetle extends bbl
{
    bcr thorax;
    bcr head;
    bcr connector2;
    ...
    public ModelTFPinchBeetle() {
        ...
        (this.RearEnd = new bcr((bbl)this, 28, 14)).a(-5.0f, -9.0f, -4.0f, 10, 10, 8);
        ...
        (this.jaw1a = new bcr((bbl)this, 40, 6)).a(-1.0f, -1.0f, -1.5f, 8, 2, 3);
        this.jaw1a.a(-3.0f, 1.0f, -6.0f);
        this.setRotation(this.jaw1a, 0.0f, 2.635447f, 0.0f);
        (this.jaw1b = new bcr((bbl)this, 40, 10)).a(-1.0f, -1.0f, -1.0f, 10, 2, 2);
        this.jaw1b.a(7.0f, 0.0f, 0.0f);
        this.setRotation(this.jaw1b, 0.0f, -1.047197f, 0.0f);
        (this.jaw2a = new bcr((bbl)this, 40, 6)).a(-1.0f, -1.0f, -1.5f, 8, 2, 3);
        this.jaw2a.a(3.0f, 1.0f, -6.0f);
        this.setRotation(this.jaw2a, 0.0f, 0.541052f, 0.0f);
        (this.jaw2b = new bcr((bbl)this, 40, 10)).a(-1.0f, -1.0f, -1.0f, 10, 2, 2);
