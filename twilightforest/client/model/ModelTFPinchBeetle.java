...
public class ModelTFPinchBeetle extends bbx
{
    bdc thorax;
    bdc head;
    bdc connector2;
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final mp par7Entity) {
        ...
        final float var11 = -(kx.b(par1 * 0.6662f * 2.0f + 0.0f) * 0.4f) * par2;
        final float var12 = -(kx.b(par1 * 0.6662f * 2.0f + 3.1415927f) * 0.4f) * par2;
        final float var13 = -(kx.b(par1 * 0.6662f * 2.0f + 4.712389f) * 0.4f) * par2;
        final float var14 = Math.abs(kx.a(par1 * 0.6662f + 0.0f) * 0.4f) * par2;
        final float var15 = Math.abs(kx.a(par1 * 0.6662f + 3.1415927f) * 0.4f) * par2;
        final float var16 = Math.abs(kx.a(par1 * 0.6662f + 4.712389f) * 0.4f) * par2;
        final bdc leg1 = this.Leg1;
        leg1.g += var11;
        final bdc leg2 = this.Leg2;
        leg2.g += -var11;
        final bdc leg3 = this.Leg3;
        leg3.g += var12;
        final bdc leg4 = this.Leg4;
        leg4.g += -var12;
        final bdc leg5 = this.Leg5;
        leg5.g += var13;
        final bdc leg6 = this.Leg6;
        leg6.g += -var13;
        final bdc leg7 = this.Leg1;
        leg7.h += var14;
        final bdc leg8 = this.Leg2;
        leg8.h += -var14;
        final bdc leg9 = this.Leg3;
        leg9.h += var15;
        final bdc leg10 = this.Leg4;
        leg10.h += -var15;
        final bdc leg11 = this.Leg5;
        leg11.h += var16;
        final bdc leg12 = this.Leg6;
        leg12.h += -var16;
    }
