...
public class ModelTFKobold extends awp
{
    axx rightear;
    axx leftear;
    axx snout;
    ...
    public ModelTFKobold() {
        ...
        this.t = 64;
        this.u = 32;
        (this.c = new axx((awt)this, 0, 0)).a(-3.5f, -7.0f, -3.0f, 7, 6, 6);
        this.c.a(0.0f, 13.0f, 0.0f);
        (this.e = new axx((awt)this, 12, 19)).a(0.0f, 0.0f, 0.0f, 7, 7, 4);
        this.e.a(-3.5f, 12.0f, -2.0f);
        (this.f = new axx((awt)this, 36, 17)).a(-3.0f, -1.0f, -1.5f, 3, 7, 3);
        this.f.a(-3.5f, 12.0f, 0.0f);
        this.g.i = true;
        (this.g = new axx((awt)this, 36, 17)).a(0.0f, -1.0f, -1.5f, 3, 7, 3);
        this.g.a(3.5f, 12.0f, 0.0f);
        this.g.i = false;
        (this.h = new axx((awt)this, 0, 20)).a(-1.5f, 0.0f, -1.5f, 3, 5, 3);
        this.h.a(-2.0f, 19.0f, 0.0f);
        (this.i = new axx((awt)this, 0, 20)).a(-1.5f, 0.0f, -1.5f, 3, 5, 3);
        this.i.a(2.0f, 19.0f, 0.0f);
        (this.rightear = new axx((awt)this, 48, 20)).a(0.0f, -4.0f, 0.0f, 4, 4, 1);
        this.rightear.a(3.5f, -3.0f, -1.0f);
        this.rightear.g = 0.2617994f;
        this.rightear.h = -0.3490659f;
        this.c.a(this.rightear);
        (this.leftear = new axx((awt)this, 48, 25)).a(-4.0f, -4.0f, 0.0f, 4, 4, 1);
        this.leftear.a(-3.5f, -3.0f, -1.0f);
        this.leftear.g = -0.2617994f;
        this.leftear.h = 0.3490659f;
        this.c.a(this.leftear);
        (this.snout = new axx((awt)this, 28, 0)).a(-1.5f, -2.0f, -2.0f, 3, 2, 3);
        this.snout.a(0.0f, -2.0f, -3.0f);
        this.c.a(this.snout);
        (this.jaw = new axx((awt)this, 28, 5)).a(-1.5f, 0.0f, -2.0f, 3, 1, 3);
