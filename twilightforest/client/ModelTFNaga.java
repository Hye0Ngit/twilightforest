...
public class ModelTFNaga extends axa
{
    public ayf head;
    public ayf body;
    
    public ModelTFNaga() {
        (this.head = new ayf((axa)this, 0, 0)).a(-8.0f, -12.0f, -8.0f, 16, 16, 16, 0.0f);
        this.head.a(0.0f, 0.0f, 0.0f);
        (this.body = new ayf((axa)this, 0, 0)).a(-8.0f, -4.0f, -8.0f, 16, 16, 16, 0.0f);
