...
public class ModelTFSquirrel extends awt
{
    axx body;
    axx leg1;
    axx leg2;
    ...
    public ModelTFSquirrel() {
        ...
        (this.body = new axx((awt)this, 0, 8)).a(-2.0f, -1.0f, -2.0f, 4, 3, 5);
        this.body.a(0.0f, 21.0f, 0.0f);
        this.body.b(32, 32);
        this.body.i = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.leg1 = new axx((awt)this, 0, 16)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.leg1.a(-2.0f, 23.0f, 2.0f);
        this.leg1.b(32, 32);
        this.leg1.i = true;
        this.setRotation(this.leg1, 0.0f, 0.0f, 0.0f);
        (this.leg2 = new axx((awt)this, 0, 16)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.leg2.a(1.0f, 23.0f, 2.0f);
        this.leg2.b(32, 32);
        this.leg2.i = true;
        this.setRotation(this.leg2, 0.0f, 0.0f, 0.0f);
        (this.leg3 = new axx((awt)this, 0, 16)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.leg3.a(-2.0f, 23.0f, -2.0f);
        this.leg3.b(32, 32);
        this.setRotation(this.leg3, 0.0f, 0.0f, 0.0f);
        (this.leg4 = new axx((awt)this, 0, 16)).a(0.0f, 0.0f, 0.0f, 1, 1, 1);
        this.leg4.a(1.0f, 23.0f, -2.0f);
        this.leg4.b(32, 32);
        this.setRotation(this.leg4, 0.0f, 0.0f, 0.0f);
        (this.head = new axx((awt)this, "head")).a(0.0f, 22.0f, -2.0f);
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        this.head.a("head", -2.0f, -5.0f, -3.0f, 4, 4, 4);
        this.head.a("ear2", -2.0f, -6.0f, -0.5f, 1, 1, 1);
        this.head.a("ear1", 1.0f, -6.0f, -0.5f, 1, 1, 1);
        (this.tail = new axx((awt)this, "tail")).a(0.0f, 21.0f, 2.0f);
        this.tail.a("base", -0.5f, -1.5f, 0.5f, 1, 1, 1);
        (this.fluff1 = new axx((awt)this, 0, 20)).a(-1.5f, -4.0f, 1.0f, 3, 3, 3);
        this.tail.a(this.fluff1);
        (this.fluff2 = new axx((awt)this, 0, 20)).a(0.0f, -3.0f, -1.5f, 3, 3, 3);
        this.fluff2.a(-1.5f, -4.0f, 2.5f);
        this.fluff1.a(this.fluff2);
        (this.fluff3 = new axx((awt)this, 0, 26)).a(1.5f, -3.0f, -1.5f, 3, 3, 3);
