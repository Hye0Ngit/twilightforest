...
public abstract class ShaderUniform
{
    ...
    public static ShaderUniform create(final String name, final int value) {
        return new ShaderUniform(name) {
            ...
            public void assignUniform(final int shader) {
                ARBShaderObjects.glGetUniformiARB(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), value);
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final IntSupplier supplier) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ARBShaderObjects.glGetUniformiARB(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), supplier.getAsInt());
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final int value0, final int value1) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform2i(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), value0, value1);
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final IntSupplier supplier0, final IntSupplier supplier1) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform2i(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), supplier0.getAsInt(), supplier1.getAsInt());
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final float value) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform1f(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), value);
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final FloatSupplier supplier) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform1f(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), supplier.get());
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final float value0, final float value1) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform2f(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), value0, value1);
            }
        };
    }
    ...
    public static ShaderUniform create(final String name, final FloatSupplier supplier0, final FloatSupplier supplier1) {
        return new ShaderUniform(name) {
            @Override
            public void assignUniform(final int shader) {
                ShaderManager.glUniform2f(ARBShaderObjects.glGetUniformLocationARB(shader, (CharSequence)this.name), supplier0.get(), supplier1.get());
            }
        };
    }
}
