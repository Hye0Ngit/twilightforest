...
public class ModelTFHydraHead extends axa
{
    ayf head;
    ayf jaw;
    ayf frill;
    ...
    public ModelTFHydraHead() {
        ...
        (this.head = new ayf((axa)this, "head")).a("box", -16.0f, -14.0f, -32.0f, 32, 24, 32);
        ...
        (this.jaw = new ayf((axa)this, "jaw")).a(0.0f, 10.0f, -20.0f);
        ...
        (this.frill = new ayf((axa)this, "frill")).a(0.0f, 0.0f, -14.0f);
    ...
    public void a(final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final lq par7Entity) {
    }
    
    public void a(final md entityliving, final float f, final float f1, final float time) {
