...
public class ModelTFHydraHead extends awt
{
    axx head;
    axx jaw;
    axx frill;
    ...
    public ModelTFHydraHead() {
        ...
        (this.head = new axx((awt)this, "head")).a("box", -16.0f, -14.0f, -32.0f, 32, 24, 32);
        ...
        (this.jaw = new axx((awt)this, "jaw")).a(0.0f, 10.0f, -20.0f);
        ...
        (this.frill = new axx((awt)this, "frill")).a(0.0f, 0.0f, -14.0f);
