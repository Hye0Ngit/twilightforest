...
public class ModelTFSlimeBeetle extends axa
{
    ayf head;
    ayf RearEnd;
    ayf Leg6;
    ...
    public ModelTFSlimeBeetle(final boolean renderpass) {
        ...
        this.t = 64;
        this.u = 64;
        (this.connector1 = new ayf((axa)this, 0, 12)).a(-3.0f, -3.0f, -1.0f, 6, 6, 1);
        this.connector1.a(0.0f, 19.0f, -4.0f);
        (this.RearEnd = new ayf((axa)this, 31, 6)).a(-4.0f, -11.0f, -4.0f, 8, 10, 8);
        ...
        (this.antenna1 = new ayf((axa)this, 38, 4)).a(0.0f, -0.5f, -0.5f, 12, 1, 1);
        this.antenna1.a(1.0f, -3.0f, -5.0f);
        this.setRotation(this.antenna1, 0.0f, 1.047198f, -0.296706f);
        (this.antenna2 = new ayf((axa)this, 38, 4)).a(0.0f, -0.5f, -0.5f, 12, 1, 1);
        ...
        (this.mouth = new ayf((axa)this, 17, 12)).a(-1.0f, -1.0f, -1.0f, 2, 2, 1);
        ...
        (this.tail1 = new ayf((axa)this, 0, 20)).a(-3.0f, -3.0f, -3.0f, 6, 6, 6);
        this.tail1.a(0.0f, 19.0f, 9.0f);
        (this.tail2 = new ayf((axa)this, 0, 20)).a(-3.0f, -6.0f, -3.0f, 6, 6, 6);
        this.tail2.a(0.0f, -3.0f, 2.0f);
        (this.slimeCube = new ayf((axa)this, 0, 40)).a(-6.0f, -12.0f, -9.0f, 12, 12, 12);
        this.slimeCube.a(0.0f, -6.0f, 0.0f);
        (this.slimeCenter = new ayf((axa)this, 32, 24)).a(-4.0f, -10.0f, -7.0f, 8, 8, 8);
