...
public class ModelTFPenguin extends awt
{
    axx body;
    axx rightarm;
    axx leftarm;
    ...
    public ModelTFPenguin() {
        this.t = 64;
        this.u = 32;
        (this.body = new axx((awt)this, 32, 0)).a(-4.0f, 0.0f, -4.0f, 8, 9, 8);
        this.body.a(0.0f, 14.0f, 0.0f);
        (this.rightarm = new axx((awt)this, 34, 18)).a(-1.0f, -1.0f, -2.0f, 1, 8, 4);
        this.rightarm.a(-4.0f, 15.0f, 0.0f);
        (this.leftarm = new axx((awt)this, 24, 18)).a(0.0f, -1.0f, -2.0f, 1, 8, 4);
        this.leftarm.a(4.0f, 15.0f, 0.0f);
        this.leftarm.i = true;
        (this.rightleg = new axx((awt)this, 0, 16)).a(-2.0f, 0.0f, -5.0f, 4, 1, 8);
        this.rightleg.a(-2.0f, 23.0f, 0.0f);
        this.rightleg.b(64, 32);
        (this.leftleg = new axx((awt)this, 0, 16)).a(-2.0f, 0.0f, -5.0f, 4, 1, 8);
        this.leftleg.a(2.0f, 23.0f, 0.0f);
        (this.head = new axx((awt)this, 0, 0)).a(-3.5f, -4.0f, -3.5f, 7, 5, 7);
        this.head.a(0.0f, 13.0f, 0.0f);
        (this.beak = new axx((awt)this, 0, 13)).a(-1.0f, 0.0f, -1.0f, 2, 1, 2);
