...
public class TileEntityTFTrophyRenderer extends biy
{
    ...
    public void a(final aqj tileentity, final double x, final double y, final double z, final float partialTime) {
    ...
    private void renderHydraHead(final float rotation, final boolean onGround) {
        ...
        this.a("/mods/twilightforest/textures/model/hydra4.png");
    ...
    private void renderNagaHead(final float rotation, final boolean onGround) {
        ...
        GL11.glScalef(0.25f, 0.25f, 0.25f);
        this.a("/mods/twilightforest/textures/model/nagahead.png");
        GL11.glScalef(1.0f, -1.0f, -1.0f);
        GL11.glRotatef(rotation, 0.0f, 1.0f, 0.0f);
        GL11.glRotatef(180.0f, 0.0f, 1.0f, 0.0f);
    ...
    private void renderLichHead(final float rotation, final boolean onGround) {
        ...
        this.a("/mods/twilightforest/textures/model/twilightlich64.png");
        GL11.glScalef(1.0f, -1.0f, -1.0f);
        GL11.glRotatef(rotation, 0.0f, 1.0f, 0.0f);
        GL11.glRotatef(180.0f, 0.0f, 1.0f, 0.0f);
        GL11.glTranslatef(0.0f, onGround ? 1.75f : 1.5f, onGround ? 0.0f : 0.25f);
    ...
    private void renderUrGhastHead(final TileEntityTFTrophy trophy, final float rotation, final boolean onGround, final float partialTime) {
        ...
        this.a("/mods/twilightforest/textures/model/towerboss.png");
        GL11.glScalef(1.0f, -1.0f, -1.0f);
        GL11.glRotatef(rotation, 0.0f, 1.0f, 0.0f);
        GL11.glRotatef(180.0f, 0.0f, 1.0f, 0.0f);
