...
public class ModelTFLich extends awp
{
    axx collar;
    axx cloak;
    axx shieldBelt;
    ...
    public ModelTFLich() {
        ...
        this.t = 64;
        this.u = 64;
        (this.e = new axx((awt)this, 8, 16)).a(-4.0f, 0.0f, -2.0f, 8, 24, 4);
        this.e.a(0.0f, -4.0f, 0.0f);
        this.e.b(64, 64);
        (this.f = new axx((awt)this, 0, 16)).a(-2.0f, -2.0f, -1.0f, 2, 12, 2);
        this.f.b(64, 64);
        this.f.a(-5.0f, -2.0f, 0.0f);
        this.g = new axx((awt)this, 0, 16);
        this.g.i = true;
        this.g.a(-2.0f, -2.0f, -1.0f, 2, 12, 2);
        this.g.a(5.0f, -2.0f, 0.0f);
        this.g.b(64, 64);
        (this.d = new axx((awt)this, 32, 0)).a(-4.0f, -12.0f, -4.0f, 8, 8, 8, 0.5f);
        this.d.a(0.0f, -4.0f, 0.0f);
        this.d.b(64, 64);
        (this.c = new axx((awt)this, 0, 0)).a(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        this.c.a(0.0f, -4.0f, 0.0f);
        this.c.b(64, 64);
        (this.h = new axx((awt)this, 0, 16)).a(-1.0f, 0.0f, -1.0f, 2, 12, 2);
        this.h.a(-2.0f, 9.5f, 0.0f);
        this.h.b(64, 64);
        (this.i = new axx((awt)this, 0, 16)).a(-1.0f, 0.0f, -1.0f, 2, 12, 2);
        this.i.a(2.0f, 9.5f, 0.0f);
        this.i.b(64, 64);
        this.i.i = true;
        (this.collar = new axx((awt)this, 32, 16)).a(-6.0f, 0.0f, 0.0f, 12, 12, 1);
        this.collar.a(0.0f, -3.0f, -1.0f);
        this.collar.b(64, 64);
        this.setRotation(this.collar, 2.164208f, 0.0f, 0.0f);
        (this.cloak = new axx((awt)this, 0, 44)).a(-6.0f, 0.0f, 0.0f, 12, 19, 1);
        this.cloak.a(0.0f, -4.0f, 2.5f);
        this.cloak.b(64, 64);
        this.setRotation(this.cloak, 0.0f, 0.0f, 0.0f);
        (this.shieldBelt = new axx((awt)this)).a(0.0f, 0.0f, 0.0f);
    }
        ...
        if (!lich.isShadowClone() && shields > 0) {
            if (this.shieldBelt.m == null || this.shieldBelt.m.size() != shields) {
                ...
                for (int i = 0; i < shields; ++i) {
                    ...
                    vec.b(rotateY);
                    final axx shield = new axx((awt)this, 26, 40);
