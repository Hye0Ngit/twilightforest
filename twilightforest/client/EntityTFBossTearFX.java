...
{
    public EntityTFBossTearFX(final World par1World, final double par2, final double par4, final double par6, final Item par8Item, final RenderEngine par9RenderEngine) {
        super(par1World, par2, par4, par6, 0.0, 0.0, 0.0);
        this.func_94052_a(par9RenderEngine, par8Item.func_77617_a(0));
        ...
        this.field_70545_g = Block.field_72039_aU.field_72017_co * 2.0f;
        this.field_70544_f = 16.0f;
        this.field_70547_e = 20 + this.field_70146_Z.nextInt(40);
    }
    
    public EntityTFBossTearFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final Item par14Item, final RenderEngine par15RenderEngine) {
    ...
    public void func_70071_h_() {
        ...
        if (this.field_70122_E && this.field_70146_Z.nextBoolean()) {
            ...
            for (int var1 = 0; var1 < 50; ++var1) {
                ...
                final int popItem = Item.field_77732_bp.field_77779_bT;
                this.field_70170_p.func_72869_a("iconcrack_" + popItem, this.field_70165_t + this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat(), this.field_70163_u + 0.5, this.field_70161_v + this.field_70146_Z.nextFloat(), gaussX, gaussY, gaussZ);
            }
            this.func_70106_y();
        }
    }
