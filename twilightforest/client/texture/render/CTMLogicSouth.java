...
public class CTMLogicSouth extends CTMLogic
{
    ...
    public boolean isConnected(final IBlockAccess world, final BlockPos current, final BlockPos connection, final EnumFacing dir, final IBlockState state) {
        ...
        return super.isConnected(world, current, current.func_177971_a((Vec3i)new BlockPos(-difference.func_177958_n(), difference.func_177952_p(), difference.func_177956_o())), dir, state);
    }
}
