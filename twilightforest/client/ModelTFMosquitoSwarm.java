...
public class ModelTFMosquitoSwarm extends axa
{
    ayf core;
    ayf node1;
    ayf node2;
    ...
    public ModelTFMosquitoSwarm() {
        ...
        (this.core = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-4.0f, 0.0f, -2.0f, 1, 1, 1);
        this.core.a(0.0f, -4.0f, 0.0f);
        (this.node1 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-5.5f, -5.0f, -13.0f, 1, 1, 1);
        this.node1.a(2.0f, -1.0f, -6.0f);
        this.core.a(this.node1);
        (this.node2 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-5.5f, -13.0f, -5.0f, 1, 1, 1);
        this.node2.a(0.0f, -7.0f, -1.0f);
        this.core.a(this.node2);
        (this.node3 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-13.0f, -5.0f, -5.0f, 1, 1, 1);
        this.node3.a(5.0f, -2.0f, -1.0f);
        this.core.a(this.node3);
        (this.node4 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-5.5f, -5.0f, -13.0f, 1, 1, 1);
        this.node4.a(2.0f, -1.0f, -6.0f);
        this.core.a(this.node4);
        (this.node5 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-5.5f, -13.0f, -5.0f, 1, 1, 1);
        this.node5.a(0.0f, -7.0f, -1.0f);
        this.core.a(this.node5);
        (this.node6 = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28))).a(-13.0f, -5.0f, -5.0f, 1, 1, 1);
    ...
    public void addBugsToNodes(final ayf node) {
        for (int bugs = 16, i = 0; i < bugs; ++i) {
            final aoj vec = aoj.a(11.0, 0.0, 0.0);
            final float rotateY = i * (360.0f / bugs) * 3.141593f / 180.0f;
            vec.b(rotateY);
            final ayf bug = new ayf((axa)this, this.rand.nextInt(28), this.rand.nextInt(28));
