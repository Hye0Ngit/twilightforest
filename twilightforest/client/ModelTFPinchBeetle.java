...
public class ModelTFPinchBeetle extends awt
{
    axx thorax;
    axx head;
    axx connector2;
    ...
    public ModelTFPinchBeetle() {
        this.t = 64;
        this.u = 32;
        (this.thorax = new axx((awt)this, 0, 22)).a(-4.5f, -4.0f, 0.0f, 9, 8, 2);
        this.thorax.a(0.0f, 18.0f, -4.5f);
        (this.connector1 = new axx((awt)this, 0, 12)).a(-3.0f, -3.0f, 0.0f, 6, 6, 1);
        this.connector1.a(0.0f, 18.0f, -3.0f);
        (this.connector2 = new axx((awt)this, 0, 12)).a(-3.0f, -3.0f, -1.0f, 6, 6, 1);
        this.connector2.a(0.0f, 18.0f, -4.0f);
        (this.RearEnd = new axx((awt)this, 28, 14)).a(-5.0f, -9.0f, -4.0f, 10, 10, 8);
