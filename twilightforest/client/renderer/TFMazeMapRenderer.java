...
public class TFMazeMapRenderer implements IItemRenderer
{
    ...
    public boolean handleRenderType(final ItemStack item, final IItemRenderer.ItemRenderType type) {
        return (item.func_77973_b() == TFItems.mazeMap || item.func_77973_b() == TFItems.oreMap) && RenderItem.field_82407_g && type == IItemRenderer.ItemRenderType.ENTITY;
    }
    ...
    private void renderMapInFrame(final ItemStack item, final RenderManager renderManager, final TFMazeMapData mapData) {
        ...
        Minecraft.func_71410_x().field_71460_t.func_147701_i().func_148250_a((MapData)mapData, false);
    }
