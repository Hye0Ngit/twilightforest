...
public class TileEntityTFFireflyRenderer extends bjb
{
    ...
    public void a(final asm tileentity, final double d, final double d1, final double d2, final float f) {
    ...
    private void renderTileEntityFireflyAt(final TileEntityTFFirefly tileentity, final double d, final double d1, final double d2, final float f) {
        ...
        this.a(TileEntityTFFireflyRenderer.textureLoc);
        GL11.glPushMatrix();
    ...
    static {
        textureLoc = new bjl("twilightforest:textures/model/firefly-tiny.png");
    }
}
