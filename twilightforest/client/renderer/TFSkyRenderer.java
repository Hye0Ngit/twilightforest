...
public class TFSkyRenderer extends IRenderHandler
{
    ...
    public TFSkyRenderer() {
        this.starGLCallList = atr.a(3);
        GL11.glPushMatrix();
        GL11.glNewList(this.starGLCallList, 4864);
        this.renderStars();
        GL11.glEndList();
        GL11.glPopMatrix();
        final bfn var5 = bfn.a;
    ...
    @SideOnly(Side.CLIENT)
    public void render(final float partialTicks, final bda world, final ats mc) {
        GL11.glDisable(3553);
        final asz var2 = this.getTwilightSkyColor((abv)world);
        ...
        GL11.glRotatef(this.getRealCelestialAngle((abv)world, partialTicks) * 360.0f, 1.0f, 0.0f, 0.0f);
        float var13 = 30.0f;
        GL11.glDisable(3553);
        ...
        final double var15 = mc.h.l(partialTicks).d - TFWorld.SEALEVEL;
        if (var15 < 0.0) {
            GL11.glPushMatrix();
    ...
    private float getRealCelestialAngle(final abv world, final float partialTicks) {
        final int var4 = (int)(world.J() % 24000L);
    ...
    private asz getTwilightSkyColor(final abv world) {
        return world.V().a(0.125, 0.1328125, 0.2890625);
    }
    
    private void renderStars() {
        final Random var1 = new Random(10842L);
        final bfn var2 = bfn.a;
        var2.b();
