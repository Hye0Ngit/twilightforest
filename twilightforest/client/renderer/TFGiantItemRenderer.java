...
public class TFGiantItemRenderer implements IItemRenderer
{
    ...
    public TFGiantItemRenderer(final GameSettings gameSettings, final TextureManager textureManager) {
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        if (type == IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON) {
            ...
            this.renderGiantItemEquipped(iicon, item);
        }
    ...
    private void renderGiantItemEquipped(final IIcon iicon, final ItemStack par2ItemStack) {
        final int par3 = 0;
        if (iicon == null) {
            GL11.glPopMatrix();
            return;
