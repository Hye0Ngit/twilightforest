...
public class RenderBlockTFMagicLeaves implements ISimpleBlockRenderingHandler
{
    ...
    private void restoreRendererRotate(final bfo renderer) {
        renderer.r = 0;
        renderer.p = 0;
        renderer.q = 0;
        renderer.s = 0;
    ...
    private void setRenderRotate(final bfo renderer, final int meta) {
        this.setRenderRotate(renderer, meta, 0, 0, 0);
    }
    
    private void setRenderRotate(final bfo renderer, final int meta, final int x, final int y, final int z) {
    ...
    public static void renderInvNormalBlock(final bfo renderblocks, final aqw par1Block, final int meta) {
