...
public class TFMagicMapRenderer implements IItemRenderer
{
    ...
    public boolean handleRenderType(final ItemStack item, final IItemRenderer.ItemRenderType type) {
        return item.field_77993_c == TFItems.magicMap.field_77779_bT && (type == IItemRenderer.ItemRenderType.FIRST_PERSON_MAP || (RenderItem.field_82407_g && type == IItemRenderer.ItemRenderType.ENTITY));
    }
