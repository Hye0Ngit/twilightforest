...
public class LegacySlimeBeetleRenderer extends MobRenderer<SlimeBeetle, SlimeBeetleLegacyModel>
{
    ...
    public LegacySlimeBeetleRenderer(final EntityRendererProvider.Context manager, final SlimeBeetleLegacyModel model, final float shadowSize) {
        super(manager, (EntityModel)model, shadowSize);
        this.m_115326_((RenderLayer)new LayerInner((RenderLayerParent<SlimeBeetle, SlimeBeetleLegacyModel>)this, manager));
    }
    ...
    public void render(final SlimeBeetle entityIn, final float entityYaw, final float partialTicks, final PoseStack matrixStackIn, final MultiBufferSource bufferIn, final int packedLightIn) {
        if (((SlimeBeetleLegacyModel)this.f_115290_).f_102609_) {
    ...
    public ResourceLocation getTextureLocation(final SlimeBeetle entity) {
        return LegacySlimeBeetleRenderer.textureLoc;
    }
    ...
    static class LayerInner extends RenderLayer<SlimeBeetle, SlimeBeetleLegacyModel>
    {
        ...
        public LayerInner(final RenderLayerParent<SlimeBeetle, SlimeBeetleLegacyModel> renderer, final EntityRendererProvider.Context manager) {
            super((RenderLayerParent)renderer);
            this.innerModel = new SlimeBeetleLegacyModel(manager.m_174023_(TFModelLayers.LEGACY_SLIME_BEETLE_TAIL));
        }
