...
public class RenderTFThrownAxe extends RenderItem
{
    ...
    public void func_76986_a(final Entity entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
        ...
        this.func_77014_a(null, par2, par4, par6, par8, spin);
        GL11.glPopMatrix();
    }
    
    public void func_77014_a(final EntityItem par1EntityItem, final double x, final double y, final double z, final float rotation, final float spin) {
        this.func_110776_a(this.func_110775_a(null));
        GL11.glPushMatrix();
        GL11.glTranslatef((float)x, (float)y, (float)z);
        GL11.glEnable(32826);
        GL11.glScalef(1.25f, 1.25f, 1.25f);
        final Icon icon1 = this.myItem.func_77617_a(0);
        this.renderDroppedItem(icon1, rotation, spin);
        GL11.glDisable(32826);
        GL11.glPopMatrix();
    }
    
    private void renderDroppedItem(final Icon par2Icon, final float rotation, final float spin) {
