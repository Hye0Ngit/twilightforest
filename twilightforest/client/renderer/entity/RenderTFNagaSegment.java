...
public class RenderTFNagaSegment extends Render
{
    ...
    public RenderTFNagaSegment(final ModelBase model, final float f) {
        this.model = model;
    }
    
    public void renderMe(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float time) {
        GL11.glPushMatrix();
    ...
    static {
        textureLoc = new ResourceLocation("twilightforest:textures/model/nagasegment.png");
    }
}
