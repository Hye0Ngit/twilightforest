...
public class RenderTFSpikeBlock extends bgj
{
    private bbl model;
    private static final bjl textureLoc;
    
    public RenderTFSpikeBlock(final bbl modelTFSpikeBlock, final float f) {
        this.model = modelTFSpikeBlock;
    }
    
    public void renderSpikeBlock(final nm par1Entity, final double par2, final double par4, final double par6, final float par8, final float time) {
        GL11.glPushMatrix();
