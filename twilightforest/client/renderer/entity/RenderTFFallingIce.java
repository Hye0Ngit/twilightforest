...
public class RenderTFFallingIce extends Render
{
    ...
    public void doRender(final EntityTFFallingIce entity, final double x, final double y, final double z, final float p_147918_8_, final float p_147918_9_) {
