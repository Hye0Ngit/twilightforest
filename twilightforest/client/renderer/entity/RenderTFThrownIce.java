...
{
    public RenderTFThrownIce(final RenderManager manager) {
        super(manager);
        this.field_76989_e = 0.5f;
    }
    
    public void doRender(final EntityTFIceBomb entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
    ...
    protected ResourceLocation getEntityTexture(final EntityTFIceBomb entity) {
