...
public class RenderTFSnowQueenIceShield extends Render
{
    ...
    public RenderTFSnowQueenIceShield() {
    ...
    public void doRender(final EntityTFSnowQueenIceShield entity, final double x, final double y, final double z, final float p_147918_8_, final float p_147918_9_) {
        final World world = entity.field_70170_p;
        final Block block = Blocks.field_150403_cj;
