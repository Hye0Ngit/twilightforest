...
public class BlockChainGoblinRenderer<T extends BlockChainGoblin, M extends BlockChainGoblinModel<T>> extends HumanoidMobRenderer<T, M>
{
    ...
    public BlockChainGoblinRenderer(final EntityRendererProvider.Context manager, final M goblinModel, final float shadowSize) {
    ...
    public void render(final T goblin, final float yaw, final float partialTicks, final PoseStack stack, final MultiBufferSource buffer, final int light) {
        ...
        final VertexConsumer ivertexbuilder = buffer.m_6299_(this.model.m_103119_(BlockChainGoblinRenderer.textureLoc));
