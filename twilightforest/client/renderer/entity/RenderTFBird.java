...
public class RenderTFBird extends RenderLiving
{
    ...
    public RenderTFBird(final ModelBase par1ModelBase, final float par2, final String textureName) {
    ...
    public void renderTFBird(final EntityTFBird par1EntityTFBird, final double par2, final double par4, final double par6, final float par8, final float par9) {
        super.func_76986_a((EntityLiving)par1EntityTFBird, par2, par4, par6, par8, par9);
    }
    ...
    protected float func_77044_a(final EntityLivingBase par1EntityLiving, final float par2) {
