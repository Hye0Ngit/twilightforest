...
public class RenderBlockTFFireflyJar implements ISimpleBlockRenderingHandler
{
    ...
    public static boolean renderJar(final baq renderblocks, final yf world, final int x, final int y, final int z, final amj block) {
        renderblocks.a();
    ...
    public static void renderInvJar(final baq renderblocks, final amj par1Block, final int meta) {
