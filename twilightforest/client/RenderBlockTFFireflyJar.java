...
public class RenderBlockTFFireflyJar implements ISimpleBlockRenderingHandler
{
    ...
    public static boolean renderJar(final bfz renderblocks, final aae world, final int x, final int y, final int z, final aou block) {
        renderblocks.a();
    ...
    public static void renderInvJar(final bfz renderblocks, final aou par1Block, final int meta) {
