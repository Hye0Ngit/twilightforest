...
public class TFSkyProvider extends SkyProvider
{
    ...
    public TFSkyProvider() {
        this.starGLCallList = arp.a(3);
        GL11.glPushMatrix();
        GL11.glNewList(this.starGLCallList, 4864);
        this.renderStars();
        GL11.glEndList();
        GL11.glPopMatrix();
        final bao var5 = bao.a;
        ...
        for (int var9 = -var6 * var7; var9 <= var6 * var7; var9 += var6) {
            for (int var10 = -var6 * var7; var10 <= var6 * var7; var10 += var6) {
                var5.b();
                var5.a((double)(var9 + 0), (double)var8, (double)(var10 + 0));
                var5.a((double)(var9 + var6), (double)var8, (double)(var10 + 0));
                var5.a((double)(var9 + var6), (double)var8, (double)(var10 + var6));
                var5.a((double)(var9 + 0), (double)var8, (double)(var10 + var6));
                var5.a();
            }
        }
        GL11.glEndList();
    ...
    @SideOnly(Side.CLIENT)
    public void render(final float partialTicks, final ayh world, final Minecraft mc) {
        GL11.glDisable(3553);
        final aob var2 = this.getTwilightSkyColor((xv)world);
        float var3 = (float)var2.c;
        float var4 = (float)var2.d;
        float var5 = (float)var2.e;
        if (mc.y.g) {
        ...
        GL11.glPushMatrix();
        final float var8 = 1.0f - world.j(partialTicks);
        ...
        GL11.glRotatef(this.getRealCelestialAngle((xv)world, partialTicks) * 360.0f, 1.0f, 0.0f, 0.0f);
        float var13 = 30.0f;
        GL11.glDisable(3553);
        ...
        final double var15 = mc.g.h(partialTicks).d - TFWorld.SEALEVEL;
        if (var15 < 0.0) {
            GL11.glPushMatrix();
            ...
            var9.b();
            var9.a(0, 255);
            var9.a((double)(-var11), (double)var12, (double)var11);
            var9.a((double)var11, (double)var12, (double)var11);
            var9.a((double)var11, (double)var13, (double)var11);
            var9.a((double)(-var11), (double)var13, (double)var11);
            var9.a((double)(-var11), (double)var13, (double)(-var11));
            var9.a((double)var11, (double)var13, (double)(-var11));
            var9.a((double)var11, (double)var12, (double)(-var11));
    ...
    private float getRealCelestialAngle(final xv world, final float partialTicks) {
        final int var4 = (int)(world.G() % 24000L);
    ...
    private aob getTwilightSkyColor(final xv world) {
        return world.S().a(0.125, 0.1328125, 0.2890625);
    }
    
    private void renderStars() {
        final Random var1 = new Random(10842L);
        final bao var2 = bao.a;
        var2.b();
        for (int var3 = 0; var3 < 3000; ++var3) {
            ...
            if (var7 < 1.0 && var7 > 0.01) {
                ...
                for (int var20 = 0; var20 < 4; ++var20) {
                    ...
                    var2.a(var8 + var28, var9 + var26, var10 + var29);
                }
            }
        }
        var2.a();
