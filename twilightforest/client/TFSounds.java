...
public class TFSounds
{
    ...
    public void loadSounds(final SoundLoadEvent event) {
        final bjw manager = event.manager;
        ...
        this.addSound(manager, "mob/tf/urghast/trapactive.ogg", "urghast/trapactive.ogg");
        this.addSound(manager, "mob/tf/urghast/trapwarmup.ogg", "urghast/trapwarmup.ogg");
        this.addSound(manager, "mob/tf/urghast/trapon0.ogg", "urghast/trapon0.ogg");
        this.addSound(manager, "mob/tf/urghast/trapon1.ogg", "urghast/trapon1.ogg");
        this.addSound(manager, "mob/tf/urghast/trapon2.ogg", "urghast/trapon2.ogg");
        this.addSound(manager, "mob/tf/urghast/trapon3.ogg", "urghast/trapon3.ogg");
        this.addSound(manager, "mob/tf/urghast/trapon4.ogg", "urghast/trapon4.ogg");
        this.addSound(manager, "mob/tf/urghast/trapspindown.ogg", "urghast/trapspindown.ogg");
    }
    
    public void addSound(final bjw manager, final String soundName, final String URL) {
        manager.b.addSound(soundName, TwilightForestMod.class.getResource("/mods/twilightforest/sounds/" + URL));
    }
}
