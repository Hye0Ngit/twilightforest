...
public class TFSounds
{
    ...
    public void loadSounds(final SoundLoadEvent event) {
        final blk manager = event.manager;
    ...
    public void addSound(final blk manager, final String soundName) {
        manager.a("TwilightForest:" + soundName);
    }
    
    public void addSound(final blk manager, final String soundName, final String URL) {
        manager.a("TwilightForest:" + soundName);
    }
}
