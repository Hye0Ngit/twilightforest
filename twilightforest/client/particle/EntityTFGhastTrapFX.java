...
public class EntityTFGhastTrapFX extends bed
{
    ...
    public EntityTFGhastTrapFX(final abv par1World, final double par2, final double par4, final double par6, final double par8, final double par9, final double par10) {
        this(par1World, par2, par4, par6, 3.0f, par8, par9, par10);
    }
    
    public EntityTFGhastTrapFX(final abv par1World, final double x, final double y, final double z, final float scale, final double mx, final double my, final double mz) {
