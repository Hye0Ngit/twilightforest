...
public class ParticleIceBeam extends Particle
{
    ...
    public ParticleIceBeam(final World world, final double x, final double y, final double z, final double vx, final double vy, final double vz) {
        this(world, x, y, z, vx, vy, vz, 1.0f);
    }
    
    public ParticleIceBeam(final World world, final double x, final double y, final double z, final double vx, final double vy, final double vz, final float scale) {
        ...
        this.func_187117_a(Minecraft.func_71410_x().func_147117_R().func_110572_b("twilightforest:particles/snow_" + this.field_187136_p.nextInt(4)));
        this.func_189213_a();
    }
