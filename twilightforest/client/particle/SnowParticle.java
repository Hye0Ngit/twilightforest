...
public class SnowParticle extends TextureSheetParticle
{
    ...
    SnowParticle(final ClientLevel world, final double x, final double y, final double z, final double vx, final double vy, final double vz) {
        this(world, x, y, z, vx, vy, vz, 1.0f);
    }
    
    SnowParticle(final ClientLevel world, final double x, final double y, final double z, final double vx, final double vy, final double vz, final float scale) {
        ...
        this.f_107225_ = (int)(6.0 / (Math.random() * 0.8 + 0.6));
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType>
    {
        ...
        public Particle createParticle(final SimpleParticleType typeIn, final ClientLevel worldIn, final double x, final double y, final double z, final double xSpeed, final double ySpeed, final double zSpeed) {
            final SnowParticle particle = new SnowParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
