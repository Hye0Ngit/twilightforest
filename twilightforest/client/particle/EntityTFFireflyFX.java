...
public class EntityTFFireflyFX extends EntityFX
{
    ...
    public void func_70539_a(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        if (this.field_70550_a != null) {
            final float f11 = this.field_70550_a.func_94209_e();
            final float f12 = this.field_70550_a.func_94212_f();
            final float f13 = this.field_70550_a.func_94206_g();
            final float f14 = this.field_70550_a.func_94210_h();
        }
        final float f15 = (float)(this.field_70169_q + (this.field_70165_t - this.field_70169_q) * par2 - EntityTFFireflyFX.field_70556_an);
        final float f16 = (float)(this.field_70167_r + (this.field_70163_u - this.field_70167_r) * par2 - EntityTFFireflyFX.field_70554_ao);
        final float f17 = (float)(this.field_70166_s + (this.field_70161_v - this.field_70166_s) * par2 - EntityTFFireflyFX.field_70555_ap);
        final float f18 = 1.0f;
        par1Tessellator.func_78369_a(this.field_70552_h * f18, this.field_70553_i * f18, this.field_70551_j * f18, this.field_82339_as);
        par1Tessellator.func_78374_a((double)(f15 - par3 * f10 - par6 * f10), (double)(f16 - par4 * f10), (double)(f17 - par5 * f10 - par7 * f10), (double)f7, (double)f9);
        par1Tessellator.func_78374_a((double)(f15 - par3 * f10 + par6 * f10), (double)(f16 + par4 * f10), (double)(f17 - par5 * f10 + par7 * f10), (double)f7, (double)f8);
        par1Tessellator.func_78374_a((double)(f15 + par3 * f10 + par6 * f10), (double)(f16 + par4 * f10), (double)(f17 + par5 * f10 + par7 * f10), (double)f6, (double)f8);
        par1Tessellator.func_78374_a((double)(f15 + par3 * f10 - par6 * f10), (double)(f16 - par4 * f10), (double)(f17 + par5 * f10 - par7 * f10), (double)f6, (double)f9);
        GL11.glDisable(3042);
        GL11.glEnable(3008);
    }
