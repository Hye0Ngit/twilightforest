...
public class EntityTFBossTearFX extends bed
{
    public EntityTFBossTearFX(final abv par1World, final double par2, final double par4, final double par6, final yb par8Item) {
        super(par1World, par2, par4, par6, 0.0, 0.0, 0.0);
        this.a(par8Item.b_(0));
        final float j = 1.0f;
        this.av = j;
        this.au = j;
        this.j = j;
        this.i = aqw.aZ.cT * 2.0f;
        this.h = 16.0f;
        this.g = 20 + this.ab.nextInt(40);
    }
    
    public EntityTFBossTearFX(final abv par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12, final yb par14Item) {
