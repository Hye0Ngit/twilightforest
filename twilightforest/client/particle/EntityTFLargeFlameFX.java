...
public class EntityTFLargeFlameFX extends bed
{
    private float flameScale;
    
    public EntityTFLargeFlameFX(final abv par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
