...
public class EntityTFLargeFlameFX extends EntityFX
{
    ...
    public EntityTFLargeFlameFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
        ...
        double var10000 = par2 + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.05f;
        var10000 = par4 + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.05f;
        var10000 = par6 + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.05f;
