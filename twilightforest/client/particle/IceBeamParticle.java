...
public class IceBeamParticle extends SpriteTexturedParticle
{
    ...
    IceBeamParticle(final ClientWorld world, final double x, final double y, final double z, final double vx, final double vy, final double vz, final float scale) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Particle makeParticle(final BasicParticleType typeIn, final ClientWorld worldIn, final double x, final double y, final double z, final double xSpeed, final double ySpeed, final double zSpeed) {
            final IceBeamParticle particle = new IceBeamParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 0.75f);
