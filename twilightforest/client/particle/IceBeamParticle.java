...
public class IceBeamParticle extends TextureSheetParticle
{
    ...
    IceBeamParticle(final ClientLevel world, final double x, final double y, final double z, final double vx, final double vy, final double vz, final float scale) {
