...
public class ModelTFFireBeetle extends awt
{
    axx thorax;
    axx head;
    axx connector2;
    ...
    public ModelTFFireBeetle() {
        ...
        (this.RearEnd = new axx((awt)this, 22, 9)).a(-6.0f, -9.0f, -4.0f, 12, 14, 9);
