...
public class ModelTFFireBeetle extends axa
{
    ayf thorax;
    ayf head;
    ayf connector2;
    ...
    public ModelTFFireBeetle() {
        ...
        (this.RearEnd = new ayf((axa)this, 22, 9)).a(-6.0f, -9.0f, -4.0f, 12, 14, 9);
