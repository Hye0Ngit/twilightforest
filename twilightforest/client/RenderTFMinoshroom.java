...
public class RenderTFMinoshroom extends bcc
{
    public RenderTFMinoshroom(final aww par1ModelBase, final float par2) {
    ...
    protected void renderMooshroomEquippedItems(final md par1EntityLiving, final float par2) {
        ...
        this.c.a((amq)amq.aj, 0, 1.0f);
        GL11.glTranslatef(0.1f, 0.0f, -0.6f);
        GL11.glRotatef(42.0f, 0.0f, 1.0f, 0.0f);
        this.c.a((amq)amq.aj, 0, 1.0f);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        ((aww)this.i).c.c(0.0625f);
        GL11.glScalef(1.0f, -1.0f, 1.0f);
