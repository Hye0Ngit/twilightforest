...
public class EntityTFLargeFlameFX extends azq
{
    private float flameScale;
    
    public EntityTFLargeFlameFX(final yc par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
    ...
    public void a(final baz par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
