...
public class ModelTFHydra extends awt
{
    axx body;
    axx leg1;
    axx leg2;
    ...
    public ModelTFHydra() {
        ...
        (this.body = new axx((awt)this, "body")).a(0.0f, -12.0f, 0.0f);
        this.body.a("body", -48.0f, 0.0f, 0.0f, 96, 96, 40);
        this.setRotation(this.body, 1.22173f, 0.0f, 0.0f);
        (this.leg1 = new axx((awt)this, "leg")).a(48.0f, -24.0f, 0.0f);
        ...
        (this.leg2 = new axx((awt)this, "leg")).a(-48.0f, -24.0f, 0.0f);
        this.leg2.i = true;
    ...
    public float getRotationY(final EntityTFHydra hydra, final EntityTFHydraPart whichHead, final float time) {
        final float yawOffset = hydra.ax + (hydra.aw - hydra.ax) * time;
