...
public class ComponentTFLeafSphere extends StructureTFComponent
{
    ...
    protected ComponentTFLeafSphere(final int index, final int x, final int y, final int z, final int radius) {
        ...
        this.g = new qg(x - radius, y - radius, z - radius, x + radius, y + radius, z + radius);
        this.rad = radius;
    }
    ...
    protected void placeBlockIfEmpty(final xd world, final int blockID, final int meta, final int x, final int y, final int z, final qg sbb) {
