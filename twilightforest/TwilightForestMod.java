...
@Mod(modid = "TwilightForest", name = "The Twilight Forest", version = "1.16.3")
...
public class TwilightForestMod
{
    ...
    private void registerCreatures() {
        ...
        TFCreatures.registerTFCreature(EntityTFMiniGhast.class, "Mini Ghast", TwilightForestMod.idMobMiniGhast);
        TFCreatures.registerTFCreature(EntityTFTowerGhast.class, "Tower Ghast", TwilightForestMod.idMobTowerGhast, 12369084, 10961731);
    ...
    private void registerDispenseBehaviors(final MinecraftServer minecraftServer) {
        alv.a.a((Object)TFItems.spawnEgg, (Object)new BehaviorTFMobEggDispense(minecraftServer));
    }
