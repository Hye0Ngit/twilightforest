...
@Mod(modid = "TwilightForest", name = "The Twilight Forest", version = "1.18.2")
...
public class TwilightForestMod
{
    ...
    private void registerThaumcraftIntegration() {
        try {
            ThaumcraftApi.registerObjectTag(TFItems.nagaScale.field_77779_bT, -1, new ObjectTags().add(EnumTag.BEAST, 16).add(EnumTag.MOTION, 16).add(EnumTag.ARMOR, 5).add(EnumTag.POWER, 2));
            ThaumcraftApi.registerComplexObjectTag(TFItems.scepterTwilight.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 24).add(EnumTag.ELDRITCH, 16).add(EnumTag.DARK, 18));
            ThaumcraftApi.registerComplexObjectTag(TFItems.scepterLifeDrain.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 24).add(EnumTag.LIFE, 16).add(EnumTag.ELDRITCH, 18));
            ThaumcraftApi.registerComplexObjectTag(TFItems.scepterZombie.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 24).add(EnumTag.DEATH, 16).add(EnumTag.CONTROL, 18));
            ThaumcraftApi.registerObjectTag(TFItems.magicMap.field_77779_bT, -1, new ObjectTags().add(EnumTag.WATER, 13).add(EnumTag.KNOWLEDGE, 16).add(EnumTag.WOOD, 4).add(EnumTag.CROP, 4).add(EnumTag.LIGHT, 4).add(EnumTag.MAGIC, 16));
            ThaumcraftApi.registerObjectTag(TFItems.mazeMap.field_77779_bT, -1, new ObjectTags().add(EnumTag.WATER, 13).add(EnumTag.KNOWLEDGE, 16).add(EnumTag.WOOD, 4).add(EnumTag.CROP, 4).add(EnumTag.LIGHT, 4).add(EnumTag.MAGIC, 16));
            ThaumcraftApi.registerObjectTag(TFItems.oreMap.field_77779_bT, -1, new ObjectTags().add(EnumTag.WATER, 13).add(EnumTag.KNOWLEDGE, 16).add(EnumTag.WOOD, 4).add(EnumTag.CROP, 4).add(EnumTag.LIGHT, 4).add(EnumTag.MAGIC, 16).add(EnumTag.METAL, 16).add(EnumTag.VALUABLE, 16));
            ThaumcraftApi.registerObjectTag(TFItems.feather.field_77779_bT, -1, new ObjectTags().add(EnumTag.FLIGHT, 2).add(EnumTag.WIND, 2).add(EnumTag.BEAST, 2).add(EnumTag.DARK, 2));
            ThaumcraftApi.registerObjectTag(TFItems.liveRoot.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 2).add(EnumTag.WOOD, 4).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.ironwoodIngot.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 2).add(EnumTag.WOOD, 6).add(EnumTag.METAL, 6).add(EnumTag.PLANT, 2));
            ThaumcraftApi.registerObjectTag(TFItems.torchberries.field_77779_bT, -1, new ObjectTags().add(EnumTag.PLANT, 3).add(EnumTag.LIGHT, 5));
            ThaumcraftApi.registerObjectTag(TFItems.fieryBlood.field_77779_bT, -1, new ObjectTags().add(EnumTag.FIRE, 8).add(EnumTag.BEAST, 4).add(EnumTag.DESTRUCTION, 2).add(EnumTag.MAGIC, 2));
            ThaumcraftApi.registerObjectTag(TFItems.trophy.field_77779_bT, -1, new ObjectTags().add(EnumTag.FIRE, 6).add(EnumTag.BEAST, 4).add(EnumTag.DESTRUCTION, 2));
            ThaumcraftApi.registerObjectTag(TFItems.steeleafIngot.field_77779_bT, -1, new ObjectTags().add(EnumTag.PLANT, 4).add(EnumTag.METAL, 1).add(EnumTag.MAGIC, 4));
            ThaumcraftApi.registerComplexObjectTag(TFItems.minotaurAxe.field_77779_bT, -1, new ObjectTags().add(EnumTag.BEAST, 4).add(EnumTag.WEAPON, 12).add(EnumTag.CRYSTAL, 12).add(EnumTag.MOTION, 8));
            ThaumcraftApi.registerComplexObjectTag(TFItems.mazebreakerPick.field_77779_bT, -1, new ObjectTags().add(EnumTag.CRYSTAL, 12).add(EnumTag.PURE, 24).add(EnumTag.DESTRUCTION, 8));
            ThaumcraftApi.registerObjectTag(TFItems.oreMagnet.field_77779_bT, -1, new ObjectTags().add(EnumTag.ROCK, 6).add(EnumTag.TOOL, 6).add(EnumTag.METAL, 6).add(EnumTag.EXCHANGE, 6));
            ThaumcraftApi.registerObjectTag(TFItems.crumbleHorn.field_77779_bT, -1, new ObjectTags().add(EnumTag.ROCK, 12).add(EnumTag.TOOL, 6).add(EnumTag.DESTRUCTION, 12));
            ThaumcraftApi.registerObjectTag(TFItems.peacockFan.field_77779_bT, -1, new ObjectTags().add(EnumTag.WIND, 10).add(EnumTag.MOTION, 10).add(EnumTag.CONTROL, 12).add(EnumTag.FLIGHT, 12));
            ThaumcraftApi.registerObjectTag(TFItems.moonwormQueen.field_77779_bT, -1, new ObjectTags().add(EnumTag.LIGHT, 12).add(EnumTag.INSECT, 12).add(EnumTag.TOOL, 6));
            ThaumcraftApi.registerObjectTag(TFItems.charmOfLife1.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 4).add(EnumTag.TRAP, 8).add(EnumTag.HEAL, 4).add(EnumTag.VALUABLE, 3));
            ThaumcraftApi.registerObjectTag(TFItems.charmOfKeeping1.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 4).add(EnumTag.EXCHANGE, 4).add(EnumTag.TRAP, 8).add(EnumTag.VALUABLE, 3));
            ThaumcraftApi.registerObjectTag(TFItems.towerKey.field_77779_bT, -1, new ObjectTags().add(EnumTag.MECHANISM, 6).add(EnumTag.MAGIC, 2));
            ThaumcraftApi.registerObjectTag(TFItems.transformPowder.field_77779_bT, -1, new ObjectTags().add(EnumTag.MAGIC, 12).add(EnumTag.EXCHANGE, 12).add(EnumTag.BEAST, 4));
            ThaumcraftApi.registerObjectTag(TFItems.venisonRaw.field_77779_bT, -1, new ObjectTags().add(EnumTag.BEAST, 1).add(EnumTag.FLESH, 4).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.venisonCooked.field_77779_bT, -1, new ObjectTags().add(EnumTag.FIRE, 1).add(EnumTag.FLESH, 4).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.meefRaw.field_77779_bT, -1, new ObjectTags().add(EnumTag.BEAST, 2).add(EnumTag.FLESH, 4).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.meefSteak.field_77779_bT, -1, new ObjectTags().add(EnumTag.FIRE, 1).add(EnumTag.BEAST, 1).add(EnumTag.FLESH, 4).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.meefStroganoff.field_77779_bT, -1, new ObjectTags().add(EnumTag.FUNGUS, 4).add(EnumTag.BEAST, 2).add(EnumTag.FLESH, 4).add(EnumTag.LIFE, 4));
            ThaumcraftApi.registerObjectTag(TFItems.mazeWafer.field_77779_bT, -1, new ObjectTags().add(EnumTag.EXCHANGE, 1).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFItems.experiment115.field_77779_bT, -1, new ObjectTags().add(EnumTag.MECHANISM, 1).add(EnumTag.LIFE, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.firefly.field_71990_ca, -1, new ObjectTags().add(EnumTag.INSECT, 4).add(EnumTag.LIGHT, 4));
            ThaumcraftApi.registerObjectTag(TFBlocks.leaves.field_71990_ca, -1, new ObjectTags().add(EnumTag.PLANT, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.mazestone.field_71990_ca, -1, new ObjectTags().add(EnumTag.ROCK, 2).add(EnumTag.KNOWLEDGE, 1).add(EnumTag.ARMOR, 1));
            ThaumcraftApi.registerObjectTag(TFBlocks.hedge.field_71990_ca, 0, new ObjectTags().add(EnumTag.PLANT, 2).add(EnumTag.WEAPON, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.hedge.field_71990_ca, 1, new ObjectTags().add(EnumTag.PLANT, 2).add(EnumTag.DARK, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.root.field_71990_ca, -1, new ObjectTags().add(EnumTag.WOOD, 2).add(EnumTag.EARTH, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.cicada.field_71990_ca, -1, new ObjectTags().add(EnumTag.INSECT, 4).add(EnumTag.SOUND, 4));
            ThaumcraftApi.registerObjectTag(TFBlocks.uncraftingTable.field_71990_ca, -1, new ObjectTags().add(EnumTag.WOOD, 16).add(EnumTag.KNOWLEDGE, 16).add(EnumTag.CRAFT, 16));
            ThaumcraftApi.registerObjectTag(TFBlocks.fireJet.field_71990_ca, -1, new ObjectTags().add(EnumTag.FIRE, 16).add(EnumTag.ROCK, 6).add(EnumTag.WIND, 4));
            ThaumcraftApi.registerObjectTag(TFBlocks.nagastone.field_71990_ca, -1, new ObjectTags().add(EnumTag.ROCK, 2).add(EnumTag.MOTION, 4));
            ThaumcraftApi.registerObjectTag(TFBlocks.magicLeaves.field_71990_ca, -1, new ObjectTags().add(EnumTag.PLANT, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.towerWood.field_71990_ca, -1, new ObjectTags().add(EnumTag.WOOD, 2).add(EnumTag.MECHANISM, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.towerDevice.field_71990_ca, -1, new ObjectTags().add(EnumTag.WOOD, 8).add(EnumTag.MECHANISM, 8).add(EnumTag.MAGIC, 8));
            ThaumcraftApi.registerObjectTag(TFBlocks.towerTranslucent.field_71990_ca, -1, new ObjectTags().add(EnumTag.WOOD, 8).add(EnumTag.MECHANISM, 8).add(EnumTag.MAGIC, 8).add(EnumTag.VOID, 6));
            ThaumcraftApi.registerObjectTag(TFBlocks.trophy.field_71990_ca, -1, new ObjectTags().add(EnumTag.VALUABLE, 99).add(EnumTag.BEAST, 8).add(EnumTag.TRAP, 8));
            ThaumcraftApi.registerObjectTag(TFBlocks.plant.field_71990_ca, 8, new ObjectTags().add(EnumTag.PLANT, 2).add(EnumTag.MAGIC, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.plant.field_71990_ca, 9, new ObjectTags().add(EnumTag.FUNGUS, 2).add(EnumTag.LIGHT, 1));
            ThaumcraftApi.registerObjectTag(TFBlocks.plant.field_71990_ca, 13, new ObjectTags().add(EnumTag.PLANT, 2).add(EnumTag.LIGHT, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.plant.field_71990_ca, 15, new ObjectTags().add(EnumTag.PLANT, 2).add(EnumTag.TRAP, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.sapling.field_71990_ca, -1, new ObjectTags().add(EnumTag.PLANT, 4).add(EnumTag.WOOD, 2));
            ThaumcraftApi.registerObjectTag(TFBlocks.moonworm.field_71990_ca, -1, new ObjectTags().add(EnumTag.INSECT, 4).add(EnumTag.LIGHT, 4));
