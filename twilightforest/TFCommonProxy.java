...
public class TFCommonProxy implements IGuiHandler
{
    ...
    public Object getServerGuiElement(final int ID, final sk player, final zv world, final int x, final int y, final int z) {
        return new ContainerTFUncrafting(player.bK, world, x, y, z);
    }
    
    public Object getClientGuiElement(final int ID, final sk player, final zv world, final int x, final int y, final int z) {
        return new GuiTFGoblinCrafting(player.bK, world, x, y, z);
    }
}
