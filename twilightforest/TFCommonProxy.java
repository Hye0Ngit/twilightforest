...
public class TFCommonProxy implements IGuiHandler
{
    ...
    public Object getServerGuiElement(final int ID, final qx player, final xv world, final int x, final int y, final int z) {
        return new ContainerTFUncrafting(player.bI, world, x, y, z);
    }
    
    public Object getClientGuiElement(final int ID, final qx player, final xv world, final int x, final int y, final int z) {
        return new GuiTFGoblinCrafting(player.bI, world, x, y, z);
    }
}
