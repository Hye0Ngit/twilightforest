...
public class EntityTFCharmEffect extends lq
{
    ...
    public EntityTFCharmEffect(final xv par1World) {
        super(par1World);
        this.a(0.25f, 0.25f);
        this.setItemID(TFItems.charmOfLife1.cg);
    }
    
    public EntityTFCharmEffect(final xv par1World, final md par2EntityLiving, final int itemID) {
        super(par1World);
        this.a(0.25f, 0.25f);
        this.orbiting = par2EntityLiving;
        this.setOwner(this.orbiting.an());
        this.setItemID(itemID);
        final aob look = this.p.S().a(1.75, 0.0, 0.0);
    ...
    public void j_() {
        ...
        if (this.orbiting != null && !this.p.J) {
