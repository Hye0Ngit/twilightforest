...
public class EntityAITFChargeAttack extends nc
{
    ...
    public boolean a() {
        ...
        final aob chargePos = this.findChargePoint((lq)this.charger, (lq)this.chargeTarget, 2.1);
    ...
    protected aob findChargePoint(final lq attacker, final lq target, final double overshoot) {
