...
public class ComponentTFHedgeMaze extends StructureTFComponent
{
    ...
    public ComponentTFHedgeMaze(final xd world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
    ...
    public boolean a(final xd world, final Random rand, final qg sbb) {
        ...
        maze.oddBias = 2;
        maze.torchBlockID = TFBlocks.critter.bO;
        ...
        for (int fx = 0; fx <= ComponentTFHedgeMaze.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFHedgeMaze.DIAMETER; ++fz) {
                this.a(world, pb.u.bO, 0, fx, ComponentTFHedgeMaze.FLOOR_LEVEL - 1, fz, sbb);
            }
        }
        this.a(world, pb.bf.bO, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, pb.bf.bO, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, pb.bf.bO, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, pb.bf.bO, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, pb.bf.bO, 2, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, pb.bf.bO, 2, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, pb.bf.bO, 0, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
        this.a(world, pb.bf.bO, 0, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
    ...
    void decorate3x3Rooms(final xd world, final int[] rcoords, final qg sbb) {
        for (int i = 0; i < rcoords.length / 2; ++i) {
            int dx = rcoords[i * 2];
    ...
    void decorate3x3Room(final xd world, final int x, final int z, final qg sbb) {
    ...
    private void roomSpawner(final xd world, final Random rand, final int x, final int z, final int diameter, final qg sbb) {
    ...
    private void roomTreasure(final xd world, final Random rand, final int x, final int z, final int diameter, final qg sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.placeTreasureAtCurrentPosition(world, rand, rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, TFTreasure.hedgemaze, sbb);
    }
    
    private void roomJackO(final xd world, final Random rand, final int x, final int z, final int diameter, final qg sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.a(world, pb.bf.bO, rand.nextInt(4), rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, sbb);
    }
