...
public class TFShaderCaseDrill extends ShaderCaseDrill
{
    ...
    public TFShaderCaseDrill(final int stackBreak, final Collection<ShaderCase.ShaderLayer> layers) {
        super((Collection)layers);
        this.headLayers = 1;
        this.STACK_BREAK = stackBreak;
    }
    
    public boolean renderModelPartForPass(final ItemStack shader, final ItemStack item, final String modelPart, final int pass) {
    ...
    public ShaderCaseDrill addHeadLayers(final ShaderCase.ShaderLayer... addedLayers) {
