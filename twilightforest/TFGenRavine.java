...
public class TFGenRavine extends xu
{
    ...
    protected void func_35626_a(final long l, final int i, final int j, final byte[] abyte0, double d, double d1, double d2, final float f, float f1, float f2, int k, int i1, final double d3) {
        ...
        while (k < i1) {
            double d6 = 1.5 + gk.a(k * 3.141593f / i1) * f * 1.0f;
            double d7 = d6 * d3;
            d6 *= random.nextFloat() * 0.25 + 0.75;
            d7 *= random.nextFloat() * 0.25 + 0.75;
            final float f6 = gk.b(f2);
            final float f7 = gk.a(f2);
            d += gk.b(f1) * f6;
            d1 += f7;
            d2 += gk.a(f1) * f6;
            f2 *= 0.7f;
            ...
            if (flag || random.nextInt(4) != 0) {
                ...
                if (d >= d4 - 16.0 - d6 * 2.0 && d2 >= d5 - 16.0 - d6 * 2.0 && d <= d4 + 16.0 + d6 * 2.0) {
                    if (d2 <= d5 + 16.0 + d6 * 2.0) {
                        int d9 = gk.c(d - d6) - i * 16 - 1;
                        int l2 = gk.c(d + d6) - i * 16 + 1;
                        int d10 = gk.c(d1 - d7) - 1;
                        int i2 = gk.c(d1 + d7) + 1;
                        int d11 = gk.c(d2 - d6) - j * 16 - 1;
                        int j3 = gk.c(d2 + d6) - j * 16 + 1;
                        if (d9 < 0) {
                            d9 = 0;
                        }
                        if (l2 > 16) {
                                ...
                                for (int j4 = i2 + 1; !flag2 && j4 >= d10 - 1; --j4) {
                                    ...
                                    if (j4 >= 0) {
                                        if (j4 < TFWorld.WORLDHEIGHT) {
                                            if (abyte0[k4] == pb.A.bO || abyte0[k4] == pb.B.bO) {
                                                flag2 = true;
                                            }
                                        ...
                                        for (int j5 = i2 - 1; j5 >= d10; --j5) {
                                            ...
                                            if ((d12 * d12 + d13 * d13) * this.field_35627_a[j5] + d14 * d14 / 6.0 < 1.0) {
                                                ...
                                                if (byte0 == pb.t.bO || byte0 == pb.v.bO || byte0 == pb.u.bO) {
                                                    abyte0[i4] = 0;
                                                    if (flag3 && abyte0[i4 - 1] == pb.v.bO) {
                                                        abyte0[i4 - 1] = this.d.a(l3 + i * 16, l4 + j * 16).A;
                                                    }
                                                }
                                            }
                                            --i4;
    ...
    protected void a(final xd world, final int centerChunkX, final int centerChunkZ, final int currentChunkX, final int currentChunkZ, final byte[] abyte0) {
        ...
        final double d = centerChunkX * 16 + this.c.nextInt(16);
        final double d2 = this.c.nextInt(this.c.nextInt(40) + 8) + 20;
        final double d3 = centerChunkZ * 16 + this.c.nextInt(16);
        for (int i1 = 1, j1 = 0; j1 < i1; ++j1) {
            ...
            this.func_35626_a(this.c.nextLong(), currentChunkX, currentChunkZ, abyte0, d, d2, d3, f3, f, f2, 0, 0, 3.0);
        }
    }
}
