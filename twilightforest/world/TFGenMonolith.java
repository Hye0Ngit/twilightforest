...
public class TFGenMonolith extends TFGenerator
{
    public boolean func_76484_a(final World world, final Random rand, final int x, final int y, final int z) {
        ...
        for (int cy = 0; cy <= h0; ++cy) {
            this.func_76486_a(world, x + 0, y + cy - 1, z + 0, (cy == ht) ? Block.field_71948_O.field_71990_ca : Block.field_72089_ap.field_71990_ca);
        }
        for (int cy = 0; cy <= h2; ++cy) {
            this.func_76486_a(world, x + 1, y + cy - 1, z + 0, (cy == ht) ? Block.field_71948_O.field_71990_ca : Block.field_72089_ap.field_71990_ca);
        }
        for (int cy = 0; cy <= h3; ++cy) {
            this.func_76486_a(world, x + 0, y + cy - 1, z + 1, (cy == ht) ? Block.field_71948_O.field_71990_ca : Block.field_72089_ap.field_71990_ca);
        }
        for (int cy = 0; cy <= h4; ++cy) {
            this.func_76486_a(world, x + 1, y + cy - 1, z + 1, (cy == ht) ? Block.field_71948_O.field_71990_ca : Block.field_72089_ap.field_71990_ca);
        }
        for (int i = 0; i < 2; ++i) {
