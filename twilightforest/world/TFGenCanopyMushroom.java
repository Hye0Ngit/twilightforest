...
public class TFGenCanopyMushroom extends TFGenerator
{
    ...
    public boolean a(final abv world, final Random random, final int x, final int y, final int z) {
        ...
        if ((blockUnder != aqw.z.cF && blockUnder != aqw.A.cF && blockUnder != aqw.bD.cF) || y >= 256 - treeHeight - 1) {
            return false;
        }
    ...
    public void drawMushroomCircle(final abv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final boolean priority) {
