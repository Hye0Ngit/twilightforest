...
public class MapGenBase4096 extends aaz
{
    public void generate(final zw par1IChunkProvider, final yc par2World, final int cx, final int cz, final short[] par5ArrayOfByte) {
    ...
    protected void recursiveGenerate(final yc par1World, final int genX, final int genZ, final int centerX, final int centerZ, final short[] par6ArrayOfByte) {
    }
}
