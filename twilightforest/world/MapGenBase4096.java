...
{
    public void func_151539_a(final IChunkProvider par1IChunkProvider, final World par2World, final int cx, final int cz, final Block[] par5ArrayOfByte) {
    ...
    protected void recursiveGenerate(final World par1World, final int genX, final int genZ, final int centerX, final int centerZ, final Block[] par6ArrayOfByte) {
    }
}
