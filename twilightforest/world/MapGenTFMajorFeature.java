...
public class MapGenTFMajorFeature extends agm
{
    ...
    protected ags b(final int chunkX, final int chunkZ) {
        ...
        this.b.setSeed(chunkXr1 ^ chunkZr2 ^ this.c.F());
        this.b.nextInt();
    ...
    public int getSpawnListIndexAt(final int par1, final int par2, final int par3) {
        ...
        for (final ags start : this.d.values()) {
            if (start.d() && start.a().a(par1, par3, par1, par3)) {
                for (final agq component : start.b()) {
