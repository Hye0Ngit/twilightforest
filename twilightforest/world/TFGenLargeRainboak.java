...
public class TFGenLargeRainboak extends TFGenerator
{
        ...
        while (var6 >= 0) {
            ...
            if (var8 < 0.0f) {
                ...
                while (var7 < var1) {
                    ...
                    final int var12 = lr.c(var10 * Math.sin(var11) + this.basePos[0] + var9);
                    final int var13 = lr.c(var10 * Math.cos(var11) + this.basePos[2] + var9);
    ...
    void genTreeLayer(final int par1, final int par2, final int par3, final float par4, final byte par5, final int par6, final int meta) {
        ...
        while (var12 <= var7) {
            ...
            for (var13 = -var7; var13 <= var7; ++var13) {
                ...
                if (var14 <= par4 * par4) {
                    ...
                    final int var15 = this.worldObj.a(var11[0], var11[1], var11[2]);
                    if (var15 == 0 || aqw.s[var15].canBeReplacedByLeaves(this.worldObj, var11[0], var11[1], var11[2])) {
                        this.a(this.worldObj, var11[0], var11[1], var11[2], par6, meta);
                    }
                }
            }
            ++var12;
    ...
    void generateLeafNode(final int par1, final int par2, final int par3) {
        for (int var4 = par2, var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, TFBlocks.leaves.cF, 3);
        }
    }
    ...
    void placeBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger, final int par3) {
        ...
        if (var4[var6] != 0) {
            ...
            for (int var13 = 0, var14 = var4[var6] + var9; var13 != var14; var13 += var9) {
                var12[var6] = lr.c(par1ArrayOfInteger[var6] + var13 + 0.5);
                var12[var7] = lr.c(par1ArrayOfInteger[var7] + var13 * var10 + 0.5);
                var12[var8] = lr.c(par1ArrayOfInteger[var8] + var13 * var11 + 0.5);
                byte var15 = 0;
                ...
                this.a(this.worldObj, var12[0], var12[1], var12[2], par3, (int)var15);
            }
        }
    }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, TFBlocks.log.cF);
        if (this.trunkSize == 2) {
    ...
    void generateLeafNodeBases() {
        ...
        while (var1 < var2) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, TFBlocks.log.cF);
            }
            ++var1;
        }
    }
    ...
    int checkBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger) {
        ...
        for (var12 = 0, var13 = var3[var5] + var8; var12 != var13; var12 += var8) {
            ...
            var11[var6] = lr.c(par1ArrayOfInteger[var6] + var12 * var9);
            var11[var7] = lr.c(par1ArrayOfInteger[var7] + var12 * var10);
            final int var14 = this.worldObj.a(var11[0], var11[1], var11[2]);
            if (var14 != 0 && var14 != aqw.P.cF) {
                break;
            }
        }
    ...
    boolean validTreeLocation() {
        ...
        final int var3 = this.worldObj.a(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
        if (var3 != 2 && var3 != 3) {
            return false;
        }
    ...
    public void a(final double par1, final double par3, final double par5) {
    ...
    @Override
    public boolean a(final abv par1World, final Random par2Random, final int par3, final int par4, final int par5) {
