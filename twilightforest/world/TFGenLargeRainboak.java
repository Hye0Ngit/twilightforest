...
public class TFGenLargeRainboak extends TFTreeGenerator
{
    ...
    void genTreeLayer(final int par1, final int par2, final int par3, final float par4, final byte par5, final Block leaves, final int meta) {
        ...
        while (var12 <= var7) {
            ...
            for (var13 = -var7; var13 <= var7; ++var13) {
                ...
                if (var14 <= par4 * par4) {
                    ...
                    final Block var15 = this.worldObj.func_147439_a(var11[0], var11[1], var11[2]);
                    if (var15 == Blocks.field_150350_a || var15.canBeReplacedByLeaves((IBlockAccess)this.worldObj, var11[0], var11[1], var11[2])) {
    ...
    void placeBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger, final Block log) {
        ...
        if (var4[var6] != 0) {
            ...
            for (int var13 = 0, var14 = var4[var6] + var9; var13 != var14; var13 += var9) {
                ...
                this.setBlockAndMetadata(this.worldObj, var12[0], var12[1], var12[2], log, var15);
            }
        }
    }
    ...
    int checkBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger) {
        ...
        for (var12 = 0, var13 = var3[var5] + var8; var12 != var13; var12 += var8) {
            ...
            final Block var14 = this.worldObj.func_147439_a(var11[0], var11[1], var11[2]);
            if (var14 != Blocks.field_150350_a && var14 != Blocks.field_150362_t) {
                break;
            }
        }
    ...
    boolean validTreeLocation() {
        ...
        final Block var3 = this.worldObj.func_147439_a(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
        if (var3 != Blocks.field_150346_d && var3 != Blocks.field_150349_c) {
            return false;
        }
