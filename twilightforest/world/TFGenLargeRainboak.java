...
public class TFGenLargeRainboak extends TFGenerator
{
        ...
        while (var12 <= var7) {
            ...
            for (var13 = -var7; var13 <= var7; ++var13) {
                ...
                if (var14 <= par4 * par4) {
                    ...
                    final int var15 = this.worldObj.func_72798_a(var11[0], var11[1], var11[2]);
                    if (var15 == 0 || Block.field_71973_m[var15].canBeReplacedByLeaves(this.worldObj, var11[0], var11[1], var11[2])) {
                        this.func_76485_a(this.worldObj, var11[0], var11[1], var11[2], par6, meta);
                    }
                }
            }
            ++var12;
    ...
    void generateLeafNode(final int par1, final int par2, final int par3) {
        for (int var4 = par2, var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, TFBlocks.leaves.field_71990_ca, 3);
        }
    }
    ...
    void placeBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger, final int par3) {
        ...
        if (var4[var6] != 0) {
            ...
            for (int var13 = 0, var14 = var4[var6] + var9; var13 != var14; var13 += var9) {
                ...
                this.func_76485_a(this.worldObj, var12[0], var12[1], var12[2], par3, (int)var15);
            }
        }
    }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, TFBlocks.log.field_71990_ca);
        if (this.trunkSize == 2) {
    ...
    void generateLeafNodeBases() {
        ...
        while (var1 < var2) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, TFBlocks.log.field_71990_ca);
            }
            ++var1;
        }
    }
    ...
    int checkBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger) {
        ...
        for (var12 = 0, var13 = var3[var5] + var8; var12 != var13; var12 += var8) {
            ...
            final int var14 = this.worldObj.func_72798_a(var11[0], var11[1], var11[2]);
    ...
    boolean validTreeLocation() {
        ...
        final int var3 = this.worldObj.func_72798_a(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
        if (var3 != 2 && var3 != 3) {
            return false;
        }
    ...
    public void func_76487_a(final double par1, final double par3, final double par5) {
    ...
    @Override
    public boolean func_76484_a(final World par1World, final Random par2Random, final int par3, final int par4, final int par5) {
