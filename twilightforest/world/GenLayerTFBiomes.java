...
public class GenLayerTFBiomes extends GenLayer
{
    ...
    public GenLayerTFBiomes(final long l, final GenLayer genlayer) {
        super(l);
        this.commonBiomes = new BiomeGenBase[] { TFBiomeBase.twilightForest, TFBiomeBase.twilightForest2, TFBiomeBase.highlands, TFBiomeBase.mushrooms, TFBiomeBase.swamp, TFBiomeBase.clearing, TFBiomeBase.darkForest };
