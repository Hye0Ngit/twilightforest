...
public class ChunkProviderTwilightForest implements zw
{
    private Random rand;
    private afz noiseGen1;
    private afz noiseGen2;
    private afz noiseGen3;
    private afz noiseGen4;
    public afz noiseGen5;
    public afz noiseGen6;
    public afz mobSpawnerNoise;
    private yc worldObj;
    ...
    private yy[] biomesForGeneration;
    double[] noise3;
    double[] noise1;
    double[] noise2;
    double[] noise5;
    ...
    public ChunkProviderTwilightForest(final yc world, final long l, final boolean flag) {
        ...
        this.noiseGen1 = new afz(this.rand, 16);
        this.noiseGen2 = new afz(this.rand, 16);
        this.noiseGen3 = new afz(this.rand, 8);
        this.noiseGen4 = new afz(this.rand, 4);
        this.noiseGen5 = new afz(this.rand, 10);
        this.noiseGen6 = new afz(this.rand, 16);
        this.mobSpawnerNoise = new afz(this.rand, 8);
    }
                    ...
                    for (int j2 = 0; j2 < 8; ++j2) {
                        ...
                        for (int k2 = 0; k2 < 4; ++k2) {
                            ...
                            for (int i3 = 0; i3 < 4; ++i3) {
                                if ((d16 += d17) > 0.0) {
                                    par3ArrayofShort[l2 += c] = (short)amq.w.cm;
                                }
                                else if (i2 * 8 + j2 < byte3) {
                                    par3ArrayofShort[l2 += c] = (short)amq.E.cm;
                                }
                                else {
    ...
    public void replaceBlocksForBiome(final int par1, final int par2, final short[] blockArray4096, final yy[] par4ArrayOfBiomeGenBase) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                final yy biomegenbase = par4ArrayOfBiomeGenBase[j + i * 16];
                ...
                for (int i2 = 127; i2 >= 0; --i2) {
                    ...
                    if (i2 <= 0 + this.rand.nextInt(5)) {
                        blockArray4096[j2] = (short)amq.C.cm;
                    }
                    else {
                        final short currentBlock = blockArray4096[j2];
                        if (currentBlock == amq.w.cm) {
                            if (l == -1) {
                                if (k <= 0) {
                                    top = 0;
                                    filler = (short)amq.w.cm;
                                }
                                ...
                                --l;
                                blockArray4096[j2] = filler;
                                if (l == 0 && filler == amq.H.cm) {
                                    l = this.rand.nextInt(4);
                                    filler = (short)amq.T.cm;
                                }
                            }
                        }
                    }
    ...
    public zz c(final int i, final int j) {
        return this.d(i, j);
    }
    
    public zz d(final int cx, final int cz) {
        ...
        this.caveGenerator.generate((zw)this, this.worldObj, cx, cz, blockStorage);
        this.ravineGenerator.generate((zw)this, this.worldObj, cx, cz, blockStorage);
        final byte[] fake = new byte[0];
        this.majorFeatureGenerator.a((zw)this, this.worldObj, cx, cz, fake);
        final zz chunk = this.makeAChunk(this.worldObj, blockStorage, metaStorage, cx, cz);
    ...
    protected zz makeAChunk(final yc world, final short[] ids, final byte[] metadata, final int chunkX, final int chunkZ) {
        final zz chunk = new zz(world, chunkX, chunkZ);
        final aaa[] storageArrays = chunk.i();
                ...
                for (int y = 0; y < height; ++y) {
                    ...
                    if (id != 0) {
                        ...
                        if (storageArrays[storageIndex] == null) {
                            storageArrays[storageIndex] = new aaa(storageIndex << 4, true);
                        }
            ...
            for (int z = 0; z < 16; ++z) {
                ...
                if (nearFeature == TFFeature.hill1 || nearFeature == TFFeature.hill2 || nearFeature == TFFeature.hill3 || nearFeature == TFFeature.hydraLair) {
                    for (int y = 0; y <= 127; ++y) {
                        ...
                        if (currentTerrain == 0 || currentTerrain == amq.aW.cm) {
                            if (newGround == -1) {
                                oldGround = y;
                                newGround = oldGround + hheight;
                            }
                            if (y <= newGround) {
                                storage[index] = (short)amq.w.cm;
                            }
                        }
                    }
                    ...
                    for (int y2 = 0; y2 <= 127; ++y2) {
                        ...
                        if (hheight > 0 && y2 < TFWorld.SEALEVEL && storage[index2] != amq.w.cm) {
                            storage[index2] = (short)amq.w.cm;
                        }
                ...
                if (nearFeature == TFFeature.hedgeMaze || nearFeature == TFFeature.nagaLair || nearFeature == TFFeature.questGrove) {
                    ...
                    for (int y3 = 0; y3 <= 127; ++y3) {
                        final int index3 = (x * 16 + z) * TFWorld.WORLDHEIGHT + y3;
                        if (y3 < mazeheight && (storage[index3] == 0 || storage[index3] == amq.E.cm)) {
                            storage[index3] = (short)amq.w.cm;
                        }
                        if (y3 >= mazeheight && storage[index3] != amq.E.cm) {
                            storage[index3] = 0;
                        }
                    }
                }
    ...
    private double[] makeLandPerBiome(double[] ad, int xx, final int zero, int zz, final int l, final int i1, final int j1) {
        ...
        for (int k2 = 0; k2 < l; ++k2) {
            for (int l3 = 0; l3 < j1; ++l3) {
                ...
                float f4 = 0.0f;
                final byte byte0 = 2;
                final yy biomegenbase = this.biomesForGeneration[k2 + 2 + (l3 + 2) * (l + 5)];
                for (int i3 = -byte0; i3 <= byte0; ++i3) {
                    for (int j3 = -byte0; j3 <= byte0; ++j3) {
                        final yy biomegenbase2 = this.biomesForGeneration[k2 + i3 + 2 + (l3 + j3 + 2) * (l + 5)];
    ...
    private void addFeatureMarker(final int cx, final int cz, final short[] blockStorage, final byte[] metaStorage) {
        ...
        if (feature != TFFeature.nothing) {
            ...
            blockStorage[0] = (short)amq.C.cm;
            blockStorage[1] = (short)amq.C.cm;
            blockStorage[2] = (short)amq.C.cm;
    ...
    public void addGlaciers(final int chunkX, final int chunkZ, final short[] blocks, final byte[] meta, final yy[] biomes) {
        for (int x = 0; x < 16; ++x) {
            for (int z = 0; z < 16; ++z) {
                final yy biome = biomes[z + x * 16];
    ...
    public void addDarkForestCanopy(final int chunkX, final int chunkZ, final short[] blocks, final byte[] meta, final yy[] biomes) {
        final double d = 0.03125;
        ...
        for (int x = 0; x < 16; ++x) {
            for (int z = 0; z < 16; ++z) {
                ...
                if (biome == TFBiomeBase.majorFeature || (biome == TFBiomeBase.minorFeature && z < 16)) {
    ...
    public void a(final zw ichunkprovider, final int chunkX, final int chunkZ) {
        akn.c = true;
        int mapX = chunkX * 16;
        int mapY = chunkZ * 16;
        yy biomegenbase = this.worldObj.a(mapX + 16, mapY + 16);
        ...
        if (!disableFeatures && this.rand.nextInt(4) == 0) {
            ...
            new abu(amq.E.cm).a(this.worldObj, this.rand, i1, i2, i3);
        }
        if (!disableFeatures && this.rand.nextInt(32) == 0) {
            ...
            if (j2 < TFWorld.SEALEVEL || this.rand.nextInt(10) == 0) {
                new abu(amq.G.cm).a(this.worldObj, this.rand, j1, j2, j3);
            }
        }
        for (int k1 = 0; k1 < 8; ++k1) {
            ...
            if (!new abx().a(this.worldObj, this.rand, k2, k3, l3)) {}
        }
        biomegenbase.a(this.worldObj, this.rand, mapX, mapY);
        yp.a(this.worldObj, biomegenbase, mapX + 8, mapY + 8, 16, 16, this.rand);
        mapX += 8;
        mapY += 8;
        for (int i4 = 0; i4 < 16; ++i4) {
            for (int j4 = 0; j4 < 16; ++j4) {
                ...
                if (this.worldObj.w(i4 + mapX, j5 - 1, j4 + mapY)) {
                    this.worldObj.e(i4 + mapX, j5 - 1, j4 + mapY, amq.aW.cm);
                }
                if (this.worldObj.y(i4 + mapX, j5, j4 + mapY)) {
                    this.worldObj.e(i4 + mapX, j5, j4 + mapY, amq.aV.cm);
                }
            }
        }
        akn.c = false;
    ...
    public List a(final me par1EnumCreatureType, final int mapX, final int mapY, final int mapZ) {
        ...
        final yy biomegenbase = this.worldObj.a(mapX, mapZ);
    ...
    public yv a(final yc par1World, final String par2Str, final int par3, final int par4, final int par5) {
        return null;
    }
    ...
    public void e(final int var1, final int var2) {
        this.majorFeatureGenerator.a((zw)this, this.worldObj, var1, var2, (byte[])null);
    }
}
