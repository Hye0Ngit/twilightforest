...
public class ChunkProviderTwilightForest implements IChunkProvider
{
    ...
    public Chunk func_73154_d(final int cx, final int cz) {
        ...
        this.hollowTreeGenerator.func_151539_a((IChunkProvider)this, this.worldObj, cx, cz, fake);
    ...
    public void func_73153_a(final IChunkProvider ichunkprovider, final int chunkX, final int chunkZ) {
        ...
        int mapX = chunkX * 16;
        int mapY = chunkZ * 16;
        final BiomeGenBase biomeGen = this.worldObj.func_72807_a(mapX + 16, mapY + 16);
    ...
    public boolean isStructureLocked(final int mapX, final int mapY, final int mapZ, final int lockIndex) {
    ...
    public void func_82695_e(final int var1, final int var2) {
        ...
        this.hollowTreeGenerator.func_151539_a((IChunkProvider)this, this.worldObj, var1, var2, (Block[])null);
    }
