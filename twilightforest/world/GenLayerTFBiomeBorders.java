        ...
        for (int dz = 0; dz < depth; ++dz) {
            for (int dx = 0; dx < width; ++dx) {
                ...
                if (this.onBorder(TFBiomeBase.tfLake.field_76756_M, center, right, left, up, down)) {
                    output[dx + dz * width] = TFBiomeBase.lakeBorder.field_76756_M;
                }
                else if (this.onBorder(TFBiomeBase.clearing.field_76756_M, center, right, left, up, down)) {
                    output[dx + dz * width] = TFBiomeBase.clearingBorder.field_76756_M;
                }
                    ...
                    output[dx + dz * width] = TFBiomeBase.snow.field_76756_M;
                }
                else {
