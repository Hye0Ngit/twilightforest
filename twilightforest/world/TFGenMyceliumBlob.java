...
public class TFGenMyceliumBlob extends abf
{
    private int myceliumBlockId;
    private int numberOfBlocks;
    
    public TFGenMyceliumBlob(final int i) {
        this.myceliumBlockId = amj.bB.cm;
        this.numberOfBlocks = i;
    }
    
    public boolean a(final xv world, final Random random, final int i, final int j, final int k) {
