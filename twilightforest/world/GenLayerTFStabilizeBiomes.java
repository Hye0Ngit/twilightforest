...
public class GenLayerTFStabilizeBiomes extends akn
{
    private static final int RAD = 1;
    private static final int DIAM = 2;
    protected akn biomeLayer;
    protected akn featureLayer;
    
    public GenLayerTFStabilizeBiomes(final int par1, final akn biomes, final akn features) {
        super((long)par1);
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] out = akl.a(width * depth);
