...
public class TFWorldChunkManager extends aau
{
    private ain myGenBiomes;
    private ain myBiomeIndexLayer;
    private aar myBiomeCache;
    private TFFeatureCache featureCache;
    private List myBiomesToSpawnIn;
    
    protected TFWorldChunkManager() {
        this.myBiomeCache = new aar((aau)this);
    ...
    public TFWorldChunkManager(final long par1, final aaf par3WorldType) {
        this();
        final ain[] agenlayer = GenLayerTF.makeTheWorld(par1);
        this.myGenBiomes = agenlayer[0];
        this.myBiomeIndexLayer = agenlayer[1];
    }
    
    public TFWorldChunkManager(final zv par1World) {
        this(par1World.F(), par1World.L().u());
    }
    ...
    public aap a(final int par1, final int par2) {
        final aap biome = this.myBiomeCache.b(par1, par2);
        if (biome == null) {
    ...
    public float[] a(float[] par1ArrayOfFloat, final int par2, final int par3, final int par4, final int par5) {
        ...
        for (int i = 0; i < par4 * par5; ++i) {
            if (ai[i] >= 0 && aap.a[ai[i]] != null) {
                float f = aap.a[ai[i]].g() / 65536.0f;
                if (f > 1.0f) {
                    f = 1.0f;
                }
    ...
    public float[] b(float[] par1ArrayOfFloat, final int par2, final int par3, final int par4, final int par5) {
        ...
        for (int var7 = 0; var7 < par4 * par5; ++var7) {
            float floatTemp;
            if (var6[var7] >= 0 && aap.a[var6[var7]] != null) {
                floatTemp = aap.a[var6[var7]].h() / 65536.0f;
            }
            else {
                floatTemp = 0.5f;
            }
    ...
    public aap[] a(aap[] par1ArrayOfBiomeGenBase, final int par2, final int par3, final int par4, final int par5) {
        ail.a();
        if (par1ArrayOfBiomeGenBase == null || par1ArrayOfBiomeGenBase.length < par4 * par5) {
            par1ArrayOfBiomeGenBase = new aap[par4 * par5];
        }
        final int[] ai = this.myGenBiomes.a(par2, par3, par4, par5);
        for (int i = 0; i < par4 * par5; ++i) {
            if (ai[i] >= 0) {
                par1ArrayOfBiomeGenBase[i] = aap.a[ai[i]];
            }
            else {
    ...
    public aap[] b(final aap[] par1ArrayOfBiomeGenBase, final int par2, final int par3, final int par4, final int par5) {
        return this.a(par1ArrayOfBiomeGenBase, par2, par3, par4, par5, true);
    }
    
    public aap[] a(aap[] par1ArrayOfBiomeGenBase, final int x, final int y, final int width, final int length, final boolean cacheFlag) {
        ail.a();
        if (par1ArrayOfBiomeGenBase == null || par1ArrayOfBiomeGenBase.length < width * length) {
            par1ArrayOfBiomeGenBase = new aap[width * length];
        }
        if (cacheFlag && width == 16 && length == 16 && (x & 0xF) == 0x0 && (y & 0xF) == 0x0) {
            final aap[] abiomegenbase = this.myBiomeCache.e(x, y);
    ...
    public boolean a(final int par1, final int par2, final int par3, final List par4List) {
        ...
        for (int k2 = 0; k2 < i2 * j2; ++k2) {
            final aap biomegenbase = aap.a[ai[k2]];
    ...
    public aan a(final int par1, final int par2, final int par3, final List par4List, final Random par5Random) {
        final int i = par1 - par3 >> 2;
        final int j = par2 - par3 >> 2;
        final int k = par1 + par3 >> 2;
        final int l = par2 + par3 >> 2;
    ...
    public int getFeatureID(final int mapX, final int mapZ, final zv world) {
        return this.getFeatureIDNoCache(mapX, mapZ, world);
    }
    
    public int getFeatureIDNoCache(final int mapX, final int mapZ, final zv world) {
        return this.getFeatureNoCache(mapX, mapZ, world).featureID;
    }
    
    public TFFeature getFeatureAt(final int mapX, final int mapZ, final zv world) {
        return this.getFeatureNoCache(mapX, mapZ, world);
    }
    
    public TFFeature getFeatureNoCache(final int mapX, final int mapZ, final zv world) {
