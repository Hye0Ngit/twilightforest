...
public class TFWorldChunkManager extends zd
{
    private agw myGenBiomes;
    private agw myBiomeIndexLayer;
    private za myBiomeCache;
    private TFFeatureCache featureCache;
    private List myBiomesToSpawnIn;
    
    protected TFWorldChunkManager() {
        this.myBiomeCache = new za((zd)this);
    ...
    public TFWorldChunkManager(final long par1, final yn par3WorldType) {
        this();
        final agw[] agenlayer = GenLayerTF.makeTheWorld(par1);
        this.myGenBiomes = agenlayer[0];
        this.myBiomeIndexLayer = agenlayer[1];
    }
    
    public TFWorldChunkManager(final yc par1World) {
    ...
    public yy a(final int par1, final int par2) {
        final yy biome = this.myBiomeCache.b(par1, par2);
        if (biome == null) {
    ...
    public float[] a(float[] par1ArrayOfFloat, final int par2, final int par3, final int par4, final int par5) {
        ...
        for (int i = 0; i < par4 * par5; ++i) {
            if (ai[i] >= 0 && yy.a[ai[i]] != null) {
                float f = yy.a[ai[i]].g() / 65536.0f;
                if (f > 1.0f) {
                    f = 1.0f;
                }
    ...
    public float[] b(float[] par1ArrayOfFloat, final int par2, final int par3, final int par4, final int par5) {
        ...
        for (int var7 = 0; var7 < par4 * par5; ++var7) {
            float floatTemp;
            if (var6[var7] >= 0 && yy.a[var6[var7]] != null) {
                floatTemp = yy.a[var6[var7]].h() / 65536.0f;
            }
            else {
    ...
    public yy[] a(yy[] par1ArrayOfBiomeGenBase, final int par2, final int par3, final int par4, final int par5) {
        agu.a();
        if (par1ArrayOfBiomeGenBase == null || par1ArrayOfBiomeGenBase.length < par4 * par5) {
            par1ArrayOfBiomeGenBase = new yy[par4 * par5];
        }
        final int[] ai = this.myGenBiomes.a(par2, par3, par4, par5);
        for (int i = 0; i < par4 * par5; ++i) {
            if (ai[i] >= 0) {
                par1ArrayOfBiomeGenBase[i] = yy.a[ai[i]];
            }
            else {
    ...
    public yy[] b(final yy[] par1ArrayOfBiomeGenBase, final int par2, final int par3, final int par4, final int par5) {
        return this.a(par1ArrayOfBiomeGenBase, par2, par3, par4, par5, true);
    }
    
    public yy[] a(yy[] par1ArrayOfBiomeGenBase, final int par2, final int par3, final int par4, final int par5, final boolean par6) {
        agu.a();
        if (par1ArrayOfBiomeGenBase == null || par1ArrayOfBiomeGenBase.length < par4 * par5) {
            par1ArrayOfBiomeGenBase = new yy[par4 * par5];
        }
        if (par6 && par4 == 16 && par5 == 16 && (par2 & 0xF) == 0x0 && (par3 & 0xF) == 0x0) {
            final yy[] abiomegenbase = this.myBiomeCache.e(par2, par3);
    ...
    public boolean a(final int par1, final int par2, final int par3, final List par4List) {
        ...
        for (int k2 = 0; k2 < i2 * j2; ++k2) {
            final yy biomegenbase = yy.a[ai[k2]];
    ...
    public yv a(final int par1, final int par2, final int par3, final List par4List, final Random par5Random) {
        final int i = par1 - par3 >> 2;
        final int j = par2 - par3 >> 2;
        final int k = par1 + par3 >> 2;
        final int l = par2 + par3 >> 2;
    ...
    public boolean isInFeatureChunkNoCache(final int mapX, final int mapZ) {
        final yy[] biomes = this.myBiomeCache.a(mapX, mapZ).c;
