...
public class TFGenSortingTree extends TFGenerator
{
    ...
    public boolean a(final zv world, final Random rand, final int x, final int y, final int z) {
        ...
        this.putBlockAndMetadata(world, x, y + 1, z, TFBlocks.magicLogSpecial.cz, this.treeMeta, true);
        return true;
    }
    
    protected void putLeaves(final zv world, final int bx, final int by, final int bz, final boolean bushy) {
