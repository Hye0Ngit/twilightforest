...
public class TFGenMangroveTree extends TFTreeGenerator
{
    ...
    public boolean a(final abv world, final Random random, final int x, final int y, final int z) {
        if ((this.checkForWater && world.a(x, y - 1, z) != aqw.G.cF) || y >= 109) {
            return false;
        }
    ...
    void buildBranch(final abv world, final Random random, final int x, final int y, final int z, final int height, final double length, final double angle, final double tilt, final boolean trunk) {
    ...
    void buildRoot(final abv world, final int x, final int y, final int z, final int height, final double length, final double angle, final double tilt) {
        final int[] src = { x, y + height, z };
        final int[] dest = TFGenerator.translate(src[0], src[1], src[2], length, angle, tilt);
