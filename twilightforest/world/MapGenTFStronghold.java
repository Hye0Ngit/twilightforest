...
public class MapGenTFStronghold extends aeo
{
    private yr[] allowedBiomeGenBases;
    private boolean ranBiomeCheck;
    private xo[] structureCoords;
    
    public MapGenTFStronghold() {
        this.allowedBiomeGenBases = new yr[] { TFBiomeBase.twilightForest, TFBiomeBase.twilightForest2, TFBiomeBase.highlands, TFBiomeBase.mushrooms, TFBiomeBase.swamp, TFBiomeBase.stream, TFBiomeBase.snow, TFBiomeBase.glacier, TFBiomeBase.clearing, TFBiomeBase.clearingBorder, TFBiomeBase.deepMushrooms };
        this.structureCoords = new xo[3];
    }
    ...
    protected boolean a(final int par1, final int par2) {
        if (!this.ranBiomeCheck) {
            ...
            for (int var5 = 0; var5 < this.structureCoords.length; ++var5) {
                ...
                for (final yr var13 : this.allowedBiomeGenBases) {
                    var9.add(var13);
                }
                final yo var14 = this.c.t().a((var7 << 4) + 8, (var8 << 4) + 8, 112, (List)var9, var3);
                if (var14 != null) {
                    var7 = var14.a >> 4;
                    var8 = var14.c >> 4;
                }
                ...
                this.structureCoords[var5] = new xo(var7, var8);
                var4 += 6.283185307179586 / this.structureCoords.length;
            }
            this.ranBiomeCheck = true;
        }
        for (final xo var18 : this.structureCoords) {
    ...
    protected List func_40482_a() {
        ...
        for (final xo var5 : this.structureCoords) {
            if (var5 != null) {
                var1.add(var5.a(64));
            }
        }
    ...
    protected aeu b(final int par1, final int par2) {
