...
public class MapGenTFStronghold extends agm
{
    private aap[] allowedBiomeGenBases;
    private boolean ranBiomeCheck;
    private zo[] structureCoords;
    
    public MapGenTFStronghold() {
        this.allowedBiomeGenBases = new aap[] { TFBiomeBase.twilightForest, TFBiomeBase.twilightForest2, TFBiomeBase.highlands, TFBiomeBase.mushrooms, TFBiomeBase.swamp, TFBiomeBase.stream, TFBiomeBase.snow, TFBiomeBase.glacier, TFBiomeBase.clearing, TFBiomeBase.clearingBorder, TFBiomeBase.deepMushrooms };
        this.structureCoords = new zo[3];
    }
    
    protected boolean a(final int par1, final int par2) {
        if (!this.ranBiomeCheck) {
            final Random var3 = new Random();
            var3.setSeed(this.c.F());
            ...
            for (int var5 = 0; var5 < this.structureCoords.length; ++var5) {
                ...
                for (final aap var13 : this.allowedBiomeGenBases) {
                    var9.add(var13);
                }
                final aan var14 = this.c.t().a((var7 << 4) + 8, (var8 << 4) + 8, 112, (List)var9, var3);
                if (var14 != null) {
                    var7 = var14.a >> 4;
                    var8 = var14.c >> 4;
                }
                ...
                this.structureCoords[var5] = new zo(var7, var8);
                var4 += 6.283185307179586 / this.structureCoords.length;
            }
            this.ranBiomeCheck = true;
        }
        for (final zo var18 : this.structureCoords) {
    ...
    protected List func_40482_a() {
        ...
        for (final zo var5 : this.structureCoords) {
            if (var5 != null) {
                var1.add(var5.a(64));
            }
        }
    ...
    protected ags b(final int par1, final int par2) {
