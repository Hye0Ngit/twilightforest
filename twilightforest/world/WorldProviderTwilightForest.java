...
public class WorldProviderTwilightForest extends WorldProviderSurface
{
    ...
    public IChunkProvider func_76555_c() {
        if (this.chunkProvider == null) {
            return (IChunkProvider)(this.chunkProvider = new ChunkProviderTwilightForest(this.field_76579_a, this.field_76579_a.func_72905_C(), this.field_76579_a.func_72912_H().func_76089_r()));
        }
    ...
    public Vec3 getSkyColor(final Entity cameraEntity, final float partialTicks) {
        return Vec3.func_72443_a(0.16796875, 0.1796875, 0.38671875);
    }
