...
public class GenLayerTFReinsertFeatures extends ain
{
    private ain withoutLayer;
    private ain withLayer;
    
    public GenLayerTFReinsertFeatures(final long par1, final ain par3GenLayer, final ain par4GenLayer) {
        super(par1);
    ...
    public int[] a(final int mapX, final int mapZ, final int mapWidth, final int mapDepth) {
        ...
        final int[] dest = ail.a(mapWidth * mapDepth);
