...
public class GenLayerTFReinsertFeatures extends agw
{
    private agw withoutLayer;
    private agw withLayer;
    
    public GenLayerTFReinsertFeatures(final long par1, final agw par3GenLayer, final agw par4GenLayer) {
        super(par1);
    ...
    public int[] a(final int mapX, final int mapZ, final int mapWidth, final int mapDepth) {
        ...
        final int[] dest = agu.a(mapWidth * mapDepth);
