...
public class TFGenSmallTwilightOak extends TFGenerator
{
    ...
    public boolean a(final xv par1World, final Random par2Random, final int par3, final int par4, final int par5) {
            ...
            for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10) {
                for (int var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11) {
                    if (var8 >= 0 && var8 < 256) {
                        ...
                        final amj block = amj.p[var12];
                        if (var12 != 0 && !block.isLeaves(par1World, var10, var8, var11) && var12 != amj.x.cm && var12 != amj.y.cm && !block.isWood(par1World, var10, var8, var11)) {
                            var7 = false;
                        }
                    }
                    else {
        ...
        if ((var8 == amj.x.cm || var8 == amj.y.cm) && par4 < 256 - var6 - 1) {
            this.a(par1World, par3, par4 - 1, par5, amj.y.cm);
            final byte var9 = 3;
            final byte var13 = 0;
            for (int var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11) {
                ...
                for (int var14 = var13 + 1 - var12 / 2, var15 = par3 - var14; var15 <= par3 + var14; ++var15) {
                    ...
                    for (int var17 = par5 - var14; var17 <= par5 + var14; ++var17) {
                        ...
                        final amj block2 = amj.p[par1World.a(var15, var11, var17)];
