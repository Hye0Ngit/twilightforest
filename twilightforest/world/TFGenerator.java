...
public abstract class TFGenerator extends abm
{
    ...
    public abstract boolean a(final yc p0, final Random p1, final int p2, final int p3, final int p4);
    ...
    protected byte randStone(final Random rand, final int howMuch) {
        return (rand.nextInt(howMuch) >= 1) ? ((byte)amq.z.cm) : ((byte)amq.ar.cm);
    }
    
    protected boolean isAreaClear(final yc world, final Random rand, final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        boolean flag = true;
        for (int cx = 0; cx < dx; ++cx) {
            for (int cz = 0; cz < dy; ++cz) {
                final agi m = world.g(x + cx, y - 1, z + cz);
                if (m != agi.c && m != agi.b && m != agi.e) {
                    flag = false;
                }
    ...
    protected boolean hasAirAround(final ym world, final int bx, final int by, final int bz) {
    ...
    protected boolean isNearSolid(final ym world, final int bx, final int by, final int bz) {
