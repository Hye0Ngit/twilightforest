...
public abstract class TFGenerator extends add
{
    public TFGenerator() {
        this(false);
    }
    ...
    public abstract boolean a(final zv p0, final Random p1, final int p2, final int p3, final int p4);
    
    protected boolean putBlock(final zv world, final int dx, final int dy, final int dz, final int blockValue, final boolean priority) {
        return this.putBlockAndMetadata(world, dx, dy, dz, blockValue, 0, priority);
    }
    
    protected boolean putBlockAndMetadata(final zv world, final int dx, final int dy, final int dz, final int blockValue, final int metaValue, final boolean priority) {
        if (priority) {
    ...
    protected void putBlockAndMetadata(final zv world, final int[] pixel, final int blockValue, final int metaValue, final boolean priority) {
        this.putBlockAndMetadata(world, pixel[0], pixel[1], pixel[2], blockValue, metaValue, priority);
    }
    
    protected void putBlock(final zv world, final int[] pixel, final int blockValue, final boolean priority) {
    ...
    protected void drawBresehnam(final zv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final boolean priority) {
        this.drawBresehnam(world, x1, y1, z1, x2, y2, z2, blockValue, 0, priority);
    }
    
    protected void drawBresehnamX(final zv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue, final boolean priority) {
    ...
    protected void drawBresehnam(final zv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue, final boolean priority) {
    ...
    public void drawCircle(final zv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final int metaValue, final boolean priority) {
    ...
    public void drawDiameterCircle(final zv world, final int sx, final int sy, final int sz, final int diam, final int block, final int meta, final boolean priority) {
    ...
    protected byte randStone(final Random rand, final int howMuch) {
        return (rand.nextInt(howMuch) >= 1) ? ((byte)aou.A.cz) : ((byte)aou.as.cz);
    }
    
    protected boolean isAreaClear(final zv world, final Random rand, final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        boolean flag = true;
        for (int cx = 0; cx < dx; ++cx) {
            for (int cz = 0; cz < dy; ++cz) {
                final ahz m = world.g(x + cx, y - 1, z + cz);
                if (m != ahz.c && m != ahz.b && m != ahz.e) {
                    flag = false;
                }
    ...
    protected void fill(final zv world, final int dx, final int dy, final int dz, final int width, final int height, final int depth, final int blockID, final int meta) {
        for (int cx = 0; cx < width; ++cx) {
            for (int cy = 0; cy < height; ++cy) {
                for (int cz = 0; cz < depth; ++cz) {
                    world.f(dx + cx, dy + cy, dz + cz, blockID, meta, 2);
                }
            }
        }
    }
    
    public void drawBlob(final zv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final int metaValue, final boolean priority) {
        for (byte dx = 0; dx <= rad; ++dx) {
    ...
    protected boolean hasAirAround(final aae world, final int bx, final int by, final int bz) {
        boolean airAround = false;
        if (world.a(bx + 1, by, bz) == 0) {
            airAround = true;
        }
        if (world.a(bx - 1, by, bz) == 0) {
            airAround = true;
        }
        if (world.a(bx, by, bz + 1) == 0) {
            airAround = true;
        }
        if (world.a(bx, by, bz - 1) == 0) {
            airAround = true;
        }
        if (world.a(bx, by + 1, bz) == 0) {
            airAround = true;
        }
        return airAround;
    }
    
    protected boolean isNearSolid(final aae world, final int bx, final int by, final int bz) {
        boolean nearSolid = false;
        if (world.g(bx + 1, by, bz).a()) {
            nearSolid = true;
        }
        if (world.g(bx - 1, by, bz).a()) {
            nearSolid = true;
        }
        if (world.g(bx, by, bz + 1).a()) {
            nearSolid = true;
        }
        if (world.g(bx, by, bz - 1).a()) {
            nearSolid = true;
