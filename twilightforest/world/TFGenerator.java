...
public abstract class TFGenerator extends WorldGenerator
{
    ...
    protected boolean isAreaSuitable(final World world, final Random rand, final int x, final int y, final int z, final int width, final int height, final int depth) {
        boolean flag = true;
        for (int cx = 0; cx < width; ++cx) {
            for (int cz = 0; cz < depth; ++cz) {
                if (world.func_72899_e(x + cx, y, z + cz)) {
    ...
    protected static boolean hasAirAround(final World world, final int bx, final int by, final int bz) {
        ...
        if (world.func_72899_e(bx + 1, by, bz) && world.func_147439_a(bx + 1, by, bz) == Blocks.field_150350_a) {
            airAround = true;
        }
        if (world.func_72899_e(bx - 1, by, bz) && world.func_147439_a(bx - 1, by, bz) == Blocks.field_150350_a) {
            airAround = true;
        }
        if (world.func_72899_e(bx, by, bz + 1) && world.func_147439_a(bx, by, bz + 1) == Blocks.field_150350_a) {
            airAround = true;
        }
        if (world.func_72899_e(bx, by, bz - 1) && world.func_147439_a(bx, by, bz - 1) == Blocks.field_150350_a) {
            airAround = true;
    ...
    protected static boolean isNearSolid(final World world, final int bx, final int by, final int bz) {
        ...
        if (world.func_72899_e(bx + 1, by, bz) && world.func_147439_a(bx + 1, by, bz).func_149688_o().func_76220_a()) {
            nearSolid = true;
        }
        if (world.func_72899_e(bx - 1, by, bz) && world.func_147439_a(bx - 1, by, bz).func_149688_o().func_76220_a()) {
            nearSolid = true;
        }
        if (world.func_72899_e(bx, by, bz + 1) && world.func_147439_a(bx, by, bz + 1).func_149688_o().func_76220_a()) {
            nearSolid = true;
        }
        if (world.func_72899_e(bx, by, bz - 1) && world.func_147439_a(bx, by, bz - 1).func_149688_o().func_76220_a()) {
            nearSolid = true;
