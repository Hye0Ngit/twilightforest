...
public abstract class TFGenerator extends afd
{
    public TFGenerator() {
        this(false);
    }
    ...
    public abstract boolean a(final abv p0, final Random p1, final int p2, final int p3, final int p4);
    
    protected boolean putBlock(final abv world, final int dx, final int dy, final int dz, final int blockValue, final boolean priority) {
        return this.putBlockAndMetadata(world, dx, dy, dz, blockValue, 0, priority);
    }
    
    protected boolean putBlockAndMetadata(final abv world, final int dx, final int dy, final int dz, final int blockValue, final int metaValue, final boolean priority) {
        if (priority) {
    ...
    protected void putBlockAndMetadata(final abv world, final int[] pixel, final int blockValue, final int metaValue, final boolean priority) {
        this.putBlockAndMetadata(world, pixel[0], pixel[1], pixel[2], blockValue, metaValue, priority);
    }
    
    protected void putBlock(final abv world, final int[] pixel, final int blockValue, final boolean priority) {
    ...
    protected void drawBresehnam(final abv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final boolean priority) {
        this.drawBresehnam(world, x1, y1, z1, x2, y2, z2, blockValue, 0, priority);
    }
    
    protected void drawBresehnamX(final abv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue, final boolean priority) {
    ...
    protected void drawBresehnam(final abv world, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue, final boolean priority) {
    ...
    public void drawCircle(final abv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final int metaValue, final boolean priority) {
    ...
    public void drawDiameterCircle(final abv world, final int sx, final int sy, final int sz, final int diam, final int block, final int meta, final boolean priority) {
    ...
    protected byte randStone(final Random rand, final int howMuch) {
        return (rand.nextInt(howMuch) >= 1) ? ((byte)aqw.B.cF) : ((byte)aqw.at.cF);
    }
    
    protected boolean isAreaClear(final abv world, final Random rand, final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        boolean flag = true;
        for (int cx = 0; cx < dx; ++cx) {
            for (int cz = 0; cz < dy; ++cz) {
                final ajz m = world.g(x + cx, y - 1, z + cz);
                if (m != ajz.c && m != ajz.b && m != ajz.e) {
                    flag = false;
                }
    ...
    protected void fill(final abv world, final int dx, final int dy, final int dz, final int width, final int height, final int depth, final int blockID, final int meta) {
    ...
    public void drawBlob(final abv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final int metaValue, final boolean priority) {
        for (byte dx = 0; dx <= rad; ++dx) {
    ...
    protected boolean hasAirAround(final ace world, final int bx, final int by, final int bz) {
    ...
    protected static boolean isNearSolid(final ace world, final int bx, final int by, final int bz) {
