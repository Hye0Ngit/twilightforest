...
public class TFGenFireJet extends TFGenerator
{
    ...
    public boolean a(final abv world, final Random rand, final int x, final int y, final int z) {
        for (int var6 = 0; var6 < 4; ++var6) {
            ...
            if (world.c(dx, dy, dz) && world.l(dx, dy, dz) && world.g(dx, dy - 1, dz) == ajz.b && world.g(dx + 1, dy - 1, dz) == ajz.b && world.g(dx - 1, dy - 1, dz) == ajz.b && world.g(dx, dy - 1, dz + 1) == ajz.b && world.g(dx, dy - 1, dz - 1) == ajz.b) {
                world.f(dx, dy - 1, dz, this.plantBlockId, this.plantBlockMeta, 0);
                for (int rx = -2; rx <= 2; ++rx) {
                    for (int rz = -2; rz <= 2; ++rz) {
                        if ((rx == 1 || rx == 0 || rx == -1) && (rz == 1 || rz == 0 || rz == -1)) {
                            world.f(dx + rx, dy - 2, dz + rz, aqw.H.cF, 0, 0);
                        }
                        else if (world.g(dx + rx, dy - 2, dz + rz) != ajz.i) {
                            world.f(dx + rx, dy - 2, dz + rz, aqw.y.cF, 0, 0);
                        }
                        world.f(dx + rx, dy - 3, dz + rz, aqw.y.cF, 0, 0);
                    }
                }
            }
        }
