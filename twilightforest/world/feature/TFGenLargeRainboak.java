...
public class TFGenLargeRainboak extends TFTreeGenerator
{
    ...
    public TFGenLargeRainboak(final boolean par1) {
        super(par1);
    ...
    void generateLeafNodeList() {
        ...
        System.arraycopy(var2, 0, (Object)(this.leafNodes = new int[var4][4]), 0, var4);
    }
    
    void genTreeLayer(final int par1, final int par2, final int par3, final float par4, final byte par5, final IBlockState leaves) {
        final int var7 = (int)(par4 + 0.618);
        final byte var8 = TFGenLargeRainboak.otherCoordPairs[par5];
        final byte var9 = TFGenLargeRainboak.otherCoordPairs[par5 + 3];
        ...
        while (var12 <= var7) {
            ...
            for (var13 = -var7; var13 <= var7; ++var13) {
                ...
                if (var14 <= par4 * par4) {
                    ...
                    final IBlockState var15 = this.world.func_180495_p(pos);
                    final Block block = var15.func_177230_c();
                    if (block == Blocks.field_150350_a || block.canBeReplacedByLeaves(var15, (IBlockAccess)this.world, pos)) {
                        this.func_175903_a(this.world, pos, leaves);
                    }
                }
            }
            ++var12;
    ...
    void generateLeafNode(final int par1, final int par2, final int par3) {
        for (int var4 = par2, var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, TFBlocks.twilight_leaves.func_176223_P().func_177226_a((IProperty)BlockTFLeaves.VARIANT, (Comparable)LeavesVariant.RAINBOAK).func_177226_a((IProperty)BlockLeaves.field_176236_b, (Comparable)false));
        }
    }
    
    void placeBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger, final Block log) {
        ...
        if (var4[var6] != 0) {
            final byte var7 = TFGenLargeRainboak.otherCoordPairs[var6];
            final byte var8 = TFGenLargeRainboak.otherCoordPairs[var6 + 3];
            byte var9;
            if (var4[var6] > 0) {
                var9 = 1;
            }
            ...
            for (int var13 = 0, var14 = var4[var6] + var9; var13 != var14; var13 += var9) {
                ...
                IBlockState var15 = log.func_176223_P();
                ...
                if (var18 > 0) {
                    if (var16 == var18) {
                        var15 = var15.func_177226_a((IProperty)BlockLog.field_176299_a, (Comparable)BlockLog.EnumAxis.X);
                    }
                    else if (var17 == var18) {
                        var15 = var15.func_177226_a((IProperty)BlockLog.field_176299_a, (Comparable)BlockLog.EnumAxis.Z);
                    }
                }
                this.func_175903_a(this.world, new BlockPos(var12[0], var12[1], var12[2]), var15);
            }
        }
    }
    ...
    int checkBlockLine(final int[] par1ArrayOfInteger, final int[] par2ArrayOfInteger) {
        ...
        final byte var6 = TFGenLargeRainboak.otherCoordPairs[var5];
        final byte var7 = TFGenLargeRainboak.otherCoordPairs[var5 + 3];
        byte var8;
        if (var3[var5] > 0) {
            var8 = 1;
        }
        ...
        for (var12 = 0, var13 = var3[var5] + var8; var12 != var13; var12 += var8) {
            ...
            final IBlockState var14 = this.world.func_180495_p(new BlockPos(var11[0], var11[1], var11[2]));
            final Block block = var14.func_177230_c();
    ...
    boolean validTreeLocation() {
        ...
        final IBlockState var3 = this.world.func_180495_p(new BlockPos(this.basePos[0], this.basePos[1] - 1, this.basePos[2]));
        final Block block = var3.func_177230_c();
    ...
    public boolean func_180709_b(final World par1World, final Random par2Random, final BlockPos position) {
        this.world = par1World;
        final long var6 = par2Random.nextLong();
        this.rand.setSeed(var6);
        this.basePos[0] = position.func_177958_n();
        this.basePos[1] = position.func_177956_o();
        this.basePos[2] = position.func_177952_p();
