...
{
    public CourtyardWallCornerInner(final ServerLevel level, final CompoundTag nbt) {
        super(NagaCourtyardPieces.TFNCWA, nbt, level, TwilightTemplateStructurePiece.readSettings(nbt).m_74383_((StructureProcessor)CourtyardMain.WALL_INTEGRITY_PROCESSOR).m_74383_((StructureProcessor)SmoothStoneVariants.INSTANCE).m_74383_((StructureProcessor)NagastoneVariants.INSTANCE).m_74383_((StructureProcessor)StoneBricksVariants.INSTANCE).m_74383_((StructureProcessor)CobbleVariants.INSTANCE), TwilightTemplateStructurePiece.readSettings(nbt).m_74383_((StructureProcessor)CourtyardMain.WALL_DECAY_PROCESSOR).m_74383_((StructureProcessor)CobbleVariants.INSTANCE));
    }
    
    public CourtyardWallCornerInner(final int i, final int x, final int y, final int z, final Rotation rotation, final StructureManager structureManager) {
        super(NagaCourtyardPieces.TFNCWA, i, structureManager, TwilightForestMod.prefix("courtyard/courtyard_wall_corner_inner"), TwilightTemplateStructurePiece.makeSettings(rotation).m_74383_((StructureProcessor)CourtyardMain.WALL_INTEGRITY_PROCESSOR).m_74383_((StructureProcessor)SmoothStoneVariants.INSTANCE).m_74383_((StructureProcessor)NagastoneVariants.INSTANCE).m_74383_((StructureProcessor)StoneBricksVariants.INSTANCE).m_74383_((StructureProcessor)CobbleVariants.INSTANCE), TwilightForestMod.prefix("courtyard/courtyard_wall_corner_inner_decayed"), TwilightTemplateStructurePiece.makeSettings(rotation).m_74383_((StructureProcessor)CourtyardMain.WALL_DECAY_PROCESSOR).m_74383_((StructureProcessor)CobbleVariants.INSTANCE), new BlockPos(x, y, z));
    }
