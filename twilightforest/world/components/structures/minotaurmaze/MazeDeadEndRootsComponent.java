...
{
    public MazeDeadEndRootsComponent(final ServerLevel level, final CompoundTag nbt) {
        this(MinotaurMazePieces.TFMMDER, nbt);
    }
    
    public MazeDeadEndRootsComponent(final StructurePieceType piece, final CompoundTag nbt) {
        super(piece, nbt);
    }
    
    public MazeDeadEndRootsComponent(final StructurePieceType type, final TFFeature feature, final int i, final int x, final int y, final int z, final Direction rotation) {
