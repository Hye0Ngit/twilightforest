...
{
    public MazeDeadEndShroomsComponent(final ServerLevel level, final CompoundTag nbt) {
    ...
    public boolean m_7832_(final WorldGenLevel world, final StructureFeatureManager manager, final ChunkGenerator generator, final Random rand, final BoundingBox sbb, final ChunkPos chunkPosIn, final BlockPos blockPos) {
        ...
        this.m_73441_(world, sbb, 1, 1, mushZ, 1, mushY, mushZ, stem, MazeDeadEndShroomsComponent.AIR, false);
        this.m_73441_(world, sbb, 1, mushY, mushZ - 1, 2, mushY, mushZ + 1, mushType, MazeDeadEndShroomsComponent.AIR, false);
        mushType = (mushFlag ? Blocks.f_50180_ : Blocks.f_50181_).m_49966_();
        mushY = rand.nextInt(4) + 1;
        mushZ = rand.nextInt(3) + 1;
        this.m_73441_(world, sbb, 4, 1, mushZ, 4, mushY, mushZ, stem, MazeDeadEndShroomsComponent.AIR, false);
        this.m_73441_(world, sbb, 3, mushY, mushZ - 1, 4, mushY, mushZ + 1, mushType, MazeDeadEndShroomsComponent.AIR, false);
        mushType = (rand.nextBoolean() ? Blocks.f_50181_ : Blocks.f_50180_).m_49966_();
        mushY = rand.nextInt(4) + 1;
        final int mushX = rand.nextInt(3) + 2;
        this.m_73441_(world, sbb, mushX, 1, 4, mushX, mushY, 4, stem, MazeDeadEndShroomsComponent.AIR, false);
        this.m_73441_(world, sbb, mushX - 1, mushY, 3, mushX + 1, mushY, 4, mushType, MazeDeadEndShroomsComponent.AIR, false);
        return true;
    }
}
