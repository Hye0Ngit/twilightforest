...
public class TFMaze
{
    ...
    public TFMaze(final int cellsWidth, final int cellsDepth) {
        ...
        this.head = 0;
        this.roots = 0;
        this.wallBlockState = ((Block)TFBlocks.CUT_MAZESTONE.get()).m_49966_();
        this.rootBlockState = ((Block)TFBlocks.MAZESTONE.get()).m_49966_();
        this.torchBlockState = Blocks.f_50081_.m_49966_();
    ...
    public void copyToStructure(final WorldGenLevel world, final StructureFeatureManager manager, final ChunkGenerator generator, final int dx, final int dy, final int dz, final TFStructureComponentOld component, final BoundingBox sbb) {
        ...
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    ...
                    if (this.isEven(x) && this.isEven(z) && this.shouldTorch(x, z) && component.m_73398_((BlockGetter)world, mdx, mdy, mdz2, sbb).m_60734_() == this.wallBlockState.m_60734_()) {
                        component.m_73434_(world, this.torchBlockState, mdx, mdy, mdz2, sbb);
                    }
                }
            }
        }
    ...
    private void makeWallThing(final WorldGenLevel world, final int dy, final TFStructureComponentOld component, final BoundingBox sbb, final int mdx, final int mdz, final int even, final int odd) {
        for (int y = 0; y < this.head; ++y) {
            this.putHeadBlock(world, mdx + even, dy + this.tall + y, mdz + odd, component, sbb);
        }
        for (int y = 0; y < this.tall; ++y) {
    ...
    private void putPillarBlock(final WorldGenLevel world, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        component.m_73434_(world, this.pillarBlockState, x, y, z, sbb);
    }
    
    private void putWallBlock(final WorldGenLevel world, final int x, final int y, final int z) {
        world.m_7731_(new BlockPos(x, y, z), this.wallBlockState, 2);
    }
    
    private void putWallBlock(final WorldGenLevel world, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        if (this.wallBlocks != null) {
            this.wallBlocks.m_7889_(this.rand, x, y, z, true);
    ...
    private void putDoorBlock(final WorldGenLevel world, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        component.m_73434_(world, this.doorBlockState, x, y, z, sbb);
    }
    
    private void carveBlock(final WorldGenLevel world, final int x, final int y, final int z) {
        world.m_7731_(new BlockPos(x, y, z), Blocks.f_50016_.m_49966_(), 2);
    }
    
    private void putHeadBlock(final WorldGenLevel world, final int x, final int y, final int z) {
        world.m_7731_(new BlockPos(x, y, z), this.headBlockState, 2);
    }
    
    private void putHeadBlock(final WorldGenLevel world, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        component.m_73434_(world, this.headBlockState, x, y, z, sbb);
    }
    
    private void putRootBlock(final WorldGenLevel world, final int x, final int y, final int z) {
        world.m_7731_(new BlockPos(x, y, z), this.rootBlockState, 2);
    }
    
    private void putRootBlock(final WorldGenLevel world, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        component.m_73434_(world, this.rootBlockState, x, y, z, sbb);
    }
    
    private void putCanopyTree(final WorldGenLevel world, final ChunkGenerator generator, final int x, final int y, final int z, final TFStructureComponentOld component, final BoundingBox sbb) {
        final BlockPos pos = component.getBlockPosWithOffset(x, y, z);
        if (sbb.m_71051_((Vec3i)pos)) {
            ConfiguredFeatures.CANOPY_TREE_BASE.m_65385_(world, generator, this.rand, pos);
        }
    }
    ...
    private void placeTorches(final WorldGenLevel world) {
        ...
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    ...
                    if (this.isEven(x) && this.isEven(z) && this.shouldTorch(x, z) && world.m_8055_(pos).m_60734_() == this.wallBlockState.m_60734_()) {
                        world.m_7731_(pos, this.torchBlockState, 2);
                    }
                }
            }
        }
