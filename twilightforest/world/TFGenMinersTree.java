...
public class TFGenMinersTree extends TFGenerator
{
    ...
    public boolean a(final zv world, final Random rand, final int x, final int y, final int z) {
        ...
        this.putBranchWithLeaves(world, x, y + 7, z - 4, false);
        this.putBranchWithLeaves(world, x, y + 6, z - 5, false);
        this.putBlockAndMetadata(world, x, y + 1, z, TFBlocks.magicLogSpecial.cz, this.branchMeta, true);
    ...
    protected void putBranchWithLeaves(final zv world, final int bx, final int by, final int bz, final boolean bushy) {
    ...
    private void buildRoot(final zv world, final double offset, final int b, final int bx, final int by, final int bz) {
