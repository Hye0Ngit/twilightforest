...
public class TFGenRavine extends MapGenBase
{
    ...
    protected void func_151538_a(final World world, final int centerChunkX, final int centerChunkZ, final int currentChunkX, final int currentChunkZ, final Block[] shortStorage) {
