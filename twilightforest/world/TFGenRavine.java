...
public class TFGenRavine extends MapGenBase4096
{
                                ...
                                for (int j4 = i2 + 1; !flag2 && j4 >= d10 - 1; --j4) {
                                    ...
                                    if (j4 >= 0) {
                                        if (j4 < TFWorld.WORLDHEIGHT) {
                                            if (shortStorage[k4] == Block.field_71942_A.field_71990_ca || shortStorage[k4] == Block.field_71943_B.field_71990_ca) {
                                                flag2 = true;
                                            }
                                    ...
                                    if (d12 * d12 + d13 * d13 < 1.0) {
                                        for (int j5 = i2 - 1; j5 >= d10; --j5) {
                                            ...
                                            if ((d12 * d12 + d13 * d13) * this.field_35627_a[j5] + d14 * d14 / 6.0 < 1.0) {
                                                ...
                                                if (curentBlock == Block.field_71980_u.field_71990_ca) {
                                                    flag3 = true;
                                                }
                                                if (curentBlock == Block.field_71981_t.field_71990_ca || curentBlock == Block.field_71979_v.field_71990_ca || curentBlock == Block.field_71980_u.field_71990_ca) {
                                                    shortStorage[i4] = 0;
                                                    if (flag3 && shortStorage[i4 - 1] == Block.field_71979_v.field_71990_ca) {
                                                        shortStorage[i4 - 1] = this.field_75039_c.func_72807_a(l3 + i * 16, l4 + j * 16).field_76752_A;
                                                    }
                                                }
                                            }
                                            --i4;
    ...
    @Override
    protected void recursiveGenerate(final World world, final int centerChunkX, final int centerChunkZ, final int currentChunkX, final int currentChunkZ, final short[] shortStorage) {
