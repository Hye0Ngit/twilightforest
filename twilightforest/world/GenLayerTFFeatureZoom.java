...
public class GenLayerTFFeatureZoom extends agw
{
    public GenLayerTFFeatureZoom(final long l, final agw genlayer) {
        super(l);
        this.a = genlayer;
    }
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] dest = agu.a(swidth * 2 * (sdepth * 2));
        ...
        final int[] output = agu.a(width * depth);
    ...
    public static agw multipleZoom(final long seed, final agw genlayer, final int loops) {
        agw layer = genlayer;
