...
public class GenLayerTFFeatureZoom extends agp
{
    public GenLayerTFFeatureZoom(final long l, final agp genlayer) {
        super(l);
        this.a = genlayer;
    }
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] dest = agn.a(swidth * 2 * (sdepth * 2));
        ...
        final int[] output = agn.a(width * depth);
    ...
    public static agp multipleZoom(final long seed, final agp genlayer, final int loops) {
        agp layer = genlayer;
