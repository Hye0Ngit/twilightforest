...
public class TFGenWoodRoots extends TFGenerator
{
    ...
    private boolean drawRoot(final zv world, final Random rand, final int x, final int y, final int z, final float length, final float angle, final float tilt) {
        ...
        if (world.a(dest[0], dest[1], dest[2]) != aou.x.cz) {
            return false;
        }
        ...
        if (length > 6.0f && rand.nextInt(4) == 0) {
            ...
            world.f(ballSrc[0], ballSrc[1], ballSrc[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballSrc[0], ballSrc[1], ballDest[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballDest[0], ballSrc[1], ballSrc[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballDest[0], ballSrc[1], ballDest[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballSrc[0], ballDest[1], ballSrc[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballSrc[0], ballDest[1], ballDest[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballDest[0], ballDest[1], ballSrc[2], this.oreBlock, this.oreMeta, 2);
            world.f(ballDest[0], ballDest[1], ballDest[2], this.oreBlock, this.oreMeta, 2);
        }
        return true;
    }
}
