...
public class TFGenWoodRoots extends TFGenerator
{
    ...
    private boolean drawRoot(final yc world, final Random rand, final int x, final int y, final int z, final float length, final float angle, final float tilt) {
        final int[] dest = TFGenerator.translate(x, y, z, length, angle, tilt);
        if (world.a(dest[0], dest[1], dest[2]) != amq.w.cm) {
            return false;
        }
