...
public class TFGenTreeOfTime extends TFGenHollowTree
{
    ...
    public boolean XXXXXgenerate(final xv world, final Random rand, final int x, final int y, final int z) {
        this.worldObj = world;
        final int height = 9 + rand.nextInt(4);
        final agb under = world.g(x, y - 1, z);
        if (under != agb.b && under != agb.c) {
            return false;
        }
