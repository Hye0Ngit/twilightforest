...
public class TFGenTreeOfTime extends TFGenHollowTree
{
    ...
    public boolean a(final zv world, final Random random, final int x, final int y, final int z) {
        ...
        this.a(world, x - 1, y + 2, z, TFBlocks.magicLogSpecial.cz, 0);
        return true;
    }
    
    protected void buildTinyCrown(final zv world, final Random random, final int x, final int y, final int z, final int diameter, final int height) {
