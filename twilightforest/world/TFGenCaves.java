...
public class TFGenCaves extends MapGenCaves
{
    ...
    protected void generateCaveNode(final long caveSeed, final int centerX, final int centerZ, final Block[] blockStorage, double randX, double randY, double randZ, float caveSize, float randPI, float angleToGenerate, int loopOne, int loopEnd, final double yScale, final boolean isHighlands) {
    ...
    protected void func_151538_a(final World par1World, final int genX, final int genZ, final int centerX, final int centerZ, final Block[] blockStorage) {
