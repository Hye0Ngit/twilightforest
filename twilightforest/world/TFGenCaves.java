...
public class TFGenCaves extends MapGenBase4096
{
    protected void generateLargeCaveNode(final long par1, final int par3, final int par4, final short[] shortStorage, final double par6, final double par8, final double par10) {
        this.generateCaveNode(par1, par3, par4, shortStorage, par6, par8, par10, 1.0f + this.field_75038_b.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }
    ...
    protected void generateCaveNode(final long caveSeed, final int par3, final int par4, final short[] shortStorage, double par6, double par8, double par10, final float par12, float par13, float par14, int par15, int par16, final double par17) {
        ...
        if (par16 <= 0) {
            final int var23 = this.field_75040_a * 16 - 16;
        ...
        while (par15 < par16) {
            final double var27 = 1.5 + MathHelper.func_76126_a(par15 * 3.1415927f / par16) * par12 * 1.0f;
            ...
            if (var24 || caveRNG.nextInt(4) != 0) {
                ...
                if (par6 >= var19 - 16.0 - var27 * 2.0 && par10 >= var20 - 16.0 - var27 * 2.0 && par6 <= var19 + 16.0 + var27 * 2.0 && par10 <= var20 + 16.0 + var27 * 2.0) {
                    ...
                    int var36 = MathHelper.func_76128_c(par6 + var27) - par3 * 16 + 1;
                    int var37 = MathHelper.func_76128_c(par8 - var28) - 1;
                    int var38 = MathHelper.func_76128_c(par8 + var28) + 1;
                    int var39 = MathHelper.func_76128_c(par10 - var27) - par4 * 16 - 1;
                    int var40 = MathHelper.func_76128_c(par10 + var27) - par4 * 16 + 1;
                    if (var35 < 0) {
                        var35 = 0;
                    }
                    if (var36 > 16) {
                        ...
                        for (int var43 = var39; !var41 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var41 && var44 >= var37 - 1; --var44) {
                                ...
                                if (var44 >= 0 && var44 < 128) {
                                    if (shortStorage[var45] == Block.field_71942_A.field_71990_ca || shortStorage[var45] == Block.field_71943_B.field_71990_ca) {
                                        var41 = true;
                                    }
                                ...
                                if (var46 * var46 + var47 * var47 < 1.0) {
                                    for (int caveY = var38 - 1; caveY >= var37; --caveY) {
                                        ...
                                        if (var48 > -0.7 && var46 * var46 + var48 * var48 + var47 * var47 < 20.0) {
                                            ...
                                            if (blockID == Block.field_71981_t.field_71990_ca || blockID == Block.field_71979_v.field_71990_ca || blockID == Block.field_71980_u.field_71990_ca) {
                                                if (var46 * var46 + var48 * var48 + var47 * var47 < 0.85) {
                                                    shortStorage[caveIndex] = (short)((caveY < 10) ? ((short)Block.field_71942_A.field_71990_ca) : 0);
                                                }
                                                else {
                                                    shortStorage[caveIndex] = (hitGrass ? ((short)Block.field_71980_u.field_71990_ca) : ((short)Block.field_71979_v.field_71990_ca));
                                                    hitGrass = false;
                                                }
                                                if (hitGrass && shortStorage[caveIndex - 1] == Block.field_71979_v.field_71990_ca) {
                                                    shortStorage[caveIndex - 1] = this.field_75039_c.func_72807_a(var42 + par3 * 16, var45 + par4 * 16).field_76752_A;
                                                }
                                            }
                                        }
                                        --caveIndex;
    ...
    @Override
    protected void recursiveGenerate(final World par1World, final int par2, final int par3, final int par4, final int par5, final short[] par6ArrayOfShort) {
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            final double var9 = par2 * 16 + this.field_75038_b.nextInt(16);
            final double var10 = this.field_75038_b.nextInt(this.field_75038_b.nextInt(120) + 8);
            final double var11 = par3 * 16 + this.field_75038_b.nextInt(16);
            int var12 = 1;
            if (this.field_75038_b.nextInt(4) == 0) {
                this.generateLargeCaveNode(this.field_75038_b.nextLong(), par4, par5, par6ArrayOfShort, var9, var10, var11);
                var12 += this.field_75038_b.nextInt(4);
            }
            for (int var13 = 0; var13 < var12; ++var13) {
                final float var14 = this.field_75038_b.nextFloat() * 3.1415927f * 2.0f;
                final float var15 = (this.field_75038_b.nextFloat() - 0.5f) * 2.0f / 8.0f;
                float var16 = this.field_75038_b.nextFloat() * 2.0f + this.field_75038_b.nextFloat();
                if (this.field_75038_b.nextInt(10) == 0) {
                    var16 *= this.field_75038_b.nextFloat() * this.field_75038_b.nextFloat() * 3.0f + 1.0f;
                }
                this.generateCaveNode(this.field_75038_b.nextLong(), par4, par5, par6ArrayOfShort, var9, var10, var11, var16, var14, var15, 0, 0, 1.0);
            }
        }
    }
}
