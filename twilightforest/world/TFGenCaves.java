...
public class TFGenCaves extends MapGenBase4096
{
                        ...
                        for (int var43 = var39; !var41 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var41 && var44 >= var37 - 1; --var44) {
                                ...
                                if (var44 >= 0 && var44 < 128) {
                                    if (shortStorage[var45] == amq.D.cm || shortStorage[var45] == amq.E.cm) {
                                        var41 = true;
                                    }
                                ...
                                if (var46 * var46 + var47 * var47 < 1.0) {
                                    for (int caveY = var38 - 1; caveY >= var37; --caveY) {
                                        ...
                                        if (var48 > -0.7 && var46 * var46 + var48 * var48 + var47 * var47 < 20.0) {
                                            ...
                                            if (blockID == amq.w.cm || blockID == amq.y.cm || blockID == amq.x.cm) {
                                                if (var46 * var46 + var48 * var48 + var47 * var47 < 0.85) {
                                                    shortStorage[caveIndex] = (short)((caveY < 10) ? ((short)amq.D.cm) : 0);
                                                }
                                                else {
                                                    shortStorage[caveIndex] = (hitGrass ? ((short)amq.x.cm) : ((short)amq.y.cm));
                                                    hitGrass = false;
                                                }
                                                if (hitGrass && shortStorage[caveIndex - 1] == amq.y.cm) {
    ...
    @Override
    protected void recursiveGenerate(final yc par1World, final int par2, final int par3, final int par4, final int par5, final short[] par6ArrayOfShort) {
