...
public class TFGenCaves extends MapGenBase4096
{
    ...
    protected void generateCaveNode(final long caveSeed, final int par3, final int par4, final short[] shortStorage, double par6, double par8, double par10, final float par12, float par13, float par14, int par15, int par16, final double par17) {
        ...
        while (par15 < par16) {
            final double var27 = 1.5 + kx.a(par15 * 3.1415927f / par16) * par12 * 1.0f;
            final double var28 = var27 * par17;
            final float var29 = kx.b(par14);
            final float var30 = kx.a(par14);
            par6 += kx.b(par13) * var29;
            par8 += var30;
            par10 += kx.a(par13) * var29;
            if (var26) {
                par14 *= 0.92f;
            }
            else {
            ...
            if (var24 || caveRNG.nextInt(4) != 0) {
                ...
                if (par6 >= var19 - 16.0 - var27 * 2.0 && par10 >= var20 - 16.0 - var27 * 2.0 && par6 <= var19 + 16.0 + var27 * 2.0 && par10 <= var20 + 16.0 + var27 * 2.0) {
                    int var35 = kx.c(par6 - var27) - par3 * 16 - 1;
                    int var36 = kx.c(par6 + var27) - par3 * 16 + 1;
                    int var37 = kx.c(par8 - var28) - 1;
                    int var38 = kx.c(par8 + var28) + 1;
                    int var39 = kx.c(par10 - var27) - par4 * 16 - 1;
                    int var40 = kx.c(par10 + var27) - par4 * 16 + 1;
                    if (var35 < 0) {
                        var35 = 0;
                    }
                    if (var36 > 16) {
                        ...
                        for (int var43 = var39; !var41 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var41 && var44 >= var37 - 1; --var44) {
                                ...
                                if (var44 >= 0 && var44 < 128) {
                                    if (shortStorage[var45] == aou.E.cz || shortStorage[var45] == aou.F.cz) {
                                        var41 = true;
                                    }
                                ...
                                if (var46 * var46 + var47 * var47 < 1.0) {
                                    for (int caveY = var38 - 1; caveY >= var37; --caveY) {
                                        ...
                                        if (var48 > -0.7 && var46 * var46 + var48 * var48 + var47 * var47 < 20.0) {
                                            ...
                                            if (blockID == aou.x.cz || blockID == aou.z.cz || blockID == aou.y.cz) {
                                                if (var46 * var46 + var48 * var48 + var47 * var47 < 0.85) {
                                                    shortStorage[caveIndex] = (short)((caveY < 10) ? ((short)aou.E.cz) : 0);
                                                }
                                                else {
                                                    shortStorage[caveIndex] = (hitGrass ? ((short)aou.y.cz) : ((short)aou.z.cz));
                                                    hitGrass = false;
                                                }
                                                if (hitGrass && shortStorage[caveIndex - 1] == aou.z.cz) {
    ...
    @Override
    protected void recursiveGenerate(final zv par1World, final int par2, final int par3, final int par4, final int par5, final short[] par6ArrayOfShort) {
