...
public class GenLayerTFMinorFeatures extends agp
{
    protected agp featureLayer;
    protected agp biomeLayer;
    
    public GenLayerTFMinorFeatures(final int par1, final agp biomes, final agp features) {
        super((long)par1);
