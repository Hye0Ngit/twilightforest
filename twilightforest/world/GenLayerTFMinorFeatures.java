...
public class GenLayerTFMinorFeatures extends agw
{
    protected agw featureLayer;
    protected agw biomeLayer;
    
    public GenLayerTFMinorFeatures(final int par1, final agw biomes, final agw features) {
        super((long)par1);
