...
public class EntityTFLichBomb extends rh
{
    public EntityTFLichBomb(final xv par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }
    
    public EntityTFLichBomb(final xv par1World, final md par2EntityLiving) {
        super(par1World, par2EntityLiving);
    }
    
    public EntityTFLichBomb(final xv par1World) {
        super(par1World);
    }
