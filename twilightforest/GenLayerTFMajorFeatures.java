...
public class GenLayerTFMajorFeatures extends wp
{
    int zoomFactor;
    
    public GenLayerTFMajorFeatures(final long l, final wp genlayer) {
        super(l);
        this.zoomFactor = 2;
        super.a = genlayer;
    }
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] dest = ad.a(swidth * this.zoomFactor * (sdepth * this.zoomFactor));
    ...
    public static wp multipleZoom(final long l, final wp genlayer, final int i) {
        Object obj = genlayer;
        for (int j = 0; j < i; ++j) {
            obj = new GenLayerTFMajorFeatures(l + j, (wp)obj);
        }
        return (wp)obj;
    }
}
