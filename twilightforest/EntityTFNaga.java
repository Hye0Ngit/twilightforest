...
public class EntityTFNaga extends qj implements qe, pl
{
    ...
    public EntityTFNaga(final xv world) {
        super(world);
        ...
        this.aF = "/twilightforest/nagahead.png";
        this.a(1.75f, 3.0f);
        this.bG = 0.6f;
        this.X = 2.0f;
        this.aQ = this.aT();
    ...
    protected int setSegmentsPerHealth() {
        ...
        int newSegments = this.aQ / this.segmentHealth + ((this.aQ > 0) ? 2 : 0);
        if (newSegments < 0) {
            newSegments = 0;
        }
        if (this.p != null && !this.p.J && newSegments != oldSegments) {
    ...
    protected void setMovementFactorPerSegments() {
        this.aM = 0.6f - this.currentSegments / 12.0f * 0.2f;
    ...
    public void j_() {
        ...
        if (!this.p.J && this.ticksSinceDamaged > EntityTFNaga.TICKS_BEFORE_HEALING && this.ticksSinceDamaged % 20 == 0) {
            this.i(1);
            this.setSegmentsPerHealth();
        }
        if (!this.p.J) {
            this.ag.b(16, (Object)this.aQ);
        }
        super.j_();
    }
    ...
    protected void bn() {
        ...
        aob vec3d = this.k() ? this.pathToEntity.a((lq)this) : null;
        ...
        if (vec3d != null) {
            ...
            if (dist > 4.0 && this.chargeCount == 0) {
                this.bB = ke.b(this.bg * 0.3f) * this.bG * 0.6f;
            }
            while (f3 < -180.0f) {
                f3 += 360.0f;
            }
    ...
    protected void acquireNewPath() {
        ...
        if (this.chargeCount > 0) {
            --this.chargeCount;
            final aob tpoint = this.findCirclePoint(this.targetEntity, 14.0, 3.141592653589793);
        ...
        if (this.circleCount > 0) {
            ...
            final aob tpoint2 = this.findCirclePoint(this.targetEntity, radius, rotation);
    ...
    protected void breakBlock(final int dx, final int dy, final int dz) {
        ...
        if (whatsThere > 0) {
            amj.p[whatsThere].c(this.p, dx, dy, dz, whatsMeta, 0);
            this.p.e(dx, dy, dz, 0);
    ...
    protected aob findCirclePoint(final lq toCircle, final double radius, final double rotation) {
    ...
    protected void a(final lq toAttack, final float f) {
        if (this.aY <= 0 && f < 4.0f && toAttack.D.e > this.D.b - 2.5 && toAttack.D.b < this.D.e + 2.5) {
            this.aY = 20;
            this.m(toAttack);
            if (this.bG > 0.8) {
