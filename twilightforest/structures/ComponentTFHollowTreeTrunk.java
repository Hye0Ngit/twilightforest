...
public class ComponentTFHollowTreeTrunk extends StructureTFComponent
{
    ...
    public void func_74861_a(final StructureComponent structurecomponent, final List list, final Random rand) {
        ...
        final ComponentTFLeafSphere leafBlob = new ComponentTFLeafSphere(index + 1, this.field_74887_e.field_78893_d, this.field_74887_e.field_78894_e, this.field_74887_e.field_78892_f, 3);
        list.add(leafBlob);
    ...
    public void makeSmallBranch(final List list, final Random rand, final int index, final int branchHeight, final int branchLength, final double branchRotation, final double branchAngle, final boolean leafy) {
        final int[] bSrc = TFGenerator.translate(this.field_74887_e.field_78897_a + this.radius, this.field_74887_e.field_78895_b + branchHeight, this.field_74887_e.field_78896_c + this.radius, this.radius, branchRotation, 0.5);
