...
public class ComponentTFTowerBridge extends ComponentTFTowerWing
{
    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        for (int x = 0; x < 3; ++x) {
            this.a(world, amj.bc.cm, 0, x, 2, 0, sbb);
            this.a(world, amj.bc.cm, 0, x, 2, 2, sbb);
            this.a(world, amj.bp.cm, 0, x, 1, 0, sbb);
            this.a(world, amj.bp.cm, 0, x, 1, 2, sbb);
            this.a(world, amj.bp.cm, 0, x, 0, 0, sbb);
            this.a(world, amj.bp.cm, 0, x, 0, 1, sbb);
            this.a(world, amj.bp.cm, 0, x, 0, 2, sbb);
            this.a(world, amj.bp.cm, 0, x, -1, 1, sbb);
        }
        this.a(world, amj.bp.cm, 0, -1, -1, 1, sbb);
        this.a(world, amj.bp.cm, 0, 3, -1, 1, sbb);
