...
public class ComponentTFTowerBeardAttached extends ComponentTFTowerBeard
{
    ...
    public ComponentTFTowerBeardAttached(final TFFeature feature, final int i, final ComponentTFTowerWing wing) {
    ...
    private boolean makeAttachedBeard(final World world, final Random rand, final StructureBoundingBox sbb) {
        for (int y = 0; y <= this.height; ++y) {
            ...
            this.func_74882_a(world, sbb, 0, this.height - y, min, max, this.height - y, max, false, rand, StructureTFComponentOld.getStrongholdStones());
        }
        return true;
    }
}
