...
public class ComponentTFTowerRoofGableForwards extends ComponentTFTowerRoof
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_151550_a(world, (Block)Blocks.field_150376_bx, slabMeta | 0xA, this.size - 1, top - 1, zMid, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150376_bx, slabMeta, 0, top, zMid, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150376_bx, slabMeta, this.size - 3, top, zMid, sbb);
