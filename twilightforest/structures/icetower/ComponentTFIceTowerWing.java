...
public class ComponentTFIceTowerWing extends ComponentTFTowerWing
{
    ...
    private void decorateTopFloorTreasure(final World world, final Random rand, final int bottom, final int top, final int rotation, final StructureBoundingBox sbb) {
    ...
    private void decorateFarWallSteps(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        for (int z = 1; z < 10; ++z) {
        ...
        if (hasTreasure) {
            ...
            final int beamMetaNS = ((this.field_74885_f + ladderUpDir) % 2 == 0) ? 4 : 8;
            this.placeBlockRotated(world, this.deco.pillarID, this.deco.pillarMeta + beamMetaNS, 1, bottom + 7, 5, ladderUpDir, sbb);
        }
    }
    
    private void decorateWraparoundWallSteps(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        for (int z = 1; z < 10; ++z) {
            final int y = bottom + 10 - z / 2;
    ...
    private void decorateWraparoundWallStepsPillars(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
    ...
    private void decoratePlatform(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
    ...
    private void decorateQuadPillarStairs(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        this.decoratePillars(world, rand, bottom, top, ladderDownDir, sbb);
        for (int z = 6; z < 9; ++z) {
            final int y = bottom - 2 + z / 2;
    ...
    private void decoratePillarPlatforms(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        for (int i = 1; i < 10; ++i) {
    ...
    private void decoratePillarPlatformsOutside(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        for (int i = 1; i < 8; ++i) {
            final int rotation = (ladderUpDir + i) % 4;
    ...
    private void decoratePillarParkour(final World world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final boolean hasTreasure, final StructureBoundingBox sbb) {
        final int rotation = ladderDownDir;
        final int beamMetaNS = ((this.field_74885_f + rotation) % 2 == 0) ? 4 : 8;
        final int beamMetaEW = (beamMetaNS == 4) ? 8 : 4;
        this.decoratePillars(world, rand, bottom, top, rotation, sbb);
