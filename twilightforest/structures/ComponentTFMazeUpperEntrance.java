...
public class ComponentTFMazeUpperEntrance extends StructureTFComponent
{
    ...
    public ComponentTFMazeUpperEntrance(final int i, final Random rand, final int x, final int y, final int z) {
        ...
        this.e = new aee(x, y, z, x + 15, y + 4, z + 15);
    }
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        this.a(world, sbb, rand, 0.7f, 0, 5, 0, 15, 5, 15, TFBlocks.mazestone.cz, 0, true);
        this.a(world, sbb, 0, 0, 0, 15, 0, 15, TFBlocks.mazestone.cz, 6, 0, 0, false);
        this.a(world, sbb, 0, 1, 0, 15, 1, 15, TFBlocks.mazestone.cz, 3, 0, 0, true);
        this.a(world, sbb, 0, 2, 0, 15, 3, 15, TFBlocks.mazestone.cz, 1, 0, 0, true);
        this.a(world, sbb, 0, 4, 0, 15, 4, 15, TFBlocks.mazestone.cz, 3, 0, 0, true);
        this.a(world, sbb, rand, 0.2f, 0, 0, 0, 15, 5, 15, aou.J.cz, 0, true);
        ...
        this.a(world, sbb, rand, 0.7f, 5, 2, 5, 10, 3, 10, aou.bt.cz, 0, false);
