...
public class StructureTFMajorFeatureStart extends aeu
{
    public TFFeature feature;
    
    public StructureTFMajorFeatureStart(final xv world, final Random rand, final int chunkX, final int chunkZ) {
        ...
        final aes firstComponent = this.makeFirstComponent(world, rand, this.feature, x, y, z);
    ...
    public aes makeFirstComponent(final xv world, final Random rand, final TFFeature feature, final int x, final int y, final int z) {
    ...
    protected void moveToAvgGroundLevel(final xv world, final int x, final int z) {
        if (world.t() instanceof TFWorldChunkManager) {
            final yr biomeAt = world.a(x, z);
            final int offY = (int)((biomeAt.D + biomeAt.E) * 8.0f);
            if (offY > 0) {
                this.b.a(0, offY, 0);
                for (final aes com : this.b()) {
                    com.b().a(0, offY, 0);
                }
            }
        }
