...
public class ComponentTFHedgeMaze extends StructureTFComponent
{
    ...
    public ComponentTFHedgeMaze(final zv world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        ...
        maze.oddBias = 2;
        maze.torchBlockID = TFBlocks.firefly.cz;
        maze.wallBlockID = TFBlocks.hedge.cz;
        maze.wallBlockMeta = 0;
        maze.type = 4;
        maze.tall = 3;
        maze.roots = 3;
        maze.setSeed(world.F() + this.e.a * this.e.c);
        for (int fx = 0; fx <= ComponentTFHedgeMaze.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFHedgeMaze.DIAMETER; ++fz) {
                this.a(world, aou.y.cz, 0, fx, ComponentTFHedgeMaze.FLOOR_LEVEL - 1, fz, sbb);
            }
        }
        this.a(world, aou.bj.cz, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, aou.bj.cz, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, aou.bj.cz, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, aou.bj.cz, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, aou.bj.cz, 2, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, aou.bj.cz, 2, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, aou.bj.cz, 0, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
        this.a(world, aou.bj.cz, 0, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
    ...
    void decorate3x3Rooms(final zv world, final int[] rcoords, final aee sbb) {
        for (int i = 0; i < rcoords.length / 2; ++i) {
            int dx = rcoords[i * 2];
    ...
    void decorate3x3Room(final zv world, final int x, final int z, final aee sbb) {
        final Random roomRNG = new Random(world.F() ^ (long)(x + z));
    ...
    private void roomSpawner(final zv world, final Random rand, final int x, final int z, final int diameter, final aee sbb) {
    ...
    private void roomTreasure(final zv world, final Random rand, final int x, final int z, final int diameter, final aee sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.placeTreasureAtCurrentPosition(world, rand, rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, TFTreasure.hedgemaze, sbb);
    }
    
    private void roomJackO(final zv world, final Random rand, final int x, final int z, final int diameter, final aee sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.a(world, aou.bj.cz, rand.nextInt(4), rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, sbb);
    }
