...
public class ComponentTFHedgeMaze extends StructureTFComponent
{
    ...
    public ComponentTFHedgeMaze(final yc world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
    ...
    public boolean a(final yc world, final Random rand, final acn sbb) {
        ...
        for (int fx = 0; fx <= ComponentTFHedgeMaze.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFHedgeMaze.DIAMETER; ++fz) {
                this.a(world, amq.x.cm, 0, fx, ComponentTFHedgeMaze.FLOOR_LEVEL - 1, fz, sbb);
            }
        }
        this.a(world, amq.bi.cm, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, amq.bi.cm, 1, 0, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, amq.bi.cm, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 24, sbb);
        this.a(world, amq.bi.cm, 3, 50, ComponentTFHedgeMaze.FLOOR_LEVEL, 29, sbb);
        this.a(world, amq.bi.cm, 2, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, amq.bi.cm, 2, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 0, sbb);
        this.a(world, amq.bi.cm, 0, 24, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
        this.a(world, amq.bi.cm, 0, 29, ComponentTFHedgeMaze.FLOOR_LEVEL, 50, sbb);
    ...
    void decorate3x3Rooms(final yc world, final int[] rcoords, final acn sbb) {
        for (int i = 0; i < rcoords.length / 2; ++i) {
            int dx = rcoords[i * 2];
    ...
    void decorate3x3Room(final yc world, final int x, final int z, final acn sbb) {
    ...
    private void roomSpawner(final yc world, final Random rand, final int x, final int z, final int diameter, final acn sbb) {
    ...
    private void roomTreasure(final yc world, final Random rand, final int x, final int z, final int diameter, final acn sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.placeTreasureAtCurrentPosition(world, rand, rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, TFTreasure.hedgemaze, sbb);
    }
    
    private void roomJackO(final yc world, final Random rand, final int x, final int z, final int diameter, final acn sbb) {
        final int rx = x + rand.nextInt(diameter) - diameter / 2;
        final int rz = z + rand.nextInt(diameter) - diameter / 2;
        this.a(world, amq.bi.cm, rand.nextInt(4), rx, ComponentTFHedgeMaze.FLOOR_LEVEL, rz, sbb);
    }
