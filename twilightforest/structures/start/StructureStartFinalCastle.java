...
public class StructureStartFinalCastle extends StructureStartTFFeatureAbstract
{
    ...
    public StructureStartFinalCastle(final World world, final TFFeature feature, final Random rand, final int chunkX, final int chunkZ) {
    ...
    protected StructureComponent makeFirstComponent(final World world, final TFFeature feature, final Random rand, final int x, final int y, final int z) {
        return new ComponentTFFinalCastleMain(TFFeature.FINAL_CASTLE, world, rand, 0, x, y, z);
    }
}
