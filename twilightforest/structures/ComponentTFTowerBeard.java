...
public class ComponentTFTowerBeard extends StructureTFComponent
{
    ...
    public ComponentTFTowerBeard(final int i, final ComponentTFTowerWing wing) {
        ...
        this.e = new aee(wing.b().a + 1, wing.b().b - this.height - 1, wing.b().c + 1, wing.b().d - 1, wing.b().b - 1, wing.b().f - 1);
    }
    ...
    private boolean makePyramidBeard(final zv world, final Random rand, final aee sbb) {
