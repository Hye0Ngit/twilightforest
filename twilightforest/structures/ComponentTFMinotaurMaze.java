...
public class ComponentTFMinotaurMaze extends StructureTFComponent
{
    ...
    protected void decorateDeadEndsCorridors(final Random random, final List list) {
        for (int x = 0; x < this.maze.width; ++x) {
            for (int z = 0; z < this.maze.depth; ++z) {
                ...
                if (component != null) {
                    list.add(component);
                    component.a((agq)this, list, random);
                }
            }
        }
    }
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        if (this.level == 2) {
            this.a(world, sbb, 0, -1, 0, this.getDiameter() + 2, 6, this.getDiameter() + 2, aou.D.cz, 0, false);
        }
        this.a(world, sbb, 1, 1, 1, this.getDiameter(), 4, this.getDiameter());
        this.a(world, sbb, 1, 5, 1, this.getDiameter(), 5, this.getDiameter(), TFBlocks.mazestone.cz, 0, aou.x.cz, 0, this.level == 1);
        this.a(world, sbb, 1, 0, 1, this.getDiameter(), 0, this.getDiameter(), TFBlocks.mazestone.cz, 6, aou.x.cz, 0, false);
        this.maze.headBlockID = TFBlocks.mazestone.cz;
        this.maze.headBlockMeta = 3;
        this.maze.wallBlockID = TFBlocks.mazestone.cz;
        this.maze.wallBlockMeta = 1;
        this.maze.rootBlockID = TFBlocks.mazestone.cz;
        this.maze.rootBlockMeta = 3;
        this.maze.pillarBlockID = TFBlocks.mazestone.cz;
        this.maze.pillarBlockMeta = 2;
        this.maze.wallVar0ID = TFBlocks.mazestone.cz;
