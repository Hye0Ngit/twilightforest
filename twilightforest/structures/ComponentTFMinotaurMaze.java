...
public class ComponentTFMinotaurMaze extends StructureTFComponent
{
    ...
    protected void decorateDeadEndsCorridors(final Random random, final List list) {
        for (int x = 0; x < this.maze.width; ++x) {
            for (int z = 0; z < this.maze.depth; ++z) {
                ...
                if (component != null) {
                    list.add(component);
                    component.a((aes)this, list, random);
                }
            }
        }
    }
    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        if (this.level == 2) {
            this.a(world, sbb, 0, -1, 0, this.getDiameter() + 2, 6, this.getDiameter() + 2, amj.C.cm, 0, false);
        }
        this.a(world, sbb, 1, 1, 1, this.getDiameter(), 4, this.getDiameter());
        this.a(world, sbb, 1, 5, 1, this.getDiameter(), 5, this.getDiameter(), TFBlocks.mazestone.cm, 0, amj.w.cm, 0, this.level == 1);
        this.a(world, sbb, 1, 0, 1, this.getDiameter(), 0, this.getDiameter(), TFBlocks.mazestone.cm, 6, amj.w.cm, 0, false);
