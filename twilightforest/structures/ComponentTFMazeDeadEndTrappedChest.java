...
public class ComponentTFMazeDeadEndTrappedChest extends ComponentTFMazeDeadEndChest
{
    ...
    public boolean a(final abv world, final Random rand, final age sbb) {
        ...
        this.a(world, aqw.bY.cF, this.getHookMeta(3), 1, 1, 2, sbb);
        this.a(world, aqw.bY.cF, this.getHookMeta(1), 4, 1, 2, sbb);
        this.a(world, aqw.bZ.cF, 0, 2, 1, 2, sbb);
        this.a(world, aqw.bZ.cF, 0, 3, 1, 2, sbb);
        this.a(world, aqw.ar.cF, 0, 0, 0, 2, sbb);
        this.a(world, 0, 0, 0, -1, 2, sbb);
        this.a(world, 0, 0, 1, -1, 2, sbb);
        this.a(world, aqw.ar.cF, 0, 2, 0, 4, sbb);
        this.a(world, aqw.ar.cF, 0, 3, 0, 4, sbb);
        this.a(world, aqw.ar.cF, 0, 2, 0, 3, sbb);
        this.a(world, aqw.ar.cF, 0, 3, 0, 3, sbb);
        return true;
    }
