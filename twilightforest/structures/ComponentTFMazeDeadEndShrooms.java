...
public class ComponentTFMazeDeadEndShrooms extends ComponentTFMazeDeadEndRoots
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        mushType = (rand.nextBoolean() ? Block.field_72001_bo.field_71990_ca : Block.field_72000_bn.field_71990_ca);
        mushY = rand.nextInt(4) + 1;
        final int mushX = rand.nextInt(3) + 2;
        this.func_74872_a(world, sbb, mushX, 1, 4, mushX, mushY, 4, mushType, 10, 0, 0, false);
        this.func_74872_a(world, sbb, mushX - 1, mushY, 3, mushX + 1, mushY, 4, mushType, 14, 0, 0, false);
        return true;
    }
}
