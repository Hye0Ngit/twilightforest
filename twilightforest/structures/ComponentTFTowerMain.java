...
{
    public ComponentTFTowerMain(final yc world, final Random rand, final int index, final int x, final int y, final int z) {
    ...
    public boolean makeTowerOutbuilding(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        final aez intersect = aez.a(list, outbuilding.b());
    ...
    protected void makeStairwayCrossings(final yc world, final Random rand, final acn sbb) {
    ...
    protected void makeStairCrossing(final yc world, final Random rand, final int flight, final acn sbb) {
        ...
        for (int dx = 6; dx <= 8; ++dx) {
            for (int dz = 4; dz <= 10; ++dz) {
                this.a(world, amq.am.cm, floorMeta, dx, floorLevel, dz, sbb);
            }
        }
        ++floorLevel;
        int dx = 6;
        for (int dz = 3; dz <= 11; ++dz) {
            this.a(world, amq.bc.cm, 0, dx, floorLevel, dz, sbb);
        }
        ++dx;
        for (int dz = 3; dz <= 11; ++dz) {
        ...
        this.a(world, amq.am.cm, floorMeta, 6, floorLevel - 1, 11, sbb);
        this.a(world, amq.am.cm, floorMeta, 8, floorLevel - 1, 3, sbb);
        this.a(world, amq.bc.cm, 0, 5, floorLevel, 11, sbb);
        this.a(world, amq.bc.cm, 0, 9, floorLevel, 3, sbb);
        ...
        this.a(world, amq.bc.cm, 0, 6, floorLevel + 1, 7, sbb);
        this.a(world, amq.bc.cm, 0, 8, floorLevel + 1, 7, sbb);
        this.a(world, amq.bc.cm, 0, 6, floorLevel + 2, 7, sbb);
        this.a(world, amq.bc.cm, 0, 8, floorLevel + 2, 7, sbb);
        this.setCoordBaseMode(temp);
    }
    
    protected void makeLichRoom(final yc world, final Random rand, final acn sbb) {
    ...
    protected void makeTowerPaintings(final yc world, final Random rand, final acn sbb) {
    ...
    protected void makeLichFloor(final yc world, final int floorLevel, final int rotation, final acn sbb) {
        final int temp = this.getCoordBaseMode();
        ...
        for (int fx = 1; fx < 14; ++fx) {
            for (int fz = 1; fz < 14; ++fz) {
                if ((fx == 1 || fx == 2) && fz >= 6 && fz <= 12) {
                    if (fz == 6) {
                        this.a(world, amq.bR.cm, 10, fx, floorLevel, fz, sbb);
                    }
                }
                    ...
                    if ((fx == 4 && fz == 4) || (fx == 10 && fz == 10)) {
                        this.a(world, amq.A.cm, 2, fx, floorLevel, fz, sbb);
                    }
                    else {
                        this.a(world, amq.P.cm, 0, fx, floorLevel, fz, sbb);
                    }
                }
    ...
    protected void decorateLichChandelier(final yc world, final int floorLevel, final acn sbb) {
        final int cx = this.size / 2;
        int cy = floorLevel + 4;
        final int cz = this.size / 2;
        this.a(world, amq.bc.cm, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, amq.bc.cm, 0, cx + 2, cy, cz + 0, sbb);
        this.a(world, amq.bc.cm, 0, cx + 1, cy, cz + 1, sbb);
        this.a(world, amq.bc.cm, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, amq.bc.cm, 0, cx + 0, cy, cz + 2, sbb);
        this.a(world, amq.bc.cm, 0, cx - 1, cy, cz + 1, sbb);
        this.a(world, amq.bc.cm, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, amq.bc.cm, 0, cx - 2, cy, cz + 0, sbb);
        this.a(world, amq.bc.cm, 0, cx - 1, cy, cz - 1, sbb);
        ...
        ++cy;
        this.a(world, amq.bc.cm, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx + 2, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx + 1, cy, cz + 1, sbb);
        this.a(world, amq.bc.cm, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, amq.at.cm, 0, cx + 0, cy, cz + 2, sbb);
        this.a(world, amq.at.cm, 0, cx - 1, cy, cz + 1, sbb);
        this.a(world, amq.bc.cm, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx - 2, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx - 1, cy, cz - 1, sbb);
        ...
        this.a(world, amq.at.cm, 0, cx + 1, cy, cz - 1, sbb);
        ++cy;
        this.a(world, amq.at.cm, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, amq.at.cm, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, amq.at.cm, 0, cx + 0, cy, cz - 1, sbb);
    ...
    protected void decoratePaintings(final yc world, final Random rand, final int floorLevel, final acn sbb) {
    ...
    protected void decorateTorches(final yc world, final Random rand, final int floorLevel, final acn sbb) {
    ...
    protected void generateTorchesOnWall(final yc world, final Random rand, final int floorLevel, final int direction, final acn sbb) {
        for (int i = 0; i < 10; ++i) {
            ...
            final aoe torchBox = aoe.a((double)tCoords.a, (double)tCoords.b, (double)tCoords.c, tCoords.a + 1.0, tCoords.b + 2.0, tCoords.c + 1.0);
            if (world.a(tCoords.a, tCoords.b, tCoords.c) == 0 && world.a(tCoords.a, tCoords.b + 1, tCoords.c) == 0 && world.b((lq)null, torchBox).size() == 0) {
                world.b(tCoords.a, tCoords.b, tCoords.c, amq.bc.cm);
                world.b(tCoords.a, tCoords.b + 1, tCoords.c, amq.at.cm);
                world.d(tCoords.a, tCoords.b + 1, tCoords.c, 5);
            }
        }
    }
    
    protected void generatePaintingsOnWall(final yc world, final Random rand, final int howMany, final int floorLevel, final int direction, final int minSize, final acn sbb) {
    ...
    protected boolean checkPainting(final yc world, final mg painting, final acn sbb) {
        if (painting == null) {
            return false;
        }
        aoe largerBox;
    ...
    protected s getRandomWallSpot(final Random rand, final int floorLevel, final int direction, final acn sbb) {
        int minX = this.e.a + 2;
        int maxX = this.e.d - 2;
