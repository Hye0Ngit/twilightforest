...
{
    public ComponentTFTowerMain(final zv world, final Random rand, final int index, final int x, final int y, final int z) {
    ...
    public boolean makeTowerOutbuilding(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        final agq intersect = agq.a(list, outbuilding.b());
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        ...
        for (int x = 0; x < this.size; ++x) {
            for (int z = 0; z < this.size; ++z) {
                this.b(world, aou.A.cz, 0, x, -1, z, sbb);
            }
        }
    ...
    protected void makeStairwayCrossings(final zv world, final Random rand, final aee sbb) {
    ...
    protected void makeStairCrossing(final zv world, final Random rand, final int flight, final aee sbb) {
        ...
        for (int dx = 6; dx <= 8; ++dx) {
            for (int dz = 4; dz <= 10; ++dz) {
                this.a(world, aou.an.cz, floorMeta, dx, floorLevel, dz, sbb);
            }
        }
        ++floorLevel;
        int dx = 6;
        for (int dz = 3; dz <= 11; ++dz) {
            this.a(world, aou.bd.cz, 0, dx, floorLevel, dz, sbb);
        }
        ++dx;
        for (int dz = 3; dz <= 11; ++dz) {
        ...
        this.a(world, aou.an.cz, floorMeta, 6, floorLevel - 1, 11, sbb);
        this.a(world, aou.an.cz, floorMeta, 8, floorLevel - 1, 3, sbb);
        this.a(world, aou.bd.cz, 0, 5, floorLevel, 11, sbb);
        this.a(world, aou.bd.cz, 0, 9, floorLevel, 3, sbb);
        ...
        this.a(world, aou.bd.cz, 0, 6, floorLevel + 1, 7, sbb);
        this.a(world, aou.bd.cz, 0, 8, floorLevel + 1, 7, sbb);
        this.a(world, aou.bd.cz, 0, 6, floorLevel + 2, 7, sbb);
        this.a(world, aou.bd.cz, 0, 8, floorLevel + 2, 7, sbb);
        this.setCoordBaseMode(temp);
    }
    
    protected void makeLichRoom(final zv world, final Random rand, final aee sbb) {
        ...
        this.a(world, TFBlocks.bossSpawner.cz, 1, this.size / 2, floorLevel + 2, this.size / 2, sbb);
    }
    
    protected void makeTowerPaintings(final zv world, final Random rand, final aee sbb) {
    ...
    protected void makeLichFloor(final zv world, final int floorLevel, final int rotation, final aee sbb) {
        final int temp = this.getCoordBaseMode();
        ...
        for (int fx = 1; fx < 14; ++fx) {
            for (int fz = 1; fz < 14; ++fz) {
                if ((fx == 1 || fx == 2) && fz >= 6 && fz <= 12) {
                    if (fz == 6) {
                        this.a(world, aou.bS.cz, 10, fx, floorLevel, fz, sbb);
                    }
                }
                    ...
                    if ((fx == 4 && fz == 4) || (fx == 10 && fz == 10)) {
                        this.a(world, aou.B.cz, 2, fx, floorLevel, fz, sbb);
                    }
                    else {
                        this.a(world, aou.Q.cz, 0, fx, floorLevel, fz, sbb);
                    }
                }
    ...
    protected void decorateLichChandelier(final zv world, final int floorLevel, final aee sbb) {
        final int cx = this.size / 2;
        int cy = floorLevel + 4;
        final int cz = this.size / 2;
        this.a(world, aou.bd.cz, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx + 2, cy, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx + 1, cy, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy, cz + 2, sbb);
        this.a(world, aou.bd.cz, 0, cx - 1, cy, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx - 2, cy, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx - 1, cy, cz - 1, sbb);
        ...
        ++cy;
        this.a(world, aou.bd.cz, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 2, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 1, cy, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, aou.au.cz, 0, cx + 0, cy, cz + 2, sbb);
        this.a(world, aou.au.cz, 0, cx - 1, cy, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx - 2, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx - 1, cy, cz - 1, sbb);
        ...
        this.a(world, aou.au.cz, 0, cx + 1, cy, cz - 1, sbb);
        ++cy;
        this.a(world, aou.au.cz, 0, cx + 1, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 0, cy, cz + 1, sbb);
        this.a(world, aou.au.cz, 0, cx - 1, cy, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 0, cy, cz - 1, sbb);
    ...
    protected void decoratePaintings(final zv world, final Random rand, final int floorLevel, final aee sbb) {
    ...
    protected void decorateTorches(final zv world, final Random rand, final int floorLevel, final aee sbb) {
    ...
    protected void generateTorchesOnWall(final zv world, final Random rand, final int floorLevel, final int direction, final aee sbb) {
        for (int i = 0; i < 10; ++i) {
            ...
            final aqr torchBox = aqr.a((double)tCoords.a, (double)tCoords.b, (double)tCoords.c, tCoords.a + 1.0, tCoords.b + 2.0, tCoords.c + 1.0);
            if (world.a(tCoords.a, tCoords.b, tCoords.c) == 0 && world.a(tCoords.a, tCoords.b + 1, tCoords.c) == 0 && world.b((mp)null, torchBox).size() == 0) {
                world.f(tCoords.a, tCoords.b, tCoords.c, aou.bd.cz, 0, 2);
                world.f(tCoords.a, tCoords.b + 1, tCoords.c, aou.au.cz, 5, 2);
            }
        }
    }
}
