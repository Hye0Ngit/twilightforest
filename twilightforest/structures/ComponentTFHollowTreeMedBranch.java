...
public class ComponentTFHollowTreeMedBranch extends StructureTFComponent
{
    ...
    public void func_74861_a(final StructureComponent structurecomponent, final List list, final Random rand) {
        ...
        if (this.leafy) {
            ...
            list.add(leafBlob2);
            leafBlob2.func_74861_a((StructureComponent)this, list, rand);
        }
    ...
    public boolean func_74875_a(final World world, final Random random, final StructureBoundingBox sbb) {
        final int[] rSrc = { this.src[0] - this.field_74887_e.field_78897_a, this.src[1] - this.field_74887_e.field_78895_b, this.src[2] - this.field_74887_e.field_78896_c };
        final int[] rDest = { this.dest[0] - this.field_74887_e.field_78897_a, this.dest[1] - this.field_74887_e.field_78895_b, this.dest[2] - this.field_74887_e.field_78896_c };
