...
public class ComponentTFHollowTreeMedBranch extends StructureTFComponent
{
    ...
    public void a(final aiq structurecomponent, final List list, final Random rand) {
        ...
        if (this.leafy) {
            ...
            list.add(leafBlob2);
            leafBlob2.a((aiq)this, list, rand);
        }
    ...
    public boolean a(final abv world, final Random random, final age sbb) {
        final int[] rSrc = { this.src[0] - this.f.a, this.src[1] - this.f.b, this.src[2] - this.f.c };
        final int[] rDest = { this.dest[0] - this.f.a, this.dest[1] - this.f.b, this.dest[2] - this.f.c };
        this.drawBresehnam(world, sbb, rSrc[0], rSrc[1], rSrc[2], rDest[0], rDest[1], rDest[2], TFBlocks.log.cF, 0);
        return true;
    }
    
    protected void drawBresehnam(final abv world, final age sbb, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue) {
