...
public class ComponentTFHollowTreeMedBranch extends StructureTFComponent
{
    ...
    protected ComponentTFHollowTreeMedBranch(final int i, final int sx, final int sy, final int sz, final double length, final double angle, final double tilt, final boolean leafy) {
        ...
        this.e = new acg(Math.min(this.src[0], this.dest[0]), Math.min(this.src[1], this.dest[1]), Math.min(this.src[2], this.dest[2]), Math.max(this.src[0], this.dest[0]), Math.max(this.src[1], this.dest[1]), Math.max(this.src[2], this.dest[2]));
    }
    ...
    public void a(final aes structurecomponent, final List list, final Random rand) {
        ...
        if (this.leafy) {
            ...
            list.add(leafBlob2);
            leafBlob2.a((aes)this, list, rand);
        }
    ...
    protected void drawBresehnam(final xv world, final acg sbb, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final int blockValue, final int metaValue) {
