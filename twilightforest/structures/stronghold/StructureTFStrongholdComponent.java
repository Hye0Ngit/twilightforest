            ...
            for (int x = sx; x <= dx; ++x) {
                for (int z = sz; z <= dz; ++z) {
                    ...
                    if (blockID == 0) {
                        ...
                        final StructurePieceBlockSelector strongBlocks = StructureTFComponent.getStrongholdStones();
                        strongBlocks.func_75062_a(rand, x, y, z, wall);
                        this.func_74864_a(world, strongBlocks.func_75063_a(), strongBlocks.func_75064_b(), x, y, z, sbb);
                    }
