...
{
    public StrongholdUpperCorridorComponent(final TemplateManager manager, final CompoundNBT nbt) {
    ...
    public MutableBoundingBox generateBoundingBox(final Direction facing, final int x, final int y, final int z) {
        return MutableBoundingBox.func_175897_a(x, y, z, -2, -1, 0, 5, 5, 9, facing);
    }
