...
public class ComponentTFStrongholdSmallStairs extends StructureTFStrongholdComponent
{
    ...
    public age generateBoundingBox(final int facing, final int x, final int y, final int z) {
        ...
        if (this.enterBottom) {
            return age.a(x, y, z, -4, -1, 0, 9, 14, 9, facing);
        }
        return age.a(x, y, z, -4, -8, 0, 9, 14, 9, facing);
    }
    ...
    public boolean a(final abv world, final Random rand, final age sbb) {
        ...
        this.a(world, sbb, 1, 7, 1, 7, 7, 7, this.deco.platformID, this.deco.platformMeta, 0, 0, false);
        this.a(world, sbb, 2, 7, 2, 6, 7, 6);
        final int rotation = this.enterBottom ? 0 : 2;
        for (int y = 1; y < 8; ++y) {
            for (int x = 3; x < 6; ++x) {
                this.placeBlockRotated(world, 0, 0, x, y + 1, y, rotation, sbb);
        ...
        if (this.hasTreasure) {
            ...
            if (this.chestTrapped) {
                this.placeBlockRotated(world, aqw.ar.cF, 0, 4, 0, 6, rotation, sbb);
            }
            for (int z = 5; z < 8; ++z) {
