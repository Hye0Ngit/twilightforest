...
public class ComponentTFStrongholdSmallStairs extends StructureTFStrongholdComponent
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_74872_a(world, sbb, 1, 7, 1, 7, 7, 7, this.deco.platformID, this.deco.platformMeta, 0, 0, false);
        ...
        if (this.hasTreasure) {
            ...
            if (this.chestTrapped) {
                this.placeBlockRotated(world, Block.field_72091_am.field_71990_ca, 0, 4, 0, 6, rotation, sbb);
            }
            for (int z = 5; z < 8; ++z) {
