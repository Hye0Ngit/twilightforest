...
{
    public StrongholdUpperTIntersectionComponent(final TemplateManager manager, final CompoundNBT nbt) {
        super(StrongholdPieces.TFSUTI, nbt);
    }
    
    public StrongholdUpperTIntersectionComponent(final TFFeature feature, final int i, final Direction facing, final int x, final int y, final int z) {
