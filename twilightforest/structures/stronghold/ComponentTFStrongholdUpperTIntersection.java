...
public class ComponentTFStrongholdUpperTIntersection extends StructureTFStrongholdComponent
{
    ...
    public ComponentTFStrongholdUpperTIntersection(final TFFeature feature, final int i, final EnumFacing facing, final int x, final int y, final int z) {
        super(feature, i, facing, x, y, z);
    }
    
    @Override
    public StructureBoundingBox generateBoundingBox(final EnumFacing facing, final int x, final int y, final int z) {
        return StructureBoundingBox.func_175897_a(x, y, z, -2, -1, 0, 5, 5, 5, facing);
    }
