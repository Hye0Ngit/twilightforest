...
public class TFStrongholdPieces
{
    ...
    public StructureTFStrongholdComponent getNextComponent(final aiq parent, final List list, final Random random, final int index, final int facing, final int x, final int y, final int z) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (final TFStrongholdPieceWeight piece : this.pieceList) {
                ...
                if (counter < 0) {
                    ...
                    if (aiq.a(list, component.b()) == null) {
