...
public class TFStrongholdPieces
{
    ...
    private static StructureTFStrongholdComponent instantiateComponent(final Class<? extends StructureTFComponent> pieceClass, final int index, final int facing, final int x, final int y, final int z) {
        try {
            return (StructureTFStrongholdComponent)pieceClass.getConstructor(Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE).newInstance(index, facing, x, y, z);
        }
