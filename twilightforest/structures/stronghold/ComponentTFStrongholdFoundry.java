...
public class ComponentTFStrongholdFoundry extends StructureTFStrongholdComponent
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_74882_a(world, sbb, 1, 19, 1, 16, 19, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74878_a(world, sbb, 2, 19, 2, 15, 19, 15);
        this.func_74882_a(world, sbb, 1, 12, 1, 16, 12, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74878_a(world, sbb, 2, 12, 2, 15, 12, 15);
        this.func_74882_a(world, sbb, 1, 5, 1, 16, 5, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74878_a(world, sbb, 2, 5, 2, 15, 5, 15);
        this.func_74882_a(world, sbb, 1, 1, 1, 1, 24, 2, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 2, 1, 1, 2, 24, 1, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 16, 1, 1, 16, 24, 2, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 15, 1, 1, 15, 24, 1, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 1, 1, 15, 1, 24, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 2, 1, 16, 2, 24, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 16, 1, 15, 16, 24, 16, false, rand, StructureTFComponent.getStrongholdStones());
        this.func_74882_a(world, sbb, 15, 1, 16, 15, 24, 16, false, rand, StructureTFComponent.getStrongholdStones());
