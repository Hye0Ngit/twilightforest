...
public class ComponentTFTowerRoofGableForwards extends ComponentTFTowerRoof
{
    ...
    public boolean a(final abv world, final Random rand, final age sbb) {
        ...
        this.a(world, aqw.bT.cF, slabMeta | 0xA, this.size - 1, top - 1, zMid, sbb);
        this.a(world, aqw.bT.cF, slabMeta, 0, top, zMid, sbb);
        this.a(world, aqw.bT.cF, slabMeta, this.size - 3, top, zMid, sbb);
        this.a(world, aqw.C.cF, slabMeta, this.size - 2, top, zMid, sbb);
        this.a(world, aqw.C.cF, slabMeta, this.size - 1, top, zMid, sbb);
        this.a(world, aqw.C.cF, slabMeta, this.size - 1, top + 1, zMid, sbb);
        return true;
    }
