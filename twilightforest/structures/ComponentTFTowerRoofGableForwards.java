...
public class ComponentTFTowerRoofGableForwards extends ComponentTFTowerRoof
{
    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        ...
        this.a(world, amj.bR.cm, slabMeta | 0xA, this.size - 1, top - 1, zMid, sbb);
        this.a(world, amj.bR.cm, slabMeta, 0, top, zMid, sbb);
        this.a(world, amj.bR.cm, slabMeta, this.size - 3, top, zMid, sbb);
        this.a(world, amj.A.cm, slabMeta, this.size - 2, top, zMid, sbb);
        this.a(world, amj.A.cm, slabMeta, this.size - 1, top, zMid, sbb);
        this.a(world, amj.A.cm, slabMeta, this.size - 1, top + 1, zMid, sbb);
        return true;
    }
