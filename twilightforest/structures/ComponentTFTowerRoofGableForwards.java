...
public class ComponentTFTowerRoofGableForwards extends ComponentTFTowerRoof
{
    ...
    public boolean a(final yc world, final Random rand, final acn sbb) {
        ...
        this.a(world, amq.bR.cm, slabMeta | 0xA, this.size - 1, top - 1, zMid, sbb);
        this.a(world, amq.bR.cm, slabMeta, 0, top, zMid, sbb);
        this.a(world, amq.bR.cm, slabMeta, this.size - 3, top, zMid, sbb);
        this.a(world, amq.A.cm, slabMeta, this.size - 2, top, zMid, sbb);
        this.a(world, amq.A.cm, slabMeta, this.size - 1, top, zMid, sbb);
        this.a(world, amq.A.cm, slabMeta, this.size - 1, top + 1, zMid, sbb);
        return true;
    }
