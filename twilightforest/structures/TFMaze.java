...
public class TFMaze
{
    ...
    public TFMaze(final int cellsWidth, final int cellsDepth) {
        ...
        this.head = 0;
        this.roots = 0;
        this.wallBlockID = TFBlocks.mazestone.cm;
        this.wallBlockMeta = 2;
        this.rootBlockID = TFBlocks.mazestone.cm;
        this.rootBlockMeta = 0;
        this.torchBlockID = amq.at.cm;
    ...
    public void copyToWorld(final yc world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final yc world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    public void copyToStructure(final yc world, final Random rand, final int dx, final int dy, final int dz, final StructureTFComponent component, final acn sbb) {
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    ...
                    if (!this.isEven(x) && this.isEven(z)) {
                        for (int even = 0; even < this.evenBias; ++even) {
                            for (int odd = 1; odd <= this.oddBias; ++odd) {
                                ...
                                for (int y = 0; y < this.tall; ++y) {
                                    this.putWallBlock(world, mdx + odd, dy + y, mdz + even, component, sbb);
                                }
                                for (int y = 1; y <= this.roots; ++y) {
    ...
    protected void putPillarBlock(final yc world, final int x, final int y, final int z, final StructureTFComponent component, final acn sbb) {
        component.a(world, this.pillarBlockID, this.pillarBlockMeta, x, y, z, sbb);
    }
    
    protected void putWallBlock(final yc world, final int x, final int y, final int z) {
        world.d(x, y, z, this.wallBlockID, this.wallBlockMeta);
    }
    
    protected void putWallBlock(final yc world, final int x, final int y, final int z, final StructureTFComponent component, final acn sbb) {
    ...
    protected void carveBlock(final yc world, final int x, final int y, final int z) {
        world.d(x, y, z, 0, 0);
    }
    
    protected void putHeadBlock(final yc world, final int x, final int y, final int z) {
        world.d(x, y, z, this.headBlockID, this.headBlockMeta);
    }
    
    protected void putHeadBlock(final yc world, final int x, final int y, final int z, final StructureTFComponent component, final acn sbb) {
        component.a(world, this.headBlockID, this.headBlockMeta, x, y, z, sbb);
    }
    
    protected void putRootBlock(final yc world, final int x, final int y, final int z) {
        world.d(x, y, z, this.rootBlockID, this.rootBlockMeta);
    }
    
    protected void putRootBlock(final yc world, final int x, final int y, final int z, final StructureTFComponent component, final acn sbb) {
        component.a(world, this.rootBlockID, this.rootBlockMeta, x, y, z, sbb);
    }
    
    protected void putCanopyTree(final yc world, final int x, final int y, final int z, final StructureTFComponent component, final acn sbb) {
    ...
    public void placeTorches(final yc world) {
