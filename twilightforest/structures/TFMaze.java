...
public class TFMaze
{
    ...
    public void copyToWorld(final xv world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final xv world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    public void copyToStructure(final xv world, final Random rand, final int dx, final int dy, final int dz, final StructureTFComponent component, final acg sbb) {
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
    ...
    protected void putPillarBlock(final xv world, final int x, final int y, final int z, final StructureTFComponent component, final acg sbb) {
        component.a(world, this.pillarBlockID, this.pillarBlockMeta, x, y, z, sbb);
    }
    
    protected void putWallBlock(final xv world, final int x, final int y, final int z) {
        world.d(x, y, z, this.wallBlockID, this.wallBlockMeta);
    }
    
    protected void putWallBlock(final xv world, final int x, final int y, final int z, final StructureTFComponent component, final acg sbb) {
    ...
    protected void carveBlock(final xv world, final int x, final int y, final int z) {
        world.d(x, y, z, 0, 0);
    }
    
    protected void putHeadBlock(final xv world, final int x, final int y, final int z) {
        world.d(x, y, z, this.headBlockID, this.headBlockMeta);
    }
    
    protected void putHeadBlock(final xv world, final int x, final int y, final int z, final StructureTFComponent component, final acg sbb) {
        component.a(world, this.headBlockID, this.headBlockMeta, x, y, z, sbb);
    }
    
    protected void putRootBlock(final xv world, final int x, final int y, final int z) {
        world.d(x, y, z, this.rootBlockID, this.rootBlockMeta);
    }
    
    protected void putRootBlock(final xv world, final int x, final int y, final int z, final StructureTFComponent component, final acg sbb) {
        component.a(world, this.rootBlockID, this.rootBlockMeta, x, y, z, sbb);
    }
    
    protected void putCanopyTree(final xv world, final int x, final int y, final int z, final StructureTFComponent component, final acg sbb) {
    ...
    public void placeTorches(final xv world) {
