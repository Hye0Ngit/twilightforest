...
public class TFMaze
{
        ...
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    ...
                    if (this.isEven(x) && this.isEven(z) && this.shouldTorch(x, z) && component.func_151548_a(world, mdx, mdy, mdz2, sbb) == this.wallBlockID) {
                        component.func_151550_a(world, this.torchBlockID, this.torchBlockMeta, mdx, mdy, mdz2, sbb);
                    }
                }
            }
        }
    ...
    public boolean shouldPillar(final int rx, final int rz) {
        return this.pillarBlockID != null && this.getRaw(rx + 1, rz) != Integer.MIN_VALUE && this.getRaw(rx - 1, rz) != Integer.MIN_VALUE && this.getRaw(rx, rz + 1) != Integer.MIN_VALUE && this.getRaw(rx, rz - 1) != Integer.MIN_VALUE && (this.getRaw(rx + 1, rz) != 0 || this.getRaw(rx - 1, rz) != 0) && (this.getRaw(rx, rz + 1) != 0 || this.getRaw(rx, rz - 1) != 0);
    }
