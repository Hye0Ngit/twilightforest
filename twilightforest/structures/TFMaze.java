...
public class TFMaze
{
    ...
    public TFMaze(final int cellsWidth, final int cellsDepth) {
        ...
        this.head = 0;
        this.roots = 0;
        this.wallBlockID = TFBlocks.mazestone.cz;
        this.wallBlockMeta = 2;
        this.rootBlockID = TFBlocks.mazestone.cz;
        this.rootBlockMeta = 0;
        this.torchBlockID = aou.au.cz;
    ...
    public void copyToWorld(final zv world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final zv world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    public void copyToStructure(final zv world, final int dx, final int dy, final int dz, final StructureTFComponent component, final aee sbb) {
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
    ...
    protected void makeWallThing(final zv world, final int dy, final StructureTFComponent component, final aee sbb, final int mdx, final int mdz, final int even, final int odd) {
        for (int y = 0; y < this.head; ++y) {
            this.putHeadBlock(world, mdx + even, dy + this.tall + y, mdz + odd, component, sbb);
        }
        for (int y = 0; y < this.tall; ++y) {
    ...
    protected void putPillarBlock(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
        component.a(world, this.pillarBlockID, this.pillarBlockMeta, x, y, z, sbb);
    }
    
    protected void putWallBlock(final zv world, final int x, final int y, final int z) {
        world.f(x, y, z, this.wallBlockID, this.wallBlockMeta, 2);
    }
    
    protected void putWallBlock(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
    ...
    protected void putDoorBlock(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
        component.a(world, this.doorBlockID, this.doorBlockMeta, x, y, z, sbb);
    }
    
    protected void carveBlock(final zv world, final int x, final int y, final int z) {
        world.f(x, y, z, 0, 0, 2);
    }
    
    protected void putHeadBlock(final zv world, final int x, final int y, final int z) {
        world.f(x, y, z, this.headBlockID, this.headBlockMeta, 2);
    }
    
    protected void putHeadBlock(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
        component.a(world, this.headBlockID, this.headBlockMeta, x, y, z, sbb);
    }
    
    protected void putRootBlock(final zv world, final int x, final int y, final int z) {
        world.f(x, y, z, this.rootBlockID, this.rootBlockMeta, 2);
    }
    
    protected void putRootBlock(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
        component.a(world, this.rootBlockID, this.rootBlockMeta, x, y, z, sbb);
    }
    
    protected void putCanopyTree(final zv world, final int x, final int y, final int z, final StructureTFComponent component, final aee sbb) {
    ...
    public void placeTorches(final zv world) {
