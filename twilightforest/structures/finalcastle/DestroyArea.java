...
public class DestroyArea
{
    ...
    public DestroyArea(final MutableBoundingBox tower, final Random rand, final int y) {
    ...
    public boolean isVecInside(final BlockPos pos) {
        return this.destroyBox.func_175898_b((Vector3i)pos);
    }
    
    public static DestroyArea createNonIntersecting(final MutableBoundingBox tower, final Random rand, final int y, final ArrayList<DestroyArea> otherAreas) {
