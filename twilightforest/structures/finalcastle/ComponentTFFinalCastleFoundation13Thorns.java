...
public class ComponentTFFinalCastleFoundation13Thorns extends ComponentTFFinalCastleFoundation13
{
    ...
    public ComponentTFFinalCastleFoundation13Thorns(final TFFeature feature, final Random rand, final int i, final StructureTFComponentOld sideTower) {
    ...
    private void makeThornVine(final World world, final Random decoRNG, final Rotation rotation, final StructureBoundingBox sbb) {
        ...
        final IBlockState thorns = TFBlocks.thorns.func_176223_P();
        while (this.getBlockStateFromPosRotated(world, x, y, z, sbb, rotation).func_177230_c() != TFBlocks.deadrock && this.func_74862_a(y) > 60) {
    ...
    private void makeThornBranch(final World world, final int x, final int y, final int z, final Rotation rotation, final StructureBoundingBox sbb) {
        ...
        if (destX > 0 && destX < this.field_74887_e.func_78883_b() && destZ > 0 && destZ < this.field_74887_e.func_78880_d()) {
            for (int i = 0; i < dist; ++i) {
                ...
                final IBlockState thorns = TFBlocks.thorns.func_176223_P().func_177226_a((IProperty)BlockTFThorns.VARIANT, (Comparable)ThornVariant.GREEN).func_177226_a((IProperty)BlockTFThorns.field_176298_M, (Comparable)((add == Rotation.NONE || add == Rotation.CLOCKWISE_180) ? EnumFacing.Axis.X : EnumFacing.Axis.Z));
                if (i > 0) {
                    this.setBlockStateRotated(world, thorns, x + dx * i, y, z + dz * i, rotation, sbb);
                }
                this.setBlockStateRotated(world, thorns.func_177226_a((IProperty)BlockTFThorns.field_176298_M, (Comparable)EnumFacing.Axis.Y), destX, y + i, destZ, rotation, sbb);
                if (i > dist / 2) {
