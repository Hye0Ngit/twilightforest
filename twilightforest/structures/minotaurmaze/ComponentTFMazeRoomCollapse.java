    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        for (int x = 1; x < 14; ++x) {
            for (int z = 1; z < 14; ++z) {
                ...
                if (gravel > 0) {
                    ++gravel;
                    this.func_74884_a(world, sbb, x, 1, z, x, gravel, z, Block.field_71940_F.field_71990_ca, 0, false);
                    this.func_74878_a(world, sbb, x, gravel, z, x, gravel + 5, z);
                }
                else if (root > 0) {
                    this.func_74884_a(world, sbb, x, 5, z, x, 5 + root, z, Block.field_71979_v.field_71990_ca, 0, true);
                    this.func_74872_a(world, sbb, x, 5 - rand.nextInt(5), z, x, 5, z, TFBlocks.plant.field_71990_ca, 14, 0, 0, false);
                }
