...
public class ComponentTFMazeRoomVault extends ComponentTFMazeRoom
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_151556_a(world, sbb, 6, 4, 5, 9, 4, 5, (Block)Blocks.field_150354_m, 0, Blocks.field_150350_a, 0, false);
        this.func_151556_a(world, sbb, 6, 4, 10, 9, 4, 10, (Block)Blocks.field_150354_m, 0, Blocks.field_150350_a, 0, false);
        this.func_151556_a(world, sbb, 5, 4, 6, 5, 4, 9, (Block)Blocks.field_150354_m, 0, Blocks.field_150350_a, 0, false);
        this.func_151556_a(world, sbb, 10, 4, 6, 10, 4, 9, (Block)Blocks.field_150354_m, 0, Blocks.field_150350_a, 0, false);
        ...
        this.func_151550_a(world, (Block)Blocks.field_150486_ae, 0, 7, 2, 6, sbb);
        this.placeTreasureAtCurrentPosition(world, rand, 8, 2, 6, TFTreasure.labyrinth_vault, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150486_ae, 0, 8, 2, 9, sbb);
        this.placeTreasureAtCurrentPosition(world, rand, 7, 2, 9, TFTreasure.labyrinth_vault, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150486_ae, 0, 6, 2, 7, sbb);
        this.placeTreasureAtCurrentPosition(world, rand, 6, 2, 8, TFTreasure.labyrinth_vault, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150486_ae, 0, 9, 2, 8, sbb);
