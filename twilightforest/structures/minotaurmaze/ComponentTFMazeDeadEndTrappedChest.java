...
public class ComponentTFMazeDeadEndTrappedChest extends ComponentTFMazeDeadEnd
{
    ...
    public ComponentTFMazeDeadEndTrappedChest(final TFFeature feature, final int i, final int x, final int y, final int z, final EnumFacing rotation) {
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_175811_a(world, Blocks.field_150447_bR.func_176223_P(), 2, 2, 4, sbb);
        this.placeTreasureAtCurrentPosition(world, rand, 3, 2, 4, TFTreasure.labyrinth_deadend, true, sbb);
        this.func_175804_a(world, sbb, 1, 1, 0, 4, 3, 1, TFBlocks.maze_stone.func_176223_P().func_177226_a((IProperty)BlockTFMazestone.VARIANT, (Comparable)MazestoneVariant.CHISELED), ComponentTFMazeDeadEndTrappedChest.AIR, false);
        this.func_175804_a(world, sbb, 1, 4, 0, 4, 4, 1, TFBlocks.maze_stone.func_176223_P().func_177226_a((IProperty)BlockTFMazestone.VARIANT, (Comparable)MazestoneVariant.DECORATIVE), ComponentTFMazeDeadEndTrappedChest.AIR, false);
        this.func_175804_a(world, sbb, 2, 1, 0, 3, 3, 1, Blocks.field_150411_aY.func_176223_P(), ComponentTFMazeDeadEndTrappedChest.AIR, false);
