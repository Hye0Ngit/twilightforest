...
public abstract class ComponentTFTowerRoof extends StructureTFComponent
{
    ...
    protected void makeAttachedOverhangBB(final ComponentTFTowerWing wing) {
        switch (this.getCoordBaseMode()) {
            case 0: {
                this.e = new aee(wing.b().a, wing.b().e, wing.b().c - 1, wing.b().d + 1, wing.b().e + this.height - 1, wing.b().f + 1);
                break;
            }
            case 1: {
                this.e = new aee(wing.b().a - 1, wing.b().e, wing.b().c, wing.b().d + 1, wing.b().e + this.height - 1, wing.b().f + 1);
                break;
            }
            case 2: {
                this.e = new aee(wing.b().a - 1, wing.b().e, wing.b().c - 1, wing.b().d, wing.b().e + this.height - 1, wing.b().f + 1);
                break;
            }
            case 3: {
                this.e = new aee(wing.b().a - 1, wing.b().e, wing.b().c - 1, wing.b().d + 1, wing.b().e + this.height - 1, wing.b().f);
                break;
            }
        }
    }
    ...
    protected void makeCapBB(final ComponentTFTowerWing wing) {
        this.e = new aee(wing.b().a, wing.b().e, wing.b().c, wing.b().d, wing.b().e + this.height, wing.b().f);
    }
    ...
    public boolean a(final zv world, final Random random, final aee structureboundingbox) {
        return false;
    }
