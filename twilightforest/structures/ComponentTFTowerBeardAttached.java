...
public class ComponentTFTowerBeardAttached extends ComponentTFTowerBeard
{
    public ComponentTFTowerBeardAttached(final int i, final ComponentTFTowerWing wing) {
        super(i, wing);
        this.e = new acg(wing.b().a, wing.b().b - this.height - 1, wing.b().c, wing.b().d, wing.b().b - 1, wing.b().f);
    }
    ...
    private boolean makeAttachedBeard(final xv world, final Random rand, final acg sbb) {
