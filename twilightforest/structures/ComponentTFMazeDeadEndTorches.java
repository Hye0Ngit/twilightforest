...
public class ComponentTFMazeDeadEndTorches extends ComponentTFMazeDeadEnd
{
    ...
    public boolean a(final yc world, final Random rand, final acn sbb) {
        ...
        this.a(world, sbb, 2, 1, 4, 3, 4, 4, amq.at.cm, 0, 0, 0, false);
        this.a(world, sbb, 1, 1, 1, 1, 4, 4, amq.at.cm, 0, 0, 0, false);
        this.a(world, sbb, 4, 1, 1, 4, 4, 4, amq.at.cm, 0, 0, 0, false);
        return true;
    }
}
