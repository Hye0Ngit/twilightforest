...
public class ComponentTFHollowTreeRoot extends ComponentTFHollowTreeMedBranch
{
    ...
    protected void drawRootLine(final World world, final StructureBoundingBox sbb, final int x1, final int y1, final int z1, final int x2, final int y2, final int z2, final Block blockValue, final int metaValue) {
        ...
        for (final ChunkCoordinates coords : bresehnamArrayCoords) {
            final Block block = this.func_151548_a(world, coords.field_71574_a, coords.field_71572_b, coords.field_71573_c, sbb);
            if (!block.isNormalCube((IBlockAccess)world, coords.field_71574_a, coords.field_71572_b, coords.field_71573_c) || (block != null && block.func_149688_o() == Material.field_151577_b)) {
                this.func_151550_a(world, TFBlocks.log, 12, coords.field_71574_a, coords.field_71572_b, coords.field_71573_c, sbb);
            }
            else if (block == null || block.func_149688_o() != Material.field_151575_d) {
