...
public class ComponentTFHollowTreeLeafDungeon extends StructureTFComponent
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        this.drawBlockBlob(world, sbb, this.radius, this.radius, this.radius, 4, TFBlocks.leaves.field_71990_ca, 0, true);
        this.drawBlockBlob(world, sbb, this.radius, this.radius, this.radius, 3, TFBlocks.log.field_71990_ca, 12, false);
        this.drawBlockBlob(world, sbb, this.radius, this.radius, this.radius, 2, 0, 0, false);
    ...
    private void drawBlockBlob(final World world, final StructureBoundingBox sbb, final int sx, final int sy, final int sz, final int blobRadius, final int blockID, final int metadata, final boolean isLeaves) {
                ...
                for (byte dz = 0; dz <= blobRadius; ++dz) {
                    ...
                    if (dist <= blobRadius) {
                        if (isLeaves) {
                            ...
                            this.func_74864_a(world, blockID, metadata, sx + dx, sy + dy, sz + dz, sbb);
                            this.func_74864_a(world, blockID, metadata, sx + dx, sy + dy, sz - dz, sbb);
                            this.func_74864_a(world, blockID, metadata, sx - dx, sy + dy, sz + dz, sbb);
                            this.func_74864_a(world, blockID, metadata, sx - dx, sy + dy, sz - dz, sbb);
                            this.func_74864_a(world, blockID, metadata, sx + dx, sy - dy, sz + dz, sbb);
