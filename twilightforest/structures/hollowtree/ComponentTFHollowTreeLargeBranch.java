...
public class ComponentTFHollowTreeLargeBranch extends ComponentTFHollowTreeMedBranch
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        for (int reinforcements = 4, i = 0; i <= reinforcements; ++i) {
            ...
            this.drawBresehnam(world, sbb, rsrc.field_71574_a + vx, rsrc.field_71572_b + vy, rsrc.field_71573_c + vz, rdest.field_71574_a, rdest.field_71572_b, rdest.field_71573_c, TFBlocks.log, 12);
        }
