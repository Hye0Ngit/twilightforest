...
public class ComponentTFNagaCourtyard extends StructureTFComponent
{
    ...
    public ComponentTFNagaCourtyard(final xv world, final Random rand, final int i, final int x, final int y, final int z) {
        super(i);
    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        for (int fx = 0; fx <= ComponentTFNagaCourtyard.DIAMETER; ++fx) {
            for (int fz = 0; fz <= ComponentTFNagaCourtyard.DIAMETER; ++fz) {
                if (rand.nextInt(3) == 0) {
                    this.a(world, amj.am.cm, 0, fx, 0, fz, sbb);
                    if (rand.nextInt(20) == 0) {
                        this.a(world, amj.an.cm, 0, fx, 1, fz, sbb);
                    }
                    else {
                    ...
                    this.a(world, amj.x.cm, 0, fx, 0, fz, sbb);
                }
            }
        }
        for (int fx = 0; fx <= ComponentTFNagaCourtyard.DIAMETER; ++fx) {
            ...
            this.a(world, amj.an.cm, 5, fx, 4, ComponentTFNagaCourtyard.DIAMETER, sbb);
            this.a(world, amj.an.cm, 5, fx, 4, 0, sbb);
            switch (fx % 23) {
                case 2: {
        ...
        for (int fz2 = 0; fz2 <= ComponentTFNagaCourtyard.DIAMETER; ++fz2) {
            ...
            this.a(world, amj.an.cm, 5, ComponentTFNagaCourtyard.DIAMETER, 4, fz2, sbb);
            this.a(world, amj.an.cm, 5, 0, 4, fz2, sbb);
            switch (fz2 % 23) {
                case 2: {
    ...
    public boolean makePillar(final xv world, final Random rand, final int x, final int y, final int z, final acg sbb) {
        final int height = 8;
        this.a(world, amj.an.cm, 0, x - 1, y + 0, z - 1, sbb);
        this.a(world, amj.an.cm, 0, x + 0, y + 0, z - 1, sbb);
        this.a(world, amj.an.cm, 0, x + 1, y + 0, z - 1, sbb);
        this.a(world, amj.an.cm, 0, x - 1, y + 0, z + 0, sbb);
        this.a(world, amj.an.cm, 0, x + 1, y + 0, z + 0, sbb);
        this.a(world, amj.an.cm, 0, x - 1, y + 0, z + 1, sbb);
        this.a(world, amj.an.cm, 0, x + 0, y + 0, z + 1, sbb);
        this.a(world, amj.an.cm, 0, x + 1, y + 0, z + 1, sbb);
        for (int i = 0; i < height; ++i) {
            ...
            if (i > 0 && rand.nextInt(2) == 0) {
                switch (rand.nextInt(4)) {
                    case 0: {
                        this.a(world, amj.bx.cm, 8, x - 1, y + i, z + 0, sbb);
                        break;
                    }
                    case 1: {
                        this.a(world, amj.bx.cm, 2, x + 1, y + i, z + 0, sbb);
                        break;
                    }
                    case 2: {
                        this.a(world, amj.bx.cm, 4, x + 0, y + i, z + 1, sbb);
                        break;
                    }
                    case 3: {
                        this.a(world, amj.bx.cm, 1, x + 0, y + i, z - 1, sbb);
                        break;
                    }
                }
            }
        ...
        if (height == 8) {
            this.a(world, amj.an.cm, 0, x - 1, y + 8, z - 1, sbb);
            this.a(world, amj.an.cm, 0, x + 0, y + 8, z - 1, sbb);
            this.a(world, amj.an.cm, 0, x + 1, y + 8, z - 1, sbb);
            this.a(world, amj.an.cm, 0, x - 1, y + 8, z + 0, sbb);
            this.a(world, amj.an.cm, 5, x + 0, y + 8, z + 0, sbb);
            this.a(world, amj.an.cm, 0, x + 1, y + 8, z + 0, sbb);
            this.a(world, amj.an.cm, 0, x - 1, y + 8, z + 1, sbb);
            this.a(world, amj.an.cm, 0, x + 0, y + 8, z + 1, sbb);
            this.a(world, amj.an.cm, 0, x + 1, y + 8, z + 1, sbb);
    ...
    public void randomBrick(final xv world, final Random rand, final int x, final int y, final int z, final acg sbb) {
        this.a(world, amj.bp.cm, rand.nextInt(3), x, y, z, sbb);
    }
