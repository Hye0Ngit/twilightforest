...
public class ComponentTFHillMaze extends StructureTFComponent
{
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        ...
        this.a(world, sbb, 0, 0, 0, this.getDiameter(), 0, this.getDiameter(), TFBlocks.mazestone.cz, 0, false);
        this.a(world, sbb, 0, 4, 0, this.getDiameter(), 4, this.getDiameter(), TFBlocks.mazestone.cz, 0, true);
        final TFMaze maze = new TFMaze(this.getMazeSize(), this.getMazeSize());
        maze.wallBlockID = TFBlocks.mazestone.cz;
