...
public class ComponentTFMushroomTowerMain extends ComponentTFMushroomTowerWing
{
    ...
    protected void makeDoorOpening(final World world, final int dx, final int dy, final int dz, final StructureBoundingBox sbb) {
        ...
        if (dx == 0) {
            this.func_74864_a(world, 0, 0, dx + 1, dy + 0, dz, sbb);
            this.func_74864_a(world, 0, 0, dx + 1, dy + 1, dz, sbb);
        }
        if (dx == this.size - 1) {
            this.func_74864_a(world, 0, 0, dx - 1, dy + 0, dz, sbb);
            this.func_74864_a(world, 0, 0, dx - 1, dy + 1, dz, sbb);
        ...
        if (dz == 0) {
            this.func_74864_a(world, 0, 0, dx, dy + 0, dz + 1, sbb);
            this.func_74864_a(world, 0, 0, dx, dy + 1, dz + 1, sbb);
        }
        if (dz == this.size - 1) {
            this.func_74864_a(world, 0, 0, dx, dy + 0, dz - 1, sbb);
            this.func_74864_a(world, 0, 0, dx, dy + 1, dz - 1, sbb);
