...
public class ComponentTFMushroomTowerBridge extends ComponentTFMushroomTowerWing
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        for (int x = 0; x < this.dSize; ++x) {
            this.func_74864_a(world, this.deco.fenceID, this.deco.fenceMeta, x, 1, 0, sbb);
            this.func_74864_a(world, this.deco.fenceID, this.deco.fenceMeta, x, 1, 2, sbb);
            this.func_74864_a(world, this.deco.floorID, this.isAscender ? 3 : this.deco.floorMeta, x, 0, 1, sbb);
        }
