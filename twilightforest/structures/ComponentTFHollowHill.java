...
public class ComponentTFHollowHill extends StructureTFComponent
{
    ...
    public ComponentTFHollowHill(final yc world, final Random rand, final int i, final int size, final int x, final int y, final int z) {
        super(i);
    ...
    protected void generateTreasureChest(final yc world, final int x, final int y, final int z, final acn sbb) {
        ...
        this.b(world, amq.z.cm, 0, x, y - 1, z, sbb);
    }
    
    protected void generateOreStalactite(final yc world, final int x, final int y, final int z, final acn sbb) {
    ...
    protected void generateStoneStalactite(final yc world, double length, final boolean up, final int x, final int y, final int z, final acn sbb) {
        final int dx = this.a(x, z);
        final int dy = this.a(y);
        final int dz = this.b(x, z);
        if (sbb.b(dx, dy, dz) && world.a(dx, dy, dz) != amq.av.cm) {
            ...
            new TFGenCaveStalactite(amq.w.cm, stalRNG.nextDouble() * length, up).a(world, stalRNG, dx, dy, dz);
        }
    }
