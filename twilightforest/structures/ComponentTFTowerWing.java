...
public class ComponentTFTowerWing extends StructureTFComponent
{
    ...
    public boolean makeTowerWing(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        final agq intersect = agq.a(list, wing.e);
    ...
    protected boolean makeBridge(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, int wingHeight, final int rotation) {
        ...
        agq intersect = agq.a(list, bridge.e);
        if (intersect != null && intersect != this) {
            return false;
        }
        intersect = agq.a(list, bridge.getWingBB());
        if (intersect == null || intersect == this) {
            list.add(bridge);
    ...
    protected void makeOpeningMarkers(final zv world, final Random rand, final int numMarkers, final aee sbb) {
        if (this.size > 4) {
            for (int i = 0; i < numMarkers; ++i) {
                final int[] spot = this.getValidOpening(rand, 0);
                this.a(world, aou.af.cz, 0, spot[0], spot[1], spot[2], sbb);
            }
            for (int i = 0; i < numMarkers; ++i) {
                final int[] spot = this.getValidOpening(rand, 1);
                this.a(world, aou.af.cz, 1, spot[0], spot[1], spot[2], sbb);
            }
            for (int i = 0; i < numMarkers; ++i) {
                final int[] spot = this.getValidOpening(rand, 2);
                this.a(world, aou.af.cz, 2, spot[0], spot[1], spot[2], sbb);
            }
            for (int i = 0; i < numMarkers; ++i) {
                final int[] spot = this.getValidOpening(rand, 3);
                this.a(world, aou.af.cz, 3, spot[0], spot[1], spot[2], sbb);
            }
        }
    }
    
    protected void decorateThisTower(final zv world, final Random rand, final aee sbb) {
        final Random decoRNG = new Random(world.F() + this.e.a * 321534781 * (this.e.c * 756839));
        if (this.size > 3) {
            if (this.isDeadEnd()) {
    ...
    protected void decorateDeadEnd(final zv world, final Random rand, final aee sbb) {
        final int floors = (this.height - 1) / 5;
        final int floorHeight = this.height / floors;
        for (int i = 1; i < floors; ++i) {
            for (int x = 1; x < this.size - 1; ++x) {
                for (int z = 1; z < this.size - 1; ++z) {
                    this.a(world, aou.B.cz, 2, x, i * floorHeight, z, sbb);
                }
            }
        }
        if (floors > 1) {
    ...
    protected void decorateFloor(final zv world, final Random rand, final int floor, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        if (ladderUpDir > -1) {
            ...
            for (int dy = bottom; dy < top; ++dy) {
                this.a(world, aou.aJ.cz, meta, dx, dy, dz, sbb);
            }
        }
        if (ladderDownDir > -1) {
    ...
    protected void decorateWell(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        final int cz;
        final int cx = cz = this.size / 2;
        final int cy = bottom;
        final int waterOrLava = (rand.nextInt(4) == 0) ? aou.H.cz : aou.F.cz;
        if (this.size > 5) {
            this.a(world, aou.bq.cz, 0, cx - 1, cy + 0, cz - 1, sbb);
            this.a(world, aou.ao.cz, 5, cx - 1, cy + 1, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 0, cy + 0, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 1, cy + 0, cz - 1, sbb);
            this.a(world, aou.ao.cz, 5, cx + 1, cy + 1, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx - 1, cy + 0, cz + 0, sbb);
    ...
    protected void decorateSkeletonRoom(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        ...
        for (int i = 0; i < this.size + 2; ++i) {
            ...
            if (!this.chainCollides(chain, chainList)) {
                for (int dy = bottom; dy < top; ++dy) {
                    this.a(world, aou.bt.cz, 0, chain.a, dy, chain.c, sbb);
                }
                chainList.add(chain);
            }
        }
        for (int dx = 1; dx <= this.size - 2; ++dx) {
            for (int dz = 1; dz <= this.size - 2; ++dz) {
                if ((dx == 1 || dx == this.size - 2 || dz == 1 || dz == this.size - 2) && !this.isWindowPos(dx, dz) && !this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir)) {
                    this.a(world, aou.aa.cz, 0, dx, top - 1, dz, sbb);
                }
            }
        }
    }
    
    protected void decorateZombieRoom(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        ...
        for (int dx = 1; dx <= this.size - 2; ++dx) {
            for (int dz = 1; dz <= this.size - 2; ++dz) {
                if (!this.isWindowPos(dx, dz) && !this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir) && rand.nextInt(5) == 0) {
                    this.a(world, aou.aj.cz, 0, dx, bottom, dz, sbb);
                }
            }
        }
        ...
        for (int i = 0; i < this.size - 1; ++i) {
            ...
            if (!this.chainCollides(slab, slabList)) {
                this.a(world, aou.bt.cz, 0, slab.a, bottom + 0, slab.c, sbb);
                this.a(world, aou.bS.cz, 2, slab.a, bottom + 1, slab.c, sbb);
                this.a(world, aou.bg.cz, 0, slab.a, bottom + 2, slab.c, sbb);
                slabList.add(slab);
            }
        }
    }
    
    protected void decorateCactusRoom(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dx = 1; dx <= this.size - 2; ++dx) {
            for (int dz = 1; dz <= this.size - 2; ++dz) {
                this.a(world, aou.I.cz, 0, dx, bottom - 1, dz, sbb);
                if (!this.isWindowPos(dx, dz) && !this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir) && rand.nextInt(4) == 0) {
                    this.a(world, aou.ac.cz, 0, dx, bottom, dz, sbb);
                }
            }
        }
        ...
        for (int i = 0; i < this.size + 12; ++i) {
            ...
            if (!this.chainCollides(cactus, cactusList)) {
                for (int dy = bottom; dy < top; ++dy) {
                    this.a(world, aou.aZ.cz, 0, cactus.a, dy, cactus.c, sbb);
                }
    ...
    protected void decorateTreasureChest(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        final int cz;
        final int cx = cz = this.size / 2;
        this.a(world, aou.bB.cz, this.getStairMeta(1), cx + 0, bottom, cz - 1, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(0), cx - 1, bottom, cz + 0, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(2), cx + 1, bottom, cz + 0, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(3), cx + 0, bottom, cz + 1, sbb);
        this.a(world, aou.bq.cz, 0, cx + 0, bottom, cz + 0, sbb);
        if (this.size > 5) {
            this.a(world, aou.bq.cz, 0, cx - 1, bottom, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 1, bottom, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx - 1, bottom, cz + 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 1, bottom, cz + 1, sbb);
        }
        this.a(world, aou.bB.cz, this.getStairMeta(1) + 4, cx + 0, top - 1, cz - 1, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(0) + 4, cx - 1, top - 1, cz + 0, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(2) + 4, cx + 1, top - 1, cz + 0, sbb);
        this.a(world, aou.bB.cz, this.getStairMeta(3) + 4, cx + 0, top - 1, cz + 1, sbb);
        this.a(world, aou.bq.cz, 0, cx + 0, top - 1, cz + 0, sbb);
        if (this.size > 5) {
            this.a(world, aou.bq.cz, 0, cx - 1, top - 1, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 1, top - 1, cz - 1, sbb);
            this.a(world, aou.bq.cz, 0, cx - 1, top - 1, cz + 1, sbb);
            this.a(world, aou.bq.cz, 0, cx + 1, top - 1, cz + 1, sbb);
        }
        if (this.size > 5) {
            for (int cy = bottom + 1; cy < top - 1; ++cy) {
                this.a(world, aou.bq.cz, 5, cx - 1, cy, cz - 1, sbb);
                this.a(world, aou.bq.cz, 5, cx + 1, cy, cz - 1, sbb);
                this.a(world, aou.bq.cz, 5, cx - 1, cy, cz + 1, sbb);
                this.a(world, aou.bq.cz, 5, cx + 1, cy, cz + 1, sbb);
            }
    ...
    protected void decorateSpiderWebs(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dy = bottom; dy < top; ++dy) {
            final int chance = top - dy + 2;
            for (int dx = 1; dx <= this.size - 2; ++dx) {
                for (int dz = 1; dz <= this.size - 2; ++dz) {
                    if (!this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir) && rand.nextInt(chance) == 0) {
                        this.a(world, aou.aa.cz, 0, dx, dy, dz, sbb);
                    }
                }
            }
        }
    ...
    protected void decorateFurniture(final zv world, final Random rand, final int bottom, final int freeSpace, final aee sbb) {
        if (rand.nextInt(3) > 0) {
            this.a(world, aou.bd.cz, 0, this.size / 2, bottom, this.size / 2, sbb);
            this.a(world, aou.aQ.cz, 0, this.size / 2, bottom + 1, this.size / 2, sbb);
        }
        if (rand.nextInt(3) == 0 && freeSpace > 1) {
            this.a(world, aou.ax.cz, this.getStairMeta(0), this.size / 2 + 1, bottom, this.size / 2, sbb);
        }
        if (rand.nextInt(3) == 0 && freeSpace > 1) {
            this.a(world, aou.ax.cz, this.getStairMeta(1), this.size / 2, bottom, this.size / 2 + 1, sbb);
        }
        if (rand.nextInt(3) == 0 && freeSpace > 1) {
            this.a(world, aou.ax.cz, this.getStairMeta(2), this.size / 2 - 1, bottom, this.size / 2, sbb);
        }
        if (rand.nextInt(3) == 0 && freeSpace > 1) {
            this.a(world, aou.ax.cz, this.getStairMeta(3), this.size / 2, bottom, this.size / 2 - 1, sbb);
        }
    }
    
    protected void decorateSolidRock(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dy = bottom; dy < top; ++dy) {
            for (int dx = 1; dx <= this.size - 2; ++dx) {
                for (int dz = 1; dz <= this.size - 2; ++dz) {
                    if (!this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir) && rand.nextInt(9) != 0) {
                        this.a(world, aou.x.cz, 0, dx, dy, dz, sbb);
                    }
                }
            }
        }
    ...
    protected void decorateLibrary(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dx = 1; dx <= this.size - 2; ++dx) {
            for (int dz = 1; dz <= this.size - 2; ++dz) {
                for (int dy = bottom; dy < top - 1; ++dy) {
                    if ((dx == 1 || dx == this.size - 2 || dz == 1 || dz == this.size - 2) && !this.isWindowPos(dx, dz) && !this.isLadderPos(dx, dz, ladderUpDir, ladderDownDir)) {
                        this.a(world, aou.ar.cz, 0, dx, dy, dz, sbb);
                    }
                }
            }
        }
    ...
    protected void decorateLibraryTreasure(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        switch (rand.nextInt(4)) {
            default: {
    ...
    protected void decorateFullLibrary(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dx = 1; dx <= this.size - 2; ++dx) {
            for (int dz = 1; dz <= this.size - 2; ++dz) {
                for (int dy = bottom; dy < top; ++dy) {
    ...
    protected void decorateTrap(final zv world, final Random rand, final int bottom, final int top, final int ladderUpDir, final int ladderDownDir, final aee sbb) {
        for (int dx = 2; dx <= this.size - 3; ++dx) {
            for (int dz = 2; dz <= this.size - 3; ++dz) {
                if (dx == 2 || dx == this.size - 3 || dz == 2 || dz == this.size - 3) {
                    this.a(world, aou.aq.cz, 0, dx, -1, dz, sbb);
                }
            }
        }
        for (int dy = bottom - 2; dy < top - 2; ++dy) {
            this.a(world, aou.aq.cz, 0, 1, dy, 1, sbb);
            this.a(world, aou.aq.cz, 0, 1, dy, this.size - 2, sbb);
            this.a(world, aou.aq.cz, 0, this.size - 2, dy, 1, sbb);
            this.a(world, aou.aq.cz, 0, this.size - 2, dy, this.size - 2, sbb);
        }
    }
    ...
    protected void decorateStairTower(final zv world, final Random rand, final aee sbb) {
        if (this.height - this.highestOpening > 8) {
            ...
            for (int i = 0; i < floors; ++i) {
                for (int x = 1; x < this.size - 1; ++x) {
                    for (int z = 1; z < this.size - 1; ++z) {
                        this.a(world, aou.B.cz, 2, x, i * floorHeight + base, z, sbb);
                    }
                }
            }
            int ladderDir = 3;
            ...
            for (int dy = 1; dy < 3; ++dy) {
                this.a(world, aou.aJ.cz, meta, dx, base - dy, dz, sbb);
            }
    ...
    protected void decorateStairFloor(final zv world, final Random rand, final aee sbb) {
        if (this.size > 5) {
            if (rand.nextInt(3) == 0) {
    ...
    protected void decorateChandelier(final zv world, final Random rand, final int decoTop, final aee sbb) {
        ...
        this.a(world, aou.bd.cz, 0, cx + 0, cy + 0, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx - 1, cy + 0, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx + 1, cy + 0, cz + 0, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy + 0, cz - 1, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy + 0, cz + 1, sbb);
        this.a(world, aou.bd.cz, 0, cx + 0, cy + 1, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx - 1, cy + 1, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 1, cy + 1, cz + 0, sbb);
        this.a(world, aou.au.cz, 0, cx + 0, cy + 1, cz - 1, sbb);
        this.a(world, aou.au.cz, 0, cx + 0, cy + 1, cz + 1, sbb);
        for (int y = cy; y < decoTop - 1; ++y) {
            this.a(world, aou.bd.cz, 0, cx + 0, y, cz + 0, sbb);
        }
    }
    
    protected void decorateHangingChains(final zv world, final Random rand, final int decoTop, final aee sbb) {
        final ArrayList chainList = new ArrayList();
        for (int i = 0; i < this.size + 2; ++i) {
    ...
    protected boolean chainCollides(final t coords, final List list) {
    ...
    protected void decorateOneChain(final zv world, final Random rand, final int dx, final int decoTop, final int length, final int dz, final aee sbb) {
        for (int y = 1; y <= length; ++y) {
            this.a(world, aou.bt.cz, 0, dx, decoTop - y - 1, dz, sbb);
        }
        int ballBlock = 0;
        int ballMeta = 0;
    ...
    protected void decorateFloatingBooks(final zv world, final Random rand, final int decoTop, final aee sbb) {
        ...
        for (int i = 0; i < this.size + 2; ++i) {
            ...
            if (!this.chainCollides(shelf, shelfList)) {
                ...
                for (int bottom = 2 + rand.nextInt(decoTop - 7), top = y = rand.nextInt(bottom - 1) + 2; y <= bottom; ++y) {
                    this.a(world, aou.ar.cz, 0, shelf.a, decoTop - y, shelf.c, sbb);
                }
                shelfList.add(shelf);
            }
        }
    ...
    protected void decorateFloatingVines(final zv world, final Random rand, final int decoTop, final aee sbb) {
        ...
        for (int i = 0; i < this.size + 2; ++i) {
            ...
            if (!this.chainCollides(moss, mossList)) {
                int y;
                for (int bottom = 2 + rand.nextInt(decoTop - 7), top = y = rand.nextInt(bottom - 1) + 2; y <= bottom; ++y) {
                    this.a(world, aou.as.cz, 0, moss.a, decoTop - y, moss.c, sbb);
                    this.a(world, aou.by.cz, this.getVineMeta(2), moss.a + 1, decoTop - y, moss.c + 0, sbb);
                    this.a(world, aou.by.cz, this.getVineMeta(0), moss.a - 1, decoTop - y, moss.c + 0, sbb);
                    this.a(world, aou.by.cz, this.getVineMeta(3), moss.a + 0, decoTop - y, moss.c + 1, sbb);
                    this.a(world, aou.by.cz, this.getVineMeta(1), moss.a + 0, decoTop - y, moss.c - 1, sbb);
                }
                mossList.add(moss);
            }
        }
        for (int y2 = this.highestOpening + 3; y2 < decoTop - 1; ++y2) {
            for (int x = 1; x < this.size - 1; ++x) {
                if (rand.nextInt(3) == 0) {
                    this.a(world, aou.by.cz, this.getVineMeta(3), x, y2, 1, sbb);
                }
                if (rand.nextInt(3) == 0) {
                    this.a(world, aou.by.cz, this.getVineMeta(1), x, y2, this.size - 2, sbb);
                }
            }
            for (int z = 1; z < this.size - 1; ++z) {
                if (rand.nextInt(3) == 0) {
                    this.a(world, aou.by.cz, this.getVineMeta(2), 1, y2, z, sbb);
                }
                if (rand.nextInt(3) == 0) {
                    this.a(world, aou.by.cz, this.getVineMeta(0), this.size - 2, y2, z, sbb);
                }
            }
        }
    }
    ...
    protected void decoratePlanter(final zv world, final Random rand, final aee sbb) {
        final int cz;
        final int cx = cz = this.size / 2;
        this.a(world, aou.ao.cz, 0, cx + 0, 1, cz + 1, sbb);
        this.a(world, aou.ao.cz, 0, cx + 0, 1, cz - 1, sbb);
        this.a(world, aou.ao.cz, 0, cx + 1, 1, cz + 0, sbb);
        this.a(world, aou.ao.cz, 0, cx - 1, 1, cz + 0, sbb);
        if (this.size > 7) {
            this.a(world, aou.an.cz, 0, cx - 1, 1, cz - 1, sbb);
            this.a(world, aou.an.cz, 0, cx + 1, 1, cz - 1, sbb);
            this.a(world, aou.an.cz, 0, cx + 1, 1, cz + 1, sbb);
            this.a(world, aou.an.cz, 0, cx - 1, 1, cz + 1, sbb);
        }
        this.a(world, aou.y.cz, 0, cx + 0, 1, cz + 0, sbb);
        int planterBlock = 0;
        int planterMeta = 0;
        switch (rand.nextInt(6)) {
            case 0: {
                planterBlock = aou.C.cz;
                planterMeta = 0;
                break;
            }
            case 1: {
            ...
            case 4: {
                planterBlock = aou.aj.cz;
                planterMeta = 0;
                break;
            }
            default: {
                planterBlock = aou.ak.cz;
                planterMeta = 0;
                break;
            }
        }
        this.a(world, planterBlock, planterMeta, cx + 0, 2, cz + 0, sbb);
        if (planterBlock == aou.C.cz) {
            final int wx = this.a(cx, cz);
            final int wy = this.a(2);
            final int wz = this.b(cx, cz);
            ((aoe)aou.C).d(world, wx, wy, wz, world.s);
        }
        if (planterBlock == aou.aj.cz || planterBlock == aou.ak.cz) {
            final int wx = this.a(cx, cz);
            final int wy = this.a(2);
            final int wz = this.b(cx, cz);
            ((anf)aou.r[planterBlock]).c(world, wx, wy, wz, world.s);
        }
        final int whatHappened = this.a(world, cx + 0, 2, cz + 0, sbb);
        if (whatHappened == planterBlock || whatHappened == 0) {
            final int potMeta = amg.a(new wg(planterBlock, 1, planterMeta));
            this.a(world, aou.cg.cz, potMeta, cx + 0, 2, cz + 0, sbb);
        }
    }
    
    protected void decorateStairWell(final zv world, final Random rand, final aee sbb) {
        final int cz;
        final int cx = cz = this.size / 2;
        final int cy = 1;
        final int waterOrLava = (rand.nextInt(4) == 0) ? aou.H.cz : aou.F.cz;
    ...
    protected void makeOpenings(final zv world, final aee sbb) {
        for (final t door : this.openings) {
            this.makeDoorOpening(world, door.a, door.b, door.c, sbb);
        }
    }
    
    protected void makeDoorOpening(final zv world, final int dx, final int dy, final int dz, final aee sbb) {
        this.a(world, 0, 0, dx, dy + 0, dz, sbb);
        this.a(world, 0, 0, dx, dy + 1, dz, sbb);
        if (this.a(world, dx, dy + 2, dz, sbb) != 0) {
            this.a(world, aou.an.cz, 0, dx, dy + 2, dz, sbb);
        }
        if (dx == 0) {
    ...
    public void updateLight(final zv world, final int dx, final int dy, final int dz) {
    ...
    protected void makeWindows(final zv world, final Random rand, final aee sbb, final boolean real) {
        for (int i = 0; i < 4; ++i) {
    ...
    protected void makeWindowBlock(final zv world, final int x, final int y, final int z, final int rotation, final aee sbb, final boolean realWindows) {
        ...
        if (realWindows && inside == 0 && outside == 0) {
            this.a(world, aou.bu.cz, 0, x, y, z, sbb);
        }
        else {
            this.a(world, aou.A.cz, 0, x, y, z, sbb);
        }
        this.setCoordBaseMode(temp);
    }
    
    protected void makeWindowBase(final zv world, final int x, final int y, final int z, final int rotation, final aee sbb) {
        final int temp = this.getCoordBaseMode();
        this.setCoordBaseMode((this.getCoordBaseMode() + rotation) % 4);
        this.a(world, aou.an.cz, 0, x, y, z, sbb);
        this.setCoordBaseMode(temp);
    }
    
    protected boolean makeStairs(final zv world, final Random rand, final aee sbb) {
        if (this.size == 15) {
    ...
    protected boolean makeStairs5(final zv world, final Random rand, final aee sbb) {
        final int rise = 1;
    ...
    protected void makeStairs5flight(final zv world, final Random rand, final aee sbb, final int height, final int rotation, final int meta) {
        final int temp = this.getCoordBaseMode();
        this.setCoordBaseMode((this.getCoordBaseMode() + rotation) % 4);
        final int singleSlabBlock = (meta == 0) ? aou.ao.cz : aou.bS.cz;
        final int doubleSlabBlock = (meta == 0) ? aou.an.cz : aou.B.cz;
        this.a(world, singleSlabBlock, meta, 2, 1 + height, 3, sbb);
        this.a(world, doubleSlabBlock, meta, 3, 1 + height, 3, sbb);
        this.setCoordBaseMode(temp);
    }
    
    protected boolean makeStairs7(final zv world, final Random rand, final aee sbb) {
        this.a(world, aou.bS.cz, 2, 1, 1, 4, sbb);
        this.a(world, aou.B.cz, 2, 1, 1, 5, sbb);
        this.a(world, aou.ao.cz, 0, 5, 1, 2, sbb);
        this.a(world, aou.an.cz, 0, 5, 1, 1, sbb);
        final int rise = 2;
        for (int numFlights = this.highestOpening / rise, i = 0; i < numFlights; ++i) {
    ...
    protected void makeStairs7flight(final zv world, final Random rand, final aee sbb, final int height, final int rotation, final int meta) {
        final int temp = this.getCoordBaseMode();
        this.setCoordBaseMode((this.getCoordBaseMode() + rotation) % 4);
        final int singleSlabBlock = (meta == 0) ? aou.ao.cz : aou.bS.cz;
        final int doubleSlabBlock = (meta == 0) ? aou.an.cz : aou.B.cz;
    ...
    protected boolean makeStairs9(final zv world, final Random rand, final aee sbb) {
        this.a(world, aou.bS.cz, 2, 1, 1, 6, sbb);
        this.a(world, aou.B.cz, 2, 1, 1, 7, sbb);
        this.a(world, aou.ao.cz, 0, 7, 1, 2, sbb);
        this.a(world, aou.an.cz, 0, 7, 1, 1, sbb);
        final int rise = 3;
        for (int numFlights = this.highestOpening / rise, i = 0; i < numFlights; ++i) {
    ...
    protected void makeStairs9flight(final zv world, final Random rand, final aee sbb, final int height, final int rotation, final int meta) {
        final int temp = this.getCoordBaseMode();
        this.setCoordBaseMode((this.getCoordBaseMode() + rotation) % 4);
        final int singleSlabBlock = (meta == 0) ? aou.ao.cz : aou.bS.cz;
        final int doubleSlabBlock = (meta == 0) ? aou.an.cz : aou.B.cz;
    ...
    protected boolean makeStairs15(final zv world, final Random rand, final aee sbb) {
        this.a(world, aou.bS.cz, 2, 1, 1, 9, sbb);
        this.a(world, aou.bS.cz, 2, 2, 1, 9, sbb);
        this.a(world, aou.B.cz, 2, 1, 1, 10, sbb);
        this.a(world, aou.B.cz, 2, 2, 1, 10, sbb);
        this.a(world, aou.bS.cz, 2, 1, 2, 11, sbb);
        this.a(world, aou.bS.cz, 2, 2, 2, 11, sbb);
        this.a(world, aou.B.cz, 2, 1, 2, 12, sbb);
        this.a(world, aou.B.cz, 2, 2, 2, 12, sbb);
        this.a(world, aou.B.cz, 2, 1, 2, 13, sbb);
        this.a(world, aou.B.cz, 2, 2, 2, 13, sbb);
        this.a(world, aou.B.cz, 2, 3, 2, 11, sbb);
        this.a(world, aou.bd.cz, 0, 3, 3, 11, sbb);
        this.a(world, aou.bd.cz, 0, 3, 4, 11, sbb);
        this.a(world, aou.B.cz, 2, 3, 1, 10, sbb);
        this.a(world, aou.bd.cz, 0, 3, 2, 10, sbb);
        this.a(world, aou.bd.cz, 0, 3, 3, 10, sbb);
        this.a(world, aou.B.cz, 2, 3, 1, 9, sbb);
        this.a(world, aou.bd.cz, 0, 3, 2, 9, sbb);
        this.a(world, aou.ao.cz, 0, 13, 1, 5, sbb);
        this.a(world, aou.ao.cz, 0, 12, 1, 5, sbb);
        this.a(world, aou.an.cz, 0, 13, 1, 4, sbb);
        this.a(world, aou.an.cz, 0, 12, 1, 4, sbb);
        this.a(world, aou.ao.cz, 0, 13, 2, 3, sbb);
        this.a(world, aou.ao.cz, 0, 12, 2, 3, sbb);
        this.a(world, aou.an.cz, 0, 13, 2, 2, sbb);
        this.a(world, aou.an.cz, 0, 12, 2, 2, sbb);
        this.a(world, aou.an.cz, 0, 13, 2, 1, sbb);
        this.a(world, aou.an.cz, 0, 12, 2, 1, sbb);
        this.a(world, aou.an.cz, 0, 11, 2, 3, sbb);
        this.a(world, aou.bd.cz, 0, 11, 3, 3, sbb);
        this.a(world, aou.bd.cz, 0, 11, 4, 3, sbb);
        this.a(world, aou.an.cz, 0, 11, 1, 4, sbb);
        this.a(world, aou.bd.cz, 0, 11, 2, 4, sbb);
        this.a(world, aou.bd.cz, 0, 11, 3, 4, sbb);
        this.a(world, aou.an.cz, 0, 11, 1, 5, sbb);
        this.a(world, aou.bd.cz, 0, 11, 2, 5, sbb);
        final int rise = 5;
        for (int numFlights = this.highestOpening / rise, i = 0; i < numFlights; ++i) {
    ...
    protected void makeStairs15flight(final zv world, final Random rand, final aee sbb, final int height, final int rotation, final int meta) {
        final int temp = this.getCoordBaseMode();
        this.setCoordBaseMode((this.getCoordBaseMode() + rotation) % 4);
        final int singleSlabBlock = (meta == 0) ? aou.ao.cz : aou.bS.cz;
        final int doubleSlabBlock = (meta == 0) ? aou.an.cz : aou.B.cz;
        ...
        this.a(world, aou.bd.cz, 0, 4, 2 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 5, 3 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 6, 3 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 7, 4 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 8, 4 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 9, 5 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 10, 5 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 11, 6 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 4, 3 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 6, 4 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 8, 5 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 10, 6 + height, 11, sbb);
        this.a(world, aou.bd.cz, 0, 11, 7 + height, 11, sbb);
        this.setCoordBaseMode(temp);
    }
    
    protected void generatePaintingsOnWall(final zv world, final Random rand, final int howMany, final int floorLevel, final int direction, final int minSize, final aee sbb) {
        for (int i = 0; i < howMany; ++i) {
            final t pCoords = this.getRandomWallSpot(rand, floorLevel, direction, sbb);
            final nj painting = new nj(world, pCoords.a, pCoords.b, pCoords.c, direction);
    ...
    protected nk getPaintingOfSize(final Random rand, final int minSize) {
        final ArrayList valid = new ArrayList();
        for (final nk art : nk.values()) {
    ...
    protected boolean checkPainting(final zv world, final nj painting, final aee sbb) {
        if (painting == null) {
            return false;
        }
        aqr largerBox;
        ...
        if (world.a((mp)painting, largerBox).size() > 0) {
            return false;
        }
        final List collidingEntities = world.b((mp)painting, largerBox);
        for (final mp entityOnList : collidingEntities) {
            if (entityOnList instanceof ne) {
                return false;
            }
        }
        return true;
    ...
    protected t getRandomWallSpot(final Random rand, final int floorLevel, final int direction, final aee sbb) {
        int minX = this.e.a + 2;
        int maxX = this.e.d - 2;
