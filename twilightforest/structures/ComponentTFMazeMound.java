...
public class ComponentTFMazeMound extends StructureTFComponent
{
    ...
    public ComponentTFMazeMound(final int i, final Random rand, final int x, final int y, final int z) {
        ...
        this.e = new acn(x, y, z, x + 35, y + 8, z + 35);
    }
        ...
        for (int x = 0; x < 35; ++x) {
            for (int z = 0; z < 35; ++z) {
                ...
                if ((cx > 2 || cx < -1 || cz > 2 || cz < -1) && (((cx > 2 || cx < -1) && (cz > 2 || cz < -1)) || hheight > 6)) {
                    this.a(world, amq.x.cm, 0, x, hheight, z, sbb);
                    if ((cx > 2 || cx < -1) && (cz > 2 || cz < -1)) {
                        this.b(world, amq.y.cm, 0, x, hheight - 1, z, sbb);
                    }
                    else if (hheight > 6) {
                        this.a(world, sbb, x, 6, z, x, hheight - 1, z, amq.y.cm, 0, false);
                    }
                }
            }
        }
    ...
    protected int getAverageGroundLevel(final yc par1World, final acn par2StructureBoundingBox) {
        int var3 = 0;
        int var4 = 0;
        for (int var5 = this.e.c; var5 <= this.e.f; ++var5) {
            for (int var6 = this.e.a; var6 <= this.e.d; ++var6) {
                if (par2StructureBoundingBox.b(var6, 64, var5)) {
                    var3 += Math.max(par1World.i(var6, var5), par1World.u.i());
                    ++var4;
                }
            }
        }
