    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        ...
        for (int x = 1; x < 14; ++x) {
            for (int z = 1; z < 14; ++z) {
                ...
                if (gravel > 0) {
                    ++gravel;
                    this.a(world, sbb, x, 1, z, x, gravel, z, amj.I.cm, 0, false);
                    this.a(world, sbb, x, gravel, z, x, gravel + 5, z);
                }
                else if (root > 0) {
                    this.a(world, sbb, x, 5, z, x, 5 + root, z, amj.y.cm, 0, true);
                    this.a(world, sbb, x, 5 - rand.nextInt(5), z, x, 5, z, TFBlocks.plant.cm, 14, 0, 0, false);
                }
