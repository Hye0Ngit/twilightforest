...
public class ComponentTFTrollCaveMain extends StructureTFComponent
{
    ...
    public ComponentTFTrollCaveMain(final World world, final Random rand, final int i, final int x, final int y, final int z) {
    ...
    protected void hollowCaveMiddle(final World par1World, final StructureBoundingBox par2StructureBoundingBox, final int minX, final int minY, final int minZ, final int maxX, final int maxY, final int maxZ) {
        ...
        for (int y = minY; y <= maxY; ++y) {
            for (int x = minX; x <= maxX; ++x) {
                for (int z = minZ; z <= maxZ; ++z) {
                    ...
                    if (Math.sqrt(ex * ey * ez) > threshold) {
