...
public class ComponentTFDarkTowerRoofRings extends ComponentTFDarkTowerRoof
{
    ...
    public ComponentTFDarkTowerRoofRings(final TFFeature feature, final int i, final ComponentTFTowerWing wing) {
    ...
    protected void makeARing(final World world, final int y, final StructureBoundingBox sbb) {
        ...
        this.func_175811_a(world, this.deco.accentState, this.size / 2 - 2, y, this.size / 2 + 0, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 - 2, y, this.size / 2 - 1, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 2, y, this.size / 2 + 1, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 2, y, this.size / 2 + 0, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 2, y, this.size / 2 - 1, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 1, y, this.size / 2 - 2, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 0, y, this.size / 2 - 2, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 - 1, y, this.size / 2 - 2, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 1, y, this.size / 2 + 2, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 + 0, y, this.size / 2 + 2, sbb);
        this.func_175811_a(world, this.deco.accentState, this.size / 2 - 1, y, this.size / 2 + 2, sbb);
