...
public class ComponentTFDarkTowerEntranceBridge extends ComponentTFDarkTowerBridge
{
    ...
    protected ComponentTFDarkTowerEntranceBridge(final TFFeature feature, final int i, final int x, final int y, final int z, final int pSize, final int pHeight, final EnumFacing direction) {
    ...
    public boolean makeTowerWing(final List<StructureComponent> list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final Rotation rotation) {
        ...
        final ComponentTFDarkTowerWing wing = new ComponentTFDarkTowerEntrance(this.getFeatureType(), index, dx[0], dx[1], dx[2], wingSize, wingHeight, direction);
        list.add(wing);
