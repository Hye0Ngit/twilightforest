...
public class ComponentTFDarkTowerBeard extends StructureTFComponent
{
    ...
    public ComponentTFDarkTowerBeard(final int i, final ComponentTFTowerWing wing) {
        ...
        this.e = new aee(wing.b().a, wing.b().b - this.height, wing.b().c, wing.b().d, wing.b().b, wing.b().f);
    }
    ...
    protected void makeDarkBeard(final zv world, final aee sbb, final int minX, final int minY, final int minZ, final int maxX, final int maxY, final int maxZ) {
        final int frameID = TFBlocks.towerWood.cz;
