...
public class ComponentTFDarkTowerWing extends ComponentTFTowerWing
{
    ...
    protected boolean makeTowerBalcony(final List<StructureComponent> list, final Random rand, final int index, final int x, final int y, final int z, final int rotation) {
        final int direction = (this.getCoordBaseMode() + rotation) % 4;
        final int[] dx = this.offsetTowerCoords(x, y, z, 5, direction);
    ...
    private void testAndChangeToNetherrack(final World world, final Random rand, final int x, final int y, final int z, final StructureBoundingBox sbb) {
        if (this.func_151548_a(world, x, y, z, sbb) != Blocks.field_150350_a) {
            ...
            if (this.func_151548_a(world, x, y + 1, z, sbb) == Blocks.field_150350_a && rand.nextBoolean()) {
                this.func_151550_a(world, (Block)Blocks.field_150480_ab, 0, x, y + 1, z, sbb);
            }
        }
    }
    
    public void drawBlob(final World world, final int sx, final int sy, final int sz, final int rad, final Block blockValue, final int metaValue, final StructureBoundingBox sbb) {
        for (byte dx = 0; dx <= rad; ++dx) {
            for (byte dy = 0; dy <= rad; ++dy) {
                for (byte dz = 0; dz <= rad; ++dz) {
                    byte dist = 0;
    ...
    private void decorateLounge(final World world, final Random rand, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150376_bx, 9, cx, y + 1, cz + 1, rotation, sbb);
    ...
    private void decorateExperimentLamp(final World world, final Random rand, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150320_F, 1, cx, y + 1, cz, rotation, sbb);
    ...
    private void decorateExperimentPulser(final World world, final Random rand, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        final int cz = (this.size > 9) ? 4 : 3;
        this.placeBlockRotated(world, (Block)Blocks.field_150320_F, 5 - this.getStairMeta(3 + rotation), cx, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, cx, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150488_af, 0, cx + 1, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, Blocks.field_150452_aw, 0, cx + 2, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150413_aR, (rotation + 1) % 4 + 4, cx - 1, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150488_af, 0, cx - 2, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150488_af, 0, cx - 2, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150488_af, 0, cx - 1, y + 1, cz + 1, rotation, sbb);
    }
    ...
    private void decoratePuzzleChest(final World world, final Random rand, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150320_F, 5 - this.getStairMeta(1 + rotation), x + 1, y + 3, z - 1, rotation, sbb);
    ...
    protected void putItemInTreasure(final World world, final int x, final int y, final int z, final ItemStack itemToAdd, final StructureBoundingBox sbb) {
        ...
        if (sbb.func_78890_b(dx, dy, dz)) {
            final TileEntity tileEntity = world.func_147438_o(dx, dy, dz);
    ...
    protected boolean checkPost(final World world, final int x, final int y, final int z, final int rotation, final StructureBoundingBox sbb) {
        ...
        final Block blockID = sbb.func_78890_b(worldX, worldY, worldZ) ? world.func_147439_a(worldX, worldY, worldZ) : Blocks.field_150350_a;
