...
public class ComponentTFDarkTowerWing extends ComponentTFTowerWing
{
    ...
    protected ArrayList openingTypes;
    ...
    public boolean makeTowerWing(final List list, final Random rand, final int index, final int x, final int y, final int z, final int wingSize, final int wingHeight, final int rotation) {
        ...
        agq intersect = agq.a(list, bridge.b());
    ...
    protected boolean makeTowerBalcony(final List list, final Random rand, final int index, final int x, final int y, final int z, final int rotation) {
        ...
        final agq intersect = agq.a(list, balcony.b());
        if (intersect == null || intersect == this) {
            list.add(balcony);
    ...
    protected void destroyTower(final zv world, final Random decoRNG, final int x, final int y, final int z, final int amount, final aee sbb) {
    ...
    private void netherTransformBlob(final zv world, final Random inRand, final int sx, final int sy, final int sz, final int rad, final aee sbb) {
    ...
    private void testAndChangeToNetherrack(final zv world, final Random rand, final int x, final int y, final int z, final aee sbb) {
        if (this.a(world, x, y, z, sbb) > 0) {
            this.a(world, aou.bf.cz, 0, x, y, z, sbb);
            if (this.a(world, x, y + 1, z, sbb) == 0 && rand.nextBoolean()) {
                this.a(world, aou.av.cz, 0, x, y + 1, z, sbb);
            }
        }
    }
    
    public void drawBlob(final zv world, final int sx, final int sy, final int sz, final int rad, final int blockValue, final int metaValue, final aee sbb) {
        for (byte dx = 0; dx <= rad; ++dx) {
            for (byte dy = 0; dy <= rad; ++dy) {
                for (byte dz = 0; dz <= rad; ++dz) {
                    byte dist = 0;
    ...
    protected void addHalfFloors(final zv world, final Random rand, final aee sbb, int bottom, final int top) {
        final int spacing = 4;
        int rotation = (this.e.b + bottom) % 3;
        if (bottom == 0) {
            bottom += spacing;
        }
    ...
    protected void makeHalfFloor(final zv world, final aee sbb, final int rotation, final int y, final int spacing) {
    ...
    protected void makeFullFloor(final zv world, final aee sbb, final int rotation, final int y, final int spacing) {
    ...
    protected void decorateTreasureRoom(final zv world, final aee sbb, final int rotation, final int y, final int spacing, final StructureTFDecorator myDeco) {
        ...
        if (this.isKeyTower()) {
            this.putItemInTreasure(world, x, y + 2, z, new wg(TFItems.towerKey), sbb);
        }
    }
    
    private void decorateSpawner(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
    ...
    private void decorateLounge(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, aou.bS.cz, 9, cx, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, this.deco.stairID, this.getStairMeta(1 + rotation) + 4, cx, y + 1, cz + 2, rotation, sbb);
    }
    
    private void decorateReappearingFloor(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        this.fillBlocksRotated(world, sbb, 4, y, 3, 7, y, 5, TFBlocks.towerDevice.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 4, y + 1, 2, 7, y + 1, 2, aou.aQ.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 4, y + 1, 6, 7, y + 1, 6, aou.aQ.cz, 0, rotation);
    }
    
    private void decorateExperimentLamp(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        final int cx = (this.size > 9) ? 5 : 3;
        final int cz = (this.size > 9) ? 5 : 4;
        this.placeBlockRotated(world, aou.Z.cz, 1, cx, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.bP.cz, 0, cx, y + 2, cz, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, cx, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 3), cx, y + 1, cz + 2, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, cx, y + 3, cz - 1, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 2) + 8, cx, y + 3, cz - 2, rotation, sbb);
    }
    
    private void decorateExperimentPulser(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        final int cx = (this.size > 9) ? 6 : 5;
        final int cz = (this.size > 9) ? 4 : 3;
        this.placeBlockRotated(world, aou.Z.cz, 5 - this.getStairMeta(3 + rotation), cx, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, cx, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.az.cz, 0, cx + 1, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.aQ.cz, 0, cx + 2, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.bl.cz, (rotation + 1) % 4 + 4, cx - 1, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.az.cz, 0, cx - 2, y + 1, cz, rotation, sbb);
        this.placeBlockRotated(world, aou.az.cz, 0, cx - 2, y + 1, cz + 1, rotation, sbb);
        this.placeBlockRotated(world, aou.az.cz, 0, cx - 1, y + 1, cz + 1, rotation, sbb);
    }
    
    private void decorateLibrary(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
    ...
    protected void makeSmallBookshelf(final zv world, final aee sbb, final int rotation, final int y, final int bx, final int bz) {
        ...
        this.placeBlockRotated(world, aou.ar.cz, 0, bx, y + 1, bz + 1, rotation, sbb);
        this.placeBlockRotated(world, aou.ar.cz, 0, bx, y + 2, bz + 1, rotation, sbb);
        this.placeBlockRotated(world, aou.ar.cz, 0, bx, y + 1, bz + 2, rotation, sbb);
        this.placeBlockRotated(world, aou.ar.cz, 0, bx, y + 2, bz + 2, rotation, sbb);
    ...
    private void decoratePuzzleChest(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        final int x = (this.size > 9) ? 4 : 3;
        final int z = (this.size > 9) ? 5 : 4;
        this.makePillarFrame(world, sbb, this.deco, rotation, x, y, z, true);
        ...
        this.placeBlockRotated(world, aou.Z.cz, 5 - this.getStairMeta(1 + rotation), x + 1, y + 3, z - 1, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, x + 1, y + 3, z - 2, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 5), x + 2, y + 3, z - 2, rotation, sbb);
        this.placeTreasureRotated(world, x + 1, y + 2, z + 1, rotation, TFTreasure.darktower_cache, sbb);
    }
    
    protected void makePillarFrame(final zv world, final aee sbb, final StructureTFDecorator myDeco, final int rotation, final int x, final int y, final int z, final boolean fenced) {
        this.makePillarFrame(world, sbb, myDeco, rotation, x, y, z, 3, 3, 3, fenced);
    }
    
    protected void makePillarFrame(final zv world, final aee sbb, final StructureTFDecorator myDeco, final int rotation, final int x, final int y, final int z, final int width, final int height, final int length, final boolean fenced) {
    ...
    protected void putItemInTreasure(final zv world, final int x, final int y, final int z, final wg itemToAdd, final aee sbb) {
        final int dx = this.a(x, z);
        final int dy = this.a(y);
        final int dz = this.b(x, z);
        if (sbb.b(dx, dy, dz)) {
            final aqj tileEntity = world.r(dx, dy, dz);
            if (tileEntity != null && tileEntity instanceof lt) {
                final lt inventory = (lt)tileEntity;
                boolean alreadyPresent = false;
                int emptySlots = 0;
                for (int i = 0; i < inventory.j_(); ++i) {
                    final wg inSlot = inventory.a(i);
                    if (inSlot == null) {
                        ++emptySlots;
                    }
                    else if (wg.b(inSlot, itemToAdd)) {
                        alreadyPresent = true;
                        break;
                    }
                }
                if (!alreadyPresent && emptySlots > 0) {
                    ...
                    for (int j = 0; j < inventory.j_(); ++j) {
                        final wg inSlot2 = inventory.a(j);
                        if (inSlot2 == null) {
    ...
    protected void addStairsDown(final zv world, final aee sbb, final int rotation, final int y, final int sz, final int spacing) {
    ...
    protected void addSmallTimberBeams(final zv world, final Random rand, final aee sbb, int bottom, final int top) {
        final int spacing = 4;
        int rotation = 0;
        if (bottom == 0) {
            bottom += spacing;
        ...
        for (int y = bottom; y < top; y += spacing) {
            ...
            if (y >= top - spacing && this.isDeadEnd()) {
                ...
                logDeco.pillarID = TFBlocks.log.cz;
                logDeco.pillarMeta = 3;
                logDeco.platformID = TFBlocks.log.cz;
                logDeco.pillarMeta = 3;
    ...
    protected void makeTimberFloor(final zv world, final Random rand, final aee sbb, final int rotation, final int y, final int spacing) {
        ...
        for (int by = 1; by < 4; ++by) {
            ...
            this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2 + rotation), 3, y - by, 2, rotation, sbb);
            this.placeBlockRotated(world, beamID, beamMetaBase + beamMetaUD, 6, y - by, 6, rotation, sbb);
            this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(4 + rotation), 5, y - by, 6, rotation, sbb);
        }
        this.placeBlockRotated(world, 0, 0, 3, y, 2, rotation, sbb);
        this.placeBlockRotated(world, 0, 0, 5, y, 6, rotation, sbb);
    }
    
    protected void makeSmallTimberBeams(final zv world, final Random rand, final aee sbb, final int rotation, final int y, final boolean bottom, final boolean top) {
        final int beamID = TFBlocks.log.cz;
        final int beamMetaBase = 3;
        final int beamMetaNS = ((this.f + rotation) % 2 == 0) ? 4 : 8;
        final int beamMetaEW = (beamMetaNS == 4) ? 8 : 4;
        ...
        for (int by = 1; by < 4; ++by) {
            ...
            if (!bottom || this.checkPost(world, x3, y - 4, z3, rotation, sbb)) {
                ...
                this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(4 + rotation), x3 - 1, y - by, z3, rotation, sbb);
            }
        }
    }
    ...
    protected boolean checkPost(final zv world, final int x, final int y, final int z, final int rotation, final aee sbb) {
    ...
    protected void makeEncasedWalls(final zv world, final Random rand, final aee sbb, final int minX, final int minY, final int minZ, final int maxX, final int maxY, final int maxZ) {
                ...
                for (int z = minZ; z <= maxZ; ++z) {
                    if (x == minX || x == maxX || y == minY || y == maxY || z == minZ || z == maxZ) {
                        if (((x == minY || x == maxX) && (y == minY || y == maxY || z == minZ || z == maxZ)) || ((y == minY || y == maxY) && (x == minY || x == maxX || z == minZ || z == maxZ)) || ((z == minZ || z == maxZ) && (x == minY || x == maxX || y == minY || y == maxY))) {
                            ...
                            final agr blocker = StructureTFComponent.getTowerWoods();
    ...
    protected void makeDoorOpening(final zv world, final int dx, final int dy, final int dz, final aee sbb) {
        ...
        if (dx == 0 || dx == this.size - 1) {
            ...
            this.a(world, sbb, dx, dy, dz - 1, dx, dy + 2, dz + 1, TFBlocks.towerDevice.cz, 2, 0, 0, false);
        }
        if (dz == 0 || dz == this.size - 1) {
            this.a(world, sbb, dx - 2, dy - 1, dz, dx + 2, dy + 3, dz, this.deco.accentID, this.deco.accentMeta, 0, 0, false);
            this.a(world, sbb, dx - 1, dy, dz, dx + 1, dy + 2, dz, TFBlocks.towerDevice.cz, 2, 0, 0, false);
        }
    }
    
    protected void makeReappearingDoorOpening(final zv world, final int dx, final int dy, final int dz, final aee sbb) {
        this.nullifySkyLightAtCurrentPosition(world, dx - 3, dy - 1, dz - 3, dx + 3, dy + 3, dz + 3);
        if (dx == 0 || dx == this.size - 1) {
            this.a(world, sbb, dx, dy - 1, dz - 2, dx, dy + 3, dz + 2, this.deco.accentID, this.deco.accentMeta, 0, 0, false);
            this.a(world, sbb, dx, dy, dz - 1, dx, dy + 2, dz + 1, TFBlocks.towerDevice.cz, 0, 0, 0, false);
        }
        if (dz == 0 || dz == this.size - 1) {
            this.a(world, sbb, dx - 2, dy - 1, dz, dx + 2, dy + 3, dz, this.deco.accentID, this.deco.accentMeta, 0, 0, false);
            this.a(world, sbb, dx - 1, dy, dz, dx + 1, dy + 2, dz, TFBlocks.towerDevice.cz, 0, 0, 0, false);
        }
    }
    
    protected void makeLockedDoorOpening(final zv world, final int dx, final int dy, final int dz, final aee sbb) {
        this.nullifySkyLightAtCurrentPosition(world, dx - 3, dy - 1, dz - 3, dx + 3, dy + 3, dz + 3);
        if (dx == 0 || dx == this.size - 1) {
            this.a(world, sbb, dx, dy - 1, dz - 2, dx, dy + 3, dz + 2, this.deco.accentID, this.deco.accentMeta, 0, 0, false);
            this.a(world, sbb, dx, dy, dz - 1, dx, dy + 2, dz + 1, TFBlocks.towerDevice.cz, 2, 0, 0, false);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx, dy + 0, dz + 1, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx, dy + 0, dz - 1, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx, dy + 2, dz + 1, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx, dy + 2, dz - 1, sbb);
        }
        if (dz == 0 || dz == this.size - 1) {
            this.a(world, sbb, dx - 2, dy - 1, dz, dx + 2, dy + 3, dz, this.deco.accentID, this.deco.accentMeta, 0, 0, false);
            this.a(world, sbb, dx - 1, dy, dz, dx + 1, dy + 2, dz, TFBlocks.towerDevice.cz, 2, 0, 0, false);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx + 1, dy + 0, dz, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx - 1, dy + 0, dz, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx + 1, dy + 2, dz, sbb);
            this.a(world, TFBlocks.towerDevice.cz, 4, dx - 1, dy + 2, dz, sbb);
        }
    }
    ...
    protected void makeNetherburst(final zv world, final Random inRand, final int radius, final int interations, final int moves, final int sx, final int y, final int sz, final int rotation, final aee sbb) {
        final Random rand = new Random(inRand.nextLong());
        for (int i = 0; i < interations; ++i) {
            ...
            for (int move = 0; move < moves; ++move) {
                this.placeBlockRotated(world, 0, 0, lx, ly, lz, rotation, sbb);
                for (int facing = 0; facing < 6; ++facing) {
                    final int fx = lx + s.b[facing];
                    final int fy = ly + s.b[facing];
                    final int fz = lz + s.b[facing];
                    if (this.getBlockIDRotated(world, fx, fy, fz, rotation, sbb) > 0 && rand.nextInt(4) == 0) {
                        this.placeBlockRotated(world, aou.bf.cz, 0, fx, fy, fz, rotation, sbb);
                        if (this.getBlockIDRotated(world, fx, fy + 1, fz, rotation, sbb) == 0 && rand.nextInt(2) == 0) {
                            this.placeBlockRotated(world, aou.av.cz, 0, fx, fy + 1, fz, rotation, sbb);
                        }
                    }
                }
