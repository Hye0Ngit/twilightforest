...
public class ComponentTFDarkTowerMain extends ComponentTFDarkTowerWing
{
    ...
    public ComponentTFDarkTowerMain(final zv world, final Random rand, final int index, final int x, final int y, final int z) {
        this(world, rand, index, x + 19, y, z + 19, 2);
    }
    
    public ComponentTFDarkTowerMain(final zv world, final Random rand, final int index, final int x, final int y, final int z, final int rotation) {
    ...
    @Override
    public void makeARoof(final agq parent, final List list, final Random rand) {
        if (this.c() < 2) {
    ...
    protected void addThreeQuarterFloors(final zv world, final Random decoRNG, final aee sbb, int bottom, final int top) {
        final int spacing = 5;
        int rotation = (this.e.b + bottom) % 4;
        if (bottom == 0) {
    ...
    protected void addThreeQuarterFloorsDecorateBoss(final zv world, final Random decoRNG, final aee sbb, int bottom, final int top) {
        final int spacing = 5;
        int rotation = (this.e.b + bottom) % 4;
        if (bottom == 0) {
            this.makeLargeStairsUp(world, sbb, rotation, 0);
    ...
    private void decorateFloor(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y, final boolean isBottom, final boolean isTop) {
        if (isTop) {
    ...
    protected void makeThreeQuarterFloor(final zv world, final aee sbb, final int rotation, final int y, final boolean isBottom, final boolean isTowerTopFloor) {
    ...
    protected void makeLargeStairsUp(final zv world, final aee sbb, final int rotation, final int y) {
        for (int i = 0; i < 5; ++i) {
    ...
    private void decorateReappearingMaze(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        final int mazeSize = 6;
        final TFMaze maze = new TFMaze(mazeSize, mazeSize);
        maze.setSeed(world.F() + this.e.a * 90342903 + y * 90342903 ^ (long)this.e.c);
        for (int i = 0; i < 13; ++i) {
            maze.putRaw(i, 0, 5);
            maze.putRaw(i, 12, 5);
            maze.putRaw(0, i, 5);
        ...
        maze.doorBlockID = TFBlocks.towerDevice.cz;
    ...
    protected void decorateMazeDeadEnds(final zv world, final Random decoRNG, final TFMaze maze, final int y, final int rotation, final aee sbb) {
    ...
    private void decorateDeadEnd(final zv world, final Random decoRNG, final TFMaze maze, final int mx, final int y, final int mz, final int facing, final int rotation, final aee sbb) {
        final int x = mx * 3 + 1;
        final int z = mz * 3 + 1;
        switch (facing) {
            case 0: {
                ...
                this.a(world, aou.ay.cz, 0, x + 0, y + 2, z + 1, sbb);
            ...
            case 1: {
                ...
                this.a(world, this.deco.accentID, this.deco.accentMeta, x + 0, y + 1, z + 1, sbb);
                this.a(world, aou.ay.cz, rotation, x + 0, y + 2, z + 0, sbb);
            ...
            case 3: {
                this.a(world, this.deco.accentID, this.deco.accentMeta, x + 1, y + 1, z + 0, sbb);
                this.a(world, this.deco.accentID, this.deco.accentMeta, x + 1, y + 1, z + 1, sbb);
                this.a(world, aou.ay.cz, rotation, x + 1, y + 2, z + 0, sbb);
                this.placeTreasureAtCurrentPosition(world, decoRNG, x + 1, y + 2, z + 1, TFTreasure.darktower_cache, sbb);
                break;
            }
        }
    ...
    private void decorateUnbuilderMaze(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, 15, y + 2, 7, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, 11, y + 3, 7, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, 15, y + 2, 13, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, 11, y + 3, 13, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, 5, y + 3, 13, rotation, sbb);
    }
    
    private void decorateLounge(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, aou.bJ.cz, 0, 13, y + 2, 5, rotation, sbb);
        this.placeBlockRotated(world, aou.bK.cz, 3, 15, y + 2, 3, rotation, sbb);
        ...
        this.fillBlocksRotated(world, sbb, 11, y + 1, 17, 12, y + 4, 17, aou.ar.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 14, y + 1, 17, 15, y + 4, 17, aou.ar.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 17, y + 1, 11, 17, y + 4, 12, aou.ar.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 17, y + 1, 14, 17, y + 4, 15, aou.ar.cz, 0, rotation);
        ...
        this.placeBlockRotated(world, aou.bP.cz, 0, 8, y + 3, 8, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, decoRNG.nextBoolean() ? 0 : 7, 8, y + 2, 8, rotation, sbb);
        this.placeTreePlanter(world, decoRNG.nextInt(5), 6, y + 1, 12, rotation, sbb);
    }
    
    private void makeDispenserPillar(final zv world, final StructureTFDecorator forgeDeco, final int x, final int y, final int z, final int stairMeta, final int rotation, final aee sbb) {
        this.placeBlockRotated(world, forgeDeco.stairID, stairMeta + 4, x, y + 2, z, rotation, sbb);
        this.placeBlockRotated(world, aou.T.cz, stairMeta + 4, x, y + 3, z, rotation, sbb);
        this.placeBlockRotated(world, forgeDeco.stairID, stairMeta, x, y + 4, z, rotation, sbb);
    }
    
    private void decorateBossSpawner(final zv world, final Random rand, final aee sbb, final int rotation, final int y) {
        this.placeBlockRotated(world, TFBlocks.bossSpawner.cz, 3, 9, y + 4, 9, rotation, sbb);
    }
    
    private void decorateExperiment(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        this.fillBlocksRotated(world, sbb, 17, y + 1, 1, 17, y + 4, 6, this.deco.pillarID, this.deco.pillarMeta, rotation);
        this.fillBlocksRotated(world, sbb, 12, y + 1, 1, 17, y + 4, 1, this.deco.pillarID, this.deco.pillarMeta, rotation);
        this.fillBlocksRotated(world, sbb, 13, y + 1, 2, 16, y + 1, 5, this.deco.blockID, this.deco.blockMeta, rotation);
        this.fillBlocksRotated(world, sbb, 12, y + 1, 2, 12, y + 1, 6, this.deco.stairID, this.getStairMeta(0 + rotation), rotation);
        ...
        this.makeStonePillar(world, this.deco, 12, y, 1, this.getStairMeta(3 + rotation), rotation, sbb);
        this.makeStonePillar(world, this.deco, 17, y, 6, this.getStairMeta(0 + rotation), rotation, sbb);
        this.placeBlockRotated(world, aou.aC.cz, 0, 14, y + 2, 4, rotation, sbb);
        this.placeItemFrameRotated(world, 13, y + 2, 1, rotation, 0, new wg(TFItems.borerEssence), sbb);
        this.placeItemFrameRotated(world, 14, y + 2, 1, rotation, 0, new wg(we.aD), sbb);
        this.placeItemFrameRotated(world, 15, y + 2, 1, rotation, 0, new wg(TFItems.borerEssence), sbb);
        this.placeItemFrameRotated(world, 13, y + 3, 1, rotation, 0, new wg(we.aD), sbb);
        this.placeItemFrameRotated(world, 14, y + 3, 1, rotation, 0, new wg(we.bq), sbb);
        this.placeItemFrameRotated(world, 15, y + 3, 1, rotation, 0, new wg(we.aD), sbb);
        this.placeItemFrameRotated(world, 13, y + 4, 1, rotation, 0, new wg(TFItems.borerEssence), sbb);
        this.placeItemFrameRotated(world, 14, y + 4, 1, rotation, 0, new wg(we.aD), sbb);
        this.placeItemFrameRotated(world, 15, y + 4, 1, rotation, 0, new wg(TFItems.borerEssence), sbb);
        this.placeItemFrameRotated(world, 17, y + 2, 3, rotation, 1, new wg(TFBlocks.towerWood, 1, 1), sbb);
        this.placeItemFrameRotated(world, 17, y + 2, 4, rotation, 1, new wg(TFBlocks.towerWood, 1, 0), sbb);
        this.placeItemFrameRotated(world, 17, y + 2, 5, rotation, 1, new wg(TFBlocks.towerWood, 1, 1), sbb);
        this.placeItemFrameRotated(world, 17, y + 3, 3, rotation, 1, new wg(TFBlocks.towerWood, 1, 0), sbb);
        this.placeItemFrameRotated(world, 17, y + 3, 4, rotation, 1, new wg(TFItems.carminite), sbb);
        this.placeItemFrameRotated(world, 17, y + 3, 5, rotation, 1, new wg(TFBlocks.towerWood, 1, 0), sbb);
        this.placeItemFrameRotated(world, 17, y + 4, 3, rotation, 1, new wg(TFBlocks.towerWood, 1, 1), sbb);
        this.placeItemFrameRotated(world, 17, y + 4, 4, rotation, 1, new wg(TFBlocks.towerWood, 1, 0), sbb);
        this.placeItemFrameRotated(world, 17, y + 4, 5, rotation, 1, new wg(TFBlocks.towerWood, 1, 1), sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 13, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 15, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 13, y + 1, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 15, y + 1, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 13, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 14, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 15, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 14, y + 1, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 14, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 13, y + 2, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 15, y + 2, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 13, y + 2, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 15, y + 2, 15, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 12, 14, y + 2, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 13, y + 3, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 15, y + 3, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 13, y + 3, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.at.cz, 0, 15, y + 3, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 13, y + 3, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 14, y + 3, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 15, y + 3, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.bf.cz, 0, 14, y + 3, 15, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 14, y + 3, 14, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 14, y + 1, 17, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 4), 13, y + 1, 17, rotation, sbb);
        this.placeBlockRotated(world, aou.ad.cz, 5 - this.getStairMeta(3 + rotation), 14, y + 2, 17, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 14, y + 2, 16, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 17, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 2), 17, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.ad.cz, 5 - this.getStairMeta(2 + rotation), 17, y + 2, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 16, y + 2, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 14, y + 2, 11, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 14, y + 1, 11, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 4) + 8, 13, y + 1, 11, rotation, sbb);
        this.placeBlockRotated(world, aou.ad.cz, 5 - this.getStairMeta(1 + rotation), 14, y + 2, 10, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 14, y + 1, 9, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 4), 13, y + 1, 9, rotation, sbb);
        this.placeBlockRotated(world, aou.Z.cz, 5 - this.getStairMeta(1 + rotation), 14, y + 2, 9, rotation, sbb);
        this.placeBlockRotated(world, aou.cs.cz, 0, 11, y + 2, 14, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 11, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 2) + 8, 11, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.ad.cz, 5 - this.getStairMeta(0 + rotation), 10, y + 2, 14, rotation, sbb);
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 9, y + 1, 14, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, 2), 9, y + 1, 13, rotation, sbb);
        this.placeBlockRotated(world, aou.Z.cz, 5 - this.getStairMeta(0 + rotation), 9, y + 2, 14, rotation, sbb);
    }
    
    private void makeWoodPillar(final zv world, final StructureTFDecorator forgeDeco, final int x, final int y, final int z, final int stairMeta, final int rotation, final aee sbb) {
        this.placeBlockRotated(world, TFBlocks.log.cz, 3, x, y + 2, z, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.log.cz, 3, x, y + 3, z, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.log.cz, 3, x, y + 4, z, rotation, sbb);
    }
    
    private void placeItemFrameRotated(final zv world, final int x, final int y, final int z, final int rotation, final int direction, final wg itemStack, final aee sbb) {
        ...
        if (sbb.b(dx, dy, dz)) {
            final nf frame = new nf(world, dx, dy, dz, (this.getCoordBaseMode() + direction + rotation) % 4);
            if (itemStack != null) {
                frame.a(itemStack);
            }
            world.d((mp)frame);
    ...
    private void decorateAquarium(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        this.makePillarFrame(world, sbb, this.deco, rotation, 12, y, 3, 4, 4, 13, false);
        this.fillBlocksRotated(world, sbb, 13, y + 4, 4, 14, y + 4, 14, aou.E.cz, 0, rotation);
        ...
        this.fillBlocksRotated(world, sbb, 7, y + 4, 13, 8, y + 5, 14, aou.E.cz, 0, rotation);
    }
    
    private void decorateForge(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, aou.cl.cz, decoRNG.nextInt(16), 13, y + 2, 5, rotation, sbb);
        this.placeBlockRotated(world, aou.cl.cz, decoRNG.nextInt(16), 13, y + 2, 13, rotation, sbb);
        this.makeFirePit(world, forgeDeco, 6, y + 1, 12, rotation, sbb);
    }
    
    private void makeFurnacePillar(final zv world, final StructureTFDecorator forgeDeco, final Random rand, final int x, final int y, final int z, final int stairMeta, final int rotation, final aee sbb) {
        this.placeBlockRotated(world, forgeDeco.stairID, stairMeta + 4, x, y + 2, z, rotation, sbb);
        this.placeBlockRotated(world, aou.aF.cz, stairMeta + 4, x, y + 3, z, rotation, sbb);
        final int amount = rand.nextBoolean() ? (rand.nextInt(5) + 4) : 0;
        if (amount > 0) {
            final int dx = this.getXWithOffsetAsIfRotated(x, z, rotation);
            final int dy = this.a(y + 3);
            final int dz = this.getZWithOffsetAsIfRotated(x, z, rotation);
            if (sbb.b(dx, dy, dz) && world.a(dx, dy, dz) == aou.aF.cz) {
                final lt inv = (lt)world.r(dx, dy, dz);
                inv.a(1, new wg(we.n, amount, 1));
            }
        }
        this.placeBlockRotated(world, forgeDeco.stairID, stairMeta, x, y + 4, z, rotation, sbb);
    }
    
    private void makeStonePillar(final zv world, final StructureTFDecorator forgeDeco, final int x, final int y, final int z, final int stairMeta, final int rotation, final aee sbb) {
    ...
    private void makeFirePit(final zv world, final StructureTFDecorator myDeco, final int x, final int y, final int z, final int rotation, final aee sbb) {
        ...
        this.placeBlockRotated(world, aou.bf.cz, 0, x, y, z, rotation, sbb);
        this.placeBlockRotated(world, aou.av.cz, 0, x, y + 1, z, rotation, sbb);
    }
    
    private void decorateNetherwart(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y, final boolean isTop) {
        final StructureTFDecorator netherDeco = this.deco;
        this.makePillarFrame(world, sbb, netherDeco, rotation, 12, y, 9, 4, 4, 7, true);
        this.fillBlocksRotated(world, sbb, 13, y + 1, 10, 14, y + 1, 14, aou.bg.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 13, y + 2, 10, 14, y + 2, 14, aou.bH.cz, 0, rotation);
        this.fillBlocksRotated(world, sbb, 13, y + 4, 10, 14, y + 4, 14, aou.bg.cz, 0, rotation);
    ...
    private void decorateBotanical(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, aou.bS.cz, 9, 13, y + 1, 7, rotation, sbb);
        this.placeBlockRotated(world, aou.bS.cz, 9, 14, y + 1, 7, rotation, sbb);
        ...
        this.placeBlockRotated(world, aou.bS.cz, 9, 13, y + 1, 10, rotation, sbb);
        this.placeBlockRotated(world, aou.bS.cz, 9, 14, y + 1, 10, rotation, sbb);
    ...
    private void placeTreePlanter(final zv world, final int treeNum, final int x, final int y, final int z, final int rotation, final aee sbb) {
        ...
        this.placeBlockRotated(world, aou.z.cz, 0, x, y, z, rotation, sbb);
        final int dx = this.getXWithOffsetAsIfRotated(x, z, rotation);
        ...
        if (sbb.b(dx, dy, dz)) {
            ...
            switch (treeNum) {
                default: {
                    treeGen = (add)new adz(false);
                    break;
                }
                case 1: {
                    treeGen = (add)new adz(true, 3, 3, 3, false);
                    break;
                }
                case 2: {
                    treeGen = (add)new acw(false);
                    break;
                }
                case 3: {
    ...
    private void placeRandomPlant(final zv world, final Random decoRNG, final int x, final int y, final int z, final int rotation, final aee sbb) {
        final int potMeta = decoRNG.nextInt(12);
        this.placeBlockRotated(world, aou.cg.cz, potMeta, x, y, z, rotation, sbb);
    }
    
    private void makeBottomEntrance(final zv world, final Random decoRNG, final aee sbb, final int rotation, final int y) {
    ...
    protected void addTimberMaze(final zv world, final Random rand, final aee sbb, int bottom, final int top) {
        final int spacing = 5;
        int floorside = 0;
        if (bottom == 0) {
            bottom += spacing;
    ...
    protected void makeTimberBeams(final zv world, final Random rand, final aee sbb, final int rotation, final int y, final boolean isBottom, final boolean isTop, final int top) {
        final int beamID = TFBlocks.log.cz;
        final int beamMetaBase = 3;
        final int beamMetaNS = ((this.f + rotation) % 2 == 0) ? 4 : 8;
        ...
        for (int by = 1; by < 5; ++by) {
            if (!isBottom || this.checkPost(world, x2, y - 5, z2, rotation, sbb)) {
                ...
                this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, rotation), x2 + 1, y - by, z2, rotation, sbb);
            }
            ...
            if (!isBottom || this.checkPost(world, x4, y - 5, z4, rotation, sbb)) {
                ...
                this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(4, rotation), x4 - 1, y - by, z4, rotation, sbb);
            }
        }
        if (isTop) {
            final int topFloorRotation = (this.e.b + top + 1) % 4;
            final int ladderX = 4;
            ...
            for (int by2 = 1; by2 < 5; ++by2) {
                ...
                this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(ladderMeta, topFloorRotation), ladderX, y + by2, ladderZ, topFloorRotation, sbb);
            }
        ...
        this.placeBlockRotated(world, aou.bP.cz, 0, lx, y + 2, lz, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, rand.nextBoolean() ? 0 : 7, lx, y + 1, lz, rotation, sbb);
    }
    
    private void makeMiniGhastSpawner(final zv world, final Random rand, final int y, final int sx, final int sz, final aee sbb) {
        final aqd spawner = this.placeSpawnerAtCurrentPosition(world, rand, sx, y + 2, sz, TFCreatures.getSpawnerNameFor("Mini Ghast"), sbb);
        if (spawner != null) {
            final bs tags = new bs();
            spawner.b(tags);
    ...
    protected void addBuilderPlatforms(final zv world, final Random rand, final aee sbb, int bottom, final int top) {
        final int spacing = 5;
        int floorside = 0;
        if (bottom == 0) {
            bottom += spacing;
        ...
        for (int y = bottom - 4; y < bottom; ++y) {
            this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, 1), 1, y, 5, 1, sbb);
            this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, 3), 1, y, 5, 3, sbb);
        }
        this.addTopBuilderPlatform(world, rand, bottom, top, spacing, sbb);
    }
    
    protected void makeBuilderPlatforms(final zv world, final Random rand, final aee sbb, final int rotation, final int y, final boolean bottom, final boolean top) {
        final int z = this.size / 2 + rand.nextInt(5) - rand.nextInt(5);
        this.makeBuilderPlatform(world, rand, rotation, y, z, false, sbb);
        this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, rotation), 1, y + 1, z, rotation, sbb);
        this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, rotation), 1, y + 2, z, rotation, sbb);
        this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, rotation), 1, y + 3, z, rotation, sbb);
        this.placeBlockRotated(world, aou.aJ.cz, this.getLadderMeta(2, rotation), 1, y + 4, z, rotation, sbb);
        ...
        if (y % 2 == 1) {
            ...
            this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 9, sx, y + 2, sz, rotation, sbb);
        }
        else {
    ...
    private void addTopBuilderPlatform(final zv world, final Random rand, final int bottom, final int top, final int spacing, final aee sbb) {
        final int rotation = (this.e.b + top + 1) % 4;
        ...
        this.fillBlocksRotated(world, sbb, 6, top - spacing + 1, 10, 6, top - 1, 10, aou.aJ.cz, this.getLadderMeta(3, rotation), rotation);
        ...
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 6, 7, top - spacing, 10, rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, rand.nextBoolean() ? 5 : 6, 7, top - spacing + 1, 11, rotation, sbb);
    }
    
    private void makeBuilderPlatform(final zv world, final Random rand, final int rotation, final int y, final int z, final boolean hole, final aee sbb) {
        ...
        this.placeBlockRotated(world, this.deco.accentID, this.deco.accentMeta, 2, y, z + 1, rotation, sbb);
        this.placeBlockRotated(world, TFBlocks.towerDevice.cz, 6, 2, y, hole ? (z + 1) : (z - 1), rotation, sbb);
        this.placeBlockRotated(world, aou.aN.cz, rand.nextBoolean() ? 5 : 6, 2, y + 1, z + 0, rotation, sbb);
    }
    
    private void makeLampCluster(final zv world, final Random rand, final int sx, final int y, final int sz, final int rotation, final aee sbb) {
        final int radius = 4;
        for (int i = 0; i < 5; ++i) {
            int lx = sx;
            int ly = y;
            ...
            for (int move = 0; move < 10; ++move) {
                this.placeBlockRotated(world, aou.bP.cz, 0, lx, ly, lz, rotation, sbb);
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (int move2 = 0; move2 < 10; ++move2) {
                ...
                if (this.getBlockIDRotated(world, lx, ly, lz, rotation, sbb) != aou.bP.cz) {
                    this.placeBlockRotated(world, aou.aN.cz, this.getLeverMeta(rotation, direction2), lx, ly, lz, rotation, sbb);
                    break;
                }
            }
        }
