...
public class ComponentTFDarkTowerMain extends ComponentTFDarkTowerWing
{
    ...
    private boolean makeEntranceTower(final List<StructureComponent> list, final Random rand, final int index, final int x, final int y, final int z, final int childSize, final int childHeight, final int rotation) {
    ...
    private boolean makeNewLargeTower(final List<StructureComponent> list, final Random rand, final int index, final int x, final int y, final int z, final int rotation) {
    ...
    private boolean makeBossTrapWing(final List<StructureComponent> list, final Random rand, final int index, final int x, final int y, final int z, final int rotation) {
    ...
    private void decorateDeadEnd(final World world, final Random decoRNG, final TFMaze maze, final int mx, final int y, final int mz, final int facing, final int rotation, final StructureBoundingBox sbb) {
        ...
        switch (facing) {
            case 0: {
                ...
                this.func_151550_a(world, (Block)Blocks.field_150486_ae, 0, x + 0, y + 2, z + 1, sbb);
            ...
            case 1: {
                ...
                this.func_151550_a(world, this.deco.accentID, this.deco.accentMeta, x + 0, y + 1, z + 1, sbb);
                this.func_151550_a(world, (Block)Blocks.field_150486_ae, rotation, x + 0, y + 2, z + 0, sbb);
            ...
            case 3: {
                this.func_151550_a(world, this.deco.accentID, this.deco.accentMeta, x + 1, y + 1, z + 0, sbb);
                this.func_151550_a(world, this.deco.accentID, this.deco.accentMeta, x + 1, y + 1, z + 1, sbb);
                this.func_151550_a(world, (Block)Blocks.field_150486_ae, rotation, x + 1, y + 2, z + 0, sbb);
                this.placeTreasureAtCurrentPosition(world, decoRNG, x + 1, y + 2, z + 1, TFTreasure.darktower_cache, sbb);
                break;
            }
        }
    ...
    private void decorateLounge(final World world, final Random decoRNG, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150383_bp, 3, 15, y + 2, 3, rotation, sbb);
    ...
    private void decorateExperiment(final World world, final Random decoRNG, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150331_J, 5 - this.getStairMeta(3 + rotation), 14, y + 2, 17, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150331_J, 5 - this.getStairMeta(2 + rotation), 17, y + 2, 14, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150331_J, 5 - this.getStairMeta(1 + rotation), 14, y + 2, 10, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150320_F, 5 - this.getStairMeta(1 + rotation), 14, y + 2, 9, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150331_J, 5 - this.getStairMeta(0 + rotation), 10, y + 2, 14, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150320_F, 5 - this.getStairMeta(0 + rotation), 9, y + 2, 14, rotation, sbb);
    }
    ...
    private void decorateAquarium(final World world, final Random decoRNG, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.fillBlocksRotated(world, sbb, 13, y + 4, 4, 14, y + 4, 14, (Block)Blocks.field_150358_i, 0, rotation);
        ...
        this.fillBlocksRotated(world, sbb, 7, y + 4, 13, 8, y + 5, 14, (Block)Blocks.field_150358_i, 0, rotation);
    }
    ...
    private void makeFurnacePillar(final World world, final StructureTFDecorator forgeDeco, final Random rand, final int x, final int y, final int z, final int stairMeta, final int rotation, final StructureBoundingBox sbb) {
        ...
        if (amount > 0) {
            ...
            if (sbb.func_78890_b(dx, dy, dz) && world.func_147439_a(dx, dy, dz) == Blocks.field_150460_al) {
                final IInventory inv = (IInventory)world.func_147438_o(dx, dy, dz);
    ...
    private void makeFirePit(final World world, final StructureTFDecorator myDeco, final int x, final int y, final int z, final int rotation, final StructureBoundingBox sbb) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150480_ab, 0, x, y + 1, z, rotation, sbb);
    }
    ...
    private void decorateBotanical(final World world, final Random decoRNG, final StructureBoundingBox sbb, final int rotation, final int y) {
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150376_bx, 9, 13, y + 1, 7, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150376_bx, 9, 14, y + 1, 7, rotation, sbb);
        ...
        this.placeBlockRotated(world, (Block)Blocks.field_150376_bx, 9, 13, y + 1, 10, rotation, sbb);
        this.placeBlockRotated(world, (Block)Blocks.field_150376_bx, 9, 14, y + 1, 10, rotation, sbb);
    ...
    private void placeTreePlanter(final World world, final int treeNum, final int x, final int y, final int z, final int rotation, final StructureBoundingBox sbb) {
        ...
        if (sbb.func_78890_b(dx, dy, dz)) {
            ...
            switch (treeNum) {
                ...
                case 2: {
                    treeGen = (WorldGenerator)new WorldGenForest(true, false);
                    break;
                }
                case 3: {
    ...
    protected void makeTimberBeams(final World world, final Random rand, final StructureBoundingBox sbb, final int rotation, final int y, final boolean isBottom, final boolean isTop, final int top) {
        final Block beamID = TFBlocks.log;
        ...
        for (int by = 1; by < 5; ++by) {
            if (!isBottom || this.checkPost(world, x2, y - 5, z2, rotation, sbb)) {
                ...
                this.placeBlockRotated(world, Blocks.field_150468_ap, this.getLadderMeta(2, rotation), x2 + 1, y - by, z2, rotation, sbb);
            }
            ...
            if (!isBottom || this.checkPost(world, x4, y - 5, z4, rotation, sbb)) {
                ...
                this.placeBlockRotated(world, Blocks.field_150468_ap, this.getLadderMeta(4, rotation), x4 - 1, y - by, z4, rotation, sbb);
            }
        }
        if (isTop) {
            ...
            for (int by2 = 1; by2 < 5; ++by2) {
                ...
                this.placeBlockRotated(world, Blocks.field_150468_ap, this.getLadderMeta(ladderMeta, topFloorRotation), ladderX, y + by2, ladderZ, topFloorRotation, sbb);
            }
            this.placeBlockRotated(world, Blocks.field_150350_a, 0, ladderX, y + 6, 9, topFloorRotation, sbb);
        ...
        this.placeBlockRotated(world, Blocks.field_150379_bu, 0, lx, y + 2, lz, rotation, sbb);
        this.placeBlockRotated(world, Blocks.field_150442_at, rand.nextBoolean() ? 0 : 7, lx, y + 1, lz, rotation, sbb);
    }
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (int move2 = 0; move2 < 10; ++move2) {
                ...
                if (this.getBlockIDRotated(world, lx, ly, lz, rotation, sbb) != Blocks.field_150379_bu) {
                    this.placeBlockRotated(world, Blocks.field_150442_at, this.getLeverMeta(rotation, direction2), lx, ly, lz, rotation, sbb);
                    break;
                }
            }
        }
