...
public class ComponentTFDarkTowerBossTrap extends ComponentTFDarkTowerWing
{
    ...
    public boolean a(final zv world, final Random rand, final aee sbb) {
        ...
        this.a(world, TFBlocks.towerDevice.cz, 10, 5, 1, 5, sbb);
        this.a(world, aou.az.cz, 0, 5, 1, 6, sbb);
        this.a(world, aou.az.cz, 0, 5, 1, 7, sbb);
        this.a(world, aou.az.cz, 0, 5, 1, 8, sbb);
        this.a(world, aou.az.cz, 0, 4, 1, 8, sbb);
        this.a(world, aou.az.cz, 0, 3, 1, 8, sbb);
        this.a(world, aou.aQ.cz, 0, 2, 1, 8, sbb);
        return true;
    }
    
    protected void addBossTrapFloors(final zv world, final Random rand, final aee sbb, final int bottom, final int top) {
