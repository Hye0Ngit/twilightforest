...
public class ComponentTFDarkTowerBossTrap extends ComponentTFDarkTowerWing
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_151550_a(world, (Block)Blocks.field_150488_af, 0, 5, 1, 6, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150488_af, 0, 5, 1, 7, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150488_af, 0, 5, 1, 8, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150488_af, 0, 4, 1, 8, sbb);
        this.func_151550_a(world, (Block)Blocks.field_150488_af, 0, 3, 1, 8, sbb);
