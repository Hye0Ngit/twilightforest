...
public class ComponentTFDarkTowerBossTrap extends ComponentTFDarkTowerWing
{
    ...
    protected ComponentTFDarkTowerBossTrap(final TFFeature feature, final int i, final int x, final int y, final int z, final int pSize, final int pHeight, final EnumFacing direction) {
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        ...
        this.func_175811_a(world, TFBlocks.tower_device.func_176223_P().func_177226_a((IProperty)BlockTFTowerDevice.VARIANT, (Comparable)TowerDeviceVariant.GHASTTRAP_INACTIVE), 5, 1, 5, sbb);
        ...
        this.func_175811_a(world, Blocks.field_150452_aw.func_176223_P(), 2, 1, 8, sbb);
        return true;
    }
    ...
    protected void addBossTrapFloors(final World world, final Random rand, final StructureBoundingBox sbb, final int bottom, final int top) {
        this.makeFullFloor(world, sbb, Rotation.COUNTERCLOCKWISE_90, 4, 4);
