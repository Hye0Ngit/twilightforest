...
public class ComponentTFDarkTowerBridge extends ComponentTFTowerWing
{
    ...
    public boolean func_74875_a(final World world, final Random rand, final StructureBoundingBox sbb) {
        this.func_74884_a(world, sbb, 0, 0, 0, this.size - 1, this.height - 1, this.size - 1, this.deco.blockID, this.deco.blockMeta, false);
        for (int x = 0; x < this.size; ++x) {
            this.func_74864_a(world, this.deco.accentID, this.deco.accentMeta, x, 0, 0, sbb);
            this.func_74864_a(world, this.deco.accentID, this.deco.accentMeta, x, this.height - 1, 0, sbb);
            this.func_74864_a(world, this.deco.accentID, this.deco.accentMeta, x, 0, this.size - 1, sbb);
            this.func_74864_a(world, this.deco.accentID, this.deco.accentMeta, x, this.height - 1, this.size - 1, sbb);
        }
