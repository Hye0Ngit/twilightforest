    ...
    public boolean a(final xv world, final Random rand, final acg sbb) {
        ...
        for (int x = 1; x < 14; ++x) {
            for (int z = 1; z < 14; ++z) {
                ...
                if (mushroom) {
                    this.a(world, mushRed ? amj.aj.cm : amj.ai.cm, 0, x, 1, z, sbb);
                }
            }
        }
        this.a(world, sbb, 1, 1, 1, 3, 1, 3, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 1, 2, 1, 1, 3, 4, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 2, 2, 1, 4, 3, 1, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 1, 4, 1, 3, 4, 3, amj.br.cm, 14, 0, 0, false);
        this.placeTreasureAtCurrentPosition(world, rand, 3, 2, 3, TFTreasure.labyrinth_room, sbb);
        this.a(world, sbb, 12, 1, 12, 14, 1, 14, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 14, 2, 11, 14, 3, 14, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 11, 2, 14, 14, 3, 14, amj.br.cm, 14, 0, 0, false);
        this.a(world, sbb, 12, 4, 12, 14, 4, 14, amj.br.cm, 14, 0, 0, false);
        this.placeTreasureAtCurrentPosition(world, rand, 12, 2, 12, TFTreasure.labyrinth_room, sbb);
        this.a(world, sbb, 1, 1, 12, 3, 1, 14, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 1, 2, 11, 1, 3, 14, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 2, 2, 14, 4, 3, 14, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 1, 4, 12, 3, 4, 14, amj.bq.cm, 14, 0, 0, false);
        this.placeTreasureAtCurrentPosition(world, rand, 3, 2, 12, TFTreasure.labyrinth_room, sbb);
        this.a(world, sbb, 12, 1, 1, 14, 1, 3, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 11, 2, 1, 14, 3, 1, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 14, 2, 2, 14, 3, 4, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 12, 4, 1, 14, 4, 3, amj.bq.cm, 14, 0, 0, false);
        this.placeTreasureAtCurrentPosition(world, rand, 12, 2, 3, TFTreasure.labyrinth_room, sbb);
        this.a(world, sbb, 5, 4, 5, 7, 5, 7, amj.bq.cm, 14, 0, 0, false);
        this.a(world, sbb, 8, 4, 8, 10, 5, 10, amj.br.cm, 14, 0, 0, false);
        if (!this.taurPlaced) {
