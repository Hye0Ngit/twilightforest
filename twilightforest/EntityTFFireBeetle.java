...
public class EntityTFFireBeetle extends qj
{
    ...
    public EntityTFFireBeetle(final xv world) {
        super(world);
        this.aF = "/twilightforest/firebeetle.png";
        this.bG = 0.23f;
        this.a(1.1f, 0.75f);
        this.bm.a(0, (nc)new mz((md)this));
        this.bm.a(2, (nc)new EntityAITFFireBreath((md)this, this.bG, 5.0f, 30, 0.1f));
    ...
    public EntityTFFireBeetle(final xv world, final double x, final double y, final double z) {
        this(world);
        this.b(x, y, z);
    }
