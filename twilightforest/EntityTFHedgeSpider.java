...
{
    public EntityTFHedgeSpider(final xv world) {
        super(world);
        this.aF = "/twilightforest/hedgespider.png";
    }
    
    public EntityTFHedgeSpider(final xv world, final double x, final double y, final double z) {
        this(world);
        this.b(x, y, z);
    }
