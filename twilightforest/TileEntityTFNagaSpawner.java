...
public class TileEntityTFNagaSpawner extends anl
{
    public TileEntityTFNagaSpawner() {
        this.a(TFCreatures.getSpawnerNameFor("Naga"));
        this.a = 0;
    }
    ...
    public void g() {
        ...
        if (!this.k.J) {
            ...
            final md entityliving = (md)lv.a(TFCreatures.getSpawnerNameFor("Naga"), this.k);
            if (entityliving == null) {
                return;
            }
            final int j = this.k.a((Class)entityliving.getClass(), anw.a((double)this.l, (double)this.m, (double)this.n, (double)(this.l + 1), (double)(this.m + 1), (double)(this.n + 1)).b(100.0, 20.0, 100.0)).size();
            if (j >= 1) {
                this.updateDelay();
                return;
            }
            ...
            entityliving.b(this.l, this.m, this.n, 46);
            entityliving.aR();
            this.updateDelay();
