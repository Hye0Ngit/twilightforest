...
public class TFMaze
{
    ...
    public void copyToWorld(final xd world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
    ...
    public void carveToWorld(final xd world, final int dx, final int dy, final int dz) {
        this.worldX = dx;
        this.worldY = dy;
        this.worldZ = dz;
        for (int x = 0; x < this.rawWidth; ++x) {
    ...
    public void copyToStructure(final xd world, final Random rand, final int dx, final int dy, final int dz, final StructureTFComponent component, final qg sbb) {
        for (int x = 0; x < this.rawWidth; ++x) {
            for (int z = 0; z < this.rawDepth; ++z) {
                if (this.getRaw(x, z) == 0) {
                    final int mdx = dx + x / 2 * (this.evenBias + this.oddBias);
    ...
    protected void putWallBlock(final xd world, final int x, final int y, final int z) {
        world.d(x, y, z, this.wallBlockID, this.wallBlockMeta);
    }
    
    protected void putWallBlock(final xd world, final int x, final int y, final int z, final StructureTFComponent component, final qg sbb) {
        component.a(world, this.wallBlockID, this.wallBlockMeta, x, y, z, sbb);
    }
    
    protected void carveBlock(final xd world, final int x, final int y, final int z) {
        world.d(x, y, z, 0, 0);
    }
    
    protected void putRootBlock(final xd world, final int x, final int y, final int z) {
        world.d(x, y, z, this.rootBlockID, this.rootBlockMeta);
    }
    
    protected void putRootBlock(final xd world, final int x, final int y, final int z, final StructureTFComponent component, final qg sbb) {
        component.a(world, this.rootBlockID, this.rootBlockMeta, x, y, z, sbb);
    }
    
    protected void putCanopyTree(final xd world, final int x, final int y, final int z, final StructureTFComponent component, final qg sbb) {
    ...
    public void placeTorches(final xd world) {
