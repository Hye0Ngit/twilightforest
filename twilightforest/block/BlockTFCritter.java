...
public abstract class BlockTFCritter extends aou
{
    protected BlockTFCritter(final int index) {
        super(index, ahz.q);
        this.c(0.0f);
        this.a((uy)TFItems.creativeTab);
        this.cM = new StepSoundTFInsect("squish", 0.25f, 0.6f);
    }
    ...
    public boolean c(final zv world, final int i, final int j, final int k) {
    ...
    public int a(final zv par1World, final int x, final int y, final int z, final int placementFacing, final float par6, final float par7, final float par8, int meta) {
    ...
    public boolean dropCritterIfCantStay(final zv world, final int x, final int y, final int z) {
    ...
    public void a(final zv world, final int x, final int y, final int z, final int blockID) {
    ...
    public boolean canPlaceAt(final zv world, final int x, final int y, final int z) {
        return world.u(x, y, z) || world.g(x, y, z) == ahz.j || world.g(x, y, z) == ahz.y;
    }
    ...
    public abstract aqj createTileEntity(final zv p0, final int p1);
    ...
    public void a(final ly par1IconRegister) {
        this.cQ = par1IconRegister.a("twilightforest:" + this.a().substring(5));
    }
}
