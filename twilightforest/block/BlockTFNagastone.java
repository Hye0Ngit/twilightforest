...
public class BlockTFNagastone extends Block
{
    ...
    public void func_71860_a(final World par1World, final int x, final int y, final int z, final EntityLivingBase par5EntityLiving, final ItemStack par6ItemStack) {
        ...
        final int pistonOrient = BlockPistonBase.func_72116_b(par1World, x, y, z, (EntityLivingBase)par5EntityLiving);
        switch (pistonOrient) {
            case 0:
            case 1: {
                direction = 2;
