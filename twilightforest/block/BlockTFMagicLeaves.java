...
public class BlockTFMagicLeaves extends amu
{
    int oakColor;
    int canopyColor;
    int mangroveColor;
    ...
    public static lx SPR_TIMELEAVES;
    public static lx SPR_TIMEFX;
    public static lx SPR_TRANSLEAVES;
    public static lx SPR_TRANSFX;
    public static lx SPR_SORTLEAVES;
    public static lx SPR_SORTFX;
    ...
    public int c(final aae world, final int x, final int y, final int z) {
    ...
    private void sparkleRunes(final zv world, final int x, final int y, final int z, final Random rand) {
