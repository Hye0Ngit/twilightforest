...
public class AuroraBrickBlock extends Block
{
    ...
    public AuroraBrickBlock(final AbstractBlock.Properties props) {
        super(props);
    }
    ...
    public BlockState func_196258_a(final BlockItemUseContext ctx) {
        return (BlockState)this.func_176223_P().func_206870_a((Property)AuroraBrickBlock.VARIANT, (Comparable)calcVariant(ctx.func_195995_a()));
    }
    ...
    public BlockState func_196271_a(final BlockState stateIn, final Direction facing, final BlockState facingState, final IWorld worldIn, final BlockPos currentPos, final BlockPos facingPos) {
        return (BlockState)this.func_176223_P().func_206870_a((Property)AuroraBrickBlock.VARIANT, (Comparable)calcVariant(currentPos));
    }
    ...
    protected void func_206840_a(final StateContainer.Builder<Block, BlockState> builder) {
        ...
        builder.func_206894_a(new Property[] { (Property)AuroraBrickBlock.VARIANT });
    }
    
    static {
        VARIANT = IntegerProperty.func_177719_a("variant", 0, 15);
    }
