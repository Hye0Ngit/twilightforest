...
public class BlockTFLeaves extends akt
{
    int oakColor;
    int canopyColor;
    int mangroveColor;
    ...
    public int a(final int i, final int j) {
        return amq.N.a(i, ((j & 0x3) == 0x3) ? 0 : j);
    }
    ...
    public void a(final int par1, final tj par2CreativeTabs, final List par3List) {
        ...
        par3List.add(new ur((amq)this, 1, 2));
        par3List.add(new ur((amq)this, 1, 3));
    }
    ...
    public void a(final yc par1World, final int par2, final int par3, final int par4, final int par5, final float par6, final int par7) {
        if (!par1World.I) {
            byte chance = 40;
            if ((par5 & 0x3) == 0x2) {
                chance = 20;
            }
            if (par1World.t.nextInt(chance) == 0) {
                final int var9 = this.a(par5, par1World.t, par7);
                this.b(par1World, par2, par3, par4, new ur(var9, 1, this.b(par5)));
            }
        }
    }
}
