...
public class BlockTFLeaves extends amu
{
    int oakColor;
    int canopyColor;
    int mangroveColor;
    ...
    public lx a(final int i, final int j) {
        return aou.O.a(i, ((j & 0x3) == 0x3) ? 0 : j);
    }
    
    public boolean a(final aae iblockaccess, final int i, final int j, final int k, final int l) {
        return aou.O.a(iblockaccess, i, j, k, l);
    }
    ...
    public void a(final int par1, final uy par2CreativeTabs, final List par3List) {
        ...
        par3List.add(new wg((aou)this, 1, 2));
        par3List.add(new wg((aou)this, 1, 3));
    }
    ...
    public void a(final zv par1World, final int par2, final int par3, final int par4, final int par5, final float par6, final int par7) {
        if (!par1World.I) {
            byte chance = 40;
            if ((par5 & 0x3) == 0x2) {
                chance = 20;
            }
            if (par1World.s.nextInt(chance) == 0) {
                final int var9 = this.a(par5, par1World.s, par7);
                this.b(par1World, par2, par3, par4, new wg(var9, 1, this.a(par5)));
            }
        }
    }
}
