...
public class BlockTFLeaves extends aow
{
    ...
    public mr a(final int i, final int j) {
        return aqw.P.a(i, ((j & 0x3) == 0x3) ? 0 : j);
    }
    ...
    public void a(final int par1, final wv par2CreativeTabs, final List par3List) {
        ...
        par3List.add(new yd((aqw)this, 1, 2));
    ...
    public void a(final abv par1World, final int par2, final int par3, final int par4, final int par5, final float par6, final int par7) {
        if (!par1World.I) {
            byte chance = 40;
            if ((par5 & 0x3) == 0x2) {
                chance = 20;
            ...
            if (par1World.s.nextInt(chance) == 0) {
                ...
                this.b(par1World, par2, par3, par4, new yd(var9, 1, this.a(par5)));
            }
        }
    }
}
