...
public class BlockTFSapling extends ama
{
    ...
    public void c(final yc world, final int x, final int y, final int z, final Random rand) {
        final int meta = world.h(x, y, z);
        abm treeGenerator = null;
        final int var8 = 0;
        final int var9 = 0;
