...
public class BlockTFHedge extends BlockLeavesBase
{
    ...
    public void func_71847_b(final World world, final int x, final int y, final int z, final Random random) {
        ...
        final List<EntityPlayer> nearbyPlayers = world.func_72872_a((Class)EntityPlayer.class, AxisAlignedBB.func_72332_a().func_72299_a((double)x, (double)y, (double)z, (double)(x + 1), (double)(y + 1), (double)(z + 1)).func_72314_b(range, range, range));
