...
public class BlockTFHedge extends BlockLeavesBase
{
    ...
    public AxisAlignedBB func_149668_a(final World world, final int x, final int y, final int z) {
        ...
        switch (meta) {
            case 0: {
                ...
                return AxisAlignedBB.func_72330_a((double)x, (double)y, (double)z, (double)(x + 1), (double)(y + 1 - f), (double)(z + 1));
            }
            default: {
    ...
    public boolean func_149646_a(final IBlockAccess par1IBlockAccess, final int par2, final int par3, final int par4, final int par5) {
        ...
        return (this.field_150121_P || i1 != this) && super.func_149646_a(par1IBlockAccess, par2, par3, par4, par5);
    }
    ...
    public void func_149724_b(final World world, final int x, final int y, final int z, final Entity entity) {
        int meta = world.func_72805_g(x, y, z);
        if (meta == 2) {
            meta = 0;
        }
    ...
    public void func_149699_a(final World world, final int x, final int y, final int z, final EntityPlayer entityplayer) {
        int meta = world.func_72805_g(x, y, z);
        if (meta == 2) {
            meta = 0;
        }
    ...
    public void func_149636_a(final World world, final EntityPlayer entityplayer, final int i, final int j, final int k, int meta) {
    ...
    public void func_149674_a(final World world, final int x, final int y, final int z, final Random random) {
        ...
        final List<EntityPlayer> nearbyPlayers = world.func_72872_a((Class)EntityPlayer.class, AxisAlignedBB.func_72330_a((double)x, (double)y, (double)z, (double)(x + 1), (double)(y + 1), (double)(z + 1)).func_72314_b(range, range, range));
