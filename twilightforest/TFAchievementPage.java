...
{
    private static final int ACH_BASE;
    ...
    static {
        ACH_BASE = TwilightForestMod.achievementBaseID;
        TFAchievementPage.twilightPortal = new Achievement(TFAchievementPage.ACH_BASE + 1, "twilightPortal", -2, 1, TFBlocks.portal, (Achievement)null).func_75987_b().func_75985_c();
        TFAchievementPage.twilightArrival = new Achievement(TFAchievementPage.ACH_BASE + 2, "twilightArrival", 0, 0, new ItemStack(TFBlocks.log, 1, 9), TFAchievementPage.twilightPortal).func_75985_c();
        TFAchievementPage.twilightHunter = new Achievement(TFAchievementPage.ACH_BASE + 3, "twilightHunter", 2, 2, TFItems.feather, TFAchievementPage.twilightArrival).func_75985_c();
        TFAchievementPage.twilightMagicMapFocus = new Achievement(TFAchievementPage.ACH_BASE + 5, "twilightMagicMapFocus", 2, 0, TFItems.magicMapFocus, TFAchievementPage.twilightHunter).func_75985_c();
        TFAchievementPage.twilightNaga = new Achievement(TFAchievementPage.ACH_BASE + 6, "twilightNaga", 2, 4, TFItems.nagaScale, TFAchievementPage.twilightHunter).func_75985_c();
        TFAchievementPage.twilightNagaArmors = new Achievement(TFAchievementPage.ACH_BASE + 7, "twilightNagaArmors", 3, 5, TFItems.plateNaga, TFAchievementPage.twilightNaga).func_75987_b().func_75985_c();
        TFAchievementPage.twilightLich = new Achievement(TFAchievementPage.ACH_BASE + 8, "twilightLich", 4, 3, TFItems.scepterTwilight, TFAchievementPage.twilightHunter).func_75985_c();
        TFAchievementPage.twilightLichScepters = new Achievement(TFAchievementPage.ACH_BASE + 9, "twilightLichScepters", 6, 4, TFItems.scepterZombie, TFAchievementPage.twilightLich).func_75987_b().func_75985_c();
        TFAchievementPage.twilightHill1 = new Achievement(TFAchievementPage.ACH_BASE + 10, "twilightHill1", -2, -1, Block.field_71949_H, TFAchievementPage.twilightArrival).func_75985_c();
        TFAchievementPage.twilightHill2 = new Achievement(TFAchievementPage.ACH_BASE + 11, "twilightHill2", -3, -2, Block.field_71941_G, TFAchievementPage.twilightArrival).func_75985_c();
        TFAchievementPage.twilightHill3 = new Achievement(TFAchievementPage.ACH_BASE + 12, "twilightHill3", -1, -3, Block.field_72073_aw, TFAchievementPage.twilightArrival).func_75985_c();
        TFAchievementPage.twilightHedge = new Achievement(TFAchievementPage.ACH_BASE + 13, "twilightHedge", 2, -3, TFBlocks.hedge, TFAchievementPage.twilightArrival).func_75985_c();
        TFAchievementPage.twilightMagicMap = new Achievement(TFAchievementPage.ACH_BASE + 14, "twilightMagicMap", 3, -1, TFItems.magicMap, TFAchievementPage.twilightMagicMapFocus).func_75985_c();
        TFAchievementPage.twilightMazeMap = new Achievement(TFAchievementPage.ACH_BASE + 15, "twilightMazeMap", -4, -1, TFItems.mazeMap, TFAchievementPage.twilightHill1).func_75985_c();
        TFAchievementPage.twilightOreMap = new Achievement(TFAchievementPage.ACH_BASE + 16, "twilightOreMap", -6, -3, TFItems.oreMap, TFAchievementPage.twilightMazeMap).func_75987_b().func_75985_c();
    }
}
