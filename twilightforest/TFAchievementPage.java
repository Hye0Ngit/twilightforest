...
public class TFAchievementPage extends AchievementPage
{
    ...
    static {
        ...
        TFAchievementPage.twilightArrival = new jg(7002, "twilightArrival", 0, 0, new ur(TFBlocks.log, 1, 9), TFAchievementPage.twilightPortal).c();
        ...
        TFAchievementPage.twilightHill1 = new jg(7010, "twilightHill1", -2, -1, amq.K, TFAchievementPage.twilightArrival).c();
        TFAchievementPage.twilightHill2 = new jg(7011, "twilightHill2", -3, -2, amq.J, TFAchievementPage.twilightArrival).c();
        TFAchievementPage.twilightHill3 = new jg(7012, "twilightHill3", -1, -3, amq.az, TFAchievementPage.twilightArrival).c();
