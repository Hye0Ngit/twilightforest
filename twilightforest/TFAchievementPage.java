...
public class TFAchievementPage extends AchievementPage
{
    ...
    static {
        ...
        TFAchievementPage.twilightProgressYeti = new Achievement("TwilightForest23", "twilightProgressYeti", -7, -3, Items.field_151126_ay, TFAchievementPage.twilightProgressUrghast).func_75971_g();
        TFAchievementPage.twilightProgressGlacier = new Achievement("TwilightForest24", "twilightProgressGlacier", -5, -5, Blocks.field_150432_aD, TFAchievementPage.twilightProgressYeti).func_75971_g();
