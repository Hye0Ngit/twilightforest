...
public class BlockTFNagastone extends amj
{
    ...
    public void a(final xv par1World, final int x, final int y, final int z, final md par5EntityLiving) {
        ...
        final int pistonOrient = ans.b(par1World, x, y, z, (qx)par5EntityLiving);
        switch (pistonOrient) {
            case 0:
            case 1: {
                direction = 2;
    ...
    public void a(final xv par1World, final int x, final int y, final int z, final int neighborID) {
    ...
    public boolean placePerfectFitBody(final xv world, final int x, final int y, final int z) {
    ...
    public boolean placePerfectFitHead(final xv world, final int x, final int y, final int z) {
    ...
    public int getOnlyNSEWConnection(final xv world, final int x, final int y, final int z) {
        final int firstConnection = this.getPosibleConnection(world, x, y, z, -1, -1);
        final int secondConnection = this.getPosibleConnection(world, x, y, z, firstConnection, -1);
    ...
    public int getOnlyConnection(final xv world, final int x, final int y, final int z) {
        final int firstConnection = this.getPosibleConnection(world, x, y, z, -1, -1);
        final int secondConnection = this.getPosibleConnection(world, x, y, z, firstConnection, -1);
    ...
    public int getPosibleConnection(final xv world, final int x, final int y, final int z, final int exclude1, final int exclude2) {
        for (int i = 0; i < 6; ++i) {
    ...
    public boolean isNagaStoneInDirection(final xv par1World, final int x, final int y, final int z, final int direction) {
        switch (direction) {
            case 0: {
    ...
    public static int determineOrientation(final xv par0World, final int par1, final int par2, final int par3, final qx par4EntityPlayer) {
