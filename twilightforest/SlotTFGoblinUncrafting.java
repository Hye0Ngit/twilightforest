...
public class SlotTFGoblinUncrafting extends sq
{
    ...
    public boolean a(final um par1ItemStack) {
        return false;
    }
    ...
    public void a(final qx par1EntityPlayer, final um par1ItemStack) {
        ...
        for (int i = 0; i < 9; ++i) {
            final um transferStack = this.uncraftingMatrix.a(i);
            if (transferStack != null && transferStack.a > 0) {
                this.assemblyMatrix.a(i, transferStack.l());
            }
        }
        final um inputStack = this.inputSlot.a(0);
        if (inputStack != null) {
