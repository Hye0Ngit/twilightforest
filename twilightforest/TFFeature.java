...
public class TFFeature
{
    ...
    public TFFeature(final int parID, final int parSize, final String parName) {
        ...
        (this.ambientMonsterList = new ArrayList()).add(new ys((Class)ow.class, 10, 8, 8));
    }
    ...
    public TFFeature addMonster(final Class monsterClass, final int weight, final int minGroup, final int maxGroup) {
        this.spawnableMonsterList.add(new ys(monsterClass, weight, minGroup, maxGroup));
        return this;
    }
    
    public static TFFeature getFeatureDirectlyAt(final int chunkX, final int chunkZ, final xv world) {
    ...
    public static TFFeature generateFeatureFor(final int chunkX, final int chunkZ, final xv world) {
        final yr biomeAt = world.a((chunkX << 4) + 8, (chunkZ << 4) + 8);
    ...
    public static TFFeature getNearestFeature(final int cx, final int cz, final xv world) {
    ...
    public static int[] getNearestCenter(final int cx, final int cz, final xv world) {
        for (int rad = 1; rad <= 3; ++rad) {
            for (int x = -rad; x <= rad; ++x) {
                for (int z = -rad; z <= rad; ++z) {
    ...
    public static s getNearestCenterXYZ(final int cx, final int cz, final xv world) {
