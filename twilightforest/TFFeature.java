...
public class TFFeature
{
    ...
    protected List<List<acq>> spawnableMonsterLists;
    protected List<acq> ambientCreatureList;
    protected List<acq> waterCreatureList;
    ...
    public TFFeature(final int parID, final int parSize, final String parName) {
        ...
        this.spawnableMonsterLists = new ArrayList<List<acq>>();
        this.ambientCreatureList = new ArrayList<acq>();
        this.waterCreatureList = new ArrayList<acq>();
        this.ambientCreatureList.add(new acq((Class)rn.class, 10, 8, 8));
    }
    ...
    public TFFeature addMonster(final int listIndex, final Class monsterClass, final int weight, final int minGroup, final int maxGroup) {
        List<acq> monsterList;
        if (this.spawnableMonsterLists.size() > listIndex) {
            monsterList = this.spawnableMonsterLists.get(listIndex);
        }
        else {
            monsterList = new ArrayList<acq>();
            this.spawnableMonsterLists.add(listIndex, monsterList);
        }
        monsterList.add(new acq(monsterClass, weight, minGroup, maxGroup));
        return this;
    }
    
    public TFFeature addWaterCreature(final Class monsterClass, final int weight, final int minGroup, final int maxGroup) {
        this.waterCreatureList.add(new acq(monsterClass, weight, minGroup, maxGroup));
        return this;
    }
    
    public static TFFeature getFeatureDirectlyAt(final int chunkX, final int chunkZ, final abv world) {
    ...
    public static TFFeature generateFeatureFor(final int chunkX, final int chunkZ, final abv world) {
        final acp biomeAt = world.a((chunkX << 4) + 8, (chunkZ << 4) + 8);
        final Random hillRNG = new Random(world.H() + chunkX * 25117 + chunkZ * 151121);
    ...
    public static TFFeature generateFeaturePreset5x5(final int chunkX, final int chunkZ, final abv world) {
        final int cf = 16;
    ...
    public static TFFeature generateFeaturePreset6x6(final int chunkX, final int chunkZ, final abv world) {
        final int cf = 16;
        if (chunkX % cf != 0 || chunkZ % cf != 0) {
            return TFFeature.nothing;
        }
    ...
    public static TFFeature getNearestFeature(final int cx, final int cz, final abv world) {
    ...
    public static TFFeature getNearestFeatureIncludeMore(final int chunkX, final int chunkZ, final abv world) {
    ...
    public static int[] getNearestCenter(final int cx, final int cz, final abv world) {
        for (int rad = 1; rad <= 3; ++rad) {
            for (int x = -rad; x <= rad; ++x) {
                for (int z = -rad; z <= rad; ++z) {
    ...
    public static t getNearestCenterXYZ(final int cx, final int cz, final abv world) {
    ...
    public List<acq> getSpawnableList(final og par1EnumCreatureType) {
        if (par1EnumCreatureType == og.a) {
            return this.getSpawnableList(og.a, 0);
        }
        if (par1EnumCreatureType == og.c) {
            return this.ambientCreatureList;
        }
        if (par1EnumCreatureType == og.d) {
            return this.waterCreatureList;
        }
        return this.emptyList;
    }
    
    public List<acq> getSpawnableList(final og par1EnumCreatureType, final int index) {
        if (par1EnumCreatureType != og.a) {
    ...
    static {
        ...
        TFFeature.wizardTower.addMonster(tv.class, 10, 4, 4);
        TFFeature.wizardTower.addMonster(tq.class, 10, 4, 4);
        TFFeature.wizardTower.addMonster(te.class, 1, 4, 4);
        TFFeature.wizardTower.addMonster(tf.class, 1, 1, 4);
        TFFeature.wizardTower.addMonster(EntityTFDeathTome.class, 10, 4, 4);
        TFFeature.hill1.addMonster(ts.class, 10, 4, 4);
        TFFeature.hill1.addMonster(tv.class, 10, 4, 4);
        ...
        TFFeature.hill2.addMonster(tq.class, 10, 4, 4);
        TFFeature.hill2.addMonster(EntityTFSwarmSpider.class, 10, 4, 4);
        TFFeature.hill2.addMonster(ts.class, 10, 4, 4);
        TFFeature.hill2.addMonster(te.class, 10, 4, 4);
        ...
        TFFeature.hill3.addMonster(tq.class, 10, 4, 4);
        TFFeature.hill3.addMonster(td.class, 10, 4, 4);
        TFFeature.hill3.addMonster(te.class, 10, 4, 4);
        TFFeature.hill3.addMonster(tf.class, 1, 1, 4);
        ...
        TFFeature.labyrinth.addMonster(td.class, 10, 4, 4);
        TFFeature.labyrinth.addMonster(te.class, 10, 4, 4);
        TFFeature.labyrinth.addMonster(EntityTFMazeSlime.class, 10, 4, 4);
        TFFeature.labyrinth.addMonster(tf.class, 1, 1, 4);
        ...
        TFFeature.underground.addMonster(ts.class, 10, 4, 4);
        TFFeature.underground.addMonster(tv.class, 10, 4, 4);
        TFFeature.underground.addMonster(tq.class, 10, 4, 4);
        TFFeature.underground.addMonster(te.class, 1, 4, 4);
        TFFeature.underground.addMonster(tr.class, 10, 4, 4);
        TFFeature.underground.addMonster(tf.class, 1, 1, 4);
        ...
        TFFeature.darkTower.addMonster(tq.class, 10, 4, 4);
        TFFeature.darkTower.addMonster(te.class, 10, 4, 4);
        TFFeature.darkTower.addMonster(tf.class, 2, 1, 4);
        ...
        TFFeature.darkTower.addWaterCreature(sb.class, 10, 4, 4);
        ...
        TFFeature.tfStronghold.addMonster(te.class, 10, 4, 4);
        TFFeature.tfStronghold.addMonster(tr.class, 5, 4, 4);
    }
}
