...
public class TFFeature
{
    ...
    public static TFFeature generateFeatureFor(final int chunkX, final int chunkZ, final World world) {
        if (TwilightForestMod.mapGenChanges) {
            return generateFeatureFor1Point7(chunkX, chunkZ, world);
        }
        ...
        switch (randnum) {
            ...
            case 13: {
                return (biomeAt != TFBiomeBase.tfSwamp) ? TFFeature.nagaLair : TFFeature.hydraLair;
            }
            case 14:
            case 15: {
    ...
    private static TFFeature generateFeatureFor1Point7(final int chunkX, final int chunkZ, final World world) {
        final BiomeGenBase biomeAt = world.func_72807_a((chunkX << 4) + 8, (chunkZ << 4) + 8);
        final Random hillRNG = new Random(world.func_72905_C() + chunkX * 25117 + chunkZ * 151121);
        final int randnum = hillRNG.nextInt(16);
        if (biomeAt == TFBiomeBase.glacier) {
    ...
    public List<SpawnListEntry> getSpawnableList(final EnumCreatureType par1EnumCreatureType) {
    ...
    public List<SpawnListEntry> getSpawnableList(final EnumCreatureType par1EnumCreatureType, final int index) {
        if (par1EnumCreatureType != EnumCreatureType.monster) {
    ...
    static {
        ...
        nagaLair = new TFFeature(5, 3, "Naga Courtyard").enableTerrainAlterations();
        ...
        TFFeature.wizardTower.addMonster(EntityWitch.class, 1, 1, 1);
