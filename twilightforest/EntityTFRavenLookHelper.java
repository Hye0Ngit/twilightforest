...
public class EntityTFRavenLookHelper extends mp
{
    ...
    public void a() {
        ...
        if (this.field_46147_d) {
            ...
            this.entity.ay = this.updateRotation(this.entity.ay, var5, this.field_46149_b);
        }
        else {
            this.entity.ay = this.updateRotation(this.entity.ay, this.entity.aw, 10.0f);
        }
        float var7;
        for (var7 = this.entity.ay - this.entity.aw; var7 < -180.0f; var7 += 360.0f) {}
        while (var7 >= 180.0f) {
            var7 -= 360.0f;
        }
        if (!this.entity.az().f()) {
            if (var7 < -75.0f) {
                this.entity.ay = this.entity.aw - 75.0f;
            }
            if (var7 > 75.0f) {
                this.entity.ay = this.entity.aw + 75.0f;
            }
