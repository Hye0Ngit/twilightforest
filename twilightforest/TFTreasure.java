...
public class TFTreasure
{
    ...
    public static TFTreasure stronghold_boss;
    public static TFTreasure aurora_cache;
    public static TFTreasure aurora_room;
    public static TFTreasure aurora_boss;
    public static TFTreasure troll_garden;
    ...
    public boolean generate(final World world, final Random rand, final int cx, final int cy, final int cz) {
        return this.generate(world, rand, cx, cy, cz, (Block)Blocks.field_150486_ae);
    }
    
    public boolean generate(final World world, final Random rand, final int cx, final int cy, final int cz, final Block chestBlock) {
        boolean flag = true;
    ...
    protected boolean addItemToChest(final World world, final Random rand, final int cx, final int cy, final int cz, final ItemStack itemStack) {
        final TileEntityChest chest = (TileEntityChest)world.func_147438_o(cx, cy, cz);
        if (chest != null) {
    ...
    protected void fill(final int i) {
        ...
        if (i == 5) {
            ...
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16373));
        }
        if (i == 6) {
        ...
        if (i == 10) {
            ...
            this.common.add(new ItemStack((Item)Items.field_151068_bn, 1, 16369));
            this.common.add(new ItemStack((Item)Items.field_151068_bn, 1, 16373));
            this.common.add(new ItemStack((Item)Items.field_151068_bn, 1, 16370));
            this.uncommon.addEnchanted(new ItemStack((Item)Items.field_151031_f), Enchantment.field_77342_w, 1, Enchantment.field_77344_u, 2);
            this.uncommon.addEnchanted(new ItemStack((Item)Items.field_151031_f), Enchantment.field_77345_t, 3, Enchantment.field_77343_v, 1);
        ...
        if (i == 7) {
            ...
            this.common.add(new ItemStack((Item)Items.field_151068_bn, 1, 0));
            ...
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16274));
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16341));
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16307));
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16348));
            this.rare.addRandomEnchanted((Item)Items.field_151169_ag, 18);
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16306));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16305));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 32725));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 32764));
            this.rare.add(TFItems.transformPowder, 12);
        ...
        if (i == 8) {
            ...
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16));
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16276));
            this.uncommon.add(new ItemStack((Item)Items.field_151068_bn, 1, 16312));
            ...
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 32696));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16369));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16373));
            this.rare.add(new ItemStack((Item)Items.field_151068_bn, 1, 16370));
            this.rare.add(TFItems.transformPowder, 12);
            this.rare.add(TFItems.charmOfKeeping1, 1);
    ...
    static {
        ...
        TFTreasure.stronghold_boss = new TFTreasure(17);
        TFTreasure.aurora_cache = new TFTreasure(18);
        TFTreasure.aurora_room = new TFTreasure(19);
        TFTreasure.aurora_boss = new TFTreasure(20);
        TFTreasure.troll_garden = new TFTreasure(21);
        TFTreasure.troll_vault = new TFTreasure(22);
    }
}
