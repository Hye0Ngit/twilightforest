...
public class TFPacketHandler
{
    ...
    public static void init() {
        ...
        TFPacketHandler.CHANNEL.messageBuilder((Class)SetSkylightEnabledPacket.class, id++).encoder(SetSkylightEnabledPacket::encode).decoder((Function)SetSkylightEnabledPacket::new).consumer(SetSkylightEnabledPacket.Handler::onMessage).add();
    ...
    static {
        CHANNEL = NetworkRegistry.newSimpleChannel(TwilightForestMod.prefix("channel"), () -> "1", (Predicate)"1"::equals, (Predicate)"1"::equals);
    }
}
