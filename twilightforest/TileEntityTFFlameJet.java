...
public class TileEntityTFFlameJet extends anq
{
    int counter;
    ...
    public void g() {
        ...
        if (this.counter % 4 == 0) {
            this.k.a(this.l + 0.5, this.m + 0.5, this.n + 0.5, "mob.ghast.fireball", 1.0f + this.k.u.nextFloat(), this.k.u.nextFloat() * 0.7f + 0.3f);
        }
        else if (this.counter == 1) {
            this.k.a(this.l + 0.5, this.m + 0.5, this.n + 0.5, "fire.ignite", 1.0f + this.k.u.nextFloat(), this.k.u.nextFloat() * 0.7f + 0.3f);
        }
        if (!this.k.J && this.counter % 5 == 0) {
            final List entitiesInRange = this.k.a((Class)lq.class, anw.a().a((double)(this.l - 2), (double)this.m, (double)(this.n - 2), (double)(this.l + 2), (double)(this.m + 4), (double)(this.n + 2)));
