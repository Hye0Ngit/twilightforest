...
public class TileEntityTFLichSpawner extends cj
{
    public TileEntityTFLichSpawner() {
        this.a("Twilight Lich");
        this.a = 0;
    }
    
    public boolean t_() {
        final yw closestPlayer = this.i.a(this.j + 0.5, this.k + 0.5, this.l + 0.5, 9.0);
        return closestPlayer != null && closestPlayer.p > this.k - 2;
    }
    ...
    public void n_() {
        ...
        if (!this.i.F) {
            ...
            final acq entityliving = (acq)aao.a("Twilight Lich", this.i);
            if (entityliving == null) {
                return;
            }
            final int j = this.i.a((Class)entityliving.getClass(), wu.b((double)this.j, (double)this.k, (double)this.l, (double)(this.j + 1), (double)(this.k + 1), (double)(this.l + 1)).b(30.0, 30.0, 30.0)).size();
            if (j >= 1) {
                this.updateDelay();
                return;
            }
