...
public class EntityTFMazeSlime extends qo
{
    ...
    public EntityTFMazeSlime(final xv par1World) {
        super(par1World);
        this.aF = "/twilightforest/mazeslime.png";
    ...
    public boolean bs() {
        return this.p.t > 0 && this.p.b(this.D) && this.p.a((lq)this, this.D).isEmpty() && !this.p.d(this.D) && this.isValidLightLevel();
    }
    ...
    protected void l(final int par1) {
        this.b(TFItems.charmOfKeeping1.cg, 1);
    }
}
