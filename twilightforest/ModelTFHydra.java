...
public class ModelTFHydra extends ho
{
    qp body;
    qp leg1;
    qp leg2;
    ...
    public ModelTFHydra() {
        ...
        (this.body = new qp((ho)this, "body")).a(0.0f, -12.0f, 0.0f);
        this.body.a("body", -48.0f, 0.0f, 0.0f, 96, 96, 40);
        this.setRotation(this.body, 1.22173f, 0.0f, 0.0f);
        (this.leg1 = new qp((ho)this, "leg")).a(48.0f, -24.0f, 0.0f);
        ...
        (this.leg2 = new qp((ho)this, "leg")).a(-48.0f, -24.0f, 0.0f);
        this.leg2.i = true;
    ...
    public void setRotationAngles(final nn entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        super.a(f, f1, f2, f3, f4, f5);
        this.leg1.f = gk.b(f * 0.6662f) * 1.4f * f1;
        this.leg2.f = gk.b(f * 0.6662f + 3.141593f) * 1.4f * f1;
        this.leg1.g = 0.0f;
        this.leg2.g = 0.0f;
    }
    
    public void a(final acq entityliving, final float f, final float f1, final float time) {
        final EntityTFHydra hydra = (EntityTFHydra)entityliving;
        bo vec = bo.b(0.0, 0.0, -112.0);
        vec.a(1.0471976f);
        vec.b(0.0f);
        this.head1.a((float)vec.a, (float)vec.b - 48.0f, (float)vec.c);
        vec = bo.b(0.0, 0.0, -144.0);
        vec.a(0.78539824f);
        vec.b(-1.0471976f);
