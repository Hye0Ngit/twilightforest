...
public final class WorldUtil
{
    ...
    public static Iterable<BlockPos> getAllAround(final BlockPos center, final int range) {
        return BlockPos.func_218278_a(center.func_177982_a(-range, -range, -range), center.func_177982_a(range, range, range));
    }
    
    public static Iterable<BlockPos> getAllInBB(final AxisAlignedBB bb) {
        return BlockPos.func_218278_a(new BlockPos(bb.field_72340_a, bb.field_72338_b, bb.field_72339_c), new BlockPos(bb.field_72336_d, bb.field_72337_e, bb.field_72334_f));
    }
