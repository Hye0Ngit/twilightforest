...
public class EntityTFSwarmSpider extends qp
{
    ...
    public EntityTFSwarmSpider(final yc world) {
        this(world, true);
    }
    
    public EntityTFSwarmSpider(final yc world, final boolean spawnMore) {
        super(world);
        this.shouldSpawn = false;
        this.a(0.8f, 0.4f);
        this.aR = 3;
        this.setSpawnMore(spawnMore);
        this.aG = "/twilightforest/swarmspider.png";
        this.bd = 2;
    }
    
    public EntityTFSwarmSpider(final yc world, final double x, final double y, final double z) {
        this(world);
        this.b(x, y, z);
    }
    ...
    protected boolean spawnAnother() {
        ...
        final double sz = this.v + (this.p.t.nextDouble() - this.aa.nextDouble()) * 4.0;
