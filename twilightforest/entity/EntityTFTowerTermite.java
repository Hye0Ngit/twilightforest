...
public class EntityTFTowerTermite extends EntityMob
{
    ...
    public EntityTFTowerTermite(final World par1World) {
        super(par1World);
        this.field_70750_az = "/mods/twilightforest/textures/model/towertermite.png";
        this.func_70105_a(0.3f, 0.7f);
        this.field_70697_bw = 0.27f;
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAIWander((EntityCreature)this, this.field_70697_bw));
        ...
        this.field_70715_bh.func_75776_a(2, (EntityAIBase)new EntityAINearestAttackableTarget((EntityLiving)this, (Class)EntityPlayer.class, 8.0f, 0, true));
    }
