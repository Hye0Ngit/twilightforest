...
public class EntityTFSkeletonDruid extends EntityMob implements IRangedAttackMob
{
    public EntityTFSkeletonDruid(final World world) {
        super(world);
        this.field_70750_az = "/mods/twilightforest/textures/model/skeletondruid.png";
        ...
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAIFleeSun((EntityCreature)this, this.field_70697_bw));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIArrowAttack((IRangedAttackMob)this, this.field_70697_bw, 60, 10.0f));
    ...
    public void func_82196_d(final EntityLiving attackTarget, final float extraDamage) {
        final EntityTFNatureBolt natureBolt = new EntityTFNatureBolt(this.field_70170_p, (EntityLiving)this);
