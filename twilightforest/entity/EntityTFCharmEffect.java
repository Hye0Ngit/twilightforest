...
public class EntityTFCharmEffect extends Entity
{
    ...
    public EntityTFCharmEffect(final World par1World) {
        ...
        this.setItemID(TFItems.charmOfLife1.field_77779_bT);
    }
    
    public EntityTFCharmEffect(final World par1World, final EntityLiving par2EntityLiving, final int itemID) {
        super(par1World);
        this.func_70105_a(0.25f, 0.25f);
        this.orbiting = par2EntityLiving;
        this.setOwner(this.orbiting.func_70023_ak());
        this.setItemID(itemID);
        final Vec3 look = this.field_70170_p.func_82732_R().func_72345_a(1.75, 0.0, 0.0);
    ...
    public EntityLiving getOwner() {
        return (EntityLiving)this.field_70170_p.func_72924_a(this.getOwnerName());
    }
    ...
    public void setItemID(final int par1Int) {
        this.field_70180_af.func_75692_b(16, (Object)par1Int);
    }
    ...
    protected void func_70014_b(final NBTTagCompound par1NBTTagCompound) {
        ...
        this.setItemID(par1NBTTagCompound.func_74765_d("ItemID"));
    }
}
