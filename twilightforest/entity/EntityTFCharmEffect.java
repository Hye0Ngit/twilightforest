...
public class EntityTFCharmEffect extends mp
{
    ...
    public EntityTFCharmEffect(final zv par1World) {
        super(par1World);
        this.a(0.25f, 0.25f);
        this.setItemID(TFItems.charmOfLife1.cp);
    }
    
    public EntityTFCharmEffect(final zv par1World, final ng par2EntityLiving, final int itemID) {
        super(par1World);
        this.a(0.25f, 0.25f);
        this.orbiting = par2EntityLiving;
        this.setOwner(this.orbiting.am());
        this.setItemID(itemID);
        final aqw look = this.q.T().a(1.75, 0.0, 0.0);
        this.b(par2EntityLiving.u, par2EntityLiving.v + par2EntityLiving.e(), par2EntityLiving.w, par2EntityLiving.A, par2EntityLiving.B);
        this.u += look.c * 1.75;
        this.w += look.e * 1.75;
    ...
    public void l_() {
        ...
        if (this.newPosRotationIncrements > 0) {
            ...
            final double var4 = kx.g(this.newRotationYaw - this.A);
        ...
        if (this.orbiting != null && !this.q.I) {
            this.b(this.orbiting.u, this.orbiting.v + this.orbiting.e(), this.orbiting.w, this.orbiting.A, this.orbiting.B);
            final aqw look = this.q.T().a(1.75, 0.0, 0.0);
            look.b(rotation);
            this.u += look.c;
            this.w += look.e;
    ...
    public ng getOwner() {
        return (ng)this.q.a(this.getOwnerName());
    }
