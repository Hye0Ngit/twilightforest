...
public class EntityTFTomeBolt extends EntityThrowable
{
    ...
    public EntityTFTomeBolt(final World par1World, final EntityLiving par2EntityLiving) {
    ...
    protected void func_70184_a(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.field_72308_g != null && par1MovingObjectPosition.field_72308_g instanceof EntityLiving && par1MovingObjectPosition.field_72308_g.func_70097_a(DamageSource.func_76356_a((Entity)this, (Entity)this.func_85052_h()), 6)) {
            final byte potionStrength = (byte)((this.field_70170_p.field_73013_u == 0) ? 3 : ((this.field_70170_p.field_73013_u == 2) ? 7 : 9));
            if (potionStrength > 0) {
                ((EntityLiving)par1MovingObjectPosition.field_72308_g).func_70690_d(new PotionEffect(Potion.field_76421_d.field_76415_H, potionStrength * 20, 1));
            }
        }
        for (int i = 0; i < 8; ++i) {
