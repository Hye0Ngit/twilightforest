...
public class EntityTFTomeBolt extends EntityThrowable
{
    ...
    protected void func_70184_a(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.field_72308_g != null && par1MovingObjectPosition.field_72308_g instanceof EntityLivingBase && par1MovingObjectPosition.field_72308_g.func_70097_a(DamageSource.func_76356_a((Entity)this, (Entity)this.func_85052_h()), 6.0f)) {
            final byte potionStrength = (byte)((this.field_70170_p.field_73013_u == EnumDifficulty.PEACEFUL) ? 3 : ((this.field_70170_p.field_73013_u == EnumDifficulty.NORMAL) ? 7 : 9));
            if (potionStrength > 0) {
        ...
        for (int i = 0; i < 8; ++i) {
            this.field_70170_p.func_72869_a("iconcrack_" + Item.func_150891_b(Items.field_151059_bz), this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70146_Z.nextGaussian() * 0.05, this.field_70146_Z.nextDouble() * 0.2, this.field_70146_Z.nextGaussian() * 0.05);
        }
