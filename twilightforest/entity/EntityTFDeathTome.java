...
public class EntityTFDeathTome extends EntityMob
{
    public EntityTFDeathTome(final World par1World) {
        super(par1World);
        this.field_70750_az = "/item/book.png";
        this.field_70697_bw = 0.25f;
        this.field_70714_bg.func_75776_a(0, (EntityAIBase)new EntityAISwimming((EntityLiving)this));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAITFMagicAttack((EntityLiving)this, this.field_70697_bw, 2, 60));
        this.field_70714_bg.func_75776_a(5, (EntityAIBase)new EntityAIWander((EntityCreature)this, this.field_70697_bw));
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, int par2) {
        if (par1DamageSource.func_76347_k()) {
            par2 *= 2;
        }
        if (super.func_70097_a(par1DamageSource, par2)) {
            if (this.field_70146_Z.nextInt(2) == 0) {
                this.func_70054_a(Item.field_77759_aK.field_77779_bT, 1, 1.0f);
            }
            return true;
        }
        return false;
    ...
    protected int func_70633_aT() {
        return Item.field_77759_aK.field_77779_bT;
    }
    
    protected void func_70628_a(final boolean par1, final int par2) {
        for (int var3 = this.field_70146_Z.nextInt(3 + par2), var4 = 0; var4 < var3; ++var4) {
            this.func_70025_b(Item.field_77759_aK.field_77779_bT, 1);
        }
        if (this.field_70146_Z.nextInt(5) - par2 <= 0) {
            this.func_70025_b(Item.field_77821_bF.field_77779_bT, 1);
        }
        else {
            this.func_70025_b(Item.field_77760_aL.field_77779_bT, 1);
        }
    }
    
    protected void func_70600_l(final int par1) {
        this.func_70025_b(TFItems.magicMapFocus.field_77779_bT, 1);
    }
