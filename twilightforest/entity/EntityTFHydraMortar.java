...
public class EntityTFHydraMortar extends ri
{
    ...
    public EntityTFHydraMortar(final yc par1World) {
        super(par1World);
    ...
    public EntityTFHydraMortar(final yc par1World, final md par2EntityLiving) {
    ...
    public float a(final xx par1Explosion, final amq par2Block, final int par3, final int par4, final int par5) {
        float var6 = super.a(par1Explosion, par2Block, par3, par4, par5);
        if (this.megaBlast && par2Block != amq.C && par2Block != amq.bK && par2Block != amq.bL) {
    ...
    public boolean a(final lh damagesource, final int i) {
        this.K();
        if (damagesource.g() != null && !this.p.I) {
            final aoj vec3d = damagesource.g().Z();
            if (vec3d != null) {
