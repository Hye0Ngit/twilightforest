...
public class EntityTFHydraMortar extends EntityThrowable
{
    ...
    public EntityLiving playerReflects;
    public int fuse;
    ...
    public EntityTFHydraMortar(final World par1World, final EntityLiving par2EntityLiving) {
    ...
    protected void detonate() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            final List nearbyList = new ArrayList(this.field_70170_p.func_72839_b((Entity)this, this.field_70121_D.func_72314_b(1.0, 1.0, 1.0)));
            for (final Entity nearby : nearbyList) {
                if (nearby.func_70097_a(DamageSource.func_76362_a((EntityFireball)null, (Entity)this.func_85052_h()), 18) && !nearby.func_70045_F()) {
    ...
    public boolean func_70097_a(final DamageSource damagesource, final int i) {
        ...
        if (damagesource.func_76346_g() != null && !this.field_70170_p.field_72995_K) {
            ...
            if (damagesource.func_76346_g() instanceof EntityLiving) {
                this.playerReflects = (EntityLiving)damagesource.func_76346_g();
            }
            return true;
        }
        return false;
