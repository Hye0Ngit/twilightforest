...
public class EntityTFBlockGoblin extends EntityMob implements IEntityMultiPart
{
    ...
    public EntityTFBlockGoblin(final World world) {
        ...
        this.partsArray = new Entity[] { this.block = new EntityTFSpikeBlock(this), this.chain1 = new EntityTFGoblinChain((Entity)this), this.chain2 = new EntityTFGoblinChain((Entity)this), this.chain3 = new EntityTFGoblinChain((Entity)this) };
    }
    ...
    public Vec3 getChainPosition(final float angle, final float distance) {
        ...
        return Vec3.func_72443_a(this.field_70165_t + var1, this.field_70163_u + this.getChainYOffset(), this.field_70161_v + var2);
    }
    ...
    protected void applyBlockCollisions(final Entity collider) {
        final List<Entity> list = this.field_70170_p.func_72839_b(collider, collider.field_70121_D.func_72314_b(0.20000000298023224, 0.0, 0.20000000298023224));
