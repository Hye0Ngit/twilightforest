...
public class EntityTFFireBeetle extends EntityMob
{
    ...
    public EntityTFFireBeetle(final World world) {
        super(world);
        this.field_70750_az = "/mods/twilightforest/textures/model/firebeetle.png";
        this.field_70697_bw = 0.23f;
        this.func_70105_a(1.1f, 0.75f);
        this.field_70714_bg.func_75776_a(0, (EntityAIBase)new EntityAISwimming((EntityLiving)this));
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAITFFireBreath((EntityLiving)this, this.field_70697_bw, 5.0f, 30, 0.1f));
    ...
    public void doBreathAttack(final Entity target) {
        if (!target.func_70045_F() && target.func_70097_a(DamageSource.field_76372_a, 2)) {
