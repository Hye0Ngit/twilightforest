...
public class EntityTFIceSnowball extends EntityThrowable
{
    ...
    public EntityTFIceSnowball(final World par1World) {
        super(par1World);
    }
    
    public EntityTFIceSnowball(final World par1World, final EntityLivingBase par2EntityLiving) {
    ...
    public void makeTrail() {
        for (int i = 0; i < 2; ++i) {
            ...
            this.field_70170_p.func_72869_a("snowballpoof", dx, dy, dz, 0.0, 0.0, 0.0);
        }
    }
    ...
    protected void pop() {
        for (int i = 0; i < 8; ++i) {
            this.field_70170_p.func_72869_a("snowballpoof", this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70146_Z.nextGaussian() * 0.05, this.field_70146_Z.nextDouble() * 0.2, this.field_70146_Z.nextGaussian() * 0.05);
        }
