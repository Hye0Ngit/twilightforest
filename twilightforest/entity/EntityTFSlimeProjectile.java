...
public class EntityTFSlimeProjectile extends EntityThrowable
{
    ...
    public EntityTFSlimeProjectile(final World par1World, final EntityLiving par2EntityLiving) {
    ...
    protected void func_70184_a(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.field_72308_g == null || !(par1MovingObjectPosition.field_72308_g instanceof EntityLiving) || par1MovingObjectPosition.field_72308_g.func_70097_a(DamageSource.func_76356_a((Entity)this, (Entity)this.func_85052_h()), 8)) {}
        this.pop();
    }
