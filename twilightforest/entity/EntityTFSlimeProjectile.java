...
public class EntityTFSlimeProjectile extends ri
{
    public EntityTFSlimeProjectile(final yc par1World) {
        super(par1World);
    }
    
    public EntityTFSlimeProjectile(final yc par1World, final md par2EntityLiving) {
