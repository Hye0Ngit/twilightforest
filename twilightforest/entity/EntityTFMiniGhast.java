...
public class EntityTFMiniGhast extends EntityTFTowerGhast
{
    ...
    protected boolean shouldAttackPlayer(final EntityPlayer par1EntityPlayer) {
        ...
        if (playerHeadArmor != null && playerHeadArmor.field_77993_c == Block.field_72061_ba.field_71990_ca) {
            return false;
        }
        ...
        Vec3 var4 = this.field_70170_p.func_82732_R().func_72345_a(this.field_70165_t - par1EntityPlayer.field_70165_t, this.field_70121_D.field_72338_b + this.field_70131_O / 2.0f - (par1EntityPlayer.field_70163_u + par1EntityPlayer.func_70047_e()), this.field_70161_v - par1EntityPlayer.field_70161_v);
