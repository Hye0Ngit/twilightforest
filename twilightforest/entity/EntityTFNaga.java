...
public class EntityTFNaga extends EntityMob implements IMob, IBossDisplayData, IEntityMultiPart
{
    ...
    protected void func_70626_be() {
        ...
        if (vec3d != null) {
            ...
            if (dist > 4.0 && this.chargeCount == 0) {
                this.field_70702_br = MathHelper.func_76134_b(this.field_70173_aa * 0.3f) * this.field_70697_bw * 0.6f;
            }
            while (f3 < -180.0f) {
                f3 += 360.0f;
            }
    ...
    protected void acquireNewPath() {
        ...
        if (this.chargeCount > 0) {
            ...
            this.pathToEntity = this.field_70170_p.func_72844_a((Entity)this, MathHelper.func_76128_c(tpoint.field_72450_a), MathHelper.func_76128_c(tpoint.field_72448_b), MathHelper.func_76128_c(tpoint.field_72449_c), 40.0f, true, true, true, true);
            if (this.chargeCount == 0) {
                this.doCircle();
            }
        }
    ...
    public boolean func_70965_a(final EntityDragonPart entitydragonpart, final DamageSource damagesource, final int i) {
        return false;
    }
