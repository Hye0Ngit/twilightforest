...
public class EntityTFNaga extends EntityMob implements IMob, IBossDisplayData, IEntityMultiPart
{
            ...
            for (int dx = minx; dx <= maxx; ++dx) {
                for (int dy = miny; dy <= maxy; ++dy) {
                    for (int dz = minz; dz <= maxz; ++dz) {
                        final Block i5 = this.field_70170_p.func_147439_a(dx, dy, dz);
    ...
    protected void breakBlock(final int dx, final int dy, final int dz) {
        final Block whatsThere = this.field_70170_p.func_147439_a(dx, dy, dz);
    ...
    protected void func_70628_a(final boolean flag, final int z) {
        final Item i = this.func_146068_u();
        if (i != null) {
    ...
    public boolean func_110176_b(final int x, final int y, final int z) {
    ...
    public void func_70645_a(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.func_76364_f() instanceof EntityPlayer) {
            ...
            ((EntityPlayer)par1DamageSource.func_76364_f()).func_71029_a((StatBase)TFAchievementPage.twilightKillNaga);
        }
