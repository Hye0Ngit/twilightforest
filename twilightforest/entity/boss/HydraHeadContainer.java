...
public class HydraHeadContainer
{
    ...
    protected void setNeckPosition() {
        ...
        if (this.headNum == 0) {
            vector = Vec3.func_72443_a(0.0, 3.0, -1.0);
            neckRotation = 0.0f;
        }
        if (this.headNum == 1) {
            vector = Vec3.func_72443_a(-1.0, 3.0, 3.0);
            neckRotation = 90.0f;
        }
        if (this.headNum == 2) {
            vector = Vec3.func_72443_a(1.0, 3.0, 3.0);
        ...
        if (this.headNum == 5) {
            vector = Vec3.func_72443_a(-1.0, 3.0, 5.0);
            neckRotation = 135.0f;
        }
        if (this.headNum == 6) {
            vector = Vec3.func_72443_a(1.0, 3.0, 5.0);
    ...
    protected void setHeadPosition() {
        ...
        final Vec3 vector = Vec3.func_72443_a(0.0, 0.0, (double)neckLength);
    ...
    private Entity getHeadLookTarget() {
        ...
        final Vec3 srcVec = Vec3.func_72443_a(this.headEntity.field_70165_t, this.headEntity.field_70163_u + 1.0, this.headEntity.field_70161_v);
    ...
    protected void setNeckPositon(final double startX, final double startY, final double startZ, final float startYaw, final float startPitch) {
        ...
        if (endPitch > 0.0f) {
            final Vec3 vector = Vec3.func_72443_a(0.0, 0.0, -1.0);
