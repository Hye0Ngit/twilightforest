...
public class EntityTFLich extends EntityMob implements IBossDisplayData
{
    ...
    private void dropGoldThing() {
        ...
        if (thingType == 0) {
            ...
            goldThing = new ItemStack((Item)Items.field_151169_ag);
        }
        else if (thingType == 2) {
            goldThing = new ItemStack((Item)Items.field_151171_ah);
        }
        else if (thingType == 3) {
            goldThing = new ItemStack((Item)Items.field_151149_ai);
        }
        else {
            goldThing = new ItemStack((Item)Items.field_151151_aj);
        }
    ...
    protected void popNearbyMob() {
        final List<Entity> nearbyMobs = this.field_70170_p.func_72839_b((Entity)this, AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
    ...
    protected boolean canPop(final Entity nearby) {
        final Class[] array;
        final Class[] poppable = array = new Class[] { EntitySkeleton.class, EntityZombie.class, EntityEnderman.class, EntitySpider.class, EntityCreeper.class, EntityTFSwarmSpider.class };
        for (final Class pop : array) {
    ...
    protected int countMyClones() {
        final List<EntityTFLich> nearbyLiches = this.field_70170_p.func_72872_a((Class)EntityTFLich.class, AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
        int count = 0;
    ...
    protected void despawnClones() {
        final List<EntityTFLich> nearbyLiches = this.field_70170_p.func_72872_a((Class)this.getClass(), AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
        for (final EntityTFLich nearbyLich : nearbyLiches) {
    ...
    protected int countMyMinions() {
        final List<EntityTFLichMinion> nearbyMinons = this.field_70170_p.func_72872_a((Class)EntityTFLichMinion.class, AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
        int count = 0;
    ...
    public void func_70645_a(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.func_76364_f() instanceof EntityPlayer) {
            ...
            ((EntityPlayer)par1DamageSource.func_76364_f()).func_71029_a((StatBase)TFAchievementPage.twilightKillLich);
        }
    ...
    static {
        heldItems = new ItemStack[] { new ItemStack(TFItems.scepterTwilight, 1), new ItemStack(TFItems.scepterZombie, 1), new ItemStack(Items.field_151010_B, 1) };
    }
}
