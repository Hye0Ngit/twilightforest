...
public class EntityTFKnightPhantom extends EntityFlying implements IMob
{
    ...
    public void func_70636_d() {
        ...
        if (this.isChargingAtPlayer()) {
            for (int i = 0; i < 4; ++i) {
                final Item particleID = this.field_70146_Z.nextBoolean() ? TFItems.phantomHelm : TFItems.knightlySword;
                this.field_70170_p.func_72869_a("iconcrack_" + Item.func_150891_b(particleID), this.field_70165_t + (this.field_70146_Z.nextFloat() * this.field_70146_Z.nextFloat() - 0.5) * this.field_70130_N, this.field_70163_u + this.field_70146_Z.nextFloat() * (this.field_70131_O - 0.75) + 0.5, this.field_70161_v + (this.field_70146_Z.nextFloat() * this.field_70146_Z.nextFloat() - 0.5) * this.field_70130_N, 0.0, -0.1, 0.0);
    ...
    public void func_70645_a(final DamageSource par1DamageSource) {
        ...
        if (!this.field_70170_p.field_72995_K && this.field_70170_p.field_73011_w instanceof WorldProviderTwilightForest) {
            final int dx = this.getHomePosition().field_71574_a;
            final int dy = this.getHomePosition().field_71572_b;
            final int dz = this.getHomePosition().field_71573_c;
    ...
    private void makeATreasure() {
        if (this.getHomePosition().field_71574_a != 0) {
            ...
            final int px = MathHelper.func_76128_c(this.field_70142_S);
            final int py = MathHelper.func_76128_c(this.field_70137_T);
            final int pz = MathHelper.func_76128_c(this.field_70136_U);
            TFTreasure.stronghold_boss.generate(this.field_70170_p, null, px, py, pz);
        }
    }
    ...
    private List<EntityTFKnightPhantom> getNearbyKnights() {
        final List<EntityTFKnightPhantom> nearbyKnights = this.field_70170_p.func_72872_a((Class)EntityTFKnightPhantom.class, AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 8.0, 32.0));
