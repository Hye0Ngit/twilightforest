...
public class EntityTFUrGhast extends EntityTFTowerGhast implements IBossDisplayData
{
    ...
    private void shedTear() {
        TwilightForestMod.proxy.spawnParticle(this.field_70170_p, "bosstear", this.field_70165_t + (this.field_70146_Z.nextDouble() - 0.5) * this.field_70130_N, this.field_70163_u + this.field_70146_Z.nextDouble() * this.field_70131_O - 0.25, this.field_70161_v + (this.field_70146_Z.nextDouble() - 0.5) * this.field_70130_N, 0.0, 0.0, 0.0);
    }
    ...
    private boolean checkGhastsAtTraps() {
        ...
        for (final ChunkCoordinates trap : this.trapLocations) {
            final AxisAlignedBB aabb = AxisAlignedBB.func_72330_a((double)trap.field_71574_a, (double)trap.field_71572_b, (double)trap.field_71573_c, (double)(trap.field_71574_a + 1), (double)(trap.field_71572_b + 1), (double)(trap.field_71573_c + 1)).func_72314_b(8.0, 16.0, 8.0);
    ...
    public void func_70645_a(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.func_76364_f() instanceof EntityPlayer) {
            ...
            ((EntityPlayer)par1DamageSource.func_76364_f()).func_71029_a((StatBase)TFAchievementPage.twilightProgressUrghast);
        }
        if (!this.field_70170_p.field_72995_K && this.field_70170_p.field_73011_w instanceof WorldProviderTwilightForest) {
            final ChunkCoordinates chestCoords = this.findChestCoords();
            final int dx = chestCoords.field_71574_a;
            final int dy = chestCoords.field_71572_b;
            final int dz = chestCoords.field_71573_c;
