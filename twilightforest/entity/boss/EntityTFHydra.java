...
public class EntityTFHydra extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    protected void func_70626_be() {
        ...
        if (this.field_70146_Z.nextFloat() < 0.7f) {
            final EntityPlayer entityplayer1 = this.field_70170_p.func_72856_b((Entity)this, (double)f);
            if (entityplayer1 != null) {
                this.field_70776_bF = (Entity)entityplayer1;
    ...
    public EntityLivingBase findSecondaryTarget(final double range) {
        ...
        final List<EntityLiving> nearbyEntities = this.field_70170_p.func_72872_a((Class)EntityLivingBase.class, AxisAlignedBB.func_72330_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(range, range, range));
    ...
    public void func_70645_a(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.func_76364_f() instanceof EntityPlayer) {
            ...
            ((EntityPlayer)par1DamageSource.func_76364_f()).func_71029_a((StatBase)TFAchievementPage.twilightKillHydra);
        }
