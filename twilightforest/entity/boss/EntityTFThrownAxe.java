...
public class EntityTFThrownAxe extends EntityThrowable
{
    ...
    public EntityTFThrownAxe(final World par1World, final EntityLivingBase par2EntityLivingBase) {
        super(par1World, par2EntityLivingBase);
        this.func_70105_a(0.5f, 0.5f);
    }
    
    public EntityTFThrownAxe(final World par1World) {
        super(par1World);
        this.func_70105_a(0.5f, 0.5f);
    }
    ...
    protected void func_70184_a(final MovingObjectPosition par1MovingObjectPosition) {
        ...
        if (par1MovingObjectPosition.field_72308_g != null) {
            ...
            if (!passThru) {
                par1MovingObjectPosition.field_72308_g.func_70097_a(DamageSource.func_76356_a((Entity)this, (Entity)this.func_85052_h()), 6.0f);
            }
        }
        for (int i = 0; i < 8; ++i) {
