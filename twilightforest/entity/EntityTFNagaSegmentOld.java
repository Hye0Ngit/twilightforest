...
public class EntityTFNagaSegmentOld extends EntityLiving implements IMob
{
    ...
    public EntityTFNagaSegmentOld(final World world) {
        super(world);
        this.sDist = 1.5;
    ...
    public EntityTFNagaSegmentOld(final World world, final double x, final double y, final double z) {
        this(world);
        this.func_70107_b(x, y, z);
    }
    
    public EntityTFNagaSegmentOld(final World world, final EntityTFNagaOld head, final int segment) {
        this(world);
        this.head = head;
    ...
    protected void func_70626_be() {
        if (this.head != null && this.head.field_70724_aR <= 0) {
            ...
            for (int i = 0; i < allNearEntities.size(); ++i) {
                ...
                if (nearEntity instanceof EntityLiving && !(nearEntity instanceof EntityTFNagaOld) && !(nearEntity instanceof EntityTFNagaSegmentOld)) {
