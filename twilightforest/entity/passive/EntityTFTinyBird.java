...
public class EntityTFTinyBird extends EntityTFBird
{
    ...
    public boolean isLandableBlock(final int x, final int y, final int z) {
        ...
        return block != Blocks.field_150350_a && (block.isLeaves((IBlockAccess)this.field_70170_p, x, y, z) || block.isSideSolid((IBlockAccess)this.field_70170_p, x, y, z, ForgeDirection.UP));
    }
