...
public class EntityTFQuestRam extends EntityAnimal
{
    ...
    public EntityTFQuestRam(final World par1World) {
        ...
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAITFFindLoose(this, 1.0f, Item.func_150898_a(Blocks.field_150325_L)));
    ...
    private void rewardNearbyPlayers(final World world, final double posX, final double posY, final double posZ) {
        final List<EntityPlayer> nearbyPlayers = world.func_72872_a((Class)EntityPlayer.class, AxisAlignedBB.func_72330_a(posX, posY, posZ, posX + 1.0, posY + 1.0, posZ + 1.0).func_72314_b(16.0, 16.0, 16.0));
    ...
    public void func_70642_aH() {
        this.field_70170_p.func_72956_a((Entity)this, "mob.sheep.say", this.func_70599_aP(), this.func_70647_i());
    }
