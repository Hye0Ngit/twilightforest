...
public class EntityTFQuestRam extends EntityAnimal
{
    ...
    public EntityTFQuestRam(final World par1World) {
        super(par1World);
        this.field_70750_az = "/mods/twilightforest/textures/model/questram.png";
        ...
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAITempt((EntityCreature)this, 0.25f, Block.field_72101_ab.field_71990_ca, false));
        this.field_70714_bg.func_75776_a(3, (EntityAIBase)new EntityAITFEatLoose(this, Block.field_72101_ab.field_71990_ca));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAITFFindLoose(this, 0.25f, Block.field_72101_ab.field_71990_ca));
    ...
    protected void func_70629_bd() {
        ...
        if (randomTickDivider <= 0) {
            ...
            if (nearFeature != TFFeature.questGrove) {
                ...
                this.func_70598_b(cc.field_71574_a, cc.field_71572_b, cc.field_71573_c, 13);
            }
