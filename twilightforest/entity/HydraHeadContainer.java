...
public class HydraHeadContainer
{
    ...
    protected void clientAnimateHeadDeath() {
        if (this.headEntity.getState() == 11) {
            final EntityTFHydraHead headEntity = this.headEntity;
            ++headEntity.aY;
            if (this.headEntity.aY > 0) {
                if (this.headEntity.aY < 20) {
                    this.doExplosionOn(this.headEntity, true);
                }
                else if (this.headEntity.aY < 30) {
                    this.doExplosionOn(this.necka, false);
                }
                else if (this.headEntity.aY < 40) {
                    this.doExplosionOn(this.neckb, false);
                }
                else if (this.headEntity.aY < 50) {
                    this.doExplosionOn(this.neckc, false);
                }
                else if (this.headEntity.aY < 60) {
                    this.doExplosionOn(this.neckd, false);
                }
                else if (this.headEntity.aY < 70) {
    ...
    protected void setHeadFacing() {
        if (this.currentState == 2) {
            ...
            final float yawOffOffset = ke.g(this.headEntity.z - this.hydraObj.ax);
            if (yawOffOffset > biteMaxYaw) {
                this.headEntity.z = this.hydraObj.ax + biteMaxYaw;
            }
            if (yawOffOffset < biteMinYaw) {
                this.headEntity.z = this.hydraObj.ax + biteMinYaw;
            }
            final aoj look = this.headEntity.Z();
    ...
    protected void moveTargetCoordsTowardsTargetEntity(final double distance) {
        if (this.targetEntity != null) {
            final aoj vect = this.headEntity.p.S().a(this.targetEntity.t - this.targetX, this.targetEntity.u - this.targetY, this.targetEntity.v - this.targetZ);
            vect.a();
    ...
    protected void addMouthParticles() {
        final aoj vector = this.headEntity.Z();
    ...
    protected void setNeckPosition() {
        ...
        vector.b(-(this.hydraObj.ax + neckRotation) * 3.141593f / 180.0f);
        this.setNeckPositon(this.hydraObj.t + vector.c, this.hydraObj.u + vector.d, this.hydraObj.v + vector.e, this.hydraObj.ax, 0.0f);
    }
    ...
    protected void setHeadPosition() {
        ...
        final aoj vector = this.headEntity.p.S().a(0.0, 0.0, (double)neckLength);
        vector.a((xRotation * 3.141593f + xSwing) / 180.0f);
        vector.b(-(this.hydraObj.ax + yRotation + ySwing) * 3.141593f / 180.0f);
    ...
    private lq getHeadLookTarget() {
        ...
        final aoj srcVec = this.headEntity.p.S().a(this.headEntity.t, this.headEntity.u + 1.0, this.headEntity.v);
        final aoj lookVec = this.headEntity.i(1.0f);
    ...
    private EntityTFHydraHead findNearbyHead(final String string) {
        final List nearbyHeads = this.hydraObj.p.a((Class)EntityTFHydraHead.class, aoe.a().a(this.hydraObj.t, this.hydraObj.u, this.hydraObj.v, this.hydraObj.t + 1.0, this.hydraObj.u + 1.0, this.hydraObj.v + 1.0).b(16.0, 16.0, 16.0));
    ...
    protected void setNeckPositon(final double startX, final double startY, final double startZ, final float startYaw, final float startPitch) {
        ...
        if (endPitch > 0.0f) {
            final aoj vector = this.headEntity.p.S().a(0.0, 0.0, -1.0);
    ...
    public void setHurtTime(final int hurtTime) {
        if (this.headEntity != null) {
            this.headEntity.aV = hurtTime;
        }
        this.necka.aV = hurtTime;
        this.neckb.aV = hurtTime;
        this.neckc.aV = hurtTime;
        this.neckd.aV = hurtTime;
        this.necke.aV = hurtTime;
    }
    
    public boolean shouldRenderHead() {
        return this.headEntity.getState() != 12 && this.headEntity.aY < 20;
    }
    
    public boolean shouldRenderNeck(final int neckNum) {
        final int time = 30 + 10 * neckNum;
        return this.headEntity.getState() != 12 && this.headEntity.aY < time;
    }
