...
public class HydraHeadContainer
{
    ...
    protected void clientAnimateHeadDeath() {
        if (this.headEntity.getState() == 11) {
            ...
            this.headEntity.func_70606_j(this.headEntity.func_70667_aM());
        }
    }
    ...
    protected void playSounds() {
        ...
        if (this.headEntity.getState() == 16) {
            this.headEntity.field_70170_p.func_72908_a(this.headEntity.field_70165_t + 0.5, this.headEntity.field_70163_u + 0.5, this.headEntity.field_70161_v + 0.5, "mob.tf.hydra.roar", 1.25f, this.headEntity.func_70681_au().nextFloat() * 0.3f + 0.7f);
        }
        if (this.headEntity.getState() == 2 && this.ticksProgress == 60) {
            this.headEntity.field_70170_p.func_72908_a(this.headEntity.field_70165_t + 0.5, this.headEntity.field_70163_u + 0.5, this.headEntity.field_70161_v + 0.5, "mob.tf.hydra.warn", 2.0f, this.headEntity.func_70681_au().nextFloat() * 0.3f + 0.7f);
        }
    ...
    protected void executeAttacks() {
        ...
        if (this.headEntity.getState() == 3) {
            final List nearbyList = this.headEntity.field_70170_p.func_72839_b((Entity)this.headEntity, this.headEntity.field_70121_D.func_72314_b(0.0, 1.0, 0.0));
            for (final Entity nearby : nearbyList) {
                if (nearby instanceof EntityLiving && !(nearby instanceof EntityTFHydraPart) && !(nearby instanceof EntityTFHydra) && !(nearby instanceof EntityDragonPart)) {
                    nearby.func_70097_a(DamageSource.func_76358_a((EntityLiving)this.hydraObj), HydraHeadContainer.BITE_DAMAGE);
                }
            }
        }
        if (this.headEntity.getState() == 6) {
            ...
            if (target != null) {
                ...
                else if (!target.func_70045_F() && target.func_70097_a(DamageSource.field_76372_a, HydraHeadContainer.FLAME_DAMAGE)) {
    ...
    private Entity getHeadLookTarget() {
        ...
        final List possibleList = this.headEntity.field_70170_p.func_72839_b((Entity)this.headEntity, this.headEntity.field_70121_D.func_72321_a(lookVec.field_72450_a * range, lookVec.field_72448_b * range, lookVec.field_72449_c * range).func_72314_b((double)var9, (double)var9, (double)var9));
        double hitDist = 0.0;
