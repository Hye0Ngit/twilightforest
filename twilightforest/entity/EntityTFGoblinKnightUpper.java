...
public class EntityTFGoblinKnightUpper extends EntityMob
{
    ...
    private void landHeavySpearAttack() {
        ...
        final AxisAlignedBB spearBB = AxisAlignedBB.func_72330_a(px - radius, py - radius, pz - radius, px + radius, py + radius, pz + radius);
        final List<Entity> inBox = this.field_70170_p.func_72872_a((Class)Entity.class, spearBB);
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, final float damageAmount) {
    ...
    public boolean takeHitOnShield(final DamageSource par1DamageSource, final float damageAmount) {
        ...
        if (par1DamageSource.func_76346_g() != null) {
            ...
            toKnockback.func_70653_a(par1DamageSource.func_76346_g(), 0.0f, d0 / 4.0, d2 / 4.0);
            if (par1DamageSource.func_76346_g() instanceof EntityLiving) {
                this.func_70604_c((EntityLivingBase)par1DamageSource.func_76346_g());
            }
        }
        return true;
    }
