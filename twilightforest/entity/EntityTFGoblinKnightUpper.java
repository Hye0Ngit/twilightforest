...
public class EntityTFGoblinKnightUpper extends EntityMob
{
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, final int damageAmount) {
        ...
        if (attacker != null) {
            ...
            if (this.hasShield() && difference > 150.0f && difference < 230.0f && this.takeHitOnShield(par1DamageSource, damageAmount)) {
                return false;
            }
    ...
    public boolean takeHitOnShield(final DamageSource par1DamageSource, final int damageAmount) {
        ...
        if (damageAmount > 10 && !this.field_70170_p.field_72995_K) {
            this.field_70170_p.func_72926_e(1010, MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.field_70163_u), MathHelper.func_76128_c(this.field_70161_v), 0);
            ++this.shieldHits;
