...
public class EntityTFLichBolt extends ri
{
    public md playerReflects;
    
    public EntityTFLichBolt(final yc par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
        this.playerReflects = null;
    }
    
    public EntityTFLichBolt(final yc par1World, final md par2EntityLiving) {
        super(par1World, par2EntityLiving);
        this.playerReflects = null;
    }
    
    public EntityTFLichBolt(final yc par1World) {
        super(par1World);
        this.playerReflects = null;
    }
