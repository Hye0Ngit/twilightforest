...
public class EntityTFPinchBeetle extends EntityMob
{
    public EntityTFPinchBeetle(final World world) {
        ...
        this.field_70714_bg.func_75776_a(1, (EntityAIBase)new EntityAITFKidnapRider((EntityCreature)this, 2.0f));
        this.field_70714_bg.func_75776_a(2, (EntityAIBase)new EntityAITFChargeAttack((EntityCreature)this, 2.0f));
        this.field_70714_bg.func_75776_a(4, (EntityAIBase)new EntityAIAttackOnCollide((EntityCreature)this, (Class)EntityPlayer.class, 1.0, false));
