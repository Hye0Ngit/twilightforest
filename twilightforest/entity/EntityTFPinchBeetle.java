...
{
    public EntityTFPinchBeetle(final yc world) {
        super(world);
        this.aG = "/twilightforest/pinchbeetle.png";
        this.bH = 0.23f;
        this.a(1.2f, 1.1f);
        this.bn.a(0, (nc)new mz((md)this));
        this.bn.a(1, (nc)new EntityAITFKidnapRider((mi)this, 0.4f));
        this.bn.a(2, (nc)new EntityAITFChargeAttack((md)this, 0.4f));
        this.bn.a(4, (nc)new nk((md)this, (Class)qx.class, this.bH, false));
    ...
    public void c() {
        ...
        if (this.n != null) {
            ...
            final aoj riderPos = this.getRiderPosition();
