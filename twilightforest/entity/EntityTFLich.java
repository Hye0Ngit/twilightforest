...
public class EntityTFLich extends EntityMob implements IBossDisplayData
{
    ...
    public EntityTFLich(final World world) {
        ...
        this.field_70750_az = "/mods/twilightforest/textures/model/twilightlich64.png";
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            this.field_70180_af.func_75692_b(19, (Object)this.field_70734_aK);
        }
        super.func_70636_d();
    }
    ...
    public boolean func_70097_a(final DamageSource par1DamageSource, final int par2) {
        ...
        if (this.getShieldStrength() > 0) {
            if (par1DamageSource.func_76363_c() && par2 > 2) {
                if (this.getShieldStrength() > 0) {
    ...
    protected void launchBoltAt(final Entity targetedEntity) {
        ...
        final EntityTFLichBolt projectile = new EntityTFLichBolt(this.field_70170_p, (EntityLiving)this);
    ...
    protected void launchBombAt(final Entity targetedEntity) {
        ...
        final double tz = targetedEntity.field_70161_v - sz;
        this.field_70170_p.func_72956_a((Entity)this, "mob.ghast.fireball", this.func_70599_aP(), (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2f + 1.0f);
        final EntityTFLichBomb projectile = new EntityTFLichBomb(this.field_70170_p, (EntityLiving)this);
        projectile.func_70186_c(tx, ty, tz, projectile.func_40077_c(), 1.0f);
        projectile.func_70012_b(sx, sy, sz, this.field_70177_z, this.field_70125_A);
        this.field_70170_p.func_72838_d((Entity)projectile);
    }
    ...
    protected void popNearbyMob() {
        final List nearbyMobs = this.field_70170_p.func_72839_b((Entity)this, AxisAlignedBB.func_72332_a().func_72299_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
    ...
    protected void despawnClones() {
        final List nearbyLiches = this.field_70170_p.func_72872_a((Class)this.getClass(), AxisAlignedBB.func_72332_a().func_72299_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
        for (final EntityTFLich nearbyLich : nearbyLiches) {
    ...
    protected void checkAndSpawnMinions(final Entity targetedEntity) {
        if (!this.field_70170_p.field_72995_K && this.getMinionsToSummon() > 0) {
            ...
            if (minions < 3) {
                this.spawnMinionAt((EntityLiving)targetedEntity);
    ...
    protected int countMyMinions() {
        final List nearbyMinons = this.field_70170_p.func_72872_a((Class)EntityTFLichMinion.class, AxisAlignedBB.func_72332_a().func_72299_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(32.0, 16.0, 32.0));
        int count = 0;
    ...
    protected void spawnMinionAt(final EntityLiving targetedEntity) {
    ...
    public void setShadowClone(final boolean par1) {
        final byte var2 = this.field_70180_af.func_75683_a(16);
        if (par1) {
            this.field_70180_af.func_75692_b(16, (Object)(byte)(var2 | 0x2));
        }
        else {
