...
public class EntityTFMoonwormShot extends EntityThrowable
{
    ...
    public EntityTFMoonwormShot(final World par1World, final EntityLiving par2EntityLiving) {
    ...
    protected void func_70184_a(final MovingObjectPosition mop) {
        if (mop.field_72313_a == EnumMovingObjectType.TILE && !this.field_70170_p.field_72995_K) {
        ...
        if (mop.field_72308_g != null) {
            mop.field_72308_g.func_70097_a(DamageSource.func_76356_a((Entity)this, (Entity)this.func_85052_h()), 0);
        }
        for (int var3 = 0; var3 < 8; ++var3) {
            this.field_70170_p.func_72869_a("tilecrack_" + TFBlocks.moonworm.field_71990_ca + "_0", this.field_70165_t, this.field_70163_u, this.field_70161_v, 0.0, 0.0, 0.0);
        }
