...
public class EntityTFMazeSlime extends EntitySlime
{
    ...
    public boolean func_70601_bi() {
        return this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL && this.field_70170_p.func_72855_b(this.field_70121_D) && this.field_70170_p.func_72945_a((Entity)this, this.field_70121_D).isEmpty() && !this.field_70170_p.func_72953_d(this.field_70121_D) && this.isValidLightLevel();
    }
    
    protected void func_110147_ax() {
        super.func_110147_ax();
        final int size = this.func_70809_q();
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(2.0 * size * size);
    }
