...
public class EntityTFNagaOld extends EntityMob implements IMob, IBossDisplayData
{
    ...
    public EntityTFNagaOld(final World world) {
        super(world);
    ...
    protected int setSegmentsPerHealth() {
        ...
        if (newSegments > EntityTFNagaOld.MAX_SEGMENTS) {
            newSegments = EntityTFNagaOld.MAX_SEGMENTS;
        }
    ...
    public void func_70071_h_() {
        ...
        if (!this.field_70170_p.field_72995_K && this.ticksSinceDamaged > EntityTFNagaOld.TICKS_BEFORE_HEALING && this.ticksSinceDamaged % 20 == 0) {
            this.func_70691_i(1);
            this.setSegmentsPerHealth();
        }
    ...
    protected void spawnBodySegments() {
        if (!this.field_70170_p.field_72995_K) {
            if (this.body == null) {
                this.body = new EntityTFNagaSegmentOld[EntityTFNagaOld.MAX_SEGMENTS];
            }
            for (int i = 0; i < this.currentSegments; ++i) {
                if (this.body[i] == null || this.body[i].field_70128_L) {
                    (this.body[i] = new EntityTFNagaSegmentOld(this.field_70170_p, this, i)).func_70012_b(this.field_70165_t + 0.1 * i, this.field_70163_u + 0.5, this.field_70161_v + 0.1 * i, this.field_70146_Z.nextFloat() * 360.0f, 0.0f);
    ...
    static {
        EntityTFNagaOld.TICKS_BEFORE_HEALING = 600;
        EntityTFNagaOld.MAX_SEGMENTS = 12;
    }
}
