...
public class EntityTFTwilightWandBolt extends up
{
    public EntityTFTwilightWandBolt(final abv par1World) {
        super(par1World);
    }
    
    public EntityTFTwilightWandBolt(final abv par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }
    
    public EntityTFTwilightWandBolt(final abv par1World, final oe par2EntityLiving) {
    ...
    protected void a(final asx par1MovingObjectPosition) {
        if (par1MovingObjectPosition.g == null || !(par1MovingObjectPosition.g instanceof oe) || par1MovingObjectPosition.g.a(na.b((nm)this, (nm)this.h()), 6.0f)) {}
        for (int i = 0; i < 8; ++i) {
