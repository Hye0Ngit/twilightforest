...
public class EntityTFTwilightWandBolt extends EntityThrowable
{
    ...
    public EntityTFTwilightWandBolt(final World par1World, final EntityLivingBase par2EntityLiving) {
    ...
    protected void func_70184_a(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.field_72308_g == null || !(par1MovingObjectPosition.field_72308_g instanceof EntityLivingBase) || par1MovingObjectPosition.field_72308_g.func_70097_a(DamageSource.func_76354_b((Entity)this, (Entity)this.func_85052_h()), 6.0f)) {}
        for (int i = 0; i < 8; ++i) {
