...
public class EntityTFUrGhast extends EntityTFTowerGhast implements IBossDisplayData
{
    ...
    @Override
    public boolean func_70097_a(final DamageSource source, int damage) {
        ...
        if (!this.field_70170_p.field_72995_K) {
            if (this.field_70737_aN == this.field_70738_aO) {
                ...
                FMLLog.info("Attack successful, %d damage until phase switch.", new Object[] { this.damageUntilNextPhase });
                if (this.damageUntilNextPhase <= 0) {
                    this.switchPhase();
                }
            }
            else {
                FMLLog.info("Attack fail with %s type attack for %d damage", new Object[] { source.field_76373_n, damage });
            }
        }
    ...
    protected void func_70626_be() {
        ...
        this.func_70623_bb();
        final List nearbyGhasts = this.field_70170_p.func_72872_a((Class)EntityTFMiniGhast.class, this.field_70121_D.func_72314_b(1.0, 1.0, 1.0));
    ...
    private void doTantrumDamageEffects() {
        ...
        final List playersBelow = this.field_70170_p.func_72872_a((Class)EntityPlayer.class, below);
        ...
        final List ghastsBelow = this.field_70170_p.func_72872_a((Class)EntityTFMiniGhast.class, below);
    ...
    private boolean checkGhastsAtTraps() {
        ...
        for (final ChunkCoordinates trap : this.trapLocations) {
            ...
            final List nearbyGhasts = this.field_70170_p.func_72872_a((Class)EntityTFMiniGhast.class, aabb);
