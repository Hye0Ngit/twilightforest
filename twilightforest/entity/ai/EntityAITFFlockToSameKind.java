...
public class EntityAITFFlockToSameKind extends EntityAIBase
{
    ...
    public EntityAITFFlockToSameKind(final EntityLiving par1EntityLiving, final double par2) {
    ...
    public boolean func_75250_a() {
        ...
        final List<EntityLiving> flockList = this.flockCreature.field_70170_p.func_72872_a((Class)this.flockCreature.getClass(), this.flockCreature.field_70121_D.func_72314_b(16.0, 4.0, 16.0));
        int flocknum = 0;
        double flockX = 0.0;
        double flockY = 0.0;
        double flockZ = 0.0;
