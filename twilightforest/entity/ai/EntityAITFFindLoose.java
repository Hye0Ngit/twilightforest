...
public class EntityAITFFindLoose extends EntityAIBase
{
    ...
    public EntityAITFFindLoose(final EntityTFQuestRam entityTFQuestRam, final float speed, final Item blockID) {
    ...
    public boolean func_75250_a() {
        ...
        final List<EntityItem> nearbyItems = this.temptedEntity.field_70170_p.func_72872_a((Class)EntityItem.class, this.temptedEntity.field_70121_D.func_72314_b(16.0, 4.0, 16.0));
