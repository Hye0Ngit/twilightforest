...
public class EntityAITFYetiRampage extends EntityAIBase
{
    ...
    public void func_75246_d() {
        ...
        if (this.currentDuration % 10 == 0) {
            final EntityTFIceBomb ice = new EntityTFIceBomb(this.yeti.field_70170_p, (EntityLivingBase)this.yeti);
            final Vec3d vec = new Vec3d((double)(0.5f + this.yeti.func_70681_au().nextFloat() * 0.5f), (double)(0.5f + this.yeti.func_70681_au().nextFloat() * 0.3f), 0.0).func_178785_b(this.yeti.func_70681_au().nextFloat() * 360.0f);
            ice.func_70186_c(vec.field_72450_a, vec.field_72448_b, vec.field_72449_c, 0.4f + this.yeti.func_70681_au().nextFloat() * 0.3f, 0.0f);
            this.yeti.func_184185_a(SoundEvents.field_187737_v, 1.0f, 1.0f / (this.yeti.func_70681_au().nextFloat() * 0.4f + 0.8f));
            this.yeti.field_70170_p.func_72838_d((Entity)ice);
        }
    }
