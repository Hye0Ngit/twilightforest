...
public class EntityAITFGiantAttackOnCollide extends EntityAIBase
{
    ...
    public EntityAITFGiantAttackOnCollide(final EntityCreature par1EntityCreature, final Class<? extends EntityLivingBase> par2Class, final double par3, final boolean par5) {
        this(par1EntityCreature, par3, par5);
        this.classTarget = par2Class;
    }
    
    public EntityAITFGiantAttackOnCollide(final EntityCreature par1EntityCreature, final double par2, final boolean par4) {
    ...
    public void func_75246_d() {
        ...
        final double attackRange = this.attacker.field_70130_N * this.attacker.field_70131_O;
        --this.delayTicks;
