...
public class EntityAITFBreathAttack<T extends EntityLiving & IBreathAttacker> extends EntityAIBase
{
    ...
    public EntityAITFBreathAttack(final T living, final float speed, final float range, final int time, final float chance) {
    ...
    private Entity getHeadLookTarget() {
        ...
        final Vec3d srcVec = new Vec3d(this.entityHost.field_70165_t, this.entityHost.field_70163_u + 0.25, this.entityHost.field_70161_v);
        final Vec3d lookVec = this.entityHost.func_70676_i(1.0f);
    ...
    public void faceVec(final double x, final double y, final double z, final float yawConstraint, final float pitchConstraint) {
        final double xOffset = x - this.entityHost.field_70165_t;
        final double zOffset = z - this.entityHost.field_70161_v;
        final double yOffset = this.entityHost.field_70163_u + 0.25 - y;
