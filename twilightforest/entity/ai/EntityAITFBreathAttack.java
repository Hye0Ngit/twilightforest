...
public class EntityAITFBreathAttack extends EntityAIBase
{
    ...
    public EntityAITFBreathAttack(final EntityLiving par1EntityLiving, final float speed, final float range, final int time, final float chance) {
    ...
    private Entity getHeadLookTarget() {
        ...
        final Vec3 srcVec = Vec3.func_72443_a(this.entityHost.field_70165_t, this.entityHost.field_70163_u + 0.25, this.entityHost.field_70161_v);
        ...
        final List<Entity> possibleList = this.entityHost.field_70170_p.func_72839_b((Entity)this.entityHost, this.entityHost.field_70121_D.func_72321_a(lookVec.field_72450_a * range, lookVec.field_72448_b * range, lookVec.field_72449_c * range).func_72314_b((double)var9, (double)var9, (double)var9));
        double hitDist = 0.0;
