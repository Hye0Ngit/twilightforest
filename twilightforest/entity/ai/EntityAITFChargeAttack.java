...
public class EntityAITFChargeAttack extends EntityAIBase
{
    ...
    public EntityAITFChargeAttack(final EntityLiving entityLiving, final float f) {
    ...
    public boolean func_75250_a() {
        ...
        final boolean canSeeTargetFromDest = this.chargeTarget.field_70170_p.func_72933_a(this.charger.field_70170_p.func_82732_R().func_72345_a(this.chargeTarget.field_70165_t, this.chargeTarget.field_70163_u + this.chargeTarget.func_70047_e(), this.chargeTarget.field_70161_v), chargePos) == null;
    ...
    public void func_75246_d() {
        ...
        if (this.windup > 0) {
            if (--this.windup == 0) {
                final boolean setpath = this.charger.func_70661_as().func_75492_a(this.chargeX, this.chargeY, this.chargeZ, this.speed);
            }
            else {
                final EntityLiving charger = this.charger;
    ...
    protected Vec3 findChargePoint(final Entity attacker, final Entity target, final double overshoot) {
        ...
        return this.charger.field_70170_p.func_82732_R().func_72345_a(attacker.field_70165_t + dx, target.field_70163_u, attacker.field_70161_v + dz);
    }
}
