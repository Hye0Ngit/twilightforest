...
public class EntityAITFEatLoose extends EntityAIBase
{
    ...
    public boolean func_75250_a() {
        ...
        final List<EntityItem> nearbyItems = this.temptedQuestRam.field_70170_p.func_72872_a((Class)EntityItem.class, this.temptedQuestRam.field_70121_D.func_72314_b(2.0, 2.0, 2.0));
