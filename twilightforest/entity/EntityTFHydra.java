...
public class EntityTFHydra extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public EntityTFHydra(final World world) {
        ...
        this.field_70750_az = "/mods/twilightforest/textures/model/hydra4.png";
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            this.field_70180_af.func_75692_b(18, (Object)this.field_70734_aK);
        }
        else {
            if (this.func_70968_i() != this.field_70734_aK) {
                this.func_70606_j(this.func_70968_i());
            }
        ...
        if (this.field_70716_bi > 0) {
            ...
            final double var3 = this.field_70161_v + (this.field_70711_bl - this.field_70161_v) / this.field_70716_bi;
    ...
    protected void func_70626_be() {
        ++this.field_70708_bq;
        final EntityPlayer entityplayer = this.field_70170_p.func_72890_a((Entity)this, -1.0);
        this.func_70623_bb();
        this.field_70702_br = 0.0f;
        this.field_70701_bs = 0.0f;
        final float f = 48.0f;
        ...
        if (this.field_70146_Z.nextFloat() < 0.7f) {
            final EntityPlayer entityplayer2 = this.field_70170_p.func_72890_a((Entity)this, (double)f);
            if (entityplayer2 != null) {
                this.currentTarget = (Entity)entityplayer2;
        ...
        if (this.currentTarget != null) {
            this.func_70625_a(this.currentTarget, 10.0f, (float)this.func_70646_bf());
            for (int i = 0; i < this.numHeads; ++i) {
                if (!this.isHeadAttacking(this.hc[i]) && !this.hc[i].isSecondaryAttacking) {
                    this.hc[i].setTargetEntity(this.currentTarget);
                }
            }
            if (this.currentTarget.func_70089_S()) {
                final float distance = this.currentTarget.func_70032_d((Entity)this);
                if (this.func_70685_l(this.currentTarget)) {
                    this.attackEntity(this.currentTarget, distance);
                }
            }
            if (this.field_70700_bx-- <= 0 || this.currentTarget.field_70128_L || this.currentTarget.func_70068_e((Entity)this) > f * f) {
                this.currentTarget = null;
            }
        }
        else {
    ...
    private void secondaryAttacks() {
        ...
        final EntityLiving secondaryTarget = this.findSecondaryTarget(20.0);
    ...
    public EntityLiving findSecondaryTarget(final double range) {
        double closestRange = -1.0;
        EntityLiving closestEntity = null;
        final List nearbyEntities = this.field_70170_p.func_72872_a((Class)EntityLiving.class, AxisAlignedBB.func_72332_a().func_72299_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70165_t + 1.0, this.field_70163_u + 1.0, this.field_70161_v + 1.0).func_72314_b(range, range, range));
        for (final EntityLiving nearbyLiving : nearbyEntities) {
    ...
    private void collideWithEntities(final List par1List, final Entity part) {
    ...
    public boolean func_70965_a(final EntityDragonPart dragonpart, final DamageSource damagesource, final int i) {
    ...
    protected boolean superAttackFrom(final DamageSource par1DamageSource, final int par2) {
        return super.func_70097_a(par1DamageSource, par2);
    }
    
    public boolean attackEntityFromPart(final EntityTFHydraPart part, final DamageSource damagesource, final int damageAmount) {
