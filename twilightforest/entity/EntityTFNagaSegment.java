...
public class EntityTFNagaSegment extends Entity
{
    ...
    public EntityTFNagaSegment(final World par1World) {
        super(par1World);
        this.texture = "/mods/twilightforest/textures/model/nagasegment.png";
    ...
    public boolean func_70097_a(final DamageSource damagesource, final int i) {
        return !damagesource.func_94541_c() && !damagesource.func_76347_k() && this.naga != null && this.naga.func_70097_a(damagesource, Math.round(i * 2.0f / 3.0f));
    }
    ...
    private void collideWithEntity(final Entity entity) {
        ...
        if (entity instanceof EntityLiving && !(entity instanceof EntityTFNagaOld) && !(entity instanceof EntityTFNagaSegmentOld)) {
            this.naga.field_70724_aR = 10;
            int attackStrength = 2;
            if (entity instanceof EntityAnimal) {
                attackStrength *= 3;
            }
            entity.func_70097_a(DamageSource.func_76358_a((EntityLiving)this.naga), attackStrength);
        }
    }
