...
public class EntityTFLichBomb extends sv
{
    public EntityTFLichBomb(final zv par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }
    
    public EntityTFLichBomb(final zv par1World, final ng par2EntityLiving) {
        super(par1World, par2EntityLiving);
    }
    
    public EntityTFLichBomb(final zv par1World) {
        super(par1World);
    }
    ...
    protected void explode() {
        ...
        this.q.a((mp)this, this.u, this.v, this.w, explosionPower, false, false);
        this.w();
    }
