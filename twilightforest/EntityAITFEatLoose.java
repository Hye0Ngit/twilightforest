...
public class EntityAITFEatLoose extends nc
{
    ...
    public boolean a() {
        ...
        for (final px itemNearby : nearbyItems) {
            if (itemNearby.a.c == this.temptID && !this.temptedQuestRam.isColorPresent(itemNearby.a.j()) && itemNearby.S()) {
    ...
    public void e() {
        ...
        if (this.temptedQuestRam.e((lq)this.temptingItem) < 6.25 && !this.temptedQuestRam.isColorPresent(this.temptingItem.a.j())) {
            this.temptingItem.x();
            this.temptedQuestRam.aO();
            this.temptedQuestRam.setColorPresent(this.temptingItem.a.j());
            this.temptedQuestRam.animateAddColor(this.temptingItem.a.j(), 50);
        }
    }
}
