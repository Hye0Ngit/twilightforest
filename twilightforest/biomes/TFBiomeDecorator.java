...
public class TFBiomeDecorator extends aat
{
    ...
    public TFBiomeDecorator(final aap biomegenbase) {
        super(biomegenbase);
        ...
        this.extraLakeGen = new adl(aou.F.cz);
        this.extraLavaPoolGen = new adl(aou.H.cz);
        this.plantRootGen = new TFGenPlantRoots();
        this.woodRootGen = new TFGenWoodRoots();
        this.caveWaterGen = new adv(aou.E.cz);
    ...
    protected void decorateUnderground(final zv world, final Random rand, final int mapX, final int mapZ) {
        for (int i = 0; i < 12; ++i) {
            final int rx = mapX + rand.nextInt(16) + 8;
            final byte ry = 64;
            final int rz = mapZ + rand.nextInt(16) + 8;
    ...
    public void decorateOnlyOres(final zv world, final Random rand, final int mapX, final int mapZ) {
        this.a = world;
        this.b = rand;
        this.c = mapX;
        this.d = mapZ;
