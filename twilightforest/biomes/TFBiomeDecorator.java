...
public class TFBiomeDecorator extends yv
{
    ...
    public TFBiomeDecorator(final yr biomegenbase) {
        super(biomegenbase);
        ...
        this.extraLakeGen = new abn(amj.E.cm);
        this.extraLavaPoolGen = new abn(amj.G.cm);
        this.plantRootGen = new TFGenPlantRoots();
        this.woodRootGen = new TFGenWoodRoots();
        this.caveWaterGen = new abx(amj.D.cm);
    ...
    protected void decorateUnderground(final xv world, final Random rand, final int mapX, final int mapZ) {
        for (int i = 0; i < 12; ++i) {
            final int rx = mapX + rand.nextInt(16) + 8;
            final byte ry = 64;
            final int rz = mapZ + rand.nextInt(16) + 8;
    ...
    public void decorateOnlyOres(final xv world, final Random rand, final int mapX, final int mapZ) {
        this.a = world;
        this.b = rand;
        this.c = mapX;
        this.d = mapZ;
