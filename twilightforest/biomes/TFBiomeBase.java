...
public abstract class TFBiomeBase extends BiomeGenBase
{
    ...
    public static boolean checkForBiomeConflicts() {
        ...
        noConflict &= checkBiomeIDisClearOrOurs(TwilightForestMod.idBiomeLightedForest);
    ...
    static {
        ...
        tfSwamp = new TFBiomeSwamp(TwilightForestMod.idBiomeSwamp).setColor(3359778).func_76735_a("Twilight Swamp");
        ...
        oakSavanna = new TFBiomeOakSavanna(TwilightForestMod.idBiomeClearingBorder).setColor(26112).func_76735_a("Oak Savanna");
        lightedForest = new TFBiomeLightedForest(TwilightForestMod.idBiomeLightedForest).setColor(26163).func_76735_a("Lighted Forest");
        ...
        darkForestCenter = new TFBiomeDarkForest(TwilightForestMod.idBiomeMajorFeature).setColor(65793).func_76735_a("Dark Forest Center");
        highlandsCenter = new TFBiomeHighlands(TwilightForestMod.idBiomeMinorFeature).setColor(3359778).func_76735_a("Highlands Center");
    }
}
