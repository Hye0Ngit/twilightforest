...
public abstract class TFBiomeBase extends BiomeGenBase
{
    ...
    public TFBiomeBase(final int i) {
        ...
        this.field_82914_M.add(new BiomeGenBase.SpawnListEntry((Class)EntityBat.class, 10, 8, 8));
    ...
    public static void registerWithBiomeDictionary() {
        BiomeDictionary.registerBiomeType(TFBiomeBase.tfLake, new BiomeDictionary.Type[] { BiomeDictionary.Type.OCEAN });
        BiomeDictionary.registerBiomeType(TFBiomeBase.twilightForest, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST });
        BiomeDictionary.registerBiomeType(TFBiomeBase.twilightForest2, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE });
        BiomeDictionary.registerBiomeType(TFBiomeBase.highlands, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.CONIFEROUS });
        ...
        BiomeDictionary.registerBiomeType(TFBiomeBase.tfSwamp, new BiomeDictionary.Type[] { BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.WET });
        BiomeDictionary.registerBiomeType(TFBiomeBase.stream, new BiomeDictionary.Type[] { BiomeDictionary.Type.RIVER });
        BiomeDictionary.registerBiomeType(TFBiomeBase.tfSnow, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS });
        BiomeDictionary.registerBiomeType(TFBiomeBase.glacier, new BiomeDictionary.Type[] { BiomeDictionary.Type.COLD, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.WASTELAND });
        BiomeDictionary.registerBiomeType(TFBiomeBase.clearing, new BiomeDictionary.Type[] { BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.SPARSE });
        BiomeDictionary.registerBiomeType(TFBiomeBase.oakSavanna, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SPARSE });
        BiomeDictionary.registerBiomeType(TFBiomeBase.fireflyForest, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.LUSH });
        ...
        BiomeDictionary.registerBiomeType(TFBiomeBase.darkForest, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.SPOOKY });
        ...
        BiomeDictionary.registerBiomeType(TFBiomeBase.fireSwamp, new BiomeDictionary.Type[] { BiomeDictionary.Type.SWAMP, BiomeDictionary.Type.WASTELAND, BiomeDictionary.Type.HOT });
        BiomeDictionary.registerBiomeType(TFBiomeBase.darkForestCenter, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.SPOOKY, BiomeDictionary.Type.MAGICAL });
        BiomeDictionary.registerBiomeType(TFBiomeBase.highlandsCenter, new BiomeDictionary.Type[] { BiomeDictionary.Type.MESA, BiomeDictionary.Type.DEAD, BiomeDictionary.Type.DRY, BiomeDictionary.Type.WASTELAND });
        BiomeDictionary.registerBiomeType(TFBiomeBase.thornlands, new BiomeDictionary.Type[] { BiomeDictionary.Type.HILLS, BiomeDictionary.Type.DEAD, BiomeDictionary.Type.DRY, BiomeDictionary.Type.WASTELAND });
    }
    ...
    public boolean doesPlayerHaveRequiredAchievement(final EntityPlayer player) {
        ...
        if (this.getRequiredAchievement() != null && player instanceof EntityClientPlayerMP && ((EntityClientPlayerMP)player).func_146107_m() != null) {
            ...
            return stats2.func_77443_a(this.getRequiredAchievement());
        }
        return true;
    }
    ...
    static {
        ...
        highlands = new TFBiomeHighlands(TwilightForestMod.idBiomeHighlands).setColor(5596740).func_76735_a("Twilight Highlands").func_150570_a(new BiomeGenBase.Height(3.5f, 0.05f));
        ...
        highlandsCenter = new TFBiomeFinalPlateau(TwilightForestMod.idBiomeHighlandsCenter).setColor(3359778).func_76735_a("Highlands Center").func_150570_a(new BiomeGenBase.Height(10.5f, 0.025f));
