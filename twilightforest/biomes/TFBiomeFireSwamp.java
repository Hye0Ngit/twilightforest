...
public class TFBiomeFireSwamp extends TFBiomeBase
{
    ...
    public void a(final xv par1World, final Random par2Random, final int mapX, final int mapZ) {
        ...
        if (nearFeature.chunkDecorationsEnabled) {
            ...
            final TFGenFireJet genSmoker = new TFGenFireJet(TFBlocks.fireJet.cm, 0);
            ...
            final TFGenFireJet genFireJet = new TFGenFireJet(TFBlocks.fireJet.cm, 8);
            for (int l = 0; l < 1; ++l) {
