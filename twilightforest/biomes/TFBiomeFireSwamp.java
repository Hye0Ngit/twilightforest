...
public class TFBiomeFireSwamp extends TFBiomeBase
{
    ...
    public void a(final abv par1World, final Random par2Random, final int mapX, final int mapZ) {
        ...
        if (nearFeature.chunkDecorationsEnabled) {
            ...
            final TFGenFireJet genSmoker = new TFGenFireJet(TFBlocks.fireJet.cF, 0);
            ...
            final TFGenFireJet genFireJet = new TFGenFireJet(TFBlocks.fireJet.cF, 8);
            for (int l = 0; l < 1; ++l) {
