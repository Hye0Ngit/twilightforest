...
public class TFBiomeLightedForest extends TFBiomeTwilightForest
{
    ...
    public void func_76728_a(final World world, final Random rand, final int mapX, final int mapZ) {
        for (int flowerCycles = rand.nextInt(5) - 1, successfulFlowers = 0; successfulFlowers < flowerCycles; ++successfulFlowers) {
            final int flowerType = rand.nextInt(3);
            if (flowerType == 0) {
                TFBiomeLightedForest.field_150610_ae.func_150548_a(1);
            }
            else if (flowerType == 1) {
                TFBiomeLightedForest.field_150610_ae.func_150548_a(4);
            }
            else if (flowerType == 2) {
                TFBiomeLightedForest.field_150610_ae.func_150548_a(5);
            }
            for (int tallFlowerTries = 0; tallFlowerTries < 5; ++tallFlowerTries) {
                ...
                if (TFBiomeLightedForest.field_150610_ae.func_76484_a(world, rand, k1, l1, i2)) {
                    break;
                }
            }
        }
    ...
    public String func_150572_a(final Random p_150572_1_, final int p_150572_2_, final int p_150572_3_, final int p_150572_4_) {
        final double flowerVar = MathHelper.func_151237_a((1.0 + TFBiomeLightedForest.field_150606_ad.func_151601_a(p_150572_2_ / 48.0, p_150572_4_ / 48.0)) / 2.0, 0.0, 0.9999);
