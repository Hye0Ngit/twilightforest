...
public class TFDarkForestBiomeDecorator extends TFBiomeDecorator
{
    ...
    public void a(final abv world, final Random rand, final int mapX, final int mapZ) {
        ...
        if (nearFeature.chunkDecorationsEnabled) {
            ...
            for (int i = 0; i < this.C; ++i) {
                ...
                new afb(aqw.ad.cF).a(world, rand, rx, ry, rz);
            }
            for (int i = 0; i < this.D; ++i) {
                ...
                if (rand.nextInt(24) == 0) {
                    ...
                    final int rz = mapZ + rand.nextInt(16) + 8;
                    final int ry = this.getGroundLevel(world, rx, rz);
                    new afy(TFBlocks.plant.cF, 9).a(world, rand, rx, ry, rz);
                }
            }
            if (rand.nextInt(4) == 0) {
    ...
    public int getGroundLevel(final abv world, final int x, final int z) {
        final adq chunk = world.d(x, z);
        ...
        for (int y = TFWorld.SEALEVEL; y < TFWorld.WORLDHEIGHT - 1; ++y) {
            ...
            if (blockID == aqw.z.cF || blockID == aqw.z.cF || blockID == aqw.z.cF) {
                lastDirt = y + 1;
            }
        }
        return lastDirt;
