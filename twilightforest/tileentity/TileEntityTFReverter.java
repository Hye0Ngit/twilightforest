...
public class TileEntityTFReverter extends asm
{
    ...
    private boolean revertBlock(final int x, final int y, final int z, final short thereBlockID, final byte thereMeta, short replaceBlockID, byte replaceMeta) {
        if (thereBlockID == 0 && aqw.s[replaceBlockID].b((ace)this.k, x, y, z)) {
            return false;
        }
        ...
        if (this.rand.nextInt(10) == 0) {
            if (replaceBlockID != 0) {
                replaceBlockID = (short)TFBlocks.towerTranslucent.cF;
                replaceMeta = 4;
            }
            ...
            if (thereBlockID == 0) {
                ...
                aqw.s[thereBlockID].c(this.k, x, y, z, (int)thereMeta, 0);
            }
        }
        return true;
    }
    ...
    private boolean isUnrevertable(final short thereBlockID, final byte thereMeta, final short replaceBlockID, final byte replaceMeta) {
        return thereBlockID == TFBlocks.towerDevice.cF || replaceBlockID == TFBlocks.towerDevice.cF || ((thereBlockID == TFBlocks.towerTranslucent.cF && replaceBlockID != 4) || (replaceBlockID == TFBlocks.towerTranslucent.cF && replaceMeta != 4)) || (thereBlockID == aqw.bQ.cF && replaceBlockID == aqw.bR.cF) || (thereBlockID == aqw.bR.cF && replaceBlockID == aqw.bQ.cF) || (thereBlockID == aqw.F.cF || replaceBlockID == aqw.F.cF) || (thereBlockID == aqw.G.cF || replaceBlockID == aqw.G.cF) || replaceBlockID == aqw.ar.cF;
    }
    ...
    private boolean canEatBlock(final int thereBlockID, final int thereMeta) {
        return thereBlockID != TFBlocks.towerDevice.cF && thereBlockID != TFBlocks.towerTranslucent.cF;
    }
