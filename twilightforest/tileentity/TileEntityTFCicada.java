...
public class TileEntityTFCicada extends TileEntityTFCritter
{
    ...
    public void playSong() {
        if (!TwilightForestMod.silentCicadas) {
            this.field_70331_k.func_72908_a((double)this.field_70329_l, (double)this.field_70330_m, (double)this.field_70327_n, "mob.tf.cicada", 1.0f, (this.field_70331_k.field_73012_v.nextFloat() - this.field_70331_k.field_73012_v.nextFloat()) * 0.2f + 1.0f);
        }
    }
}
