...
public class TileEntityTFTowerBuilder extends aqj
{
    ...
    public TileEntityTFTowerBuilder() {
        ...
        this.blocksMade = 0;
        this.blockBuiltID = TFBlocks.towerTranslucent.cz;
    ...
    public void h() {
        if (!this.k.I && this.makingBlocks) {
            ...
            if (++this.ticksStopped == 60) {
                this.k.f(this.l, this.m, this.n, TFBlocks.towerDevice.cz, 8, 3);
                this.k.a(this.l, this.m, this.n, TFBlocks.towerDevice.cz, 4);
            }
        }
    }
    ...
    private int findNextFacing() {
        if (this.trackedPlayer != null) {
            final int pitch = kx.c(this.trackedPlayer.B * 4.0f / 360.0f + 1.5) & 0x3;
            if (pitch == 0) {
                return 1;
            }
            if (pitch == 2) {
            ...
            final int direction = kx.c(this.trackedPlayer.A * 4.0f / 360.0f + 0.5) & 0x3;
            switch (direction) {
                case 0: {
                    return 3;
                }
    ...
    private sk findClosestValidPlayer() {
