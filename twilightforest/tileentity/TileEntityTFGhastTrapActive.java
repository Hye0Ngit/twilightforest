...
public class TileEntityTFGhastTrapActive extends TileEntity
{
    ...
    public void func_70316_g() {
        ...
        if (this.field_70331_k.field_72995_K) {
            ...
            if (this.counter < 30) {
                this.field_70331_k.func_72980_b(this.field_70329_l + 0.5, this.field_70330_m + 1.5, this.field_70327_n + 0.5, "TwilightForest:mob.urghast.trapwarmup", 1.0f, 4.0f, false);
            }
            else if (this.counter < 80) {
                this.field_70331_k.func_72980_b(this.field_70329_l + 0.5, this.field_70330_m + 1.5, this.field_70327_n + 0.5, "TwilightForest:mob.urghast.trapon", 1.0f, 4.0f, false);
            }
            else {
                this.field_70331_k.func_72980_b(this.field_70329_l + 0.5, this.field_70330_m + 1.5, this.field_70327_n + 0.5, "TwilightForest:mob.urghast.trapspindown", 1.0f, 4.0f, false);
            }
        }
        if (!this.field_70331_k.field_72995_K) {
            ...
            final List<EntityGhast> nearbyGhasts = this.field_70331_k.func_72872_a((Class)EntityGhast.class, aabb);
