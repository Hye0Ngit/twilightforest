...
public class TileEntityTFGhastTrapActive extends aqj
{
    public int counter;
    public Random rand;
    ...
    public void h() {
        ...
        if (this.k.I) {
            ...
            if (this.counter < 30) {
                this.k.a(this.l + 0.5, this.m + 1.5, this.n + 0.5, "mob.tf.urghast.trapwarmup", 1.0f, 4.0f, false);
            }
            else if (this.counter < 80) {
                this.k.a(this.l + 0.5, this.m + 1.5, this.n + 0.5, "mob.tf.urghast.trapon", 1.0f, 4.0f, false);
            }
            else {
                this.k.a(this.l + 0.5, this.m + 1.5, this.n + 0.5, "mob.tf.urghast.trapspindown", 1.0f, 4.0f, false);
            }
        }
        if (!this.k.I) {
            final aqr aabb = aqr.a().a((double)this.l, this.m + 16.0, (double)this.n, (double)(this.l + 1), (double)(this.m + 16 + 1), (double)(this.n + 1)).b(6.0, 16.0, 6.0);
            final List nearbyGhasts = this.k.a((Class)rs.class, aabb);
            for (final rs ghast : nearbyGhasts) {
            ...
            if (this.counter >= 120) {
                this.k.f(this.l, this.m, this.n, TFBlocks.towerDevice.cz, 10, 3);
            }
        }
    }
}
