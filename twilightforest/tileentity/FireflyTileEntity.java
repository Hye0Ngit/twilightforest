...
public class FireflyTileEntity extends TileEntity implements ITickableTileEntity
{
    ...
    public FireflyTileEntity() {
        super((TileEntityType)TFTileEntities.FIREFLY.get());
    }
    ...
    private boolean anyPlayerInRange() {
        return this.field_145850_b.func_217366_a(this.field_174879_c.func_177958_n() + 0.5, this.field_174879_c.func_177956_o() + 0.5, this.field_174879_c.func_177952_p() + 0.5, 16.0, false) != null;
    }
    ...
    private void spawnParticles() {
        ...
        this.field_145850_b.func_195594_a((IParticleData)TFParticleType.FIREFLY.get(), rx, ry, rz, 0.0, 0.0, 0.0);
    }
}
