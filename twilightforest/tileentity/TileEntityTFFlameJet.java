...
public class TileEntityTFFlameJet extends TileEntity
{
    ...
    public void func_70316_g() {
        ...
        if (!this.field_70331_k.field_72995_K && this.counter % 5 == 0) {
            final List<Entity> entitiesInRange = this.field_70331_k.func_72872_a((Class)Entity.class, AxisAlignedBB.func_72332_a().func_72299_a((double)(this.field_70329_l - 2), (double)this.field_70330_m, (double)(this.field_70327_n - 2), (double)(this.field_70329_l + 2), (double)(this.field_70330_m + 4), (double)(this.field_70327_n + 2)));
