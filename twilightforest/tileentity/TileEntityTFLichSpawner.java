...
public class TileEntityTFLichSpawner extends ans
{
    ...
    public void g() {
        ...
        if (!this.k.I) {
            ...
            final int j = this.k.a((Class)entityliving.getClass(), aoe.a().a((double)this.l, (double)this.m, (double)this.n, (double)(this.l + 1), (double)(this.m + 1), (double)(this.n + 1)).b(30.0, 30.0, 30.0)).size();
            if (j >= 1) {
                this.updateDelay();
                return;
            }
