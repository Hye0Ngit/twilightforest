    ...
    public void func_70316_g() {
        ...
        if (this.anyPlayerInRange()) {
            if (this.field_70331_k.field_72995_K) {
                ...
                final double rx2 = this.field_70329_l + 0.5;
                final double ry2 = this.field_70330_m + 0.5;
                final double rz2 = this.field_70327_n + 0.5;
                myCreature.func_70012_b(rx2, ry2, rz2, this.field_70331_k.field_73012_v.nextFloat() * 360.0f, 0.0f);
