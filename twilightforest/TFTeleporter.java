...
public class TFTeleporter extends yq
{
    ...
    public boolean b(final lq entity, final double par3, final double par5, final double par7, final float par9) {
        ...
        for (int j2 = l - c; j2 <= l + c; ++j2) {
            ...
            for (int j3 = i2 - c; j3 <= i2 + c; ++j3) {
                ...
                for (int k2 = TFWorld.WORLDHEIGHT - 1; k2 >= 0; --k2) {
                    if (this.isBlockPortal((yc)this.myWorld, j2, k2, j3)) {
                        while (this.isBlockPortal((yc)this.myWorld, j2, k2 - 1, j3)) {
                            --k2;
                        }
        ...
        if (d >= 0.0) {
            ...
            if (this.isBlockPortal((yc)this.myWorld, k3 - 1, l2, i3)) {
                portalX -= 0.5;
            }
            if (this.isBlockPortal((yc)this.myWorld, k3 + 1, l2, i3)) {
                portalX += 0.5;
            }
            if (this.isBlockPortal((yc)this.myWorld, k3, l2, i3 - 1)) {
                portalZ -= 0.5;
            }
            if (this.isBlockPortal((yc)this.myWorld, k3, l2, i3 + 1)) {
                portalZ += 0.5;
    ...
    public boolean isBlockPortal(final yc world, final int x, final int y, final int z) {
        return world.a(x, y, z) == TFBlocks.portal.cm;
    }
    
    public boolean a(final lq entity) {
        final double yFactor = (this.myWorld.u.h == 0) ? 2.0 : 0.5;
        final byte byte0 = 16;
        double weight = -1.0;
        ...
        int pz = ez;
        int k1 = 0;
        final int l1 = this.myWorld.t.nextInt(4);
        ...
        this.makePortalAt((yc)this.myWorld, portalX, portalY, portalZ);
        return true;
    }
    
    private void makePortalAt(final yc world, final int px, int py, final int pz) {
        if (py < 30) {
            py = 30;
        }
        world.getClass();
        ...
        --py;
        world.r = true;
        world.b(px - 1, py + 0, pz - 1, amq.x.cm);
        world.b(px + 0, py + 0, pz - 1, amq.x.cm);
        world.b(px + 1, py + 0, pz - 1, amq.x.cm);
        world.b(px + 2, py + 0, pz - 1, amq.x.cm);
        world.b(px - 1, py + 0, pz + 0, amq.x.cm);
        world.b(px + 2, py + 0, pz + 0, amq.x.cm);
        world.b(px - 1, py + 0, pz + 1, amq.x.cm);
        world.b(px + 2, py + 0, pz + 1, amq.x.cm);
        world.b(px - 1, py + 0, pz + 2, amq.x.cm);
        world.b(px + 0, py + 0, pz + 2, amq.x.cm);
        world.b(px + 1, py + 0, pz + 2, amq.x.cm);
        world.b(px + 2, py + 0, pz + 2, amq.x.cm);
        world.b(px + 0, py - 1, pz + 0, amq.y.cm);
        world.b(px + 1, py - 1, pz + 0, amq.y.cm);
        world.b(px + 0, py - 1, pz + 1, amq.y.cm);
        world.b(px + 1, py - 1, pz + 1, amq.y.cm);
        ...
        world.c(px - 1, py + 1, pz - 1, this.randNatureBlockID(world.t), 2);
        world.c(px + 0, py + 1, pz - 1, this.randNatureBlockID(world.t), 2);
        world.c(px + 1, py + 1, pz - 1, this.randNatureBlockID(world.t), 2);
        world.c(px + 2, py + 1, pz - 1, this.randNatureBlockID(world.t), 2);
        world.c(px - 1, py + 1, pz + 0, this.randNatureBlockID(world.t), 2);
        world.c(px + 2, py + 1, pz + 0, this.randNatureBlockID(world.t), 2);
        world.c(px - 1, py + 1, pz + 1, this.randNatureBlockID(world.t), 2);
        world.c(px + 2, py + 1, pz + 1, this.randNatureBlockID(world.t), 2);
        world.c(px - 1, py + 1, pz + 2, this.randNatureBlockID(world.t), 2);
        world.c(px + 0, py + 1, pz + 2, this.randNatureBlockID(world.t), 2);
        world.c(px + 1, py + 1, pz + 2, this.randNatureBlockID(world.t), 2);
        world.c(px + 2, py + 1, pz + 2, this.randNatureBlockID(world.t), 2);
        world.r = false;
    }
    
    public int randNatureBlockID(final Random random) {
        final int[] block = { amq.ai.cm, amq.aj.cm, amq.aa.cm, amq.ah.cm, amq.ag.cm };
