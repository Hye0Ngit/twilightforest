...
public class EntityTFNatureBolt extends rh
{
    public EntityTFNatureBolt(final xv par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }
    
    public EntityTFNatureBolt(final xv par1World, final md par2EntityLiving) {
        super(par1World, par2EntityLiving);
    }
    
    public EntityTFNatureBolt(final xv par1World) {
        super(par1World);
    }
    ...
    protected void a(final anz par1MovingObjectPosition) {
        if (par1MovingObjectPosition.g != null && par1MovingObjectPosition.g instanceof md) {
            if (par1MovingObjectPosition.g.a(lh.b((lq)this, (lq)this.h()), 2)) {
                final byte poisonStrength = (byte)((this.p.t == 0) ? 0 : ((this.p.t == 2) ? 3 : 7));
                if (poisonStrength > 0) {
            ...
            if (this.p.g(dx, dy, dz).a()) {
                this.p.d(dx, dy, dz, amj.N.cm, 2);
            }
        }
        for (int i = 0; i < 8; ++i) {
            this.p.a("iconcrack_" + amj.N.cm, this.t, this.u, this.v, this.aa.nextGaussian() * 0.05, this.aa.nextDouble() * 0.2, this.aa.nextGaussian() * 0.05);
        }
        if (!this.p.J) {
            this.x();
        }
