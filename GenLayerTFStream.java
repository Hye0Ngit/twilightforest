...
public class GenLayerTFStream extends fh
{
    public GenLayerTFStream(final long l, final fh genlayer) {
        super(l);
        super.a = genlayer;
    }
