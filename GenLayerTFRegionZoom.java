...
public class GenLayerTFRegionZoom extends fh
{
    public boolean shiftCenter;
    
    public GenLayerTFRegionZoom(final long l, final fh genlayer, final boolean sc) {
        super(l);
        super.a = genlayer;
        this.shiftCenter = sc;
    }
    ...
    public int[] a(final int x, final int z, final int width, final int depth) {
        ...
        final int[] dest = ak.a(swidth * 2 * (sdepth * 2));
        ...
        final int[] output = ak.a(width * depth);
    ...
    public static fh multipleZoom(final long l, final fh genlayer, final int i) {
        Object obj = genlayer;
        for (int j = 0; j < i; ++j) {
            obj = new GenLayerTFRegionZoom(l + j, (fh)obj, false);
        }
        return (fh)obj;
    }
}
