...
public class ModelTFPenguin extends hl
{
    ql body;
    ql rightarm;
    ql leftarm;
    ...
    public ModelTFPenguin() {
        this.l = 64;
        this.m = 32;
        (this.body = new ql((hl)this, 32, 0)).a(-4.0f, 0.0f, -4.0f, 8, 9, 8);
        this.body.a(0.0f, 14.0f, 0.0f);
        (this.rightarm = new ql((hl)this, 34, 18)).a(-1.0f, -1.0f, -2.0f, 1, 8, 4);
        this.rightarm.a(-4.0f, 15.0f, 0.0f);
        (this.leftarm = new ql((hl)this, 24, 18)).a(0.0f, -1.0f, -2.0f, 1, 8, 4);
        this.leftarm.a(4.0f, 15.0f, 0.0f);
        this.leftarm.i = true;
        (this.rightleg = new ql((hl)this, 0, 16)).a(-2.0f, 0.0f, -5.0f, 4, 1, 8);
        this.rightleg.a(-2.0f, 23.0f, 0.0f);
        this.rightleg.b(64, 32);
        (this.leftleg = new ql((hl)this, 0, 16)).a(-2.0f, 0.0f, -5.0f, 4, 1, 8);
        this.leftleg.a(2.0f, 23.0f, 0.0f);
        (this.head = new ql((hl)this, 0, 0)).a(-3.5f, -4.0f, -3.5f, 7, 5, 7);
        this.head.a(0.0f, 13.0f, 0.0f);
        (this.beak = new ql((hl)this, 0, 13)).a(-1.0f, 0.0f, -1.0f, 2, 1, 2);
        this.beak.a(0.0f, -1.0f, -4.0f);
        this.head.a(this.beak);
    }
    
    public void a(final nk par1Entity, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
    ...
    public void a(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6) {
        ...
        this.rightleg.f = gh.b(par1) * 0.7f * par2;
        this.leftleg.f = gh.b(par1 + 3.1415927f) * 0.7f * par2;
